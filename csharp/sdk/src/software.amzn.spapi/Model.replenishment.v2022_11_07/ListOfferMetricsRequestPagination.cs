...
namespace software.amzn.spapi.Model.replenishment.v2022_11_07
{
    ...
    public partial class ListOfferMetricsRequestPagination : IValidatableObject
    {
        ...
        public ListOfferMetricsRequestPagination(long? limit = default(long?), long? offset = default(long?))
        {
            ...
            if (limit == null)
            {
                throw new ArgumentNullException("limit is a required property for ListOfferMetricsRequestPagination and cannot be null");
            }
            this.Limit = limit;
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new ArgumentNullException("offset is a required property for ListOfferMetricsRequestPagination and cannot be null");
            }
            this.Offset = offset;
        }
