...
namespace software.amzn.spapi.Model.externalFulfillment.inventory.v2024_09_11
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        */
        ...
        /*
        <example>Invalid input provided. Refer to the API documentation for further details.</example>
        */
        ...
        /*
        <example>Provided input contains more number of batches than max supported.</example>
        */
