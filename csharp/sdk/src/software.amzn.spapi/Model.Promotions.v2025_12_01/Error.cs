...
namespace software.amzn.spapi.Model.Promotions.v2025_12_01
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        /// <param name="itemIdentifier">itemIdentifier.</param>
        public Error(string code = default(string), string message = default(string), string? details = default(string?), ItemIdentifier? itemIdentifier = default(ItemIdentifier?))
        {
