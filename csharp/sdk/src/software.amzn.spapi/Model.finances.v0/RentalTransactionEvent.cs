...
namespace software.amzn.spapi.Model.finances.v0
{
    ...
    public partial class RentalTransactionEvent : IValidatableObject
    {
        ...
        /// <param name="rentalEventType">The type of rental event.  Possible values:  * &#x60;RentalCustomerPayment-Buyout&#x60;: A transaction type that represents when the customer wants to buy out a rented item.  * &#x60;RentalCustomerPayment-Extension&#x60;: A transaction type that represents when the customer wants to extend the rental period.  * &#x60;RentalCustomerRefund-Buyout&#x60;: A transaction type that represents when the customer requests a refund for the buyout of the rented item.  * &#x60;RentalCustomerRefund-Extension&#x60;: A transaction type that represents when the customer requests a refund over the extension on the rented item.  * &#x60;RentalHandlingFee&#x60;: A transaction type that represents the fee that Amazon charges sellers who rent through Amazon.  * &#x60;RentalChargeFailureReimbursement&#x60;: A transaction type that represents when Amazon sends money to the seller to compensate for a failed charge.  * &#x60;RentalLostItemReimbursement&#x60;: A transaction type that represents when Amazon sends money to the seller to compensate for a lost item..</param>
        ...
        [DataMember(Name = "ExtensionLength", EmitDefaultValue = true)]
