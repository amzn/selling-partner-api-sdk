...
namespace software.amzn.spapi.Model.finances.v0
{
    ...
    public partial class RemovalShipmentItemAdjustment : IValidatableObject
    {
        ...
        /// <param name="taxCollectionModel">The tax collection model that is applied to the item.  Possible values:  * &#x60;MarketplaceFacilitator&#x60;: Tax is withheld and remitted to the taxing authority by Amazon on behalf of the seller. * &#x60;Standard&#x60;: Tax is paid to the seller and not remitted to the taxing authority by Amazon..</param>
        /// <param name="fulfillmentNetworkSKU">The Amazon fulfillment network SKU for the item..</param>
        /// <param name="adjustedQuantity">Adjusted quantity of &#x60;RemovalShipmentItemAdjustment&#x60; items..</param>
        ...
        /// </summary>
        /// <value>Adjusted quantity of &#x60;RemovalShipmentItemAdjustment&#x60; items.</value>
        [DataMember(Name = "AdjustedQuantity", EmitDefaultValue = true)]
