...
namespace software.amzn.spapi.Model.awd.v2024_05_09
{
    ...
    /// </summary>
    [DataContract(Name = "OutboundExecutionError")]
    public partial class OutboundExecutionError : IValidatableObject
    {
        /// <summary>
        ...
        public OutboundExecutionError(string failureCode = default(string), List<string> failureReasons = default(List<string>), string? sku = default(string?))
        {
            ...
            if (failureCode == null)
            {
                throw new ArgumentNullException("failureCode is a required property for OutboundExecutionError and cannot be null");
            }
            this.FailureCode = failureCode;
            // to ensure "failureReasons" is required (not null)
            if (failureReasons == null)
            {
                throw new ArgumentNullException("failureReasons is a required property for OutboundExecutionError and cannot be null");
            }
