...
namespace software.amzn.spapi.Api.listings.items.v2021_08_01
{
    ...
    public interface IListingsApi : IApiAccessor
    {
        ...
        /// <param name="marketplaceIds">A comma-delimited list of Amazon store identifiers for the request.</param>
        /// <param name="issueLocale">A locale for localization of issues. When not provided, the default language code of the first Amazon store is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when localization is not available for the specified locale. (optional)</param>
        ...
        /// <param name="mode">Describes the mode of operation for the request. (optional)</param>
        /// <param name="issueLocale">A locale for localization of issues. When not provided, the default language code of the first Amazon store is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when localization is not available for the specified locale. (optional)</param>
        /// <returns>ListingsItemSubmissionResponse</returns>
        ...
        /// <param name="sellerId">A selling partner identifier, such as a merchant account or vendor code.</param>
        /// <param name="marketplaceIds">A comma-delimited list of Amazon store identifiers for the request.</param>
        /// <param name="issueLocale">A locale that is used to localize issues. When not provided, the default language code of the first Amazon store is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. When a localization is not available in the specified locale, localized messages default to \&quot;en_US\&quot;. (optional)</param>
        /// <param name="includedData">A comma-delimited list of data sets that you want to include in the response. Default: &#x60;summaries&#x60;. (optional)</param>
