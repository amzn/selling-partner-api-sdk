...
namespace software.amzn.spapi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "amazon-selling-partner-api-sdk/" + Version + "/csharp";
        ...
        /// <summary>
        /// Gets or sets whether rate limit protection is enabled.
        /// When enabled (default), the SDK applies exponential backoff, rate tracking, and circuit breaker logic.
        /// When disabled, HTTP 429 responses are passed directly to the caller without interception.
        /// This value is set at construction time and cannot be changed afterward.
        /// </summary>
        /// <value>True if rate limit protection is enabled (default), false otherwise.</value>
        public virtual bool RateLimitEnabled { get; set; } = true;
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2026-01-30\n";
