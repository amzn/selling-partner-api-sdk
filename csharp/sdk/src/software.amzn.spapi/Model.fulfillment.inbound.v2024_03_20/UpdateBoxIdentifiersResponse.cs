...
namespace software.amzn.spapi.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateBoxIdentifiersResponse")]
    public partial class UpdateBoxIdentifiersResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBoxIdentifiersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateBoxIdentifiersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBoxIdentifiersResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateBoxIdentifiersResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for UpdateBoxIdentifiersResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateBoxIdentifiersResponse {\n");
