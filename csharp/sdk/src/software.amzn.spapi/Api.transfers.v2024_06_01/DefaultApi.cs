...
namespace software.amzn.spapi.Api.transfers.v2024_06_01
{
    ...
    public interface IDefaultApi : IApiAccessor
    {
        ...
        /// <param name="marketplaceId">The identifier of the Amazon store from which you want to retrieve payment methods. For the list of store identifiers, refer to [Store Identifiers](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).</param>
        ...
        /// </remarks>
        /// <exception cref="software.amzn.spapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="marketplaceIds">The Amazon stores from which to retrieve payouts. The Amazon store ID is a globally unique identifier assigned to each Amazon store. If omitted, the response includes payouts from all applicable stores. To find the Amazon store ID for your region, refer to [Store Identifiers](https://developer-docs.amazon/sp-api/docs/store-identifiers). (optional)</param>
        /// <param name="accountType">The response only includes the accounts of the specified account type. (optional)</param>
        ...
        /// <exception cref="software.amzn.spapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="marketplaceIds">The Amazon stores from which to retrieve payouts. The Amazon store ID is a globally unique identifier assigned to each Amazon store. If omitted, the response includes payouts from all applicable stores. To find the Amazon store ID for your region, refer to [Store Identifiers](https://developer-docs.amazon/sp-api/docs/store-identifiers). (optional)</param>
        /// <param name="createdAfter">The response only includes payouts created on or after this date-time. The value must be formatted in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. If omitted, no start date filter is applied. (optional)</param>
        /// <param name="createdBefore">The response only includes payouts created before this date-time. The value must be formatted in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. If omitted, no end date filter is applied. (optional)</param>
        /// <param name="payoutId">The response only includes the payout matching the specified identifier. (optional)</param>
        /// <param name="accountType">The response only includes payouts associated with the specified account type. (optional)</param>
