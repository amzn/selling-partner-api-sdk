...
namespace software.amzn.spapi.Model.orders.v2026_01_01
{
    ...
    /// </summary>
    [DataContract(Name = "ExceptionDate")]
    public partial class ExceptionDate : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="varExceptionDate">Specific calendar date when normal operating hours do not apply. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format at day granularity..</param>
        ...
        public ExceptionDate(DateOnly? varExceptionDate = default(DateOnly?), ExceptionDateTypeEnum? exceptionDateType = default(ExceptionDateTypeEnum?), List<TimeWindow>? timeWindows = default(List<TimeWindow>?))
        {
            this.VarExceptionDate = varExceptionDate;
        ...
        public DateOnly? VarExceptionDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarExceptionDate: ").Append(VarExceptionDate).Append("\n");
