...
namespace software.amzn.spapi.Model.fulfillment.outbound.v2026_07_04
{
    ...
    public partial class Money : IValidatableObject
    {
        ...
        /// <param name="amount">A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows [RFC 7159](https://datatracker.ietf.org/doc/html/rfc7159) for number representation. (required).</param>
