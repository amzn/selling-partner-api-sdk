...
namespace software.amzn.spapi.Model.fulfillment.outbound.v2026_07_04
{
    ...
    public partial class OrderProduct : IValidatableObject
    {
        /// <summary>
        ...
        public OrderProduct(ProductIdentifier productIdentifier = default(ProductIdentifier), Money? perUnitDeclaredValue = default(Money?))
        {
            // to ensure "productIdentifier" is required (not null)
            if (productIdentifier == null)
            {
                throw new ArgumentNullException("productIdentifier is a required property for OrderProduct and cannot be null");
            }
