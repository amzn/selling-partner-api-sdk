...
namespace software.amzn.spapi.Api.finances.v0
{
    ...
    public interface IDefaultApi : IApiAccessor
    {
        ...
        /// <param name="maxResultsPerPage">The maximum number of results per page. If the response exceeds the maximum number of transactions or 10 MB, the response is &#x60;InvalidInput&#x60;. (optional, default to 10)</param>
        /// <param name="financialEventGroupStartedBefore">A date that selects financial event groups that opened before (but not at) a specified date and time, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. The date-time must be after &#x60;FinancialEventGroupStartedAfter&#x60; and more than two minutes before the time of request. If &#x60;FinancialEventGroupStartedAfter&#x60; and &#x60;FinancialEventGroupStartedBefore&#x60; are more than 180 days apart, no financial event groups are returned. (optional)</param>
        /// <param name="financialEventGroupStartedAfter">A date that selects financial event groups that opened after (or at) a specified date and time, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. The date-time must be more than two minutes before you submit the request. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="software.amzn.spapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="maxResultsPerPage">The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the response is &#x60;InvalidInput&#x60;. (optional, default to 100)</param>
        /// <param name="postedAfter">The response includes financial events posted after (or on) this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The date-time must be more than two minutes before the time of the request. (optional)</param>
        ...
        /// <param name="marketplaceId">The ID of the marketplace from which you want to retrieve transactions.</param>
        /// <param name="postedBefore">The response includes financial events posted before (but not on) this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.  The date-time must be later than &#x60;PostedAfter&#x60; and more than two minutes before the request was submitted. If &#x60;PostedAfter&#x60; and &#x60;PostedBefore&#x60; are more than 180 days apart, the response is empty. If you include the &#x60;PostedBefore&#x60; parameter in your request, you must also specify the &#x60;PostedAfter&#x60; parameter.  **Default:** Two minutes before the time of the request. (optional)</param>
        /// <param name="nextToken">The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)</param>
        /// <returns>ListTransactionsResponse</returns>
        ListTransactionsResponse ListTransactions (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null);
        ...
        ApiResponse<ListTransactionsResponse> ListTransactionsWithHttpInfo (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null);
        ...
        System.Threading.Tasks.Task<ListTransactionsResponse> ListTransactionsAsync (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ListTransactionsResponse>> ListTransactionsAsyncWithHttpInfo (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null);
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// <param name="nextToken">The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)</param>
        /// <returns>ListTransactionsResponse</returns>
        public ListTransactionsResponse ListTransactions (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null)
        {
             ApiResponse<ListTransactionsResponse> localVarResponse = ListTransactionsWithHttpInfo(postedAfter, marketplaceId, postedBefore, nextToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="nextToken">The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)</param>
        /// <returns>ApiResponse of ListTransactionsResponse</returns>
        public ApiResponse< ListTransactionsResponse > ListTransactionsWithHttpInfo (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null)
        {
            ...
            if (marketplaceId == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceId' when calling DefaultApi->ListTransactions");

            var localVarPath = "/finances/v0/transactions";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="nextToken">The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)</param>
        /// <returns>Task of ListTransactionsResponse</returns>
        public async System.Threading.Tasks.Task<ListTransactionsResponse> ListTransactionsAsync (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null)
        {
             ApiResponse<ListTransactionsResponse> localVarResponse = await ListTransactionsAsyncWithHttpInfo(postedAfter, marketplaceId, postedBefore, nextToken);
             return localVarResponse.Data;
        ...
        /// <param name="nextToken">The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)</param>
        /// <returns>Task of ApiResponse (ListTransactionsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ListTransactionsResponse>> ListTransactionsAsyncWithHttpInfo (DateTime postedAfter, string marketplaceId, DateTime? postedBefore = null, string? nextToken = null)
        {
            // verify the required parameter 'postedAfter' is set
            if (postedAfter == null)
                throw new ApiException(400, "Missing required parameter 'postedAfter' when calling DefaultApi->ListTransactions");
