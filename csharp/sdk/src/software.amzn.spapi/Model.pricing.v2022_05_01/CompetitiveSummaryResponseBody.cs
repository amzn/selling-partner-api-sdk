...
namespace software.amzn.spapi.Model.pricing.v2022_05_01
{
    ...
    public partial class CompetitiveSummaryResponseBody : IValidatableObject
    {
        ...
        /// <param name="marketplaceId">The &#x60;MarketplaceID&#x60; is the globally unique identifier of an Amazon store. To find the ID for your Amazon store, refer to [Amazon store IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids). (required).</param>
        ...
        /// </summary>
        /// <value>The &#x60;MarketplaceID&#x60; is the globally unique identifier of an Amazon store. To find the ID for your Amazon store, refer to [Amazon store IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).</value>
