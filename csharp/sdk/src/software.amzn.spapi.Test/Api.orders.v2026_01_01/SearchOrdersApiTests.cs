...
namespace software.amzn.spapi.Test.Api.orders.v2026_01_01
{
    ...
    public class SearchOrdersApiTests
    {
        private SearchOrdersApi api;
        ...
        public void Init()
        {
            ...
            api = new SearchOrdersApi.Builder()
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("searchOrders") + "-" + FormatOperationId("SearchOrders") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            

            var response = api.SearchOrdersWithHttpInfo(null, null, null, null, null, null, null, null, null, null);
