...
namespace software.amzn.spapi.Test.Api.sellerWallet.v2024_03_01
{
    ...
    public class TransferPreviewApiTests
    {
        private TransferPreviewApi api;
        ...
        public void Init()
        {
            ...
            api = new TransferPreviewApi.Builder()
        ...
        [Fact]
        public void GetTransferPreviewTest()
        {
            Init();
            var url = "http://localhost:3000/response/" + FormatOperationId("GetTransferPreview") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, AppendQualifier(url, "GetTransferPreview"));
            httpClient.Send(request);
            
            string sourceCountryCode = fixture.Create<string>();
            
            string sourceCurrencyCode = fixture.Create<string>();
            
            string destinationCountryCode = fixture.Create<string>();
            
            string destinationCurrencyCode = fixture.Create<string>();
            
            decimal baseAmount = fixture.Create<decimal>();
            
            string marketplaceId = fixture.Create<string>();
            

            var response = api.GetTransferPreviewWithHttpInfo(sourceCountryCode, sourceCurrencyCode, destinationCountryCode, destinationCurrencyCode, baseAmount, marketplaceId);
