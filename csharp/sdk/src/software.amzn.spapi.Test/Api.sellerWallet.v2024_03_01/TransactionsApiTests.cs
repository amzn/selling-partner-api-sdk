...
namespace software.amzn.spapi.Test.Api.sellerWallet.v2024_03_01
{
    ...
    public class TransactionsApiTests
    {
        ...
        public void Init()
        {
            ...
            api = new TransactionsApi.Builder()
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + FormatOperationId("CreateTransaction") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, AppendQualifier(url, "CreateTransaction"));
            ...
            TransactionInitiationRequest body = fixture.Create<TransactionInitiationRequest>();
            

            var response = api.CreateTransactionWithHttpInfo(destAccountDigitalSignature, amountDigitalSignature, marketplaceId, body);
        ...
        public void GetTransactionTest()
        {
            ...
            var response = api.GetTransactionWithHttpInfo(transactionId, marketplaceId);
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + FormatOperationId("ListAccountTransactions") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, AppendQualifier(url, "ListAccountTransactions"));
            httpClient.Send(request);
            ...
            var response = api.ListAccountTransactionsWithHttpInfo(accountId, marketplaceId, null);
