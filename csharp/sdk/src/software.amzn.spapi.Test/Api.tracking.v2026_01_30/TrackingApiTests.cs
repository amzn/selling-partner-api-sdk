...
using software.amzn.spapi.Api.tracking.v2026_01_30;
using software.amzn.spapi.Model.tracking.v2026_01_30;
using software.amzn.spapi.Model.awd.v2024_05_09;
using HttpMethod = System.Net.Http.HttpMethod;

namespace software.amzn.spapi.Test.Api.tracking.v2026_01_30
{
    ...
    public class TrackingApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("Tracking") + "-" + FormatOperationId("GetShipmentTracking") + "/code/200";
