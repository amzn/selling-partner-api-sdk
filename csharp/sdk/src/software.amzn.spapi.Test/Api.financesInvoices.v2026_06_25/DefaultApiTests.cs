...
using software.amzn.spapi.Api.financesInvoices.v2026_06_25;
using software.amzn.spapi.Model.financesInvoices.v2026_06_25;
using software.amzn.spapi.Model.awd.v2024_05_09;
using HttpMethod = System.Net.Http.HttpMethod;

namespace software.amzn.spapi.Test.Api.financesInvoices.v2026_06_25
{
    ...
    public class DefaultApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("default") + "-" + FormatOperationId("GetInvoice") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            
            string marketplaceId = fixture.Create<string>();
            
            string invoiceIdentifier = fixture.Create<string>();
            

            var response = api.GetInvoiceWithHttpInfo(marketplaceId, invoiceIdentifier, null);
        ...
        [Fact]
        public void GetInvoiceHeadersTest()
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("default") + "-" + FormatOperationId("GetInvoiceHeaders") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            ...
            var response = api.GetInvoiceHeadersWithHttpInfo(marketplaceId, null, null, null, null);
