...
namespace software.amzn.spapi.Test.Api.fulfillment.outbound.v2026_07_04
{
    ...
    public class OffersApiTests
    {
        ...
        [Fact]
        public void GetOffers_0Test()
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("fulfillmentOutbound") + "-" + FormatOperationId("GetOffers_0") + "/code/200";
            ...
            var response = api.GetOffers_0WithHttpInfo(body, null);
