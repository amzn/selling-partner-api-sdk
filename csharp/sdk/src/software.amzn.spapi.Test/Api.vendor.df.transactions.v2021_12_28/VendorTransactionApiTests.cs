...
namespace software.amzn.spapi.Test.Api.vendor.df.transactions.v2021_12_28
{
    ...
    public class VendorTransactionApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + FormatOperationId("GetTransactionStatus") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, AppendQualifier(url, "GetTransactionStatus"));
        ...
        private static string AppendQualifier(string url, string operationId) {
            if ("Api.vendor.df.transactions.v2021_12_28".Contains("vendor") && operationId.Equals("GetOrder")) url += "?qualifier=Vendor";
