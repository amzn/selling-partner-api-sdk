...
namespace software.amzn.spapi.Test.Api.vendor.df.shipping.v2021_12_28
{
    ...
    public class CreateContainerLabelApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + FormatOperationId("CreateContainerLabel") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, AppendQualifier(url, "CreateContainerLabel"));
