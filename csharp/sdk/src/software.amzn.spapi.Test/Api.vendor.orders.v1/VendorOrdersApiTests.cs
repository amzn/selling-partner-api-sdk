...
namespace software.amzn.spapi.Test.Api.vendor.orders.v1
{
    ...
    public class VendorOrdersApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("vendorOrders") + "-" + FormatOperationId("GetPurchaseOrder") + "/code/200";
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("vendorOrders") + "-" + FormatOperationId("GetPurchaseOrders") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("vendorOrders") + "-" + FormatOperationId("GetPurchaseOrdersStatus") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
