...
namespace software.amzn.spapi.Test.Api.sellers.v1
{
    ...
    public class SellersApiTests
    {
        ...
        private static string AppendQualifier(string url, string operationId) {
            ...
            if ("Api.sellers.v1".Contains("externalFulfillment") && operationId.Equals("GetShipment")) url += "?qualifier=ExternalFulfillment";
            if ("Api.sellers.v1".Contains("externalFulfillment") && operationId.Equals("GetShipments")) url += "?qualifier=ExternalFulfillment";
            return url;
        }
    }
}
