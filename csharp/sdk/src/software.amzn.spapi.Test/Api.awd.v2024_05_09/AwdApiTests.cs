...
namespace software.amzn.spapi.Test.Api.awd.v2024_05_09
{
    ...
    public class AwdApiTests
    {
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("awd") + "-" + FormatOperationId("ConfirmReplenishmentOrder") + "/code/204";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            ...
            api.ConfirmReplenishmentOrderWithHttpInfo(orderId);
        ...
        [Fact]
        public void CreateReplenishmentOrderTest()
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("awd") + "-" + FormatOperationId("CreateReplenishmentOrder") + "/code/201";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            
            ReplenishmentOrderCreationData body = fixture.Create<ReplenishmentOrderCreationData>();
            

            var response = api.CreateReplenishmentOrderWithHttpInfo(body);
        ...
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("awd") + "-" + FormatOperationId("GetReplenishmentOrder") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            ...
            var response = api.GetReplenishmentOrderWithHttpInfo(orderId);
        ...
        [Fact]
        public void ListReplenishmentOrdersTest()
        {
            Init();
            var url = "http://localhost:3000/response/" + ToLowerCaseAndCompress("awd") + "-" + FormatOperationId("ListReplenishmentOrders") + "/code/200";
            var request = new HttpRequestMessage(HttpMethod.Post, url);
            httpClient.Send(request);
            

            var response = api.ListReplenishmentOrdersWithHttpInfo(null, null, null, null, null);
