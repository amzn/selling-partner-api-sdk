...
public class FbaInventoryApiTest {
    ...
    public void addInventoryTest() throws Exception {
        ...
        AddInventoryRequest addInventoryRequestBody = easyRandom.nextObject(AddInventoryRequest.class);

        ApiResponse<AddInventoryResponse> response =
                api.addInventoryWithHttpInfo(xAmznIdempotencyToken, addInventoryRequestBody);
    ...
    public void createInventoryItemTest() throws Exception {
        ...
        CreateInventoryItemRequest createInventoryItemRequestBody =
                easyRandom.nextObject(CreateInventoryItemRequest.class);

        ApiResponse<CreateInventoryItemResponse> response =
                api.createInventoryItemWithHttpInfo(createInventoryItemRequestBody);
