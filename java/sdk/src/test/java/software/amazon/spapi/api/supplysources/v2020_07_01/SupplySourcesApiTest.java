...
public class SupplySourcesApiTest {
    ...
    public void createSupplySourceTest() throws Exception {
        ...
        CreateSupplySourceRequest payload = easyRandom.nextObject(CreateSupplySourceRequest.class);

        ApiResponse<CreateSupplySourceResponse> response = api.createSupplySourceWithHttpInfo(payload);
