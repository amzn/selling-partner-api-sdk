...
public class DefaultApiTest {
    ...
    public void getInvoiceTest() throws Exception {
        instructBackendMock("default", "getInvoice", "200");

        String marketplaceId = easyRandom.nextObject(String.class);

        String invoiceIdentifier = easyRandom.nextObject(String.class);

        ApiResponse<GetInvoiceResponse> response = api.getInvoiceWithHttpInfo(marketplaceId, invoiceIdentifier, null);
    ...
    @Test
    public void getInvoiceHeadersTest() throws Exception {
        instructBackendMock("default", "getInvoiceHeaders", "200");

        String marketplaceId = easyRandom.nextObject(String.class);

        ApiResponse<GetInvoicesResponse> response =
                api.getInvoiceHeadersWithHttpInfo(marketplaceId, null, null, null, null);
