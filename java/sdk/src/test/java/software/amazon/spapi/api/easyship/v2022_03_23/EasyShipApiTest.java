...
public class EasyShipApiTest {
    ...
    public void createScheduledPackageTest() throws Exception {
        ...
        CreateScheduledPackageRequest createScheduledPackageRequest =
                easyRandom.nextObject(CreateScheduledPackageRequest.class);

        ApiResponse<ModelPackage> response = api.createScheduledPackageWithHttpInfo(createScheduledPackageRequest);
    ...
    public void createScheduledPackageBulkTest() throws Exception {
        ...
        ApiResponse<CreateScheduledPackagesResponse> response =
                api.createScheduledPackageBulkWithHttpInfo(createScheduledPackagesRequest);
