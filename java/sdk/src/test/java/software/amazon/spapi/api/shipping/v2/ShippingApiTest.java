...
public class ShippingApiTest {
    ...
    public void linkCarrierAccountTest() throws Exception {
        ...
        ApiResponse<LinkCarrierAccountResponse> response = api.linkCarrierAccountWithHttpInfo(carrierId, body, null);
    ...
    public void linkCarrierAccount_0Test() throws Exception {
        ...
        ApiResponse<LinkCarrierAccountResponse> response = api.linkCarrierAccount_0WithHttpInfo(carrierId, body, null);
    ...
    public void unlinkCarrierAccountTest() throws Exception {
        ...
        ApiResponse<UnlinkCarrierAccountResponse> response =
                api.unlinkCarrierAccountWithHttpInfo(carrierId, body, null);
