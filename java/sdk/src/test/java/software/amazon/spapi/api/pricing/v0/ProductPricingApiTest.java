...
public class ProductPricingApiTest {
    ...
    public void getItemOffersBatchTest() throws Exception {
        ...
        GetItemOffersBatchRequest getItemOffersBatchRequestBody =
                easyRandom.nextObject(GetItemOffersBatchRequest.class);

        ApiResponse<GetItemOffersBatchResponse> response =
                api.getItemOffersBatchWithHttpInfo(getItemOffersBatchRequestBody);
    ...
    public void getListingOffersBatchTest() throws Exception {
        ...
        GetListingOffersBatchRequest getListingOffersBatchRequestBody =
                easyRandom.nextObject(GetListingOffersBatchRequest.class);

        ApiResponse<GetListingOffersBatchResponse> response =
                api.getListingOffersBatchWithHttpInfo(getListingOffersBatchRequestBody);
