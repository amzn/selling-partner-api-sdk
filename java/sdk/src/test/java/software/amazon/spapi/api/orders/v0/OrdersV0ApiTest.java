...
public class OrdersV0ApiTest {
    ...
    public void confirmShipmentTest() throws Exception {
        ...
        ConfirmShipmentRequest payload = easyRandom.nextObject(ConfirmShipmentRequest.class);
    ...
    public void updateVerificationStatusTest() throws Exception {
        ...
        UpdateVerificationStatusRequest payload = easyRandom.nextObject(UpdateVerificationStatusRequest.class);
