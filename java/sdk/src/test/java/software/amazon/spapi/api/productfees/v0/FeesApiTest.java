...
public class FeesApiTest {
    ...
    public void getMyFeesEstimateForASINTest() throws Exception {
        ...
        ApiResponse<GetMyFeesEstimateResponse> response = api.getMyFeesEstimateForASINWithHttpInfo(asin, body);
    ...
    public void getMyFeesEstimateForSKUTest() throws Exception {
        ...
        ApiResponse<GetMyFeesEstimateResponse> response = api.getMyFeesEstimateForSKUWithHttpInfo(sellerSKU, body);
