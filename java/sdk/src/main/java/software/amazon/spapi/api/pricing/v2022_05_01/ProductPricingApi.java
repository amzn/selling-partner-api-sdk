...
public class ProductPricingApi {
    ...
    private okhttp3.Call getCompetitiveSummaryValidateBeforeCall(
        ...
        if (requests == null) {
            throw new ApiException(
                    "Missing the required parameter 'requests' when calling getCompetitiveSummary(Async)");
        }

        return getCompetitiveSummaryCall(requests, progressRequestListener);
    }
    ...
    public CompetitiveSummaryBatchResponse getCompetitiveSummary(
            CompetitiveSummaryBatchRequest requests, String restrictedDataToken) throws ApiException, LWAException {
        ApiResponse<CompetitiveSummaryBatchResponse> resp =
                getCompetitiveSummaryWithHttpInfo(requests, restrictedDataToken);
        return resp.getData();
    }
    ...
    public CompetitiveSummaryBatchResponse getCompetitiveSummary(CompetitiveSummaryBatchRequest requests)
            throws ApiException, LWAException {
        ApiResponse<CompetitiveSummaryBatchResponse> resp = getCompetitiveSummaryWithHttpInfo(requests, null);
        return resp.getData();
    }
    ...
    public ApiResponse<CompetitiveSummaryBatchResponse> getCompetitiveSummaryWithHttpInfo(
            CompetitiveSummaryBatchRequest requests, String restrictedDataToken) throws ApiException, LWAException {
        okhttp3.Call call = getCompetitiveSummaryValidateBeforeCall(requests, null);
     ...
     */
    public ApiResponse<CompetitiveSummaryBatchResponse> getCompetitiveSummaryWithHttpInfo(
            CompetitiveSummaryBatchRequest requests) throws ApiException, LWAException {
        return getCompetitiveSummaryWithHttpInfo(requests, null);
    }
    ...
    public okhttp3.Call getCompetitiveSummaryAsync(
            CompetitiveSummaryBatchRequest requests, final ApiCallback<CompetitiveSummaryBatchResponse> callback)
            throws ApiException, LWAException {
        return getCompetitiveSummaryAsync(requests, callback, null);
    }
    /**
     * (asynchronously) Returns the competitive summary response, including featured buying options for the ASIN and
     * &#x60;marketplaceId&#x60; combination. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
     ...
     *
     * @param getFeaturedOfferExpectedPriceBatchRequestBody The batch of &#x60;getFeaturedOfferExpectedPrice&#x60;
     *     requests. (required)
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private okhttp3.Call getFeaturedOfferExpectedPriceBatchValidateBeforeCall(
        ...
        if (getFeaturedOfferExpectedPriceBatchRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'getFeaturedOfferExpectedPriceBatchRequestBody' when calling getFeaturedOfferExpectedPriceBatch(Async)");
        }

        return getFeaturedOfferExpectedPriceBatchCall(
                getFeaturedOfferExpectedPriceBatchRequestBody, progressRequestListener);
    }
    ...
    public GetFeaturedOfferExpectedPriceBatchResponse getFeaturedOfferExpectedPriceBatch(
            ...
            String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<GetFeaturedOfferExpectedPriceBatchResponse> resp = getFeaturedOfferExpectedPriceBatchWithHttpInfo(
                getFeaturedOfferExpectedPriceBatchRequestBody, restrictedDataToken);
        return resp.getData();
    }
    ...
    public GetFeaturedOfferExpectedPriceBatchResponse getFeaturedOfferExpectedPriceBatch(
        ...
        ApiResponse<GetFeaturedOfferExpectedPriceBatchResponse> resp =
                getFeaturedOfferExpectedPriceBatchWithHttpInfo(getFeaturedOfferExpectedPriceBatchRequestBody, null);
        return resp.getData();
    }
    ...
    public ApiResponse<GetFeaturedOfferExpectedPriceBatchResponse> getFeaturedOfferExpectedPriceBatchWithHttpInfo(
        ...
        okhttp3.Call call = getFeaturedOfferExpectedPriceBatchValidateBeforeCall(
                getFeaturedOfferExpectedPriceBatchRequestBody, null);
    ...
    public ApiResponse<GetFeaturedOfferExpectedPriceBatchResponse> getFeaturedOfferExpectedPriceBatchWithHttpInfo(
            GetFeaturedOfferExpectedPriceBatchRequest getFeaturedOfferExpectedPriceBatchRequestBody)
            throws ApiException, LWAException {
        return getFeaturedOfferExpectedPriceBatchWithHttpInfo(getFeaturedOfferExpectedPriceBatchRequestBody, null);
    }
    ...
    public okhttp3.Call getFeaturedOfferExpectedPriceBatchAsync(
            ...
            throws ApiException, LWAException {
        return getFeaturedOfferExpectedPriceBatchAsync(getFeaturedOfferExpectedPriceBatchRequestBody, callback, null);
    }
    /**
     * (asynchronously) Returns the set of responses that correspond to the batched list of up to 40 requests defined in
     * the request body. The response for each successful (HTTP status code 200) request in the set includes the
