...
public class Address {
     ...
     * @return county
     */
    @Schema(description = "Optional county where this address is located.")
     ...
     * @return phoneNumber
     */
    @Schema(description = "Optional E.164-formatted phone number for an available contact at this address.")
