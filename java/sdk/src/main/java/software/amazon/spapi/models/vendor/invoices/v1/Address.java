...
public class Address {
     ...
     */
    @javax.annotation.Nullable public String getPostalOrZipCode() {
        return postalOrZipCode;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if ((jsonObj.get("postalOrZipCode") != null
                        && !jsonObj.get("postalOrZipCode").isJsonNull())
                && !jsonObj.get("postalOrZipCode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(
                    "Expected the field `postalOrZipCode` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("postalOrZipCode").toString()));
        }
