...
public class ItemSearchResults {
     ...
     * @return refinements
     */
    @javax.annotation.Nullable public Refinements getRefinements() {
        return refinements;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the optional field `refinements`
        if (jsonObj.get("refinements") != null && !jsonObj.get("refinements").isJsonNull()) {
            Refinements.validateJsonElement(jsonObj.get("refinements"));
        }
