...
public class VendorOrdersApi {
     ...
     */
    private okhttp3.Call getPurchaseOrderCall(String purchaseOrderNumber, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath;
        if ("/vendor/orders/v1/purchaseOrders/{purchaseOrderNumber}"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/vendor/orders/v1/purchaseOrders/{purchaseOrderNumber}"
    ...
    private okhttp3.Call getPurchaseOrderValidateBeforeCall(
            String purchaseOrderNumber, final ApiCallback progressRequestListener) throws ApiException, LWAException {
     ...
     *     be same as &#39;sellingParty.partyId&#39; in the purchase order. If not included in the filter, all purchase
     *     orders for all of the vendor codes that exist in the vendor group used to authorize the API client
    ...
    private okhttp3.Call getPurchaseOrdersCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/vendor/orders/v1/purchaseOrders".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/vendor/orders/v1/purchaseOrders";
        } else {
            localVarPath = "/vendor/orders/v1/purchaseOrders";
        }
     ...
     * &#x60;changedBefore&#x60; parameters. The date range must not exceed 7 days and is available to pull data from
     * the past 6 months. You can choose to get only the purchase order numbers by setting &#x60;includeDetails&#x60; to
     * false. You can then use the &#x60;getPurchaseOrder&#x60; operation to receive details for a specific purchase
     ...
     *     returned. (optional)
     * @param shipToPartyId Filters purchase orders for a specific buyer&#39;s Fulfillment Center/warehouse by providing
     *     ship to location id here. This value should be same as &#39;shipToParty.partyId&#39; in the purchase order.
     *     If not included in filter, this will return purchase orders for all the buyer&#39;s warehouses used for
     *     vendor group purchase orders. (optional)
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
    ...
    private okhttp3.Call getPurchaseOrdersStatusCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/vendor/orders/v1/purchaseOrdersStatus".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/vendor/orders/v1/purchaseOrdersStatus";
        } else {
            localVarPath = "/vendor/orders/v1/purchaseOrdersStatus";
        }
    ...
    private okhttp3.Call submitAcknowledgementCall(
            SubmitAcknowledgementRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath;
        if ("/vendor/orders/v1/acknowledgements".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/vendor/orders/v1/acknowledgements";
        } else {
            localVarPath = "/vendor/orders/v1/acknowledgements";
        }
