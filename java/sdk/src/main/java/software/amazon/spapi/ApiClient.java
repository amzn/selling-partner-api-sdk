...
public class ApiClient {
    ...
    public ApiClient(boolean rateLimitEnabled) {
        this.rateLimitEnabled = rateLimitEnabled;
        this.rateLimitInterceptor =
                new RateLimitInterceptor(new RateLimitInterceptor.RateLimitConfig(rateLimitEnabled));
    ...
    public ApiClient(OkHttpClient httpClient, boolean rateLimitEnabled) {
        this.rateLimitEnabled = rateLimitEnabled;
        this.rateLimitInterceptor =
                new RateLimitInterceptor(new RateLimitInterceptor.RateLimitConfig(rateLimitEnabled));
    ...
    public <T> ApiResponse<T> execute(Call call, Type returnType) throws ApiException {
        try {
            Response response;
            if (rateLimitEnabled) {
                String operationKey = deriveOperationKey(call);
                response = rateLimitInterceptor.executeWithProtection(
                        operationKey, () -> call.clone().execute());
            } else {
    ...
    /**
     * Derive the operation key from the OkHttp Call object. Format: "METHOD /path" (e.g., "GET /orders/v0/orders")
     *
     * @param call The OkHttp Call
     * @return The operation key string
     */
    private String deriveOperationKey(Call call) {
     ...
     *
     * @return true if rate limit protection is enabled
     */
    ...
    /**
     * Get the RateLimitInterceptor instance.
     *
    ...
    /**
     * Builder for constructing ApiClient instances with custom configuration.
     *
     * <p>Example usage:
     *
     * <pre>
    ...
    public static class Builder {
        ...
        /**
         * Set whether rate limit protection is enabled (default: true).
         *
         * <p>When enabled, the SDK automatically retries HTTP 429 responses with exponential backoff, tracks rate
         * limits from response headers, and applies per-operation circuit breaking.
         *
         * @param enabled true to enable rate limit protection, false to disable
        ...
        /**
         * Set a custom OkHttpClient instance.
         *
        ...
        /**
         * Build the ApiClient instance.
         *
         * @return A configured ApiClient instance
         */
        public ApiClient build() {
            if (httpClient != null) {
                return new ApiClient(httpClient, rateLimitEnabled);
            }
            return new ApiClient(rateLimitEnabled);
        }
    }
}
