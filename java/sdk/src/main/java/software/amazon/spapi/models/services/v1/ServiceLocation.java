...
@io.swagger.v3.oas.annotations.media.Schema(description = "Information about the location of the service job.")
public class ServiceLocation {
     ...
     */
    @io.swagger.v3.oas.annotations.media.Schema(description = "The location of the service job.")
