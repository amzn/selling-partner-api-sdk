...
@io.swagger.v3.oas.annotations.media.Schema(description = "A list of transfer schedules.")
public class TransferScheduleListing {
    @SerializedName("nextPageToken")
    private String nextPageToken = null;

    @SerializedName("transferSchedules")
    private List<TransferSchedule> transferSchedules = null;
     ...
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "A list of transfer schedules.")
