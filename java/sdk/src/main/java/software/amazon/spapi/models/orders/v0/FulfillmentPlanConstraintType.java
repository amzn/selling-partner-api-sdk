...
public enum FulfillmentPlanConstraintType {
    ...
    public static FulfillmentPlanConstraintType fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<FulfillmentPlanConstraintType> {
        @Override
        public void write(final JsonWriter jsonWriter, final FulfillmentPlanConstraintType enumeration)
                throws IOException {
        ...
        public FulfillmentPlanConstraintType read(final JsonReader jsonReader) throws IOException {
            ...
            return FulfillmentPlanConstraintType.fromValue((String) (value));
        }
    }
}
