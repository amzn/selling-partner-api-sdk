...
public class FbaOutboundApi {
    ...
    private okhttp3.Call cancelFulfillmentOrderCall(
            String sellerFulfillmentOrderId, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel"
                    .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", sellerFulfillmentOrderId.toString());
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel"
                    .replaceAll(
    ...
    private okhttp3.Call createFulfillmentOrderCall(
            CreateFulfillmentOrderRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders";
        }
    ...
    private okhttp3.Call createFulfillmentReturnCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/return"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/return"
                    .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", sellerFulfillmentOrderId.toString());
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/return"
                    .replaceAll(
    ...
    private okhttp3.Call createFulfillmentReturnValidateBeforeCall(
        ...
        return createFulfillmentReturnCall(sellerFulfillmentOrderId, body, progressRequestListener);
    }
    ...
    public CreateFulfillmentReturnResponse createFulfillmentReturn(
            String sellerFulfillmentOrderId, CreateFulfillmentReturnRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<CreateFulfillmentReturnResponse> resp =
                createFulfillmentReturnWithHttpInfo(sellerFulfillmentOrderId, body, restrictedDataToken);
        return resp.getData();
    }
     ...
     */
    public CreateFulfillmentReturnResponse createFulfillmentReturn(
            String sellerFulfillmentOrderId, CreateFulfillmentReturnRequest body) throws ApiException, LWAException {
        ApiResponse<CreateFulfillmentReturnResponse> resp =
                createFulfillmentReturnWithHttpInfo(sellerFulfillmentOrderId, body, null);
        return resp.getData();
    }
    ...
    public ApiResponse<CreateFulfillmentReturnResponse> createFulfillmentReturnWithHttpInfo(
            String sellerFulfillmentOrderId, CreateFulfillmentReturnRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = createFulfillmentReturnValidateBeforeCall(sellerFulfillmentOrderId, body, null);
    ...
    public ApiResponse<CreateFulfillmentReturnResponse> createFulfillmentReturnWithHttpInfo(
            String sellerFulfillmentOrderId, CreateFulfillmentReturnRequest body) throws ApiException, LWAException {
        return createFulfillmentReturnWithHttpInfo(sellerFulfillmentOrderId, body, null);
    }
    ...
    public okhttp3.Call createFulfillmentReturnAsync(
            ...
            throws ApiException, LWAException {
        return createFulfillmentReturnAsync(sellerFulfillmentOrderId, body, callback, null);
    }
    /**
     * (asynchronously) Creates a fulfillment return. **Usage Plan:** | Rate (requests per second) | Burst | | ---- |
     * ---- | | 2 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
    ...
    public okhttp3.Call createFulfillmentReturnAsync(
        ...
        okhttp3.Call call =
                createFulfillmentReturnValidateBeforeCall(sellerFulfillmentOrderId, body, progressRequestListener);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    private okhttp3.Call deliveryOffersCall(GetDeliveryOffersRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/deliveryOffers".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/deliveryOffers";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/deliveryOffers";
        }
    ...
    private okhttp3.Call deliveryOffersValidateBeforeCall(
            GetDeliveryOffersRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
    ...
    private okhttp3.Call getFeatureInventoryCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/features/inventory/{featureName}"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/features/inventory/{featureName}"
                    .replaceAll("\\{" + "featureName" + "\\}", featureName.toString());
        } else {
            localVarPath = "/fba/outbound/2020-07-01/features/inventory/{featureName}"
    ...
    private okhttp3.Call getFeatureSKUCall(
            String marketplaceId, String featureName, String sellerSku, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/features/inventory/{featureName}/{sellerSku}"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/features/inventory/{featureName}/{sellerSku}"
                    .replaceAll("\\{" + "featureName" + "\\}", featureName.toString())
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    private okhttp3.Call getFeaturesCall(String marketplaceId, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/features".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/features";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/features";
        }
    ...
    private okhttp3.Call getFeaturesValidateBeforeCall(String marketplaceId, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
    ...
    private okhttp3.Call getFulfillmentOrderCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}"
                    .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", sellerFulfillmentOrderId.toString());
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}"
                    .replaceAll(
    ...
    private okhttp3.Call getFulfillmentPreviewCall(
            GetFulfillmentPreviewRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders/preview"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/preview";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/preview";
        }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    private okhttp3.Call getPackageTrackingDetailsCall(Integer packageNumber, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/tracking".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/tracking";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/tracking";
        }
    ...
    private okhttp3.Call getPackageTrackingDetailsValidateBeforeCall(
            Integer packageNumber, final ApiCallback progressRequestListener) throws ApiException, LWAException {
    ...
    private okhttp3.Call listAllFulfillmentOrdersCall(
            OffsetDateTime queryStartDate, String nextToken, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listReturnReasonCodesCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/returnReasonCodes".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/returnReasonCodes";
        } else {
            localVarPath = "/fba/outbound/2020-07-01/returnReasonCodes";
        }
    ...
    private okhttp3.Call submitFulfillmentOrderStatusUpdateCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/status"
                .equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/status"
                    .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", sellerFulfillmentOrderId.toString());
        } else {
            localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/status"
                    .replaceAll(
    ...
    private okhttp3.Call submitFulfillmentOrderStatusUpdateValidateBeforeCall(
        ...
        return submitFulfillmentOrderStatusUpdateCall(sellerFulfillmentOrderId, body, progressRequestListener);
    }
    ...
    public SubmitFulfillmentOrderStatusUpdateResponse submitFulfillmentOrderStatusUpdate(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> resp =
                submitFulfillmentOrderStatusUpdateWithHttpInfo(sellerFulfillmentOrderId, body, restrictedDataToken);
        return resp.getData();
    }
    ...
    public SubmitFulfillmentOrderStatusUpdateResponse submitFulfillmentOrderStatusUpdate(
            ...
            throws ApiException, LWAException {
        ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> resp =
                submitFulfillmentOrderStatusUpdateWithHttpInfo(sellerFulfillmentOrderId, body, null);
        return resp.getData();
    }
    ...
    public ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> submitFulfillmentOrderStatusUpdateWithHttpInfo(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = submitFulfillmentOrderStatusUpdateValidateBeforeCall(sellerFulfillmentOrderId, body, null);
    ...
    public ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> submitFulfillmentOrderStatusUpdateWithHttpInfo(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body)
            throws ApiException, LWAException {
        return submitFulfillmentOrderStatusUpdateWithHttpInfo(sellerFulfillmentOrderId, body, null);
    }
    ...
    public okhttp3.Call submitFulfillmentOrderStatusUpdateAsync(
            ...
            throws ApiException, LWAException {
        return submitFulfillmentOrderStatusUpdateAsync(sellerFulfillmentOrderId, body, callback, null);
    }
    /**
     * (asynchronously) Requests that Amazon update the status of an order in the sandbox testing environment. This is a
     * sandbox-only operation and must be directed to a sandbox endpoint. Refer to [Fulfillment Outbound Dynamic Sandbox
    ...
    public okhttp3.Call submitFulfillmentOrderStatusUpdateAsync(
        ...
        okhttp3.Call call = submitFulfillmentOrderStatusUpdateValidateBeforeCall(
                sellerFulfillmentOrderId, body, progressRequestListener);
    ...
    private okhttp3.Call updateFulfillmentOrderValidateBeforeCall(
        ...
        return updateFulfillmentOrderCall(sellerFulfillmentOrderId, body, progressRequestListener);
    }
    ...
    public UpdateFulfillmentOrderResponse updateFulfillmentOrder(
            String sellerFulfillmentOrderId, UpdateFulfillmentOrderRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<UpdateFulfillmentOrderResponse> resp =
                updateFulfillmentOrderWithHttpInfo(sellerFulfillmentOrderId, body, restrictedDataToken);
        return resp.getData();
    }
     ...
     */
    public UpdateFulfillmentOrderResponse updateFulfillmentOrder(
            String sellerFulfillmentOrderId, UpdateFulfillmentOrderRequest body) throws ApiException, LWAException {
        ApiResponse<UpdateFulfillmentOrderResponse> resp =
                updateFulfillmentOrderWithHttpInfo(sellerFulfillmentOrderId, body, null);
        return resp.getData();
    }
    ...
    public ApiResponse<UpdateFulfillmentOrderResponse> updateFulfillmentOrderWithHttpInfo(
            String sellerFulfillmentOrderId, UpdateFulfillmentOrderRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = updateFulfillmentOrderValidateBeforeCall(sellerFulfillmentOrderId, body, null);
    ...
    public ApiResponse<UpdateFulfillmentOrderResponse> updateFulfillmentOrderWithHttpInfo(
            String sellerFulfillmentOrderId, UpdateFulfillmentOrderRequest body) throws ApiException, LWAException {
        return updateFulfillmentOrderWithHttpInfo(sellerFulfillmentOrderId, body, null);
    }
    ...
    public okhttp3.Call updateFulfillmentOrderAsync(
            ...
            throws ApiException, LWAException {
        return updateFulfillmentOrderAsync(sellerFulfillmentOrderId, body, callback, null);
    }
    /**
     * (asynchronously) Updates and/or requests shipment for a fulfillment order with an order hold on it. **Usage
     * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60;
    ...
    public okhttp3.Call updateFulfillmentOrderAsync(
        ...
        okhttp3.Call call =
                updateFulfillmentOrderValidateBeforeCall(sellerFulfillmentOrderId, body, progressRequestListener);
