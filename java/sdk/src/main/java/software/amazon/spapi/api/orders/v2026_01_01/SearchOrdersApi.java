...
public class SearchOrdersApi {
     ...
     * @param lastUpdatedAfter The response includes orders updated at or after this time. An update is any change made
     *     by Amazon or the seller, including changes to order status. The date must be in [ISO
     *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. **Note**: You must provide exactly one
     ...
     * @param lastUpdatedBefore The response includes orders updated at or before this time. An update is any change
     *     made by Amazon or the seller, including changes to order status. The date must be in [ISO
     *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. **Note**: If you include
     ...
     * specific types of orders. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0056 | 20 |
     * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that are applied to the
    ...
    /**
     * (asynchronously) Returns orders created or updated during the time period that you specify. You can filter the
     * response for specific types of orders. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
     * 0.0056 | 20 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that are
