...
public class DefaultApi {
     ...
     * @param postedAfter The response includes financial events posted after (or on) this date. This date must be in
     *     [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The date-time must be
     *     more than two minutes before the time of the request. (required)
     * @param marketplaceId The ID of the marketplace from which you want to retrieve transactions. (required)
     * @param postedBefore The response includes financial events posted before (but not on) this date. This date must
     *     be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The date-time must
     *     be later than &#x60;PostedAfter&#x60; and more than two minutes before the request was submitted. If
     *     &#x60;PostedAfter&#x60; and &#x60;PostedBefore&#x60; are more than 180 days apart, the response is empty. If
    ...
    private okhttp3.Call listTransactionsCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/finances/v0/transactions".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/finances/v0/transactions";
        } else {
            localVarPath = "/finances/v0/transactions";
        }
    ...
    private okhttp3.Call listTransactionsValidateBeforeCall(
        ...
        if (marketplaceId == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceId' when calling listTransactions(Async)");
        }

        return listTransactionsCall(postedAfter, marketplaceId, postedBefore, nextToken, progressRequestListener);
    }

    /**
     * Returns transactions for the given parameters. Orders from the last 48 hours might not be included in financial
     * events. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 10 | The
     * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the
     * requested operation, when available. The preceding table contains the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput can have higher rate and burst
     * values than those shown here. For more information, refer to [Usage Plans and Rate
    ...
    public ListTransactionsResponse listTransactions(
            ...
            String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<ListTransactionsResponse> resp =
                listTransactionsWithHttpInfo(postedAfter, marketplaceId, postedBefore, nextToken, restrictedDataToken);
        return resp.getData();
    }
     ...
     */
    public ListTransactionsResponse listTransactions(
            OffsetDateTime postedAfter, String marketplaceId, OffsetDateTime postedBefore, String nextToken)
            throws ApiException, LWAException {
        ApiResponse<ListTransactionsResponse> resp =
                listTransactionsWithHttpInfo(postedAfter, marketplaceId, postedBefore, nextToken, null);
        return resp.getData();
    }
    ...
    public ApiResponse<ListTransactionsResponse> listTransactionsWithHttpInfo(
            ...
            throws ApiException, LWAException {
        okhttp3.Call call =
                listTransactionsValidateBeforeCall(postedAfter, marketplaceId, postedBefore, nextToken, null);
    ...
    public ApiResponse<ListTransactionsResponse> listTransactionsWithHttpInfo(
            OffsetDateTime postedAfter, String marketplaceId, OffsetDateTime postedBefore, String nextToken)
            throws ApiException, LWAException {
        return listTransactionsWithHttpInfo(postedAfter, marketplaceId, postedBefore, nextToken, null);
    }

    /**
     * (asynchronously) Returns transactions for the given parameters. Orders from the last 48 hours might not be
     * included in financial events. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 10 |
     * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to
     * the requested operation, when available. The preceding table contains the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput can have higher rate and burst
     * values than those shown here. For more information, refer to [Usage Plans and Rate
    ...
    public okhttp3.Call listTransactionsAsync(
            ...
            throws ApiException, LWAException {
        return listTransactionsAsync(postedAfter, marketplaceId, postedBefore, nextToken, callback, null);
    }
    /**
     * (asynchronously) Returns transactions for the given parameters. Orders from the last 48 hours might not be
     * included in financial events. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 10 |
    ...
    public okhttp3.Call listTransactionsAsync(
        ...
        okhttp3.Call call = listTransactionsValidateBeforeCall(
                postedAfter, marketplaceId, postedBefore, nextToken, progressRequestListener);
