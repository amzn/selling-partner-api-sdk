...
/** Details of quantity. */
@io.swagger.v3.oas.annotations.media.Schema(description = "Details of quantity.")
public class ItemQuantity {
     ...
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "Unit of measure for the quantity.")
     ...
     * @return unitSize
     */
    @io.swagger.v3.oas.annotations.media.Schema(description = "The case size, if the unit of measure value is Cases.")
