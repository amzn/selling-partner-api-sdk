...
public class Constraint {
     ...
     * @return type
     */
    @Schema(example = "ValidationError", required = true, description = "The type of constraint.")
     ...
     * @return code
     */
    @Schema(example = "ItemQuantityNotAvailable", required = true, description = "The constraint code.")
