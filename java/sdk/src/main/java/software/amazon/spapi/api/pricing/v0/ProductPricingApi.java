...
public class ProductPricingApi {
     ...
     *
     * @param getItemOffersBatchRequestBody The request associated with the &#x60;getItemOffersBatch&#x60; API call.
     *     (required)
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private okhttp3.Call getItemOffersBatchValidateBeforeCall(
        ...
        return getItemOffersBatchCall(getItemOffersBatchRequestBody, progressRequestListener);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetItemOffersBatchResponse getItemOffersBatch(
            GetItemOffersBatchRequest getItemOffersBatchRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<GetItemOffersBatchResponse> resp =
                getItemOffersBatchWithHttpInfo(getItemOffersBatchRequestBody, restrictedDataToken);
        return resp.getData();
    }
    ...
    public GetItemOffersBatchResponse getItemOffersBatch(GetItemOffersBatchRequest getItemOffersBatchRequestBody)
            throws ApiException, LWAException {
        ApiResponse<GetItemOffersBatchResponse> resp =
                getItemOffersBatchWithHttpInfo(getItemOffersBatchRequestBody, null);
        return resp.getData();
    }
    ...
    public ApiResponse<GetItemOffersBatchResponse> getItemOffersBatchWithHttpInfo(
            GetItemOffersBatchRequest getItemOffersBatchRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = getItemOffersBatchValidateBeforeCall(getItemOffersBatchRequestBody, null);
    ...
    public ApiResponse<GetItemOffersBatchResponse> getItemOffersBatchWithHttpInfo(
        ...
        return getItemOffersBatchWithHttpInfo(getItemOffersBatchRequestBody, null);
    }
    ...
    public okhttp3.Call getItemOffersBatchAsync(
            ...
            throws ApiException, LWAException {
        return getItemOffersBatchAsync(getItemOffersBatchRequestBody, callback, null);
    }
    /**
     * (asynchronously) Returns the lowest priced offers for a batch of items based on ASIN. **Usage Plan:** | Rate
     * (requests per second) | Burst | | ---- | ---- | | 0.1 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
    ...
    public okhttp3.Call getItemOffersBatchAsync(
        ...
        okhttp3.Call call =
                getItemOffersBatchValidateBeforeCall(getItemOffersBatchRequestBody, progressRequestListener);
     ...
     *
     * @param getListingOffersBatchRequestBody The request associated with the &#x60;getListingOffersBatch&#x60; API
     *     call. (required)
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private okhttp3.Call getListingOffersBatchValidateBeforeCall(
        ...
        return getListingOffersBatchCall(getListingOffersBatchRequestBody, progressRequestListener);
    }
    ...
    public GetListingOffersBatchResponse getListingOffersBatch(
            GetListingOffersBatchRequest getListingOffersBatchRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<GetListingOffersBatchResponse> resp =
                getListingOffersBatchWithHttpInfo(getListingOffersBatchRequestBody, restrictedDataToken);
        return resp.getData();
    }
    ...
    public GetListingOffersBatchResponse getListingOffersBatch(
        ...
        ApiResponse<GetListingOffersBatchResponse> resp =
                getListingOffersBatchWithHttpInfo(getListingOffersBatchRequestBody, null);
        return resp.getData();
    }
    ...
    public ApiResponse<GetListingOffersBatchResponse> getListingOffersBatchWithHttpInfo(
            GetListingOffersBatchRequest getListingOffersBatchRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = getListingOffersBatchValidateBeforeCall(getListingOffersBatchRequestBody, null);
    ...
    public ApiResponse<GetListingOffersBatchResponse> getListingOffersBatchWithHttpInfo(
            GetListingOffersBatchRequest getListingOffersBatchRequestBody) throws ApiException, LWAException {
        return getListingOffersBatchWithHttpInfo(getListingOffersBatchRequestBody, null);
    }
    ...
    public okhttp3.Call getListingOffersBatchAsync(
            ...
            throws ApiException, LWAException {
        return getListingOffersBatchAsync(getListingOffersBatchRequestBody, callback, null);
    }
    /**
     * (asynchronously) Returns the lowest priced offers for a batch of listings by SKU. **Usage Plan:** | Rate
     * (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
    ...
    public okhttp3.Call getListingOffersBatchAsync(
        ...
        okhttp3.Call call =
                getListingOffersBatchValidateBeforeCall(getListingOffersBatchRequestBody, progressRequestListener);
     ...
     * @param offerType Indicates whether to request pricing information for the seller&#39;s B2C or B2B offers. Default
     *     is B2C. (optional)
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
