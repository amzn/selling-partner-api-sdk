...
@io.swagger.v3.oas.annotations.media.Schema(description = "The `listShipmentBoxes` response.")
public class ListShipmentBoxesResponse {
     ...
     * @return boxes
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "A list of boxes in a shipment.")
