...
public class PartyIdentification {
    ...
    private List<TaxRegistrationDetails> taxRegistrationDetails = new ArrayList<>();
     ...
     */
    @javax.annotation.Nullable public List<TaxRegistrationDetails> getTaxRegistrationDetails() {
        return taxRegistrationDetails;
    }
        ...
        if (jsonObj.get("taxRegistrationDetails") != null
            ...
            if (jsonArraytaxRegistrationDetails != null) {
                ...
                for (int i = 0; i < jsonArraytaxRegistrationDetails.size(); i++) {
                    TaxRegistrationDetails.validateJsonElement(jsonArraytaxRegistrationDetails.get(i));
                }
                ;
            }
        }
