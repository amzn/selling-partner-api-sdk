...
@io.swagger.v3.oas.annotations.media.Schema(description = "Address of the party.")
public class Address {
     ...
     * @return addressLine1
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "First line of the address.")
