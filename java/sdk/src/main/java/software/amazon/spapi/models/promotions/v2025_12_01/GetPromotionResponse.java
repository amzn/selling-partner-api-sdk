...
/**
 * The response schema for &#x60;getPromotion&#x60;. **Note:** &#x60;selectionDetails&#x60; are included when
 * &#x60;SELECTION&#x60; is in the &#x60;includedData&#x60; request parameter.
 */
...
public class GetPromotionResponse {
    ...
    public GetPromotionResponse issues(List<PromotionIssue> issues) {
        this.issues = issues;
        return this;
    }

    public GetPromotionResponse addIssuesItem(PromotionIssue issuesItem) {
        if (this.issues == null) {
    ...
    public GetPromotionResponse promotionTitle(String promotionTitle) {
    ...
    public GetPromotionResponse selection(Selection selection) {
    ...
    public GetPromotionResponse purchaseRequirements(PurchaseRequirements purchaseRequirements) {
    ...
    public GetPromotionResponse schedule(Schedule schedule) {
    ...
    public GetPromotionResponse budget(Budget budget) {
        this.budget = budget;
        return this;
    }
    ...
    public GetPromotionResponse customerSegments(List<CustomerSegment> customerSegments) {
        this.customerSegments = customerSegments;
        return this;
    }

    public GetPromotionResponse addCustomerSegmentsItem(CustomerSegment customerSegmentsItem) {
    ...
    public GetPromotionResponse benefit(PromotionBenefit benefit) {
    ...
    public GetPromotionResponse merchandising(Merchandising merchandising) {
    ...
    public GetPromotionResponse createdDate(OffsetDateTime createdDate) {
    ...
    public GetPromotionResponse lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
    ...
    public GetPromotionResponse feeSnapshot(PromotionFeeSnapshot feeSnapshot) {
    ...
    public GetPromotionResponse marketplaceId(String marketplaceId) {
    ...
    public GetPromotionResponse promotionId(String promotionId) {
    ...
    public GetPromotionResponse promotionType(PromotionType promotionType) {
    ...
    public GetPromotionResponse couponType(CouponType couponType) {
    ...
    public GetPromotionResponse trackingId(String trackingId) {
    ...
    public GetPromotionResponse status(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GetPromotionResponse latestRevision(LatestRevision latestRevision) {
    ...
    public boolean equals(Object o) {
        ...
        GetPromotionResponse getPromotionResponse = (GetPromotionResponse) o;
        return Objects.equals(this.issues, getPromotionResponse.issues)
                && Objects.equals(this.promotionTitle, getPromotionResponse.promotionTitle)
                && Objects.equals(this.selection, getPromotionResponse.selection)
                && Objects.equals(this.purchaseRequirements, getPromotionResponse.purchaseRequirements)
                && Objects.equals(this.schedule, getPromotionResponse.schedule)
                && Objects.equals(this.budget, getPromotionResponse.budget)
                && Objects.equals(this.customerSegments, getPromotionResponse.customerSegments)
                && Objects.equals(this.benefit, getPromotionResponse.benefit)
                && Objects.equals(this.merchandising, getPromotionResponse.merchandising)
                && Objects.equals(this.createdDate, getPromotionResponse.createdDate)
                && Objects.equals(this.lastUpdatedDate, getPromotionResponse.lastUpdatedDate)
                && Objects.equals(this.feeSnapshot, getPromotionResponse.feeSnapshot)
                && Objects.equals(this.marketplaceId, getPromotionResponse.marketplaceId)
                && Objects.equals(this.promotionId, getPromotionResponse.promotionId)
                && Objects.equals(this.promotionType, getPromotionResponse.promotionType)
                && Objects.equals(this.couponType, getPromotionResponse.couponType)
                && Objects.equals(this.trackingId, getPromotionResponse.trackingId)
                && Objects.equals(this.status, getPromotionResponse.status)
                && Objects.equals(this.latestRevision, getPromotionResponse.latestRevision);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetPromotionResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetPromotionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in GetPromotionResponse is not found in the empty JSON string",
                        GetPromotionResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetPromotionResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(
                        "The field `%s` in the JSON string is not defined in the `GetPromotionResponse` properties. JSON: %s",
                        entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetPromotionResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetPromotionResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetPromotionResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetPromotionResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(GetPromotionResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetPromotionResponse>() {
                        @Override
                        public void write(JsonWriter out, GetPromotionResponse value) throws IOException {
                            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                            elementAdapter.write(out, obj);
                        }

                        @Override
                        public GetPromotionResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetPromotionResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetPromotionResponse
     * @throws IOException if the JSON string is invalid with respect to GetPromotionResponse
     */
    public static GetPromotionResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetPromotionResponse.class);
    }

    /**
     * Convert an instance of GetPromotionResponse to an JSON string
     *
     * @return JSON string
     */
