...
public class OrdersV0Api {
    ...
    private okhttp3.Call confirmShipmentValidateBeforeCall(
        ...
        return confirmShipmentCall(orderId, payload, progressRequestListener);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public void confirmShipment(String orderId, ConfirmShipmentRequest payload, String restrictedDataToken)
            throws ApiException, LWAException {
        confirmShipmentWithHttpInfo(orderId, payload, restrictedDataToken);
    }
    ...
    public void confirmShipment(String orderId, ConfirmShipmentRequest payload) throws ApiException, LWAException {
        confirmShipmentWithHttpInfo(orderId, payload, null);
    }
    ...
    public ApiResponse<Void> confirmShipmentWithHttpInfo(
            String orderId, ConfirmShipmentRequest payload, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = confirmShipmentValidateBeforeCall(orderId, payload, null);
    ...
    public ApiResponse<Void> confirmShipmentWithHttpInfo(String orderId, ConfirmShipmentRequest payload)
            throws ApiException, LWAException {
        return confirmShipmentWithHttpInfo(orderId, payload, null);
    }
    ...
    public okhttp3.Call confirmShipmentAsync(
            String orderId, ConfirmShipmentRequest payload, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        return confirmShipmentAsync(orderId, payload, callback, null);
    }
    /**
     * (asynchronously) Updates the shipment confirmation status for a specified order. **Usage Plan:** | Rate (requests
     * per second) | Burst | | ---- | ---- | | 2 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains
    ...
    private okhttp3.Call updateVerificationStatusValidateBeforeCall(
        ...
        return updateVerificationStatusCall(orderId, payload, progressRequestListener);
    }
    ...
    public void updateVerificationStatus(
            String orderId, UpdateVerificationStatusRequest payload, String restrictedDataToken)
            throws ApiException, LWAException {
        updateVerificationStatusWithHttpInfo(orderId, payload, restrictedDataToken);
    }
    ...
    public void updateVerificationStatus(String orderId, UpdateVerificationStatusRequest payload)
            throws ApiException, LWAException {
        updateVerificationStatusWithHttpInfo(orderId, payload, null);
    }
    ...
    public ApiResponse<Void> updateVerificationStatusWithHttpInfo(
            String orderId, UpdateVerificationStatusRequest payload, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = updateVerificationStatusValidateBeforeCall(orderId, payload, null);
     ...
     */
    public ApiResponse<Void> updateVerificationStatusWithHttpInfo(
            String orderId, UpdateVerificationStatusRequest payload) throws ApiException, LWAException {
        return updateVerificationStatusWithHttpInfo(orderId, payload, null);
    }
    ...
    public okhttp3.Call updateVerificationStatusAsync(
            String orderId, UpdateVerificationStatusRequest payload, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        return updateVerificationStatusAsync(orderId, payload, callback, null);
    }
    /**
     * (asynchronously) Updates (approves or rejects) the verification status of an order containing regulated products.
     * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
