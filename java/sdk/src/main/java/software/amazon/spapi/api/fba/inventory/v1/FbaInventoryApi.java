...
public class FbaInventoryApi {
    ...
    private okhttp3.Call addInventoryCall(
        ...
        String localVarPath;
        if ("/fba/inventory/v1/items/inventory".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/inventory/v1/items/inventory";
        } else {
            localVarPath = "/fba/inventory/v1/items/inventory";
        }
    ...
    private okhttp3.Call addInventoryValidateBeforeCall(
        ...
        if (addInventoryRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'addInventoryRequestBody' when calling addInventory(Async)");
        }

        return addInventoryCall(xAmznIdempotencyToken, addInventoryRequestBody, progressRequestListener);
    }
    ...
    public AddInventoryResponse addInventory(
            String xAmznIdempotencyToken, AddInventoryRequest addInventoryRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<AddInventoryResponse> resp =
                addInventoryWithHttpInfo(xAmznIdempotencyToken, addInventoryRequestBody, restrictedDataToken);
        return resp.getData();
    }
    ...
    public AddInventoryResponse addInventory(String xAmznIdempotencyToken, AddInventoryRequest addInventoryRequestBody)
            throws ApiException, LWAException {
        ApiResponse<AddInventoryResponse> resp =
                addInventoryWithHttpInfo(xAmznIdempotencyToken, addInventoryRequestBody, null);
        return resp.getData();
    }
    ...
    public ApiResponse<AddInventoryResponse> addInventoryWithHttpInfo(
            String xAmznIdempotencyToken, AddInventoryRequest addInventoryRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = addInventoryValidateBeforeCall(xAmznIdempotencyToken, addInventoryRequestBody, null);
     ...
     */
    public ApiResponse<AddInventoryResponse> addInventoryWithHttpInfo(
            String xAmznIdempotencyToken, AddInventoryRequest addInventoryRequestBody)
            throws ApiException, LWAException {
        return addInventoryWithHttpInfo(xAmznIdempotencyToken, addInventoryRequestBody, null);
    }
    ...
    public okhttp3.Call addInventoryAsync(
            ...
            throws ApiException, LWAException {
        return addInventoryAsync(xAmznIdempotencyToken, addInventoryRequestBody, callback, null);
    }
    /**
     * (asynchronously) Requests that Amazon add items to the Sandbox Inventory with desired amount of quantity in the
     * sandbox environment. This is a sandbox-only operation and must be directed to a sandbox endpoint. Refer to
    ...
    public okhttp3.Call addInventoryAsync(
        ...
        okhttp3.Call call =
                addInventoryValidateBeforeCall(xAmznIdempotencyToken, addInventoryRequestBody, progressRequestListener);
    ...
    private okhttp3.Call createInventoryItemCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/inventory/v1/items".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/inventory/v1/items";
        } else {
            localVarPath = "/fba/inventory/v1/items";
        }
    ...
    private okhttp3.Call createInventoryItemValidateBeforeCall(
        ...
        if (createInventoryItemRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'createInventoryItemRequestBody' when calling createInventoryItem(Async)");
        }

        return createInventoryItemCall(createInventoryItemRequestBody, progressRequestListener);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public CreateInventoryItemResponse createInventoryItem(
            CreateInventoryItemRequest createInventoryItemRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<CreateInventoryItemResponse> resp =
                createInventoryItemWithHttpInfo(createInventoryItemRequestBody, restrictedDataToken);
        return resp.getData();
    }
    ...
    public CreateInventoryItemResponse createInventoryItem(CreateInventoryItemRequest createInventoryItemRequestBody)
            throws ApiException, LWAException {
        ApiResponse<CreateInventoryItemResponse> resp =
                createInventoryItemWithHttpInfo(createInventoryItemRequestBody, null);
        return resp.getData();
    }
    ...
    public ApiResponse<CreateInventoryItemResponse> createInventoryItemWithHttpInfo(
            CreateInventoryItemRequest createInventoryItemRequestBody, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = createInventoryItemValidateBeforeCall(createInventoryItemRequestBody, null);
     ...
     */
    public ApiResponse<CreateInventoryItemResponse> createInventoryItemWithHttpInfo(
            CreateInventoryItemRequest createInventoryItemRequestBody) throws ApiException, LWAException {
        return createInventoryItemWithHttpInfo(createInventoryItemRequestBody, null);
    }
    ...
    public okhttp3.Call createInventoryItemAsync(
            ...
            throws ApiException, LWAException {
        return createInventoryItemAsync(createInventoryItemRequestBody, callback, null);
    }
    /**
     * (asynchronously) Requests that Amazon create product-details in the Sandbox Inventory in the sandbox environment.
     * This is a sandbox-only operation and must be directed to a sandbox endpoint. Refer to [Selling Partner API
    ...
    public okhttp3.Call createInventoryItemAsync(
        ...
        okhttp3.Call call =
                createInventoryItemValidateBeforeCall(createInventoryItemRequestBody, progressRequestListener);
    ...
    private okhttp3.Call deleteInventoryItemCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/inventory/v1/items/{sellerSku}".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath =
                    "/fba/inventory/v1/items/{sellerSku}".replaceAll("\\{" + "sellerSku" + "\\}", sellerSku.toString());
        } else {
            localVarPath = "/fba/inventory/v1/items/{sellerSku}"
    ...
    private okhttp3.Call getInventorySummariesCall(
        ...
        // create path and map variables
        String localVarPath;
        if ("/fba/inventory/v1/summaries".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/fba/inventory/v1/summaries";
        } else {
            localVarPath = "/fba/inventory/v1/summaries";
        }
