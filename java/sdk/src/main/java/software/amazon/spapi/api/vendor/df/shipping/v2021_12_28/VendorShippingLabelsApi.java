...
public class VendorShippingLabelsApi {
    ...
    private okhttp3.Call createShippingLabelsCall(
            String purchaseOrderNumber, CreateShippingLabelsRequest body, final ApiCallback progressRequestListener)
    ...
    private okhttp3.Call createShippingLabelsValidateBeforeCall(
        ...
        return createShippingLabelsCall(purchaseOrderNumber, body, progressRequestListener);
    }
    ...
    public ShippingLabel createShippingLabels(
            String purchaseOrderNumber, CreateShippingLabelsRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<ShippingLabel> resp =
                createShippingLabelsWithHttpInfo(purchaseOrderNumber, body, restrictedDataToken);
        return resp.getData();
    }
    ...
    public ShippingLabel createShippingLabels(String purchaseOrderNumber, CreateShippingLabelsRequest body)
            throws ApiException, LWAException {
        ApiResponse<ShippingLabel> resp = createShippingLabelsWithHttpInfo(purchaseOrderNumber, body, null);
        return resp.getData();
    }
    ...
    public ApiResponse<ShippingLabel> createShippingLabelsWithHttpInfo(
            String purchaseOrderNumber, CreateShippingLabelsRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = createShippingLabelsValidateBeforeCall(purchaseOrderNumber, body, null);
     ...
     */
    public ApiResponse<ShippingLabel> createShippingLabelsWithHttpInfo(
            String purchaseOrderNumber, CreateShippingLabelsRequest body) throws ApiException, LWAException {
        return createShippingLabelsWithHttpInfo(purchaseOrderNumber, body, null);
    }
    ...
    public okhttp3.Call createShippingLabelsAsync(
            String purchaseOrderNumber, CreateShippingLabelsRequest body, final ApiCallback<ShippingLabel> callback)
            throws ApiException, LWAException {
        return createShippingLabelsAsync(purchaseOrderNumber, body, callback, null);
    }
    /**
     * createShippingLabels (asynchronously) Creates shipping labels for a purchase order and returns the labels.
     * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 | The
    ...
    public okhttp3.Call createShippingLabelsAsync(
        ...
        okhttp3.Call call = createShippingLabelsValidateBeforeCall(purchaseOrderNumber, body, progressRequestListener);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    private okhttp3.Call getShippingLabelCall(String purchaseOrderNumber, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
    ...
    private okhttp3.Call submitShippingLabelRequestCall(
            SubmitShippingLabelsRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
