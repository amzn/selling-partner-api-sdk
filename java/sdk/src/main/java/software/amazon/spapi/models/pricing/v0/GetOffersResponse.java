...
public class GetOffersResponse {
    ...
    private GetOffersResult payload;
     ...
     * @return payload
     */
    @javax.annotation.Nullable public GetOffersResult getPayload() {
        return payload;
    }
    ...
    public GetOffersResponse errors(List<Error> errors) {
        this.errors = errors;
        return this;
    }

    public GetOffersResponse addErrorsItem(Error errorsItem) {
        if (this.errors == null) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("payload") != null && !jsonObj.get("payload").isJsonNull()) {
            GetOffersResult.validateJsonElement(jsonObj.get("payload"));
        }
