...
public class VarianceReason {
     ...
     * On-hold but still shipped the products. * &#x60;FAILED_PO_CONFIRMATION&#x60;: Vendor&#x27;s latest PO
     * confirmation message for this line item failed processing and was not translated correctly. * &#x60;OTHER&#x60;:
     * Defect type not belonging to a predefined category.
     *
     * @return defectTypes
     */
    @Schema(
