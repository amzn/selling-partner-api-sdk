...
public class AppIntegrationsApi {
    ...
    private okhttp3.Call createNotificationCall(
            CreateNotificationRequest body, final ApiCallback progressRequestListener)
    ...
    private okhttp3.Call deleteNotificationsCall(
            DeleteNotificationsRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    private okhttp3.Call recordActionFeedbackCall(
            String notificationId, RecordActionFeedbackRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    private okhttp3.Call recordActionFeedbackValidateBeforeCall(
        ...
        return recordActionFeedbackCall(notificationId, body, progressRequestListener);
    }
    ...
    public void recordActionFeedback(
            String notificationId, RecordActionFeedbackRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        recordActionFeedbackWithHttpInfo(notificationId, body, restrictedDataToken);
    }
    ...
    public void recordActionFeedback(String notificationId, RecordActionFeedbackRequest body)
            throws ApiException, LWAException {
        recordActionFeedbackWithHttpInfo(notificationId, body, null);
    }
    ...
    public ApiResponse<Void> recordActionFeedbackWithHttpInfo(
            String notificationId, RecordActionFeedbackRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = recordActionFeedbackValidateBeforeCall(notificationId, body, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> recordActionFeedbackWithHttpInfo(String notificationId, RecordActionFeedbackRequest body)
            throws ApiException, LWAException {
        return recordActionFeedbackWithHttpInfo(notificationId, body, null);
    }
    ...
    public okhttp3.Call recordActionFeedbackAsync(
            String notificationId, RecordActionFeedbackRequest body, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        return recordActionFeedbackAsync(notificationId, body, callback, null);
    }
    /**
     * (asynchronously) Records the seller&#39;s response to a notification. **Usage Plan:** | Rate (requests per
     * second) | Burst | | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
    ...
    public okhttp3.Call recordActionFeedbackAsync(
        ...
        okhttp3.Call call = recordActionFeedbackValidateBeforeCall(notificationId, body, progressRequestListener);
