...
public class TransactionStatus {
     ...
     */
    @javax.annotation.Nullable public Transaction getTransactionStatus() {
        return transactionStatus;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TransactionStatus
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TransactionStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in TransactionStatus is not found in the empty JSON string",
                        TransactionStatus.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TransactionStatus.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(
                        "The field `%s` in the JSON string is not defined in the `TransactionStatus` properties. JSON: %s",
        ...
        if (jsonObj.get("transactionStatus") != null
            ...
            Transaction.validateJsonElement(jsonObj.get("transactionStatus"));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<TransactionStatus>() {
                        @Override
