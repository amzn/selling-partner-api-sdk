...
public class VendorPaymentsApi {
     ...
     */
    public okhttp3.Call submitInvoicesCall(SubmitInvoicesRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
    ...
    private okhttp3.Call submitInvoicesValidateBeforeCall(SubmitInvoicesRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public okhttp3.Call submitInvoicesAsync(SubmitInvoicesRequest body, final ApiCallback<SubmitInvoicesResponse> callback) throws ApiException, LWAException {
