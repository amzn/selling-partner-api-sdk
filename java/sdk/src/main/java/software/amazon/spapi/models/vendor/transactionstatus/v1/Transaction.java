...
@io.swagger.v3.oas.annotations.media.Schema(description = "The transaction status.")
public class Transaction {
    ...
    /**
     * The unique identifier returned in the &#39;transactionId&#39; field in response to the post request of a specific
     * transaction.
     *
