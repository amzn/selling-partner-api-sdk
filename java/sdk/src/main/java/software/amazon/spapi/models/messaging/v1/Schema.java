...
public class Schema {
     ...
     * @return the Schema instance itself
     */
    public Schema putAdditionalProperty(String key, Object value) {
        ...
        if (jsonElement == null) {
            if (!Schema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in Schema is not found in the empty JSON string",
                        Schema.openapiRequiredFields.toString()));
            }
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Schema> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Schema.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<Schema>() {
                        @Override
                        ...
                        public Schema read(JsonReader in) throws IOException {
                            ...
                            Schema instance = thisAdapter.fromJsonTree(jsonObj);
