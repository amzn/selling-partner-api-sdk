...
@io.swagger.v3.oas.annotations.media.Schema(description = "The `listInboundPlanItems` response.")
public class ListInboundPlanItemsResponse {
     ...
     * @return items
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "The items in an inbound plan.")
