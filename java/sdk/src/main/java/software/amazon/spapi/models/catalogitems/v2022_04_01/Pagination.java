...
public class Pagination {
     ...
     */
    @javax.annotation.Nullable public String getPreviousToken() {
        return previousToken;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if ((jsonObj.get("previousToken") != null
                        && !jsonObj.get("previousToken").isJsonNull())
                && !jsonObj.get("previousToken").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(
                    "Expected the field `previousToken` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("previousToken").toString()));
        }
    }
