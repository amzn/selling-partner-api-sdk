...
public class ShipmentInvoiceApi {
     ...
     */
    private okhttp3.Call getInvoiceStatusCall(String shipmentId, final ApiCallback progressRequestListener)
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    private okhttp3.Call getShipmentDetailsCall(String shipmentId, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call submitInvoiceCall(
            String shipmentId, SubmitInvoiceRequest body, final ApiCallback progressRequestListener)
            throws ApiException, LWAException {
    ...
    private okhttp3.Call submitInvoiceValidateBeforeCall(
        ...
        return submitInvoiceCall(shipmentId, body, progressRequestListener);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public SubmitInvoiceResponse submitInvoice(String shipmentId, SubmitInvoiceRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<SubmitInvoiceResponse> resp = submitInvoiceWithHttpInfo(shipmentId, body, restrictedDataToken);
        return resp.getData();
    }
    ...
    public SubmitInvoiceResponse submitInvoice(String shipmentId, SubmitInvoiceRequest body)
            throws ApiException, LWAException {
        ApiResponse<SubmitInvoiceResponse> resp = submitInvoiceWithHttpInfo(shipmentId, body, null);
        return resp.getData();
    }
    ...
    public ApiResponse<SubmitInvoiceResponse> submitInvoiceWithHttpInfo(
            String shipmentId, SubmitInvoiceRequest body, String restrictedDataToken)
            throws ApiException, LWAException {
        okhttp3.Call call = submitInvoiceValidateBeforeCall(shipmentId, body, null);
    ...
    public ApiResponse<SubmitInvoiceResponse> submitInvoiceWithHttpInfo(String shipmentId, SubmitInvoiceRequest body)
            throws ApiException, LWAException {
        return submitInvoiceWithHttpInfo(shipmentId, body, null);
    }
    ...
    public okhttp3.Call submitInvoiceAsync(
            String shipmentId, SubmitInvoiceRequest body, final ApiCallback<SubmitInvoiceResponse> callback)
            throws ApiException, LWAException {
        return submitInvoiceAsync(shipmentId, body, callback, null);
    }
    /**
     * (asynchronously) Submits a shipment invoice document for a given shipment. **Usage Plan:** | Rate (requests per
     * second) | Burst | | ---- | ---- | | 1.133 | 25 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
    ...
    public okhttp3.Call submitInvoiceAsync(
        ...
        okhttp3.Call call = submitInvoiceValidateBeforeCall(shipmentId, body, progressRequestListener);
