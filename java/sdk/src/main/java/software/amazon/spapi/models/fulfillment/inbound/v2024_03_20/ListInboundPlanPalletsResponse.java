...
@io.swagger.v3.oas.annotations.media.Schema(description = "The `listInboundPlanPallets` response.")
public class ListInboundPlanPalletsResponse {
     ...
     * @return pallets
     */
    @io.swagger.v3.oas.annotations.media.Schema(required = true, description = "The pallets in an inbound plan.")
