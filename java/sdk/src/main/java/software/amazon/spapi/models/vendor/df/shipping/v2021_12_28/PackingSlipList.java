...
@io.swagger.v3.oas.annotations.media.Schema(description = "A list of packing slips.")
public class PackingSlipList {
     ...
     * @return packingSlips
     */
    @io.swagger.v3.oas.annotations.media.Schema(description = "An array of packing slip objects.")
