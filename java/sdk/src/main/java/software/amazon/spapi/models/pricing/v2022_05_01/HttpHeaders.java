...
public class HttpHeaders {
     ...
     * @return the HttpHeaders instance itself
     */
    public HttpHeaders putAdditionalProperty(String key, Object value) {
        ...
        if (jsonElement == null) {
            if (!HttpHeaders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in HttpHeaders is not found in the empty JSON string",
                        HttpHeaders.openapiRequiredFields.toString()));
            }
        }
    }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<HttpHeaders>() {
                        ...
                        public HttpHeaders read(JsonReader in) throws IOException {
                            ...
                            HttpHeaders instance = thisAdapter.fromJsonTree(jsonObj);
