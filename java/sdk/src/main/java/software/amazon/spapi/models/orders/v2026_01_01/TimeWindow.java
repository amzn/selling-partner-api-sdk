...
public class TimeWindow {
     ...
     * @return startTime
     */
    @javax.annotation.Nullable public HourMinute getStartTime() {
        return startTime;
    }
     ...
     * @return endTime
     */
    @javax.annotation.Nullable public HourMinute getEndTime() {
        return endTime;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("startTime") != null && !jsonObj.get("startTime").isJsonNull()) {
            HourMinute.validateJsonElement(jsonObj.get("startTime"));
        }
        // validate the optional field `endTime`
        if (jsonObj.get("endTime") != null && !jsonObj.get("endTime").isJsonNull()) {
            HourMinute.validateJsonElement(jsonObj.get("endTime"));
        }
    }
