...
public class OneClickShipmentResult {
    ...
    public OneClickShipmentResult packageDocumentDetails(List<PackageDocumentDetail> packageDocumentDetails) {
        this.packageDocumentDetails = packageDocumentDetails;
        return this;
    }

    public OneClickShipmentResult addPackageDocumentDetailsItem(PackageDocumentDetail packageDocumentDetailsItem) {
