        ...
        if (jsonElement == null) {
            if (!ReportOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in ReportOptions is not found in the empty JSON string",
                        ReportOptions.openapiRequiredFields.toString()));
            }
        }
    }
