...
public class ApplicationsApi {
    ...
    private okhttp3.Call rotateApplicationClientSecretCall(final ApiCallback progressRequestListener)
        ...
        String localVarPath;
        if ("/applications/2023-11-30/clientSecret".equals("/uploads/2020-11-01/uploadDestinations/{resource}")) {
            localVarPath = "/applications/2023-11-30/clientSecret";
        } else {
            localVarPath = "/applications/2023-11-30/clientSecret";
        }
     ...
     * generated and sent to the developer-registered queue. For more information, refer to [Rotate your
     * application&#39;s client
     * secret](https://developer-docs.amazon.com/sp-api/docs/rotate-your-application-client-secret). **Usage Plan:** |
     * Rate (requests per second) | Burst | | ---- | ---- | | 0.0167 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60;
