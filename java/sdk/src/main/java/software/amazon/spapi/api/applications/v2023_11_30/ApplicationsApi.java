...
public class ApplicationsApi {
     ...
     */
    public okhttp3.Call rotateApplicationClientSecretCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
    ...
    private okhttp3.Call rotateApplicationClientSecretValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public okhttp3.Call rotateApplicationClientSecretAsync(final ApiCallback<Void> callback) throws ApiException, LWAException {
