 ...
 * @module js_client.pricing_v0.model/BatchOffersResponse
 * @version v0
 */
export class BatchOffersResponse {
   ...
   * @alias module:js_client.pricing_v0.model/BatchOffersResponse
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/BatchOffersResponse} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/BatchOffersResponse} The populated <code>BatchOffersResponse</code> instance.
   */
