 ...
 * @module js_client.pricing_v0.model/Points
 * @version v0
 */
export class Points {
  /**
   ...
   * @alias module:js_client.pricing_v0.model/Points
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/Points} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/Points} The populated <code>Points</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/MoneyType} pointsMonetaryValue
 */
