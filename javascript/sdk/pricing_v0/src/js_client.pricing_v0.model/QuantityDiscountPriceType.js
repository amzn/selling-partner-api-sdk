 ...
 * @module js_client.pricing_v0.model/QuantityDiscountPriceType
 * @version v0
 */
export class QuantityDiscountPriceType {
   ...
   * @alias module:js_client.pricing_v0.model/QuantityDiscountPriceType
   * @class
   * @param quantityTier {Number} Indicates at what quantity this price becomes active.
   * @param quantityDiscountType {module:js_client.pricing_v0.model/QuantityDiscountType} 
   ...
   * @param {module:js_client.pricing_v0.model/QuantityDiscountPriceType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/QuantityDiscountPriceType} The populated <code>QuantityDiscountPriceType</code> instance.
   */
