 ...
 * @module js_client.pricing_v0.model/BatchOffersRequestParams
 * @version v0
 */
export class BatchOffersRequestParams {
   ...
   * @alias module:js_client.pricing_v0.model/BatchOffersRequestParams
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/BatchOffersRequestParams} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/BatchOffersRequestParams} The populated <code>BatchOffersRequestParams</code> instance.
   */
