 ...
 * @module js_client.pricing_v0.model/SellerFeedbackType
 * @version v0
 */
export class SellerFeedbackType {
   ...
   * @alias module:js_client.pricing_v0.model/SellerFeedbackType
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/SellerFeedbackType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/SellerFeedbackType} The populated <code>SellerFeedbackType</code> instance.
   */
