 ...
 * @module js_client.pricing_v0.model/ItemOffersResponse
 * @version v0
 */
export class ItemOffersResponse {
   ...
   * @alias module:js_client.pricing_v0.model/ItemOffersResponse
   * @class
   * @implements module:js_client.pricing_v0.model/BatchOffersResponse
   * @param body {module:js_client.pricing_v0.model/GetOffersResponse} 
   * @param request {module:js_client.pricing_v0.model/ItemOffersRequestParams} 
   */
   ...
   * @param {module:js_client.pricing_v0.model/ItemOffersResponse} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ItemOffersResponse} The populated <code>ItemOffersResponse</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/HttpResponseHeaders} headers
 */
ItemOffersResponse.prototype.headers = undefined;

/**
 * @member {module:js_client.pricing_v0.model/GetOffersHttpStatusLine} status
 */
ItemOffersResponse.prototype.status = undefined;

/**
 * @member {module:js_client.pricing_v0.model/GetOffersResponse} body
 */
ItemOffersResponse.prototype.body = undefined;

/**
 * @member {module:js_client.pricing_v0.model/ItemOffersRequestParams} request
 */
