 ...
 * @module js_client.pricing_v0.model/CompetitivePricingType
 * @version v0
 */
export class CompetitivePricingType {
   ...
   * @alias module:js_client.pricing_v0.model/CompetitivePricingType
   * @class
   * @param competitivePrices {Array.<module:js_client.pricing_v0.model/CompetitivePriceType>} A list of competitive pricing information.
   * @param numberOfOfferListings {Array.<module:js_client.pricing_v0.model/OfferListingCountType>} The number of active offer listings for the item that was submitted. The listing count is returned by condition, one for each listing condition value that is returned.
   */
   ...
   * @param {module:js_client.pricing_v0.model/CompetitivePricingType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/CompetitivePricingType} The populated <code>CompetitivePricingType</code> instance.
   */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/CompetitivePriceType>} competitivePrices
 */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/OfferListingCountType>} numberOfOfferListings
 */
CompetitivePricingType.prototype.numberOfOfferListings = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} tradeInValue
 */
