 ...
 * @module js_client.pricing_v0.model/MoneyType
 * @version v0
 */
export class MoneyType {
   ...
   * @alias module:js_client.pricing_v0.model/MoneyType
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/MoneyType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/MoneyType} The populated <code>MoneyType</code> instance.
   */
