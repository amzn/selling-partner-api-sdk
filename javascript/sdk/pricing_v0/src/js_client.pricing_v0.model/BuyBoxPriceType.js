 ...
 * @module js_client.pricing_v0.model/BuyBoxPriceType
 * @version v0
 */
export class BuyBoxPriceType {
   ...
   * @alias module:js_client.pricing_v0.model/BuyBoxPriceType
   * @class
   * @param condition {String} Indicates the condition of the item. For example: New, Used, Collectible, Refurbished, or Club.
   * @param landedPrice {module:js_client.pricing_v0.model/MoneyType} 
   ...
   * @param {module:js_client.pricing_v0.model/BuyBoxPriceType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/BuyBoxPriceType} The populated <code>BuyBoxPriceType</code> instance.
   */
