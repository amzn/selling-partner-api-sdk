 ...
 * @module js_client.pricing_v0.model/ItemIdentifier
 * @version v0
 */
export class ItemIdentifier {
   ...
   * @alias module:js_client.pricing_v0.model/ItemIdentifier
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/ItemIdentifier} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ItemIdentifier} The populated <code>ItemIdentifier</code> instance.
   */
