 ...
 * @module js_client.pricing_v0.model/LowestPriceType
 * @version v0
 */
export class LowestPriceType {
   ...
   * @alias module:js_client.pricing_v0.model/LowestPriceType
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/LowestPriceType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/LowestPriceType} The populated <code>LowestPriceType</code> instance.
   */
