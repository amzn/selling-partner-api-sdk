 ...
 * @module js_client.pricing_v0.model/ListingOffersRequest
 * @version v0
 */
export class ListingOffersRequest {
   ...
   * @alias module:js_client.pricing_v0.model/ListingOffersRequest
   * @class
   * @implements module:js_client.pricing_v0.model/BatchRequest
   * @implements module:js_client.pricing_v0.model/BatchOffersRequestParams
   ...
   * @param method {module:js_client.pricing_v0.model/HttpMethod} 
   * @param marketplaceId {String} A marketplace identifier. Specifies the marketplace for which prices are returned.
   * @param itemCondition {module:js_client.pricing_v0.model/ItemCondition} 
   */
   ...
   * @param {module:js_client.pricing_v0.model/ListingOffersRequest} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ListingOffersRequest} The populated <code>ListingOffersRequest</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/HttpMethod} method
 */
...
/**
 * @member {module:js_client.pricing_v0.model/ItemCondition} itemCondition
 */
ListingOffersRequest.prototype.itemCondition = undefined;

/**
 * @member {module:js_client.pricing_v0.model/CustomerType} customerType
 */
