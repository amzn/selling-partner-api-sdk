 ...
 * @module js_client.pricing_v0.model/CompetitivePriceType
 * @version v0
 */
export class CompetitivePriceType {
   ...
   * @alias module:js_client.pricing_v0.model/CompetitivePriceType
   * @class
   ...
   * @param price {module:js_client.pricing_v0.model/PriceType} 
   */
   ...
   * @param {module:js_client.pricing_v0.model/CompetitivePriceType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/CompetitivePriceType} The populated <code>CompetitivePriceType</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/PriceType} price
 */
...
/**
 * @member {module:js_client.pricing_v0.model/QuantityDiscountType} quantityDiscountType
 */
