 ...
 * @module js_client.pricing_v0.model/Summary
 * @version v0
 */
export class Summary {
   ...
   * @alias module:js_client.pricing_v0.model/Summary
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/Summary} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/Summary} The populated <code>Summary</code> instance.
   */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/OfferCountType>} numberOfOffers
 */
Summary.prototype.numberOfOffers = undefined;

/**
 * A list of the lowest prices.
 * @member {Array.<module:js_client.pricing_v0.model/LowestPriceType>} lowestPrices
 */
Summary.prototype.lowestPrices = undefined;

/**
 * A list of the Buy Box prices.
 * @member {Array.<module:js_client.pricing_v0.model/BuyBoxPriceType>} buyBoxPrices
 */
Summary.prototype.buyBoxPrices = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} listPrice
 */
Summary.prototype.listPrice = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} competitivePriceThreshold
 */
Summary.prototype.competitivePriceThreshold = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} suggestedLowerPricePlusShipping
 */
Summary.prototype.suggestedLowerPricePlusShipping = undefined;

/**
 * A list of sales rank information for the item, by category.
 * @member {Array.<module:js_client.pricing_v0.model/SalesRankType>} salesRankings
 */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/OfferCountType>} buyBoxEligibleOffers
 */
