 ...
 * @module js_client.pricing_v0.model/BatchRequest
 * @version v0
 */
export class BatchRequest {
   ...
   * @alias module:js_client.pricing_v0.model/BatchRequest
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/BatchRequest} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/BatchRequest} The populated <code>BatchRequest</code> instance.
   */
