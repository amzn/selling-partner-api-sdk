 ...
 * @module js_client.pricing_v0.model/GetListingOffersBatchRequest
 * @version v0
 */
export class GetListingOffersBatchRequest {
   ...
   * @alias module:js_client.pricing_v0.model/GetListingOffersBatchRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/GetListingOffersBatchRequest} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/GetListingOffersBatchRequest} The populated <code>GetListingOffersBatchRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/ListingOffersRequest>} requests
 */
