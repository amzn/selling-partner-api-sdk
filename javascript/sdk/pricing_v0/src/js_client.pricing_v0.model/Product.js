 ...
 * @module js_client.pricing_v0.model/Product
 * @version v0
 */
export class Product {
   ...
   * An item.
   * @alias module:js_client.pricing_v0.model/Product
   * @class
   * @param identifiers {module:js_client.pricing_v0.model/IdentifierType} 
   */
   ...
   * @param {module:js_client.pricing_v0.model/Product} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/Product} The populated <code>Product</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/IdentifierType} identifiers
 */
...
/**
 * @member {module:js_client.pricing_v0.model/CompetitivePricingType} competitivePricing
 */
...
/**
 * A list of offers.
 * @member {Array.<module:js_client.pricing_v0.model/OfferType>} offers
 */
