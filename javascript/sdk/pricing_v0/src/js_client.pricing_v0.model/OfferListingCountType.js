 ...
 * @module js_client.pricing_v0.model/OfferListingCountType
 * @version v0
 */
export class OfferListingCountType {
   ...
   * @alias module:js_client.pricing_v0.model/OfferListingCountType
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/OfferListingCountType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/OfferListingCountType} The populated <code>OfferListingCountType</code> instance.
   */
