 ...
 * @module js_client.pricing_v0.model/GetOffersResult
 * @version v0
 */
export class GetOffersResult {
   ...
   * @alias module:js_client.pricing_v0.model/GetOffersResult
   * @class
   * @param marketplaceID {String} A marketplace identifier.
   * @param itemCondition {module:js_client.pricing_v0.model/ConditionType} 
   * @param status {String} The status of the operation.
   * @param identifier {module:js_client.pricing_v0.model/ItemIdentifier} 
   * @param summary {module:js_client.pricing_v0.model/Summary} 
   * @param offers {Array.<module:js_client.pricing_v0.model/OfferDetail>} A list of offer details. The list is the same length as the TotalOfferCount in the Summary or 20, whichever is less.
   */
   ...
   * @param {module:js_client.pricing_v0.model/GetOffersResult} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/GetOffersResult} The populated <code>GetOffersResult</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/ConditionType} itemCondition
 */
...
/**
 * @member {module:js_client.pricing_v0.model/ItemIdentifier} identifier
 */
GetOffersResult.prototype.identifier = undefined;

/**
 * @member {module:js_client.pricing_v0.model/Summary} summary
 */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/OfferDetail>} offers
 */
