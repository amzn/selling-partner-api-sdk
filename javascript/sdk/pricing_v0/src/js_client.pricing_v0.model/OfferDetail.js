 ...
 * @module js_client.pricing_v0.model/OfferDetail
 * @version v0
 */
export class OfferDetail {
   ...
   * @alias module:js_client.pricing_v0.model/OfferDetail
   * @class
   ...
   * @param shippingTime {module:js_client.pricing_v0.model/DetailedShippingTimeType} 
   * @param listingPrice {module:js_client.pricing_v0.model/MoneyType} 
   * @param shipping {module:js_client.pricing_v0.model/MoneyType} 
   ...
   * @param {module:js_client.pricing_v0.model/OfferDetail} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/OfferDetail} The populated <code>OfferDetail</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/OfferCustomerType} offerType
 */
...
/**
 * @member {module:js_client.pricing_v0.model/SellerFeedbackType} sellerFeedbackRating
 */
OfferDetail.prototype.sellerFeedbackRating = undefined;

/**
 * @member {module:js_client.pricing_v0.model/DetailedShippingTimeType} shippingTime
 */
 ...
 * @member {Array.<module:js_client.pricing_v0.model/QuantityDiscountPriceType>} quantityDiscountPrices
 */
...
/**
 * @member {module:js_client.pricing_v0.model/ShipsFromType} shipsFrom
 */
...
/**
 * @member {module:js_client.pricing_v0.model/PrimeInformationType} primeInformation
 */
