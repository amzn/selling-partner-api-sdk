 ...
 * @module js_client.pricing_v0.model/DetailedShippingTimeType
 * @version v0
 */
export class DetailedShippingTimeType {
   ...
   * @alias module:js_client.pricing_v0.model/DetailedShippingTimeType
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/DetailedShippingTimeType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/DetailedShippingTimeType} The populated <code>DetailedShippingTimeType</code> instance.
   */
 ...
 * @member {module:js_client.pricing_v0.model/DetailedShippingTimeType.AvailabilityTypeEnum} availabilityType
 */
