 ...
 * @module js_client.pricing_v0.model/ASINIdentifier
 * @version v0
 */
export class ASINIdentifier {
   ...
   * @alias module:js_client.pricing_v0.model/ASINIdentifier
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/ASINIdentifier} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ASINIdentifier} The populated <code>ASINIdentifier</code> instance.
   */
