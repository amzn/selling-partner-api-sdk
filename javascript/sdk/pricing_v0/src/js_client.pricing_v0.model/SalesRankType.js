 ...
 * @module js_client.pricing_v0.model/SalesRankType
 * @version v0
 */
export class SalesRankType {
   ...
   * @alias module:js_client.pricing_v0.model/SalesRankType
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/SalesRankType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/SalesRankType} The populated <code>SalesRankType</code> instance.
   */
