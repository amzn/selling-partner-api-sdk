 ...
 * @module js_client.pricing_v0.model/ItemOffersRequest
 * @version v0
 */
export class ItemOffersRequest {
   ...
   * @alias module:js_client.pricing_v0.model/ItemOffersRequest
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/ItemOffersRequest} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ItemOffersRequest} The populated <code>ItemOffersRequest</code> instance.
   */
