 ...
 * @module js_client.pricing_v0.model/OfferCountType
 * @version v0
 */
export class OfferCountType {
   ...
   * @alias module:js_client.pricing_v0.model/OfferCountType
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/OfferCountType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/OfferCountType} The populated <code>OfferCountType</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/FulfillmentChannelType} fulfillmentChannel
 */
