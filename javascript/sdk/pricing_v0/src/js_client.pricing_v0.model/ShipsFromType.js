 ...
 * @module js_client.pricing_v0.model/ShipsFromType
 * @version v0
 */
export class ShipsFromType {
   ...
   * @alias module:js_client.pricing_v0.model/ShipsFromType
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.pricing_v0.model/ShipsFromType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ShipsFromType} The populated <code>ShipsFromType</code> instance.
   */
