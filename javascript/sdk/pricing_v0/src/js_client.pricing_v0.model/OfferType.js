 ...
 * @module js_client.pricing_v0.model/OfferType
 * @version v0
 */
export class OfferType {
   ...
   * @alias module:js_client.pricing_v0.model/OfferType
   * @class
   * @param buyingPrice {module:js_client.pricing_v0.model/PriceType} 
   * @param regularPrice {module:js_client.pricing_v0.model/MoneyType} 
   ...
   * @param {module:js_client.pricing_v0.model/OfferType} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/OfferType} The populated <code>OfferType</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/PriceType} buyingPrice
 */
OfferType.prototype.buyingPrice = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} regularPrice
 */
OfferType.prototype.regularPrice = undefined;

/**
 * @member {module:js_client.pricing_v0.model/MoneyType} businessPrice
 */
