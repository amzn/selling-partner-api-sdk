 ...
 * @module js_client.pricing_v0.model/SellerSKUIdentifier
 * @version v0
 */
export class SellerSKUIdentifier {
   ...
   * @alias module:js_client.pricing_v0.model/SellerSKUIdentifier
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/SellerSKUIdentifier} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/SellerSKUIdentifier} The populated <code>SellerSKUIdentifier</code> instance.
   */
