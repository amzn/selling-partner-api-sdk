 ...
 * @module js_client.pricing_v0.model/Price
 * @version v0
 */
export class Price {
  /**
   ...
   * @alias module:js_client.pricing_v0.model/Price
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/Price} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/Price} The populated <code>Price</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/Product} product
 */
