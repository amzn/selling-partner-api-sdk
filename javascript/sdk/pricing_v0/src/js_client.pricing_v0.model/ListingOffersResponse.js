 ...
 * @module js_client.pricing_v0.model/ListingOffersResponse
 * @version v0
 */
export class ListingOffersResponse {
   ...
   * @alias module:js_client.pricing_v0.model/ListingOffersResponse
   * @class
   ...
   * @param {module:js_client.pricing_v0.model/ListingOffersResponse} obj Optional instance to populate.
   * @return {module:js_client.pricing_v0.model/ListingOffersResponse} The populated <code>ListingOffersResponse</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v0.model/ListingOffersRequestParams} request
 */
