...
* @module js_client.pricing_v0.api/ProductPricingApi
* @version v0
*/
export class ProductPricingApi {
    ...
    * @alias module:js_client.pricing_v0.api/ProductPricingApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.pricing_v0.model/String} itemType Indicates whether ASIN values or seller SKU values are used to identify items. If you specify Asin, the information in the response will be dependent on the list of Asins you provide in the Asins parameter. If you specify Sku, the information in the response will be dependent on the list of Skus you provide in the Skus parameter. Possible values: Asin, Sku.
     ...
     * @param {module:js_client.pricing_v0.model/String} opts.customerType Indicates whether to request pricing information from the point of view of Consumer or Business buyers. Default is Consumer.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.pricing_v0.model/GetPricingResponse} and HTTP response
     */
     ...
     * @param {Array.<String>} opts.skus A list of up to twenty seller SKU values used to identify items in the given marketplace.
     * @param {module:js_client.pricing_v0.model/String} opts.customerType Indicates whether to request pricing information from the point of view of Consumer or Business buyers. Default is Consumer.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.pricing_v0.model/GetPricingResponse}
     */
     ...
     * @param {String} marketplaceId A marketplace identifier. Specifies the marketplace for which prices are returned.
     * @param {module:js_client.pricing_v0.model/String} itemCondition Filters the offer listings to be considered based on item condition. Possible values: New, Used, Collectible, Refurbished, Club.
     * @param {String} asin The Amazon Standard Identification Number (ASIN) of the item.
     * @param {Object} opts Optional parameters
     * @param {module:js_client.pricing_v0.model/String} opts.customerType Indicates whether to request Consumer or Business offers. Default is Consumer.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.pricing_v0.model/GetOffersResponse} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:js_client.pricing_v0.model/String} opts.customerType Indicates whether to request Consumer or Business offers. Default is Consumer.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.pricing_v0.model/GetOffersResponse}
     */
     ...
     * @param {module:js_client.pricing_v0.model/GetItemOffersBatchRequest} getItemOffersBatchRequestBody The request associated with the &#x60;getItemOffersBatch&#x60; API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.pricing_v0.model/GetItemOffersBatchResponse} and HTTP response
     */
     ...
     * Returns the lowest priced offers for a batch of items based on ASIN.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.1 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.pricing_v0.model/GetItemOffersBatchRequest} getItemOffersBatchRequestBody The request associated with the &#x60;getItemOffersBatch&#x60; API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.pricing_v0.model/GetItemOffersBatchResponse}
     */
     ...
     * @param {String} marketplaceId A marketplace identifier. Specifies the marketplace for which prices are returned.
     * @param {module:js_client.pricing_v0.model/String} itemCondition Filters the offer listings based on item condition. Possible values: New, Used, Collectible, Refurbished, Club.
     ...
     * @param {module:js_client.pricing_v0.model/GetListingOffersBatchRequest} getListingOffersBatchRequestBody The request associated with the &#x60;getListingOffersBatch&#x60; API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.pricing_v0.model/GetListingOffersBatchResponse} and HTTP response
     */
     ...
     * Returns the lowest priced offers for a batch of listings by SKU.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](doc:usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.pricing_v0.model/GetListingOffersBatchRequest} getListingOffersBatchRequestBody The request associated with the &#x60;getListingOffersBatch&#x60; API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.pricing_v0.model/GetListingOffersBatchResponse}
     */
     ...
     * @param {Array.<String>} opts.asins A list of up to twenty Amazon Standard Identification Number (ASIN) values used to identify items in the given marketplace.
     * @param {Array.<String>} opts.skus A list of up to twenty seller SKU values used to identify items in the given marketplace.
     * @param {module:js_client.pricing_v0.model/String} opts.itemCondition Filters the offer listings based on item condition. Possible values: New, Used, Collectible, Refurbished, Club.
     * @param {module:js_client.pricing_v0.model/String} opts.offerType Indicates whether to request pricing information for the seller&#39;s B2C or B2B offers. Default is B2C.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.pricing_v0.model/GetPricingResponse} and HTTP response
     */
