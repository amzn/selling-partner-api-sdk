...
/**
* Fees service.
* @module js_client.productfees_v0.api/FeesApi
* @version v0
*/
export class FeesApi {
    ...
    * @alias module:js_client.productfees_v0.api/FeesApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.productfees_v0.model/GetMyFeesEstimateRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.productfees_v0.model/GetMyFeesEstimateResponse} and HTTP response
     */
     ...
     * @param {String} asin The Amazon Standard Identification Number (ASIN) of the item.
     * @param {module:js_client.productfees_v0.model/GetMyFeesEstimateRequest} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.productfees_v0.model/GetMyFeesEstimateResponse}
     */
     ...
     * @param {Array.<module:js_client.productfees_v0.model/FeesEstimateByIdRequest>} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:js_client.productfees_v0.model/FeesEstimateResult>} and HTTP response
     */
     ...
     * Returns the estimated fees for a list of products.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](doc:usage-plans-and-rate-limits-in-the-sp-api).
     * @param {Array.<module:js_client.productfees_v0.model/FeesEstimateByIdRequest>} body 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:js_client.productfees_v0.model/FeesEstimateResult>}
     */
