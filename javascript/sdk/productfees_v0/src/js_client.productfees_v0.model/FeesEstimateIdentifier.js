 ...
 * @module js_client.productfees_v0.model/FeesEstimateIdentifier
 * @version v0
 */
export class FeesEstimateIdentifier {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimateIdentifier
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimateIdentifier} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimateIdentifier} The populated <code>FeesEstimateIdentifier</code> instance.
   */
...
/**
 * @member {module:js_client.productfees_v0.model/IdType} idType
 */
...
/**
 * @member {module:js_client.productfees_v0.model/PriceToEstimateFees} priceToEstimateFees
 */
...
/**
 * @member {module:js_client.productfees_v0.model/OptionalFulfillmentProgram} optionalFulfillmentProgram
 */
