 ...
 * @module js_client.productfees_v0.model/GetMyFeesEstimateRequest
 * @version v0
 */
export class GetMyFeesEstimateRequest {
   ...
   * Request schema.
   * @alias module:js_client.productfees_v0.model/GetMyFeesEstimateRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.productfees_v0.model/GetMyFeesEstimateRequest} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/GetMyFeesEstimateRequest} The populated <code>GetMyFeesEstimateRequest</code> instance.
   */
