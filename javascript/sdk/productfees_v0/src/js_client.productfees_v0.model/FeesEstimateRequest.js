 ...
 * @module js_client.productfees_v0.model/FeesEstimateRequest
 * @version v0
 */
export class FeesEstimateRequest {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimateRequest
   * @class
   * @param marketplaceId {String} A marketplace identifier.
   * @param priceToEstimateFees {module:js_client.productfees_v0.model/PriceToEstimateFees} 
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimateRequest} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimateRequest} The populated <code>FeesEstimateRequest</code> instance.
   */
