 ...
 * @module js_client.productfees_v0.model/FeesEstimateByIdRequest
 * @version v0
 */
export class FeesEstimateByIdRequest {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimateByIdRequest
   * @class
   * @param idType {module:js_client.productfees_v0.model/IdType} 
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimateByIdRequest} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimateByIdRequest} The populated <code>FeesEstimateByIdRequest</code> instance.
   */
...
/**
 * @member {module:js_client.productfees_v0.model/FeesEstimateRequest} feesEstimateRequest
 */
