 ...
 * @module js_client.productfees_v0.model/FeesEstimateResult
 * @version v0
 */
export class FeesEstimateResult {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimateResult
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimateResult} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimateResult} The populated <code>FeesEstimateResult</code> instance.
   */
...
/**
 * @member {module:js_client.productfees_v0.model/FeesEstimateIdentifier} feesEstimateIdentifier
 */
FeesEstimateResult.prototype.feesEstimateIdentifier = undefined;

/**
 * @member {module:js_client.productfees_v0.model/FeesEstimate} feesEstimate
 */
FeesEstimateResult.prototype.feesEstimate = undefined;

/**
 * @member {module:js_client.productfees_v0.model/FeesEstimateError} error
 */
