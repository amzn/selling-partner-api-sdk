 ...
 * @module js_client.productfees_v0.model/FeesEstimateError
 * @version v0
 */
export class FeesEstimateError {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimateError
   * @class
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimateError} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimateError} The populated <code>FeesEstimateError</code> instance.
   */
