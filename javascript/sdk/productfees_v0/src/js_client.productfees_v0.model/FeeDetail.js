 ...
 * @module js_client.productfees_v0.model/FeeDetail
 * @version v0
 */
export class FeeDetail {
   ...
   * @alias module:js_client.productfees_v0.model/FeeDetail
   * @class
   * @param feeType {String} The type of fee charged to a seller.
   * @param feeAmount {module:js_client.productfees_v0.model/MoneyType} 
   * @param finalFee {module:js_client.productfees_v0.model/MoneyType} 
   */
   ...
   * @param {module:js_client.productfees_v0.model/FeeDetail} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeeDetail} The populated <code>FeeDetail</code> instance.
   */
...
/**
 * @member {module:js_client.productfees_v0.model/MoneyType} feeAmount
 */
FeeDetail.prototype.feeAmount = undefined;

/**
 * @member {module:js_client.productfees_v0.model/MoneyType} feePromotion
 */
FeeDetail.prototype.feePromotion = undefined;

/**
 * @member {module:js_client.productfees_v0.model/MoneyType} taxAmount
 */
FeeDetail.prototype.taxAmount = undefined;

/**
 * @member {module:js_client.productfees_v0.model/MoneyType} finalFee
 */
FeeDetail.prototype.finalFee = undefined;

/**
 * A list of other fees that contribute to a given fee.
 * @member {Array.<module:js_client.productfees_v0.model/IncludedFeeDetail>} includedFeeDetailList
 */
