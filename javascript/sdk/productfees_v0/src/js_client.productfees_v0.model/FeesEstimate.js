 ...
 * @module js_client.productfees_v0.model/FeesEstimate
 * @version v0
 */
export class FeesEstimate {
   ...
   * @alias module:js_client.productfees_v0.model/FeesEstimate
   * @class
   ...
   * @param {module:js_client.productfees_v0.model/FeesEstimate} obj Optional instance to populate.
   * @return {module:js_client.productfees_v0.model/FeesEstimate} The populated <code>FeesEstimate</code> instance.
   */
...
/**
 * @member {module:js_client.productfees_v0.model/MoneyType} totalFeesEstimate
 */
FeesEstimate.prototype.totalFeesEstimate = undefined;

/**
 * A list of other fees that contribute to a given fee.
 * @member {Array.<module:js_client.productfees_v0.model/FeeDetail>} feeDetailList
 */
