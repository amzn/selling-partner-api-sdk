 ...
 * @module js_client.vendorshipments_v1.model/Weight
 * @version v1
 */
export class Weight {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Weight
   * @class
   * @param unitOfMeasure {module:js_client.vendorshipments_v1.model/Weight.UnitOfMeasureEnum} The unit of measurement.
   ...
   * @param {module:js_client.vendorshipments_v1.model/Weight} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Weight} The populated <code>Weight</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/Weight.UnitOfMeasureEnum} unitOfMeasure
 */
