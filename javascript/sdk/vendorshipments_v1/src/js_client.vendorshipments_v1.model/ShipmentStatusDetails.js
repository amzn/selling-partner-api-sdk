 ...
 * @module js_client.vendorshipments_v1.model/ShipmentStatusDetails
 * @version v1
 */
export class ShipmentStatusDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ShipmentStatusDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/ShipmentStatusDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ShipmentStatusDetails} The populated <code>ShipmentStatusDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ShipmentStatusDetails.ShipmentStatusEnum} shipmentStatus
 */
