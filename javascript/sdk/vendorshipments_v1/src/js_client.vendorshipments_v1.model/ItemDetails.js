 ...
 * @module js_client.vendorshipments_v1.model/ItemDetails
 * @version v1
 */
export class ItemDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ItemDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/ItemDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ItemDetails} The populated <code>ItemDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ItemDetails.HandlingCodeEnum} handlingCode
 */
