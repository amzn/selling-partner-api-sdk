 ...
 * @module js_client.vendorshipments_v1.model/Pallet
 * @version v1
 */
export class Pallet {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Pallet
   * @class
   * @param palletIdentifiers {Array.<module:js_client.vendorshipments_v1.model/ContainerIdentification>} A list of pallet identifiers.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/Pallet} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Pallet} The populated <code>Pallet</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendorshipments_v1.model/ContainerIdentification>} palletIdentifiers
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/CartonReferenceDetails} cartonReferenceDetails
 */
Pallet.prototype.cartonReferenceDetails = undefined;

/**
 * A list of container item details.
 * @member {Array.<module:js_client.vendorshipments_v1.model/ContainerItem>} items
 */
