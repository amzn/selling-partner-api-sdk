 ...
 * @module js_client.vendorshipments_v1.model/Address
 * @version v1
 */
export class Address {
   ...
   * @alias module:js_client.vendorshipments_v1.model/Address
   * @class
   ...
   * @param {module:js_client.vendorshipments_v1.model/Address} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Address} The populated <code>Address</code> instance.
   */
