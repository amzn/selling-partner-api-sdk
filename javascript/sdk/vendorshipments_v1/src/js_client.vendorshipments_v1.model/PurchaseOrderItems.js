 ...
 * @module js_client.vendorshipments_v1.model/PurchaseOrderItems
 * @version v1
 */
export class PurchaseOrderItems {
   ...
   * @alias module:js_client.vendorshipments_v1.model/PurchaseOrderItems
   * @class
   ...
   * @param shippedQuantity {module:js_client.vendorshipments_v1.model/ItemQuantity} 
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/PurchaseOrderItems} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/PurchaseOrderItems} The populated <code>PurchaseOrderItems</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/ItemQuantity} shippedQuantity
 */
PurchaseOrderItems.prototype.shippedQuantity = undefined;

/**
 * @member {module:js_client.vendorshipments_v1.model/Money} maximumRetailPrice
 */
