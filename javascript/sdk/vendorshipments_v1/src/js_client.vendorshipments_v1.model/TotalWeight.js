 ...
 * @module js_client.vendorshipments_v1.model/TotalWeight
 * @version v1
 */
export class TotalWeight {
   ...
   * @alias module:js_client.vendorshipments_v1.model/TotalWeight
   * @class
   * @param unitOfMeasure {module:js_client.vendorshipments_v1.model/TotalWeight.UnitOfMeasureEnum} The unit of measure for the weight of items that are ordered by cases and support pricing by weight.
   ...
   * @param {module:js_client.vendorshipments_v1.model/TotalWeight} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/TotalWeight} The populated <code>TotalWeight</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/TotalWeight.UnitOfMeasureEnum} unitOfMeasure
 */
