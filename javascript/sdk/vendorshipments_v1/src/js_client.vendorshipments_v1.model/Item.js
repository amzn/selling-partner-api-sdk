 ...
 * @module js_client.vendorshipments_v1.model/Item
 * @version v1
 */
export class Item {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Item
   * @class
   ...
   * @param {module:js_client.vendorshipments_v1.model/Item} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Item} The populated <code>Item</code> instance.
   */
