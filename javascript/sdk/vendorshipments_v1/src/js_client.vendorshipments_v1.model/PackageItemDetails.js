 ...
 * @module js_client.vendorshipments_v1.model/PackageItemDetails
 * @version v1
 */
export class PackageItemDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/PackageItemDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/PackageItemDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/PackageItemDetails} The populated <code>PackageItemDetails</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Expiry} expiry
 */
