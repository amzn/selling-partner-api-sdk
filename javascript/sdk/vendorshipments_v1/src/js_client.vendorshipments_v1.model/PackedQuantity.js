 ...
 * @module js_client.vendorshipments_v1.model/PackedQuantity
 * @version v1
 */
export class PackedQuantity {
   ...
   * @alias module:js_client.vendorshipments_v1.model/PackedQuantity
   * @class
   ...
   * @param unitOfMeasure {module:js_client.vendorshipments_v1.model/PackedQuantity.UnitOfMeasureEnum} Unit of measure for the shipped quantity.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/PackedQuantity} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/PackedQuantity} The populated <code>PackedQuantity</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/PackedQuantity.UnitOfMeasureEnum} unitOfMeasure
 */
