 ...
 * @module js_client.vendorshipments_v1.model/TaxRegistrationDetails
 * @version v1
 */
export class TaxRegistrationDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/TaxRegistrationDetails
   * @class
   * @param taxRegistrationType {module:js_client.vendorshipments_v1.model/TaxRegistrationDetails.TaxRegistrationTypeEnum} Tax registration type for the entity.
   ...
   * @param {module:js_client.vendorshipments_v1.model/TaxRegistrationDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/TaxRegistrationDetails} The populated <code>TaxRegistrationDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/TaxRegistrationDetails.TaxRegistrationTypeEnum} taxRegistrationType
 */
