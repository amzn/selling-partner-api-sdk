 ...
 * @module js_client.vendorshipments_v1.model/CarrierDetails
 * @version v1
 */
export class CarrierDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/CarrierDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/CarrierDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/CarrierDetails} The populated <code>CarrierDetails</code> instance.
   */
