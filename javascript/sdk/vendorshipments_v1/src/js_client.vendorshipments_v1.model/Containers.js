 ...
 * @module js_client.vendorshipments_v1.model/Containers
 * @version v1
 */
export class Containers {
   ...
   * @alias module:js_client.vendorshipments_v1.model/Containers
   * @class
   * @param containerType {module:js_client.vendorshipments_v1.model/Containers.ContainerTypeEnum} The type of container.
   * @param containerIdentifiers {Array.<module:js_client.vendorshipments_v1.model/ContainerIdentification>} A list of carton identifiers.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/Containers} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Containers} The populated <code>Containers</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/Containers.ContainerTypeEnum} containerType
 */
 ...
 * @member {Array.<module:js_client.vendorshipments_v1.model/ContainerIdentification>} containerIdentifiers
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Dimensions} dimensions
 */
Containers.prototype.dimensions = undefined;

/**
 * @member {module:js_client.vendorshipments_v1.model/Weight} weight
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/InnerContainersDetails} innerContainersDetails
 */
Containers.prototype.innerContainersDetails = undefined;

/**
 * A list of packed items.
 * @member {Array.<module:js_client.vendorshipments_v1.model/PackedItems>} packedItems
 */
