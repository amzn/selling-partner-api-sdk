 ...
 * @module js_client.vendorshipments_v1.model/Stop
 * @version v1
 */
export class Stop {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Stop
   * @class
   * @param functionCode {module:js_client.vendorshipments_v1.model/Stop.FunctionCodeEnum} Provide the function code.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/Stop} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Stop} The populated <code>Stop</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/Stop.FunctionCodeEnum} functionCode
 */
Stop.prototype.functionCode = undefined;

/**
 * @member {module:js_client.vendorshipments_v1.model/Location} locationIdentification
 */
