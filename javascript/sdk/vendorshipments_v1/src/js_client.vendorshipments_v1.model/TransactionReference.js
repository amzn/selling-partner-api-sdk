 ...
 * @module js_client.vendorshipments_v1.model/TransactionReference
 * @version v1
 */
export class TransactionReference {
   ...
   * @alias module:js_client.vendorshipments_v1.model/TransactionReference
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/TransactionReference} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/TransactionReference} The populated <code>TransactionReference</code> instance.
   */
