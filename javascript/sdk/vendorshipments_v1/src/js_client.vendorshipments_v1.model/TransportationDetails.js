 ...
 * @module js_client.vendorshipments_v1.model/TransportationDetails
 * @version v1
 */
export class TransportationDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/TransportationDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/TransportationDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/TransportationDetails} The populated <code>TransportationDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/TransportationDetails.ShipModeEnum} shipMode
 */
 ...
 * @member {module:js_client.vendorshipments_v1.model/TransportationDetails.TransportationModeEnum} transportationMode
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/CarrierDetails} carrierDetails
 */
