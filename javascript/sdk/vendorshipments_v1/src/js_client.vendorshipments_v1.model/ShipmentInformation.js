 ...
 * @module js_client.vendorshipments_v1.model/ShipmentInformation
 * @version v1
 */
export class ShipmentInformation {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ShipmentInformation
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/ShipmentInformation} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ShipmentInformation} The populated <code>ShipmentInformation</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/VendorDetails} vendorDetails
 */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ShipmentInformation.ShipModeEnum} shipMode
 */
