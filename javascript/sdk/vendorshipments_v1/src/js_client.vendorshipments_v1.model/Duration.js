 ...
 * @module js_client.vendorshipments_v1.model/Duration
 * @version v1
 */
export class Duration {
   ...
   * @alias module:js_client.vendorshipments_v1.model/Duration
   * @class
   * @param durationUnit {module:js_client.vendorshipments_v1.model/Duration.DurationUnitEnum} Unit for duration.
   ...
   * @param {module:js_client.vendorshipments_v1.model/Duration} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Duration} The populated <code>Duration</code> instance.
   */
...
/**
 * Unit for duration.
 * @member {module:js_client.vendorshipments_v1.model/Duration.DurationUnitEnum} durationUnit
 */
