 ...
 * @module js_client.vendorshipments_v1.model/Expiry
 * @version v1
 */
export class Expiry {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Expiry
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/Expiry} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Expiry} The populated <code>Expiry</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Duration} expiryAfterDuration
 */
