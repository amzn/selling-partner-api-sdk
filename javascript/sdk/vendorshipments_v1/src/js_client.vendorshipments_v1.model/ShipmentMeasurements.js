 ...
 * @module js_client.vendorshipments_v1.model/ShipmentMeasurements
 * @version v1
 */
export class ShipmentMeasurements {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ShipmentMeasurements
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/ShipmentMeasurements} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ShipmentMeasurements} The populated <code>ShipmentMeasurements</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Weight} grossShipmentWeight
 */
