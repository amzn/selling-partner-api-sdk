 ...
 * @module js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest
 * @version v1
 */
export class SubmitShipmentConfirmationsRequest {
   ...
   * @alias module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest} The populated <code>SubmitShipmentConfirmationsRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendorshipments_v1.model/ShipmentConfirmation>} shipmentConfirmations
 */
