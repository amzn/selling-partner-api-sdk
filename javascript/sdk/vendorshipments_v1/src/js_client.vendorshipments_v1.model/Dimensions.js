 ...
 * @module js_client.vendorshipments_v1.model/Dimensions
 * @version v1
 */
export class Dimensions {
   ...
   * @alias module:js_client.vendorshipments_v1.model/Dimensions
   * @class
   ...
   * @param unitOfMeasure {module:js_client.vendorshipments_v1.model/Dimensions.UnitOfMeasureEnum} The unit of measure for dimensions.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/Dimensions} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Dimensions} The populated <code>Dimensions</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/Dimensions.UnitOfMeasureEnum} unitOfMeasure
 */
