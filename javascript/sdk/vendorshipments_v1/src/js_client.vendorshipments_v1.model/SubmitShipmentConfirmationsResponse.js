 ...
 * @module js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse
 * @version v1
 */
export class SubmitShipmentConfirmationsResponse {
   ...
   * @alias module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse} The populated <code>SubmitShipmentConfirmationsResponse</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/TransactionReference} payload
 */
SubmitShipmentConfirmationsResponse.prototype.payload = undefined;

/**
 * A list of error responses returned when a request is unsuccessful.
 * @member {Array.<module:js_client.vendorshipments_v1.model/Error>} errors
 */
