 ...
 * @module js_client.vendorshipments_v1.model/PurchaseOrders
 * @version v1
 */
export class PurchaseOrders {
   ...
   * @alias module:js_client.vendorshipments_v1.model/PurchaseOrders
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/PurchaseOrders} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/PurchaseOrders} The populated <code>PurchaseOrders</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendorshipments_v1.model/PurchaseOrderItems>} items
 */
