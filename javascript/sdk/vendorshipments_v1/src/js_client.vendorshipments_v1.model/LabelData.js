 ...
 * @module js_client.vendorshipments_v1.model/LabelData
 * @version v1
 */
export class LabelData {
   ...
   * @alias module:js_client.vendorshipments_v1.model/LabelData
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/LabelData} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/LabelData} The populated <code>LabelData</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/LabelData.LabelFormatEnum} labelFormat
 */
