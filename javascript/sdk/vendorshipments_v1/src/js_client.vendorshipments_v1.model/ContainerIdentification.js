 ...
 * @module js_client.vendorshipments_v1.model/ContainerIdentification
 * @version v1
 */
export class ContainerIdentification {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ContainerIdentification
   * @class
   * @param containerIdentificationType {module:js_client.vendorshipments_v1.model/ContainerIdentification.ContainerIdentificationTypeEnum} The container identification type.
   ...
   * @param {module:js_client.vendorshipments_v1.model/ContainerIdentification} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ContainerIdentification} The populated <code>ContainerIdentification</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ContainerIdentification.ContainerIdentificationTypeEnum} containerIdentificationType
 */
