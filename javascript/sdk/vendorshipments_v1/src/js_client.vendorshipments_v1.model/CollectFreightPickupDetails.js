 ...
 * @module js_client.vendorshipments_v1.model/CollectFreightPickupDetails
 * @version v1
 */
export class CollectFreightPickupDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/CollectFreightPickupDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/CollectFreightPickupDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/CollectFreightPickupDetails} The populated <code>CollectFreightPickupDetails</code> instance.
   */
