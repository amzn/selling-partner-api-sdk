 ...
 * @module js_client.vendorshipments_v1.model/ImportDetails
 * @version v1
 */
export class ImportDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ImportDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/ImportDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ImportDetails} The populated <code>ImportDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ImportDetails.MethodOfPaymentEnum} methodOfPayment
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Route} route
 */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Weight} billableWeight
 */
 ...
 * @member {module:js_client.vendorshipments_v1.model/ImportDetails.HandlingInstructionsEnum} handlingInstructions
 */
