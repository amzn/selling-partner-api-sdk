 ...
 * @module js_client.vendorshipments_v1.model/Carton
 * @version v1
 */
export class Carton {
  /**
   ...
   * @alias module:js_client.vendorshipments_v1.model/Carton
   * @class
   ...
   * @param items {Array.<module:js_client.vendorshipments_v1.model/ContainerItem>} A list of container item details.
   */
   ...
   * @param {module:js_client.vendorshipments_v1.model/Carton} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/Carton} The populated <code>Carton</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendorshipments_v1.model/ContainerIdentification>} cartonIdentifiers
 */
