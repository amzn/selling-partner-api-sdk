 ...
 * @module js_client.vendorshipments_v1.model/CartonReferenceDetails
 * @version v1
 */
export class CartonReferenceDetails {
   ...
   * @alias module:js_client.vendorshipments_v1.model/CartonReferenceDetails
   * @class
   ...
   * @param {module:js_client.vendorshipments_v1.model/CartonReferenceDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/CartonReferenceDetails} The populated <code>CartonReferenceDetails</code> instance.
   */
