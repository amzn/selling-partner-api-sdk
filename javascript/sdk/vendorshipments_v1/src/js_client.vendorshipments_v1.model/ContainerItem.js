 ...
 * @module js_client.vendorshipments_v1.model/ContainerItem
 * @version v1
 */
export class ContainerItem {
   ...
   * @alias module:js_client.vendorshipments_v1.model/ContainerItem
   * @class
   ...
   * @param {module:js_client.vendorshipments_v1.model/ContainerItem} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/ContainerItem} The populated <code>ContainerItem</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/ItemDetails} itemDetails
 */
