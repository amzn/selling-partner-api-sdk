 ...
 * @module js_client.vendorshipments_v1.model/TransportShipmentMeasurements
 * @version v1
 */
export class TransportShipmentMeasurements {
   ...
   * @alias module:js_client.vendorshipments_v1.model/TransportShipmentMeasurements
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorshipments_v1.model/TransportShipmentMeasurements} obj Optional instance to populate.
   * @return {module:js_client.vendorshipments_v1.model/TransportShipmentMeasurements} The populated <code>TransportShipmentMeasurements</code> instance.
   */
...
/**
 * @member {module:js_client.vendorshipments_v1.model/Weight} shipmentWeight
 */
TransportShipmentMeasurements.prototype.shipmentWeight = undefined;

/**
 * @member {module:js_client.vendorshipments_v1.model/Volume} shipmentVolume
 */
