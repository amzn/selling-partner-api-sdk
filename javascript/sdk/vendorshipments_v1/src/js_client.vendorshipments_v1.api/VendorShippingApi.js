...
* @module js_client.vendorshipments_v1.api/VendorShippingApi
* @version v1
*/
export class VendorShippingApi {
    ...
    * @alias module:js_client.vendorshipments_v1.api/VendorShippingApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.vendorshipments_v1.model/String} opts.sortOrder Sort in ascending or descending order by purchase order creation date.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendorshipments_v1.model/GetShipmentDetailsResponse} and HTTP response
     */
     ...
     * @param {String} opts.buyerWarehouseCode Get Shipping Details based on buyer warehouse code. This value should be same as &#39;shipToParty.partyId&#39; in the Shipment.
     * @param {String} opts.sellerWarehouseCode Get Shipping Details based on vendor warehouse code. This value should be same as &#39;sellingParty.partyId&#39; in the Shipment.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendorshipments_v1.model/GetShipmentDetailsResponse}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit The limit to the number of records returned. Default value is 50 records.
     * @param {module:js_client.vendorshipments_v1.model/String} opts.sortOrder Sort the list by shipment label creation date in ascending or descending order.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendorshipments_v1.model/GetShipmentLabels} and HTTP response
     */
     ...
     * @param {String} opts.vendorShipmentIdentifier Get Shipment labels by passing vendor shipment identifier.
     * @param {String} opts.sellerWarehouseCode Get Shipping labels based on vendor warehouse code. This value must be same as the &#x60;sellingParty.partyId&#x60; in the shipment.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendorshipments_v1.model/GetShipmentLabels}
     */
     ...
     * @param {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest} body A request to submit shipment confirmation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse} and HTTP response
     */
     ...
     * Submits one or more shipment confirmations for vendor orders.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsRequest} body A request to submit shipment confirmation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse}
     */
     ...
     * @param {module:js_client.vendorshipments_v1.model/SubmitShipments} body A request to submit shipment request.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendorshipments_v1.model/SubmitShipmentConfirmationsResponse} and HTTP response
     */
