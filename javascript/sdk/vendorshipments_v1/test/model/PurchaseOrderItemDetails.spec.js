...
(function(root, factory) {
  ...
  describe('PurchaseOrderItemDetails', function() {
    it('should create an instance of PurchaseOrderItemDetails', function() {
      // uncomment below and update the code to test PurchaseOrderItemDetails
      //var instance = new SellingPartnerApiForRetailProcurementShipments.PurchaseOrderItemDetails();
