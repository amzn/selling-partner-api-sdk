...
(function(root, factory) {
  ...
  describe('ShipmentStatusDetails', function() {
    it('should create an instance of ShipmentStatusDetails', function() {
      // uncomment below and update the code to test ShipmentStatusDetails
      //var instance = new SellingPartnerApiForRetailProcurementShipments.ShipmentStatusDetails();
    ...
    it('should have the property shipmentStatusDate (base name: "shipmentStatusDate")', function() {
      // uncomment below and update the code to test the property shipmentStatusDate
      //var instance = new SellingPartnerApiForRetailProcurementShipments.ShipmentStatusDetails();
      //expect(instance).to.be();
    });
