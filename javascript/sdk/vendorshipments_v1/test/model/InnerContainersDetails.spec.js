...
(function(root, factory) {
  ...
  describe('InnerContainersDetails', function() {
    it('should create an instance of InnerContainersDetails', function() {
      // uncomment below and update the code to test InnerContainersDetails
      //var instance = new SellingPartnerApiForRetailProcurementShipments.InnerContainersDetails();
    ...
    it('should have the property containerSequenceNumbers (base name: "containerSequenceNumbers")', function() {
      // uncomment below and update the code to test the property containerSequenceNumbers
      //var instance = new SellingPartnerApiForRetailProcurementShipments.InnerContainersDetails();
      //expect(instance).to.be();
    });
