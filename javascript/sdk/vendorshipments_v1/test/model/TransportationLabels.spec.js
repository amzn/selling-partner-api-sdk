...
(function(root, factory) {
  ...
  describe('TransportationLabels', function() {
    it('should create an instance of TransportationLabels', function() {
      // uncomment below and update the code to test TransportationLabels
      //var instance = new SellingPartnerApiForRetailProcurementShipments.TransportationLabels();
    ...
    it('should have the property transportLabels (base name: "transportLabels")', function() {
      // uncomment below and update the code to test the property transportLabels
      //var instance = new SellingPartnerApiForRetailProcurementShipments.TransportationLabels();
      //expect(instance).to.be();
    });
