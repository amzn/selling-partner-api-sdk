 ...
 * @module js_client.sales_v1.model/OrderMetricsInterval
 * @version v1
 */
export class OrderMetricsInterval {
   ...
   * @alias module:js_client.sales_v1.model/OrderMetricsInterval
   * @class
   ...
   * @param averageUnitPrice {module:js_client.sales_v1.model/Money} 
   * @param totalSales {module:js_client.sales_v1.model/Money} 
   */
   ...
   * @param {module:js_client.sales_v1.model/OrderMetricsInterval} obj Optional instance to populate.
   * @return {module:js_client.sales_v1.model/OrderMetricsInterval} The populated <code>OrderMetricsInterval</code> instance.
   */
...
/**
 * @member {module:js_client.sales_v1.model/Money} averageUnitPrice
 */
OrderMetricsInterval.prototype.averageUnitPrice = undefined;

/**
 * @member {module:js_client.sales_v1.model/Money} totalSales
 */
