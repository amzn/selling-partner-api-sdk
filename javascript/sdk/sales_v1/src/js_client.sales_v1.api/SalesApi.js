...
/**
* Sales service.
* @module js_client.sales_v1.api/SalesApi
* @version v1
*/
export class SalesApi {
    ...
    * @alias module:js_client.sales_v1.api/SalesApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.sales_v1.model/String} opts.buyerType Filters the results by the buyer type that you specify, B2B (business to business) or B2C (business to customer). Example: B2B, if you want the response to include order metrics for only B2B buyers. (default to &#39;All&#39;)
     ...
     * @param {module:js_client.sales_v1.model/String} opts.firstDayOfWeek Specifies the day that the week starts on when granularity&#x3D;Week, either Monday or Sunday. Default: Monday. Example: Sunday, if you want the week to start on a Sunday. (default to &#39;Monday&#39;)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.sales_v1.model/GetOrderMetricsResponse} and HTTP response
     */
     ...
     * @param {String} opts.asin Filters the results by the ASIN that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all ASINs. Example: B0792R1RSN, if you want the response to include order metrics for only ASIN B0792R1RSN.
     * @param {String} opts.sku Filters the results by the SKU that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all SKUs. Example: TestSKU, if you want the response to include order metrics for only SKU TestSKU.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.sales_v1.model/GetOrderMetricsResponse}
     */
