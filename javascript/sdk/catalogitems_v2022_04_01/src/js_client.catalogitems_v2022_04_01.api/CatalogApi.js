...
/**
* Catalog service.
* @module js_client.catalogitems_v2022_04_01.api/CatalogApi
* @version 2022-04-01
*/
export class CatalogApi {
    ...
    * @alias module:js_client.catalogitems_v2022_04_01.api/CatalogApi
    * @class
    ...
    */
     ...
     * @param {Array.<module:js_client.catalogitems_v2022_04_01.model/String>} opts.includedData A comma-delimited list of datasets to include in the response.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.catalogitems_v2022_04_01.model/Item} and HTTP response
     */
     ...
     * @param {Array.<module:js_client.catalogitems_v2022_04_01.model/String>} opts.includedData A comma-delimited list of datasets to include in the response.
     * @param {String} opts.locale The locale for which you want to retrieve localized summaries. Defaults to the primary locale of the marketplace.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.catalogitems_v2022_04_01.model/Item}
     */
     ...
     * @param {module:js_client.catalogitems_v2022_04_01.model/String} opts.identifiersType The type of product identifiers that you can use to search the Amazon catalog. **Note:** &#x60;identifiersType&#x60; is required when &#x60;identifiers&#x60; is in the request.
     * @param {Array.<module:js_client.catalogitems_v2022_04_01.model/String>} opts.includedData A comma-delimited list of datasets to include in the response.
     * @param {String} opts.locale The locale for which you want to retrieve localized summaries. Defaults to the primary locale of the marketplace.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.catalogitems_v2022_04_01.model/ItemSearchResults} and HTTP response
     */
     ...
     * @param {String} opts.pageToken A token that you can use to fetch a specific page when there are multiple pages of results.
     * @param {String} opts.keywordsLocale The language of the keywords that are included in queries based on &#x60;keywords&#x60;. Defaults to the primary locale of the marketplace. **Note:** Cannot be used with &#x60;identifiers&#x60;.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.catalogitems_v2022_04_01.model/ItemSearchResults}
     */
