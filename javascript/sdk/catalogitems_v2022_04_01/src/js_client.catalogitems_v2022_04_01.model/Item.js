 ...
 * @module js_client.catalogitems_v2022_04_01.model/Item
 * @version 2022-04-01
 */
export class Item {
  /**
   ...
   * @alias module:js_client.catalogitems_v2022_04_01.model/Item
   * @class
   ...
   * @param {module:js_client.catalogitems_v2022_04_01.model/Item} obj Optional instance to populate.
   * @return {module:js_client.catalogitems_v2022_04_01.model/Item} The populated <code>Item</code> instance.
   */
 ...
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemBrowseClassificationsByMarketplace>} classifications
 */
 ...
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemDimensionsByMarketplace>} dimensions
 */
Item.prototype.dimensions = undefined;

/**
 * Identifiers associated with the item in the Amazon catalog, such as UPC and EAN identifiers.
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemIdentifiersByMarketplace>} identifiers
 */
Item.prototype.identifiers = undefined;

/**
 * The images for an item in the Amazon catalog.
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemImagesByMarketplace>} images
 */
Item.prototype.images = undefined;

/**
 * Product types that are associated with the Amazon catalog item.
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemProductTypeByMarketplace>} productTypes
 */
 ...
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemRelationshipsByMarketplace>} relationships
 */
Item.prototype.relationships = undefined;

/**
 * Sales ranks of an Amazon catalog item.
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemSalesRanksByMarketplace>} salesRanks
 */
Item.prototype.salesRanks = undefined;

/**
 * Summaries of Amazon catalog items.
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemSummaryByMarketplace>} summaries
 */
 ...
 * @member {Array.<module:js_client.catalogitems_v2022_04_01.model/ItemVendorDetailsByMarketplace>} vendorDetails
 */
