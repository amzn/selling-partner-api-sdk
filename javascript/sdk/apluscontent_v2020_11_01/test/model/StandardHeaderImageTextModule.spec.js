...
(function(root, factory) {
  ...
  describe('StandardHeaderImageTextModule', function() {
    it('should create an instance of StandardHeaderImageTextModule', function() {
      // uncomment below and update the code to test StandardHeaderImageTextModule
      //var instance = new SellingPartnerApiForAContentManagement.StandardHeaderImageTextModule();
