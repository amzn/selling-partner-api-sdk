...
(function(root, factory) {
  ...
  describe('StandardImageTextCaptionBlock', function() {
    it('should create an instance of StandardImageTextCaptionBlock', function() {
      // uncomment below and update the code to test StandardImageTextCaptionBlock
      //var instance = new SellingPartnerApiForAContentManagement.StandardImageTextCaptionBlock();
