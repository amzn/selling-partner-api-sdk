...
(function(root, factory) {
  ...
  describe('StandardComparisonTableModule', function() {
    it('should create an instance of StandardComparisonTableModule', function() {
      // uncomment below and update the code to test StandardComparisonTableModule
      //var instance = new SellingPartnerApiForAContentManagement.StandardComparisonTableModule();
    ...
    it('should have the property productColumns (base name: "productColumns")', function() {
      // uncomment below and update the code to test the property productColumns
      //var instance = new SellingPartnerApiForAContentManagement.StandardComparisonTableModule();
      //expect(instance).to.be();
    });

    it('should have the property metricRowLabels (base name: "metricRowLabels")', function() {
      // uncomment below and update the code to test the property metricRowLabels
      //var instance = new SellingPartnerApiForAContentManagement.StandardComparisonTableModule();
      //expect(instance).to.be();
    });
