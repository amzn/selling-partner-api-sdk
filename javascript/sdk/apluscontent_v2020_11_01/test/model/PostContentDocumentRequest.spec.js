...
(function(root, factory) {
  ...
  describe('PostContentDocumentRequest', function() {
    it('should create an instance of PostContentDocumentRequest', function() {
      // uncomment below and update the code to test PostContentDocumentRequest
      //var instance = new SellingPartnerApiForAContentManagement.PostContentDocumentRequest();
    ...
    it('should have the property contentDocument (base name: "contentDocument")', function() {
      // uncomment below and update the code to test the property contentDocument
      //var instance = new SellingPartnerApiForAContentManagement.PostContentDocumentRequest();
