...
(function(root, factory) {
  ...
  describe('StandardImageCaptionBlock', function() {
    it('should create an instance of StandardImageCaptionBlock', function() {
      // uncomment below and update the code to test StandardImageCaptionBlock
      //var instance = new SellingPartnerApiForAContentManagement.StandardImageCaptionBlock();
