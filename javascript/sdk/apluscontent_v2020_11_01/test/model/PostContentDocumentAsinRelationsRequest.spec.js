...
(function(root, factory) {
  ...
  describe('PostContentDocumentAsinRelationsRequest', function() {
    it('should create an instance of PostContentDocumentAsinRelationsRequest', function() {
      // uncomment below and update the code to test PostContentDocumentAsinRelationsRequest
      //var instance = new SellingPartnerApiForAContentManagement.PostContentDocumentAsinRelationsRequest();
    ...
    it('should have the property asinSet (base name: "asinSet")', function() {
      // uncomment below and update the code to test the property asinSet
      //var instance = new SellingPartnerApiForAContentManagement.PostContentDocumentAsinRelationsRequest();
