...
(function(root, factory) {
  ...
  describe('PostContentDocumentAsinRelationsResponse', function() {
    it('should create an instance of PostContentDocumentAsinRelationsResponse', function() {
      // uncomment below and update the code to test PostContentDocumentAsinRelationsResponse
      //var instance = new SellingPartnerApiForAContentManagement.PostContentDocumentAsinRelationsResponse();
