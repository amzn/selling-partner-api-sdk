...
(function(root, factory) {
  ...
  describe('ColorType', function() {
    it('should create an instance of ColorType', function() {
      // uncomment below and update the code to test ColorType
      //var instance = new SellingPartnerApiForAContentManagement.ColorType();
      //expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ColorType);
    });
