...
(function(root, factory) {
  ...
  describe('AsinBadge', function() {
    it('should create an instance of AsinBadge', function() {
      // uncomment below and update the code to test AsinBadge
      //var instance = new SellingPartnerApiForAContentManagement.AsinBadge();
      //expect(instance).to.be.a(SellingPartnerApiForAContentManagement.AsinBadge);
    });
