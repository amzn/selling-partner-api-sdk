...
(function(root, factory) {
  ...
  describe('ContentModuleType', function() {
    it('should create an instance of ContentModuleType', function() {
      // uncomment below and update the code to test ContentModuleType
      //var instance = new SellingPartnerApiForAContentManagement.ContentModuleType();
      //expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ContentModuleType);
    });
