...
(function(root, factory) {
  ...
  describe('StandardCompanyLogoModule', function() {
    it('should create an instance of StandardCompanyLogoModule', function() {
      // uncomment below and update the code to test StandardCompanyLogoModule
      //var instance = new SellingPartnerApiForAContentManagement.StandardCompanyLogoModule();
