...
(function(root, factory) {
  ...
  describe('DecoratorType', function() {
    it('should create an instance of DecoratorType', function() {
      // uncomment below and update the code to test DecoratorType
      //var instance = new SellingPartnerApiForAContentManagement.DecoratorType();
      //expect(instance).to.be.a(SellingPartnerApiForAContentManagement.DecoratorType);
    });
