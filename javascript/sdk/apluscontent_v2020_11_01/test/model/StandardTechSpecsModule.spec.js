...
(function(root, factory) {
  ...
  describe('StandardTechSpecsModule', function() {
    it('should create an instance of StandardTechSpecsModule', function() {
      // uncomment below and update the code to test StandardTechSpecsModule
      //var instance = new SellingPartnerApiForAContentManagement.StandardTechSpecsModule();
    ...
    it('should have the property specificationList (base name: "specificationList")', function() {
      // uncomment below and update the code to test the property specificationList
      //var instance = new SellingPartnerApiForAContentManagement.StandardTechSpecsModule();
      //expect(instance).to.be();
    });
