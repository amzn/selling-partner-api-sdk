...
(function(root, factory) {
  ...
  describe('StandardSingleSideImageModule', function() {
    it('should create an instance of StandardSingleSideImageModule', function() {
      // uncomment below and update the code to test StandardSingleSideImageModule
      //var instance = new SellingPartnerApiForAContentManagement.StandardSingleSideImageModule();
    ...
    it('should have the property imagePositionType (base name: "imagePositionType")', function() {
      // uncomment below and update the code to test the property imagePositionType
      //var instance = new SellingPartnerApiForAContentManagement.StandardSingleSideImageModule();
