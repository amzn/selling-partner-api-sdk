...
(function(root, factory) {
  ...
  describe('AppointmentSlotReport', function() {
    it('should create an instance of AppointmentSlotReport', function() {
      // uncomment below and update the code to test AppointmentSlotReport
      //var instance = new SellingPartnerApiForServices.AppointmentSlotReport();
    ...
    it('should have the property appointmentSlots (base name: "appointmentSlots")', function() {
      // uncomment below and update the code to test the property appointmentSlots
      //var instance = new SellingPartnerApiForServices.AppointmentSlotReport();
      //expect(instance).to.be();
    });
