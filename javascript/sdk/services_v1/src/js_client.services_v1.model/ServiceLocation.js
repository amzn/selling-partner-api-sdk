 ...
 * @module js_client.services_v1.model/ServiceLocation
 * @version v1
 */
export class ServiceLocation {
   ...
   * @alias module:js_client.services_v1.model/ServiceLocation
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ServiceLocation} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ServiceLocation} The populated <code>ServiceLocation</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/ServiceLocation.ServiceLocationTypeEnum} serviceLocationType
 */
ServiceLocation.prototype.serviceLocationType = undefined;

/**
 * @member {module:js_client.services_v1.model/Address} address
 */
