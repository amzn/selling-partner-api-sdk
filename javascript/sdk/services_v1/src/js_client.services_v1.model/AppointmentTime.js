 ...
 * @module js_client.services_v1.model/AppointmentTime
 * @version v1
 */
export class AppointmentTime {
   ...
   * @alias module:js_client.services_v1.model/AppointmentTime
   * @class
   ...
   * @param {module:js_client.services_v1.model/AppointmentTime} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AppointmentTime} The populated <code>AppointmentTime</code> instance.
   */
