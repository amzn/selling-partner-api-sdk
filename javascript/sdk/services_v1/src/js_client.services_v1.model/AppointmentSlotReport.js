 ...
 * @module js_client.services_v1.model/AppointmentSlotReport
 * @version v1
 */
export class AppointmentSlotReport {
   ...
   * @alias module:js_client.services_v1.model/AppointmentSlotReport
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/AppointmentSlotReport} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AppointmentSlotReport} The populated <code>AppointmentSlotReport</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/AppointmentSlotReport.SchedulingTypeEnum} schedulingType
 */
 ...
 * @member {Array.<module:js_client.services_v1.model/AppointmentSlot>} appointmentSlots
 */
