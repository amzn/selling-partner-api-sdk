 ...
 * @module js_client.services_v1.model/FixedSlotCapacityQuery
 * @version v1
 */
export class FixedSlotCapacityQuery {
   ...
   * @alias module:js_client.services_v1.model/FixedSlotCapacityQuery
   * @class
   ...
   * @param {module:js_client.services_v1.model/FixedSlotCapacityQuery} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/FixedSlotCapacityQuery} The populated <code>FixedSlotCapacityQuery</code> instance.
   */
