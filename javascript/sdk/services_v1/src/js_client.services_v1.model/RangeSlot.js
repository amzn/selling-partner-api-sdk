 ...
 * @module js_client.services_v1.model/RangeSlot
 * @version v1
 */
export class RangeSlot {
   ...
   * @alias module:js_client.services_v1.model/RangeSlot
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/RangeSlot} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/RangeSlot} The populated <code>RangeSlot</code> instance.
   */
