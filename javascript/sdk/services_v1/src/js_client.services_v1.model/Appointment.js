 ...
 * @module js_client.services_v1.model/Appointment
 * @version v1
 */
export class Appointment {
   ...
   * @alias module:js_client.services_v1.model/Appointment
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/Appointment} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Appointment} The populated <code>Appointment</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/Appointment.AppointmentStatusEnum} appointmentStatus
 */
Appointment.prototype.appointmentStatus = undefined;

/**
 * @member {module:js_client.services_v1.model/AppointmentTime} appointmentTime
 */
Appointment.prototype.appointmentTime = undefined;

/**
 * A list of technicians assigned to the service job.
 * @member {Array.<module:js_client.services_v1.model/Technician>} assignedTechnicians
 */
...
/**
 * @member {module:js_client.services_v1.model/Poa} poa
 */
