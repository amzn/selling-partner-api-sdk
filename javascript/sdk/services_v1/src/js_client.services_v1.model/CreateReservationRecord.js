 ...
 * @module js_client.services_v1.model/CreateReservationRecord
 * @version v1
 */
export class CreateReservationRecord {
   ...
   * @alias module:js_client.services_v1.model/CreateReservationRecord
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/CreateReservationRecord} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/CreateReservationRecord} The populated <code>CreateReservationRecord</code> instance.
   */
