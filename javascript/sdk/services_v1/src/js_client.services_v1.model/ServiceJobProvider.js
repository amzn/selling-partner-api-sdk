 ...
 * @module js_client.services_v1.model/ServiceJobProvider
 * @version v1
 */
export class ServiceJobProvider {
   ...
   * @alias module:js_client.services_v1.model/ServiceJobProvider
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ServiceJobProvider} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ServiceJobProvider} The populated <code>ServiceJobProvider</code> instance.
   */
