 ...
 * @module js_client.services_v1.model/UpdateReservationRequest
 * @version v1
 */
export class UpdateReservationRequest {
   ...
   * @alias module:js_client.services_v1.model/UpdateReservationRequest
   * @class
   * @param resourceId {String} Resource (store) identifier.
   * @param reservation {module:js_client.services_v1.model/Reservation} 
   */
   ...
   * @param {module:js_client.services_v1.model/UpdateReservationRequest} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/UpdateReservationRequest} The populated <code>UpdateReservationRequest</code> instance.
   */
