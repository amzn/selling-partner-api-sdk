 ...
 * @module js_client.services_v1.model/EncryptionDetails
 * @version v1
 */
export class EncryptionDetails {
   ...
   * @alias module:js_client.services_v1.model/EncryptionDetails
   * @class
   * @param standard {module:js_client.services_v1.model/EncryptionDetails.StandardEnum} The encryption standard required to encrypt or decrypt the document contents.
   ...
   * @param {module:js_client.services_v1.model/EncryptionDetails} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/EncryptionDetails} The populated <code>EncryptionDetails</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/EncryptionDetails.StandardEnum} standard
 */
