 ...
 * @module js_client.services_v1.model/AppointmentResource
 * @version v1
 */
export class AppointmentResource {
   ...
   * @alias module:js_client.services_v1.model/AppointmentResource
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/AppointmentResource} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AppointmentResource} The populated <code>AppointmentResource</code> instance.
   */
