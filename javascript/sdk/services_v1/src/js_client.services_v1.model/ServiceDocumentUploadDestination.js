 ...
 * @module js_client.services_v1.model/ServiceDocumentUploadDestination
 * @version v1
 */
export class ServiceDocumentUploadDestination {
   ...
   * @alias module:js_client.services_v1.model/ServiceDocumentUploadDestination
   * @class
   ...
   * @param encryptionDetails {module:js_client.services_v1.model/EncryptionDetails} 
   */
   ...
   * @param {module:js_client.services_v1.model/ServiceDocumentUploadDestination} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ServiceDocumentUploadDestination} The populated <code>ServiceDocumentUploadDestination</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/EncryptionDetails} encryptionDetails
 */
