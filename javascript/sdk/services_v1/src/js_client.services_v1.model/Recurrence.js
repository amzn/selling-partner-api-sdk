 ...
 * @module js_client.services_v1.model/Recurrence
 * @version v1
 */
export class Recurrence {
   ...
   * @alias module:js_client.services_v1.model/Recurrence
   * @class
   ...
   * @param {module:js_client.services_v1.model/Recurrence} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Recurrence} The populated <code>Recurrence</code> instance.
   */
 ...
 * @member {Array.<module:js_client.services_v1.model/DayOfWeek>} daysOfWeek
 */
