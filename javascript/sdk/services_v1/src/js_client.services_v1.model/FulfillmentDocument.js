 ...
 * @module js_client.services_v1.model/FulfillmentDocument
 * @version v1
 */
export class FulfillmentDocument {
   ...
   * @alias module:js_client.services_v1.model/FulfillmentDocument
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/FulfillmentDocument} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/FulfillmentDocument} The populated <code>FulfillmentDocument</code> instance.
   */
