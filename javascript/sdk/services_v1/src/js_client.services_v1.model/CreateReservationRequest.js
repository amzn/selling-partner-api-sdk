 ...
 * @module js_client.services_v1.model/CreateReservationRequest
 * @version v1
 */
export class CreateReservationRequest {
   ...
   * @alias module:js_client.services_v1.model/CreateReservationRequest
   * @class
   ...
   * @param {module:js_client.services_v1.model/CreateReservationRequest} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/CreateReservationRequest} The populated <code>CreateReservationRequest</code> instance.
   */
