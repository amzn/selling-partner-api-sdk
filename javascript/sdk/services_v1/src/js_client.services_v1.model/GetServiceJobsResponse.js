 ...
 * @module js_client.services_v1.model/GetServiceJobsResponse
 * @version v1
 */
export class GetServiceJobsResponse {
   ...
   * @alias module:js_client.services_v1.model/GetServiceJobsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/GetServiceJobsResponse} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/GetServiceJobsResponse} The populated <code>GetServiceJobsResponse</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/JobListing} payload
 */
