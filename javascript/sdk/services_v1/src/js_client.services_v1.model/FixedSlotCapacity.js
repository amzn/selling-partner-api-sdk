 ...
 * @module js_client.services_v1.model/FixedSlotCapacity
 * @version v1
 */
export class FixedSlotCapacity {
   ...
   * @alias module:js_client.services_v1.model/FixedSlotCapacity
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/FixedSlotCapacity} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/FixedSlotCapacity} The populated <code>FixedSlotCapacity</code> instance.
   */
 ...
 * @member {Array.<module:js_client.services_v1.model/FixedSlot>} capacities
 */
