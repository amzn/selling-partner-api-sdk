 ...
 * @module js_client.services_v1.model/RangeSlotCapacity
 * @version v1
 */
export class RangeSlotCapacity {
   ...
   * @alias module:js_client.services_v1.model/RangeSlotCapacity
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/RangeSlotCapacity} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/RangeSlotCapacity} The populated <code>RangeSlotCapacity</code> instance.
   */
 ...
 * @member {Array.<module:js_client.services_v1.model/RangeCapacity>} capacities
 */
