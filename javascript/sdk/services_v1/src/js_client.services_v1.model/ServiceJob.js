 ...
 * @module js_client.services_v1.model/ServiceJob
 * @version v1
 */
export class ServiceJob {
   ...
   * @alias module:js_client.services_v1.model/ServiceJob
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ServiceJob} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ServiceJob} The populated <code>ServiceJob</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/ServiceJob.ServiceJobStatusEnum} serviceJobStatus
 */
ServiceJob.prototype.serviceJobStatus = undefined;

/**
 * @member {module:js_client.services_v1.model/ScopeOfWork} scopeOfWork
 */
ServiceJob.prototype.scopeOfWork = undefined;

/**
 * @member {module:js_client.services_v1.model/Seller} seller
 */
ServiceJob.prototype.seller = undefined;

/**
 * @member {module:js_client.services_v1.model/ServiceJobProvider} serviceJobProvider
 */
ServiceJob.prototype.serviceJobProvider = undefined;

/**
 * A list of appointment windows preferred by the buyer. Included only if the buyer selected appointment windows when creating the order.
 * @member {Array.<module:js_client.services_v1.model/AppointmentTime>} preferredAppointmentTimes
 */
ServiceJob.prototype.preferredAppointmentTimes = undefined;

/**
 * A list of appointments.
 * @member {Array.<module:js_client.services_v1.model/Appointment>} appointments
 */
...
/**
 * @member {module:js_client.services_v1.model/Buyer} buyer
 */
ServiceJob.prototype.buyer = undefined;

/**
 * A list of items associated with the service job.
 * @member {Array.<module:js_client.services_v1.model/AssociatedItem>} associatedItems
 */
ServiceJob.prototype.associatedItems = undefined;

/**
 * @member {module:js_client.services_v1.model/ServiceLocation} serviceLocation
 */
