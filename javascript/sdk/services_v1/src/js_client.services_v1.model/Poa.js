 ...
 * @module js_client.services_v1.model/Poa
 * @version v1
 */
export class Poa {
  /**
   ...
   * @alias module:js_client.services_v1.model/Poa
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/Poa} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Poa} The populated <code>Poa</code> instance.
   */
 ...
 * @member {Array.<module:js_client.services_v1.model/Technician>} technicians
 */
 ...
 * @member {module:js_client.services_v1.model/Poa.PoaTypeEnum} poaType
 */
