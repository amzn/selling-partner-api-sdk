 ...
 * @module js_client.services_v1.model/AppointmentTimeInput
 * @version v1
 */
export class AppointmentTimeInput {
   ...
   * @alias module:js_client.services_v1.model/AppointmentTimeInput
   * @class
   ...
   * @param {module:js_client.services_v1.model/AppointmentTimeInput} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AppointmentTimeInput} The populated <code>AppointmentTimeInput</code> instance.
   */
