 ...
 * @module js_client.services_v1.model/UpdateScheduleResponse
 * @version v1
 */
export class UpdateScheduleResponse {
   ...
   * @alias module:js_client.services_v1.model/UpdateScheduleResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/UpdateScheduleResponse} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/UpdateScheduleResponse} The populated <code>UpdateScheduleResponse</code> instance.
   */
 ...
 * @member {Array.<module:js_client.services_v1.model/UpdateScheduleRecord>} payload
 */
