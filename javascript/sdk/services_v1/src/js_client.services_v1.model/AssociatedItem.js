 ...
 * @module js_client.services_v1.model/AssociatedItem
 * @version v1
 */
export class AssociatedItem {
   ...
   * @alias module:js_client.services_v1.model/AssociatedItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/AssociatedItem} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AssociatedItem} The populated <code>AssociatedItem</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/AssociatedItem.ItemStatusEnum} itemStatus
 */
...
/**
 * @member {module:js_client.services_v1.model/ItemDelivery} itemDelivery
 */
