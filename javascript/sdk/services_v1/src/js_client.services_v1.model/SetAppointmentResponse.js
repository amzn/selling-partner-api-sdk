 ...
 * @module js_client.services_v1.model/SetAppointmentResponse
 * @version v1
 */
export class SetAppointmentResponse {
   ...
   * @alias module:js_client.services_v1.model/SetAppointmentResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/SetAppointmentResponse} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/SetAppointmentResponse} The populated <code>SetAppointmentResponse</code> instance.
   */
