 ...
 * @module js_client.services_v1.model/Reservation
 * @version v1
 */
export class Reservation {
   ...
   * @alias module:js_client.services_v1.model/Reservation
   * @class
   * @param type {module:js_client.services_v1.model/Reservation.TypeEnum} Type of reservation.
   * @param availability {module:js_client.services_v1.model/AvailabilityRecord} 
   */
   ...
   * @param {module:js_client.services_v1.model/Reservation} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Reservation} The populated <code>Reservation</code> instance.
   */
...
/**
 * Type of reservation.
 * @member {module:js_client.services_v1.model/Reservation.TypeEnum} type
 */
Reservation.prototype.type = undefined;

/**
 * @member {module:js_client.services_v1.model/AvailabilityRecord} availability
 */
