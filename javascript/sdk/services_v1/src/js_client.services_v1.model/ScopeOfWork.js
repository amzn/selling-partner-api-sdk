 ...
 * @module js_client.services_v1.model/ScopeOfWork
 * @version v1
 */
export class ScopeOfWork {
   ...
   * @alias module:js_client.services_v1.model/ScopeOfWork
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ScopeOfWork} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ScopeOfWork} The populated <code>ScopeOfWork</code> instance.
   */
