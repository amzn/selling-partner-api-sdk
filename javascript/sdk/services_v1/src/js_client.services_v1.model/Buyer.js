 ...
 * @module js_client.services_v1.model/Buyer
 * @version v1
 */
export class Buyer {
  /**
   ...
   * @alias module:js_client.services_v1.model/Buyer
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/Buyer} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Buyer} The populated <code>Buyer</code> instance.
   */
