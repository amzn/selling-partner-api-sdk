 ...
 * @module js_client.services_v1.model/Warning
 * @version v1
 */
export class Warning {
   ...
   * @alias module:js_client.services_v1.model/Warning
   * @class
   ...
   * @param {module:js_client.services_v1.model/Warning} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/Warning} The populated <code>Warning</code> instance.
   */
