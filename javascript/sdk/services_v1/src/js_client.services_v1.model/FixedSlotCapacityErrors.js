 ...
 * @module js_client.services_v1.model/FixedSlotCapacityErrors
 * @version v1
 */
export class FixedSlotCapacityErrors {
   ...
   * @alias module:js_client.services_v1.model/FixedSlotCapacityErrors
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/FixedSlotCapacityErrors} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/FixedSlotCapacityErrors} The populated <code>FixedSlotCapacityErrors</code> instance.
   */
