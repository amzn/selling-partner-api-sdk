 ...
 * @module js_client.services_v1.model/ItemDelivery
 * @version v1
 */
export class ItemDelivery {
   ...
   * @alias module:js_client.services_v1.model/ItemDelivery
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ItemDelivery} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ItemDelivery} The populated <code>ItemDelivery</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/ItemDeliveryPromise} itemDeliveryPromise
 */
