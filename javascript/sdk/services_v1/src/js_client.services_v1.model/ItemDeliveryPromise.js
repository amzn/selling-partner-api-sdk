 ...
 * @module js_client.services_v1.model/ItemDeliveryPromise
 * @version v1
 */
export class ItemDeliveryPromise {
   ...
   * @alias module:js_client.services_v1.model/ItemDeliveryPromise
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/ItemDeliveryPromise} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ItemDeliveryPromise} The populated <code>ItemDeliveryPromise</code> instance.
   */
