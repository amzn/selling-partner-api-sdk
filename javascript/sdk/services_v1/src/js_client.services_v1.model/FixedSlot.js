 ...
 * @module js_client.services_v1.model/FixedSlot
 * @version v1
 */
export class FixedSlot {
   ...
   * @alias module:js_client.services_v1.model/FixedSlot
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/FixedSlot} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/FixedSlot} The populated <code>FixedSlot</code> instance.
   */
