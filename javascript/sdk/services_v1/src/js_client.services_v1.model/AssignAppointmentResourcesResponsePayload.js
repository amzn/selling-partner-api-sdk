 ...
 * @module js_client.services_v1.model/AssignAppointmentResourcesResponsePayload
 * @version v1
 */
export class AssignAppointmentResourcesResponsePayload {
   ...
   * @alias module:js_client.services_v1.model/AssignAppointmentResourcesResponsePayload
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/AssignAppointmentResourcesResponsePayload} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AssignAppointmentResourcesResponsePayload} The populated <code>AssignAppointmentResourcesResponsePayload</code> instance.
   */
