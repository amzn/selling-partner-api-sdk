 ...
 * @module js_client.services_v1.model/UpdateReservationResponse
 * @version v1
 */
export class UpdateReservationResponse {
   ...
   * @alias module:js_client.services_v1.model/UpdateReservationResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/UpdateReservationResponse} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/UpdateReservationResponse} The populated <code>UpdateReservationResponse</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/UpdateReservationRecord} payload
 */
