 ...
 * @module js_client.services_v1.model/RescheduleAppointmentRequest
 * @version v1
 */
export class RescheduleAppointmentRequest {
   ...
   * @alias module:js_client.services_v1.model/RescheduleAppointmentRequest
   * @class
   * @param appointmentTime {module:js_client.services_v1.model/AppointmentTimeInput} 
   ...
   * @param {module:js_client.services_v1.model/RescheduleAppointmentRequest} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/RescheduleAppointmentRequest} The populated <code>RescheduleAppointmentRequest</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/AppointmentTimeInput} appointmentTime
 */
