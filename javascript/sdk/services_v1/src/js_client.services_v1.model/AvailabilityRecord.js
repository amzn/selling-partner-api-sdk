 ...
 * @module js_client.services_v1.model/AvailabilityRecord
 * @version v1
 */
export class AvailabilityRecord {
   ...
   * @alias module:js_client.services_v1.model/AvailabilityRecord
   * @class
   ...
   * @param {module:js_client.services_v1.model/AvailabilityRecord} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AvailabilityRecord} The populated <code>AvailabilityRecord</code> instance.
   */
...
/**
 * @member {module:js_client.services_v1.model/Recurrence} recurrence
 */
