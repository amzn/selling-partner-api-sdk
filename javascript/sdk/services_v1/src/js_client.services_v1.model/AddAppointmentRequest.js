 ...
 * @module js_client.services_v1.model/AddAppointmentRequest
 * @version v1
 */
export class AddAppointmentRequest {
   ...
   * @alias module:js_client.services_v1.model/AddAppointmentRequest
   * @class
   ...
   * @param {module:js_client.services_v1.model/AddAppointmentRequest} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/AddAppointmentRequest} The populated <code>AddAppointmentRequest</code> instance.
   */
