 ...
 * @module js_client.services_v1.model/ServiceUploadDocument
 * @version v1
 */
export class ServiceUploadDocument {
   ...
   * @alias module:js_client.services_v1.model/ServiceUploadDocument
   * @class
   * @param contentType {module:js_client.services_v1.model/ServiceUploadDocument.ContentTypeEnum} The content type of the to-be-uploaded file
   ...
   * @param {module:js_client.services_v1.model/ServiceUploadDocument} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/ServiceUploadDocument} The populated <code>ServiceUploadDocument</code> instance.
   */
 ...
 * @member {module:js_client.services_v1.model/ServiceUploadDocument.ContentTypeEnum} contentType
 */
