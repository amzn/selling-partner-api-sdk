...
* @module js_client.vendororders_v1.api/VendorOrdersApi
* @version v1
*/
export class VendorOrdersApi {
    ...
    * @alias module:js_client.vendororders_v1.api/VendorOrdersApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrderResponse} and HTTP response
     */
     ...
     * Returns a purchase order based on the &#x60;purchaseOrderNumber&#x60; value that you specify.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {String} purchaseOrderNumber The purchase order identifier for the order that you want. Formatting Notes: 8-character alpha-numeric code.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrderResponse}
     */
     ...
     * @param {module:js_client.vendororders_v1.model/String} opts.sortOrder Sort in ascending or descending order by purchase order creation date.
     ...
     * @param {module:js_client.vendororders_v1.model/String} opts.poItemState Current state of the purchase order item. If this value is Cancelled, this API will return purchase orders which have one or more items cancelled by Amazon with updated item quantity as zero.
     ...
     * @param {module:js_client.vendororders_v1.model/String} opts.purchaseOrderState Filters purchase orders based on the purchase order state.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrdersResponse} and HTTP response
     */
     ...
     * @param {module:js_client.vendororders_v1.model/String} opts.purchaseOrderState Filters purchase orders based on the purchase order state.
     * @param {String} opts.orderingVendorCode Filters purchase orders based on the specified ordering vendor code. This value should be same as &#39;sellingParty.partyId&#39; in the purchase order. If not included in the filter, all purchase orders for all of the vendor codes that exist in the vendor group used to authorize the API client application are returned.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrdersResponse}
     */
     ...
     * @param {module:js_client.vendororders_v1.model/String} opts.purchaseOrderStatus Filters purchase orders based on the specified purchase order status. If not included in filter, this will return purchase orders for all statuses.
     * @param {module:js_client.vendororders_v1.model/String} opts.itemConfirmationStatus Filters purchase orders based on their item confirmation status. If the item confirmation status is not included in the filter, purchase orders for all confirmation statuses are included.
     * @param {module:js_client.vendororders_v1.model/String} opts.itemReceiveStatus Filters purchase orders based on the purchase order&#39;s item receive status. If the item receive status is not included in the filter, purchase orders for all receive statuses are included.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse} and HTTP response
     */
     ...
     * @param {String} opts.orderingVendorCode Filters purchase orders based on the specified ordering vendor code. This value should be same as &#39;sellingParty.partyId&#39; in the purchase order. If not included in filter, all purchase orders for all the vendor codes that exist in the vendor group used to authorize API client application are returned.
     * @param {String} opts.shipToPartyId Filters purchase orders for a specific buyer&#39;s Fulfillment Center/warehouse by providing ship to location id here. This value should be same as &#39;shipToParty.partyId&#39; in the purchase order. If not included in filter, this will return purchase orders for all the buyer&#39;s warehouses used for vendor group purchase orders.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse}
     */
     ...
     * @param {module:js_client.vendororders_v1.model/SubmitAcknowledgementRequest} body Submits acknowledgements for one or more purchase orders from a vendor.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendororders_v1.model/SubmitAcknowledgementResponse} and HTTP response
     */
     ...
     * Submits acknowledgements for one or more purchase orders.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.vendororders_v1.model/SubmitAcknowledgementRequest} body Submits acknowledgements for one or more purchase orders from a vendor.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendororders_v1.model/SubmitAcknowledgementResponse}
     */
