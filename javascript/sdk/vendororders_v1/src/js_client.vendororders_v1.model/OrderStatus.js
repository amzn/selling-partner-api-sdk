 ...
 * @module js_client.vendororders_v1.model/OrderStatus
 * @version v1
 */
export class OrderStatus {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderStatus
   * @class
   ...
   * @param purchaseOrderStatus {module:js_client.vendororders_v1.model/OrderStatus.PurchaseOrderStatusEnum} The status of the buyer's purchase order for this order.
   * @param purchaseOrderDate {Date} The date the purchase order was placed. Must be in ISO-8601 date/time format.
   * @param sellingParty {module:js_client.vendororders_v1.model/PartyIdentification} 
   * @param shipToParty {module:js_client.vendororders_v1.model/PartyIdentification} 
   * @param itemStatus {Array.<module:js_client.vendororders_v1.model/OrderItemStatus>} Detailed description of items order status.
   */
   ...
   * @param {module:js_client.vendororders_v1.model/OrderStatus} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderStatus} The populated <code>OrderStatus</code> instance.
   */
 ...
 * @member {module:js_client.vendororders_v1.model/OrderStatus.PurchaseOrderStatusEnum} purchaseOrderStatus
 */
...
/**
 * @member {module:js_client.vendororders_v1.model/PartyIdentification} sellingParty
 */
OrderStatus.prototype.sellingParty = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/PartyIdentification} shipToParty
 */
OrderStatus.prototype.shipToParty = undefined;

/**
 * Detailed description of items order status.
 * @member {Array.<module:js_client.vendororders_v1.model/OrderItemStatus>} itemStatus
 */
