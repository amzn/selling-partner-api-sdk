 ...
 * @module js_client.vendororders_v1.model/OrderAcknowledgement
 * @version v1
 */
export class OrderAcknowledgement {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderAcknowledgement
   * @class
   ...
   * @param items {Array.<module:js_client.vendororders_v1.model/OrderAcknowledgementItem>} A list of the items being acknowledged with associated details.
   */
   ...
   * @param {module:js_client.vendororders_v1.model/OrderAcknowledgement} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderAcknowledgement} The populated <code>OrderAcknowledgement</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendororders_v1.model/OrderAcknowledgementItem>} items
 */
