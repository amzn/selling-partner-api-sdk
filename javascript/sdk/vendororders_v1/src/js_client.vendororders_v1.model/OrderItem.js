 ...
 * @module js_client.vendororders_v1.model/OrderItem
 * @version v1
 */
export class OrderItem {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderItem
   * @class
   ...
   * @param {module:js_client.vendororders_v1.model/OrderItem} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderItem} The populated <code>OrderItem</code> instance.
   */
