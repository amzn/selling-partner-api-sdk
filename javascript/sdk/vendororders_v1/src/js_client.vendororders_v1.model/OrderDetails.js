 ...
 * @module js_client.vendororders_v1.model/OrderDetails
 * @version v1
 */
export class OrderDetails {
   ...
   * Details of an order.
   * @alias module:js_client.vendororders_v1.model/OrderDetails
   * @class
   ...
   * @param items {Array.<module:js_client.vendororders_v1.model/OrderItem>} A list of items in this purchase order.
   */
   ...
   * @param {module:js_client.vendororders_v1.model/OrderDetails} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderDetails} The populated <code>OrderDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendororders_v1.model/OrderDetails.PurchaseOrderTypeEnum} purchaseOrderType
 */
OrderDetails.prototype.purchaseOrderType = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/ImportDetails} importDetails
 */
...
/**
 * Payment method used.
 * @member {module:js_client.vendororders_v1.model/OrderDetails.PaymentMethodEnum} paymentMethod
 */
OrderDetails.prototype.paymentMethod = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/PartyIdentification} buyingParty
 */
...
/**
 * @member {module:js_client.vendororders_v1.model/PartyIdentification} billToParty
 */
 ...
 * @member {Array.<module:js_client.vendororders_v1.model/OrderItem>} items
 */
