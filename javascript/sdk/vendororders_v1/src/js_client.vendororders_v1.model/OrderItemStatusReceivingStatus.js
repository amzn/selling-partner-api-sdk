 ...
 * @module js_client.vendororders_v1.model/OrderItemStatusReceivingStatus
 * @version v1
 */
export class OrderItemStatusReceivingStatus {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderItemStatusReceivingStatus
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendororders_v1.model/OrderItemStatusReceivingStatus} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderItemStatusReceivingStatus} The populated <code>OrderItemStatusReceivingStatus</code> instance.
   */
 ...
 * @member {module:js_client.vendororders_v1.model/OrderItemStatusReceivingStatus.ReceiveStatusEnum} receiveStatus
 */
OrderItemStatusReceivingStatus.prototype.receiveStatus = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/ItemQuantity} receivedQuantity
 */
