 ...
 * @module js_client.vendororders_v1.model/TransactionId
 * @version v1
 */
export class TransactionId {
   ...
   * @alias module:js_client.vendororders_v1.model/TransactionId
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendororders_v1.model/TransactionId} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/TransactionId} The populated <code>TransactionId</code> instance.
   */
