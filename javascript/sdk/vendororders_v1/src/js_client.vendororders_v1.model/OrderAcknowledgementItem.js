 ...
 * @module js_client.vendororders_v1.model/OrderAcknowledgementItem
 * @version v1
 */
export class OrderAcknowledgementItem {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderAcknowledgementItem
   * @class
   * @param orderedQuantity {module:js_client.vendororders_v1.model/ItemQuantity} 
   * @param itemAcknowledgements {Array.<module:js_client.vendororders_v1.model/OrderItemAcknowledgement>} This is used to indicate acknowledged quantity.
   */
   ...
   * @param {module:js_client.vendororders_v1.model/OrderAcknowledgementItem} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderAcknowledgementItem} The populated <code>OrderAcknowledgementItem</code> instance.
   */
...
/**
 * @member {module:js_client.vendororders_v1.model/Money} netCost
 */
OrderAcknowledgementItem.prototype.netCost = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/Money} listPrice
 */
 ...
 * @member {Array.<module:js_client.vendororders_v1.model/OrderItemAcknowledgement>} itemAcknowledgements
 */
