 ...
 * @module js_client.vendororders_v1.model/OrderItemStatusOrderedQuantity
 * @version v1
 */
export class OrderItemStatusOrderedQuantity {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderItemStatusOrderedQuantity
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendororders_v1.model/OrderItemStatusOrderedQuantity} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderItemStatusOrderedQuantity} The populated <code>OrderItemStatusOrderedQuantity</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendororders_v1.model/OrderedQuantityDetails>} orderedQuantityDetails
 */
