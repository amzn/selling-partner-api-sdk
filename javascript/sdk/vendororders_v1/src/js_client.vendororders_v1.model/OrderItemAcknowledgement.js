 ...
 * @module js_client.vendororders_v1.model/OrderItemAcknowledgement
 * @version v1
 */
export class OrderItemAcknowledgement {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderItemAcknowledgement
   * @class
   * @param acknowledgementCode {module:js_client.vendororders_v1.model/OrderItemAcknowledgement.AcknowledgementCodeEnum} This indicates the acknowledgement code.
   * @param acknowledgedQuantity {module:js_client.vendororders_v1.model/ItemQuantity} 
   */
   ...
   * @param {module:js_client.vendororders_v1.model/OrderItemAcknowledgement} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderItemAcknowledgement} The populated <code>OrderItemAcknowledgement</code> instance.
   */
 ...
 * @member {module:js_client.vendororders_v1.model/OrderItemAcknowledgement.AcknowledgementCodeEnum} acknowledgementCode
 */
OrderItemAcknowledgement.prototype.acknowledgementCode = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/ItemQuantity} acknowledgedQuantity
 */
 ...
 * @member {module:js_client.vendororders_v1.model/OrderItemAcknowledgement.RejectionReasonEnum} rejectionReason
 */
