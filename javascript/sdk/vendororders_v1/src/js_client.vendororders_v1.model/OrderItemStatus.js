 ...
 * @module js_client.vendororders_v1.model/OrderItemStatus
 * @version v1
 */
export class OrderItemStatus {
   ...
   * @alias module:js_client.vendororders_v1.model/OrderItemStatus
   * @class
   ...
   * @param {module:js_client.vendororders_v1.model/OrderItemStatus} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/OrderItemStatus} The populated <code>OrderItemStatus</code> instance.
   */
...
/**
 * @member {module:js_client.vendororders_v1.model/OrderItemStatusOrderedQuantity} orderedQuantity
 */
OrderItemStatus.prototype.orderedQuantity = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/OrderItemStatusAcknowledgementStatus} acknowledgementStatus
 */
OrderItemStatus.prototype.acknowledgementStatus = undefined;

/**
 * @member {module:js_client.vendororders_v1.model/OrderItemStatusReceivingStatus} receivingStatus
 */
