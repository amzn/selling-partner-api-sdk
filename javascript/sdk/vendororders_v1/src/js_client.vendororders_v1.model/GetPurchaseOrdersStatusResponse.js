 ...
 * @module js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse
 * @version v1
 */
export class GetPurchaseOrdersStatusResponse {
   ...
   * @alias module:js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/GetPurchaseOrdersStatusResponse} The populated <code>GetPurchaseOrdersStatusResponse</code> instance.
   */
...
/**
 * @member {module:js_client.vendororders_v1.model/OrderListStatus} payload
 */
