 ...
 * @module js_client.vendororders_v1.model/Pagination
 * @version v1
 */
export class Pagination {
   ...
   * @alias module:js_client.vendororders_v1.model/Pagination
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendororders_v1.model/Pagination} obj Optional instance to populate.
   * @return {module:js_client.vendororders_v1.model/Pagination} The populated <code>Pagination</code> instance.
   */
