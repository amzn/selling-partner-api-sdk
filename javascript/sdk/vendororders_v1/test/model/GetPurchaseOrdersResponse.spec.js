...
(function(root, factory) {
  ...
  describe('GetPurchaseOrdersResponse', function() {
    it('should create an instance of GetPurchaseOrdersResponse', function() {
      // uncomment below and update the code to test GetPurchaseOrdersResponse
      //var instance = new SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrdersResponse();
