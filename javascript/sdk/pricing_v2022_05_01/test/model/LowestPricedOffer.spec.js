...
(function(root, factory) {
  ...
  describe('LowestPricedOffer', function() {
    it('should create an instance of LowestPricedOffer', function() {
      // uncomment below and update the code to test LowestPricedOffer
      //var instance = new SellingPartnerApiForPricing.LowestPricedOffer();
    ...
    it('should have the property lowestPricedOffersInput (base name: "lowestPricedOffersInput")', function() {
      // uncomment below and update the code to test the property lowestPricedOffersInput
      //var instance = new SellingPartnerApiForPricing.LowestPricedOffer();
