...
(function(root, factory) {
  ...
  describe('GetFeaturedOfferExpectedPriceBatchResponse', function() {
    it('should create an instance of GetFeaturedOfferExpectedPriceBatchResponse', function() {
      // uncomment below and update the code to test GetFeaturedOfferExpectedPriceBatchResponse
      //var instance = new SellingPartnerApiForPricing.GetFeaturedOfferExpectedPriceBatchResponse();
