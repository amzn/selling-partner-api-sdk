...
(function(root, factory) {
  ...
  describe('FeaturedOfferExpectedPriceResponse', function() {
    it('should create an instance of FeaturedOfferExpectedPriceResponse', function() {
      // uncomment below and update the code to test FeaturedOfferExpectedPriceResponse
      //var instance = new SellingPartnerApiForPricing.FeaturedOfferExpectedPriceResponse();
