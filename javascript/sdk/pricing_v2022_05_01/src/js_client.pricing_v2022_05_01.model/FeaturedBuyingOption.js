 ...
 * @module js_client.pricing_v2022_05_01.model/FeaturedBuyingOption
 * @version 2022-05-01
 */
export class FeaturedBuyingOption {
   ...
   * @alias module:js_client.pricing_v2022_05_01.model/FeaturedBuyingOption
   * @class
   * @param buyingOptionType {module:js_client.pricing_v2022_05_01.model/FeaturedBuyingOption.BuyingOptionTypeEnum} The buying option type for the featured offer. `buyingOptionType` represents the buying options that a customer receives on the detail page, such as `B2B`, `Fresh`, and `Subscribe n Save`. `buyingOptionType` currently supports `NEW` as a value.
   * @param segmentedFeaturedOffers {Array.<module:js_client.pricing_v2022_05_01.model/SegmentedFeaturedOffer>} A list of segmented featured offers for the current buying option type. A segment can be considered as a group of regional contexts that all have the same featured offer. A regional context is a combination of factors such as customer type, region, or postal code and buying option.
   */
   ...
   * @param {module:js_client.pricing_v2022_05_01.model/FeaturedBuyingOption} obj Optional instance to populate.
   * @return {module:js_client.pricing_v2022_05_01.model/FeaturedBuyingOption} The populated <code>FeaturedBuyingOption</code> instance.
   */
 ...
 * @member {module:js_client.pricing_v2022_05_01.model/FeaturedBuyingOption.BuyingOptionTypeEnum} buyingOptionType
 */
 ...
 * @member {Array.<module:js_client.pricing_v2022_05_01.model/SegmentedFeaturedOffer>} segmentedFeaturedOffers
 */
