 ...
 * @module js_client.pricing_v2022_05_01.model/LowestPricedOffersInput
 * @version 2022-05-01
 */
export class LowestPricedOffersInput {
   ...
   * @alias module:js_client.pricing_v2022_05_01.model/LowestPricedOffersInput
   * @class
   * @param itemCondition {module:js_client.pricing_v2022_05_01.model/Condition} 
   * @param offerType {module:js_client.pricing_v2022_05_01.model/LowestPricedOffersInput.OfferTypeEnum} The input parameter specifies the type of offers requested for `LowestPricedOffers`. This applies to `Consumer` and `Business` offers. `Consumer` is the default `offerType`.
   */
   ...
   * @param {module:js_client.pricing_v2022_05_01.model/LowestPricedOffersInput} obj Optional instance to populate.
   * @return {module:js_client.pricing_v2022_05_01.model/LowestPricedOffersInput} The populated <code>LowestPricedOffersInput</code> instance.
   */
...
/**
 * @member {module:js_client.pricing_v2022_05_01.model/Condition} itemCondition
 */
 ...
 * @member {module:js_client.pricing_v2022_05_01.model/LowestPricedOffersInput.OfferTypeEnum} offerType
 */
