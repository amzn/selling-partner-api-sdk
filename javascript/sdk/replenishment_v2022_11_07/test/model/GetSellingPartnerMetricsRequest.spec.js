...
(function(root, factory) {
  ...
  describe('GetSellingPartnerMetricsRequest', function() {
    it('should create an instance of GetSellingPartnerMetricsRequest', function() {
      // uncomment below and update the code to test GetSellingPartnerMetricsRequest
      //var instance = new SellingPartnerApiForReplenishment.GetSellingPartnerMetricsRequest();
