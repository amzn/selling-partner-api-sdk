...
(function(root, factory) {
  ...
  describe('ListOfferMetricsRequestPagination', function() {
    it('should create an instance of ListOfferMetricsRequestPagination', function() {
      // uncomment below and update the code to test ListOfferMetricsRequestPagination
      //var instance = new SellingPartnerApiForReplenishment.ListOfferMetricsRequestPagination();
