...
(function(root, factory) {
  ...
  describe('EligibilityStatus', function() {
    it('should create an instance of EligibilityStatus', function() {
      // uncomment below and update the code to test EligibilityStatus
      //var instance = new SellingPartnerApiForReplenishment.EligibilityStatus();
      //expect(instance).to.be.a(SellingPartnerApiForReplenishment.EligibilityStatus);
    });
