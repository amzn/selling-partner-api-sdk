 ...
 * @module js_client.replenishment_v2022_11_07.model/GetSellingPartnerMetricsRequest
 * @version 2022-11-07
 */
export class GetSellingPartnerMetricsRequest {
   ...
   * @alias module:js_client.replenishment_v2022_11_07.model/GetSellingPartnerMetricsRequest
   * @class
   * @param timeInterval {module:js_client.replenishment_v2022_11_07.model/TimeInterval} 
   * @param timePeriodType {module:js_client.replenishment_v2022_11_07.model/TimePeriodType} 
   * @param marketplaceId {String} The marketplace identifier. The supported marketplaces for both sellers and vendors are US, CA, ES, UK, FR, IT, IN, DE and JP. The supported marketplaces for vendors only are BR, AU, MX, AE and NL. Refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) to find the identifier for the marketplace.
   * @param programTypes {Array.<module:js_client.replenishment_v2022_11_07.model/ProgramType>} A list of replenishment program types.
   */
   ...
   * @param {module:js_client.replenishment_v2022_11_07.model/GetSellingPartnerMetricsRequest} obj Optional instance to populate.
   * @return {module:js_client.replenishment_v2022_11_07.model/GetSellingPartnerMetricsRequest} The populated <code>GetSellingPartnerMetricsRequest</code> instance.
   */
...
/**
 * @member {module:js_client.replenishment_v2022_11_07.model/AggregationFrequency} aggregationFrequency
 */
 ...
 * @member {Array.<module:js_client.replenishment_v2022_11_07.model/Metric>} metrics
 */
GetSellingPartnerMetricsRequest.prototype.metrics = undefined;

/**
 * @member {module:js_client.replenishment_v2022_11_07.model/TimePeriodType} timePeriodType
 */
 ...
 * @member {Array.<module:js_client.replenishment_v2022_11_07.model/ProgramType>} programTypes
 */
