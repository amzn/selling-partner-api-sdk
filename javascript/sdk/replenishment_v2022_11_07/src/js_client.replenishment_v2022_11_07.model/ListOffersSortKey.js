...
* @readonly
*/
export default class ListOffersSortKey {
    ...
    * @return {module:js_client.replenishment_v2022_11_07.model/ListOffersSortKey} The enum <code>ListOffersSortKey</code> value.
    */
