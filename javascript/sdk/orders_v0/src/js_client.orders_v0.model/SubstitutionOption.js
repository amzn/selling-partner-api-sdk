 ...
 * @module js_client.orders_v0.model/SubstitutionOption
 * @version v0
 */
export class SubstitutionOption {
   ...
   * @alias module:js_client.orders_v0.model/SubstitutionOption
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/SubstitutionOption} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/SubstitutionOption} The populated <code>SubstitutionOption</code> instance.
   */
