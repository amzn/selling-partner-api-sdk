 ...
 * @module js_client.orders_v0.model/Address
 * @version v0
 */
export class Address {
   ...
   * @alias module:js_client.orders_v0.model/Address
   * @class
   ...
   * @param {module:js_client.orders_v0.model/Address} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/Address} The populated <code>Address</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/AddressExtendedFields} extendedFields
 */
 ...
 * @member {module:js_client.orders_v0.model/Address.AddressTypeEnum} addressType
 */
