 ...
 * @module js_client.orders_v0.model/DeliveryPreferences
 * @version v0
 */
export class DeliveryPreferences {
   ...
   * @alias module:js_client.orders_v0.model/DeliveryPreferences
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/DeliveryPreferences} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/DeliveryPreferences} The populated <code>DeliveryPreferences</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/PreferredDeliveryTime} preferredDeliveryTime
 */
 ...
 * @member {Array.<module:js_client.orders_v0.model/OtherDeliveryAttributes>} otherAttributes
 */
