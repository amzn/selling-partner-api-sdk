 ...
 * @module js_client.orders_v0.model/OpenTimeInterval
 * @version v0
 */
export class OpenTimeInterval {
   ...
   * @alias module:js_client.orders_v0.model/OpenTimeInterval
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/OpenTimeInterval} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OpenTimeInterval} The populated <code>OpenTimeInterval</code> instance.
   */
