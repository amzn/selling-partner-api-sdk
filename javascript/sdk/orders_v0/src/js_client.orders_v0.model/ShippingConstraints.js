 ...
 * @module js_client.orders_v0.model/ShippingConstraints
 * @version v0
 */
export class ShippingConstraints {
   ...
   * @alias module:js_client.orders_v0.model/ShippingConstraints
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/ShippingConstraints} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/ShippingConstraints} The populated <code>ShippingConstraints</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/ConstraintType} palletDelivery
 */
ShippingConstraints.prototype.palletDelivery = undefined;

/**
 * @member {module:js_client.orders_v0.model/ConstraintType} signatureConfirmation
 */
ShippingConstraints.prototype.signatureConfirmation = undefined;

/**
 * @member {module:js_client.orders_v0.model/ConstraintType} recipientIdentityVerification
 */
ShippingConstraints.prototype.recipientIdentityVerification = undefined;

/**
 * @member {module:js_client.orders_v0.model/ConstraintType} recipientAgeVerification
 */
