 ...
 * @module js_client.orders_v0.model/PrescriptionDetail
 * @version v0
 */
export class PrescriptionDetail {
   ...
   * @alias module:js_client.orders_v0.model/PrescriptionDetail
   * @class
   ...
   * @param {module:js_client.orders_v0.model/PrescriptionDetail} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/PrescriptionDetail} The populated <code>PrescriptionDetail</code> instance.
   */
