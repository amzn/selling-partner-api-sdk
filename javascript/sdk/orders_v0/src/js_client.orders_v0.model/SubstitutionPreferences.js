 ...
 * @module js_client.orders_v0.model/SubstitutionPreferences
 * @version v0
 */
export class SubstitutionPreferences {
   ...
   * @alias module:js_client.orders_v0.model/SubstitutionPreferences
   * @class
   * @param substitutionType {module:js_client.orders_v0.model/SubstitutionPreferences.SubstitutionTypeEnum} The type of substitution that these preferences represent.
   */
   ...
   * @param {module:js_client.orders_v0.model/SubstitutionPreferences} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/SubstitutionPreferences} The populated <code>SubstitutionPreferences</code> instance.
   */
 ...
 * @member {module:js_client.orders_v0.model/SubstitutionPreferences.SubstitutionTypeEnum} substitutionType
 */
SubstitutionPreferences.prototype.substitutionType = undefined;

/**
 * A collection of substitution options.
 * @member {Array.<module:js_client.orders_v0.model/SubstitutionOption>} substitutionOptions
 */
