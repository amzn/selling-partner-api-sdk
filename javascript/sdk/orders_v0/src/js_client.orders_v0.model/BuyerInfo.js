 ...
 * @module js_client.orders_v0.model/BuyerInfo
 * @version v0
 */
export class BuyerInfo {
   ...
   * Buyer information.
   * @alias module:js_client.orders_v0.model/BuyerInfo
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/BuyerInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/BuyerInfo} The populated <code>BuyerInfo</code> instance.
   */
