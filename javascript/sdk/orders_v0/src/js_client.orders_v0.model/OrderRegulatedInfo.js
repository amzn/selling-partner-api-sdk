 ...
 * @module js_client.orders_v0.model/OrderRegulatedInfo
 * @version v0
 */
export class OrderRegulatedInfo {
   ...
   * @alias module:js_client.orders_v0.model/OrderRegulatedInfo
   * @class
   * @param amazonOrderId {String} An Amazon-defined order identifier, in 3-7-7 format.
   * @param regulatedInformation {module:js_client.orders_v0.model/RegulatedInformation} 
   * @param requiresDosageLabel {Boolean} When true, the order requires attaching a dosage information label when shipped.
   * @param regulatedOrderVerificationStatus {module:js_client.orders_v0.model/RegulatedOrderVerificationStatus} 
   */
   ...
   * @param {module:js_client.orders_v0.model/OrderRegulatedInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderRegulatedInfo} The populated <code>OrderRegulatedInfo</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/RegulatedInformation} regulatedInformation
 */
...
/**
 * @member {module:js_client.orders_v0.model/RegulatedOrderVerificationStatus} regulatedOrderVerificationStatus
 */
