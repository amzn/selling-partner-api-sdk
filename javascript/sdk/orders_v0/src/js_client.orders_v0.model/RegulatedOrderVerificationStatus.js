 ...
 * @module js_client.orders_v0.model/RegulatedOrderVerificationStatus
 * @version v0
 */
export class RegulatedOrderVerificationStatus {
   ...
   * @alias module:js_client.orders_v0.model/RegulatedOrderVerificationStatus
   * @class
   * @param status {module:js_client.orders_v0.model/VerificationStatus} 
   ...
   * @param validRejectionReasons {Array.<module:js_client.orders_v0.model/RejectionReason>} A list of valid rejection reasons that may be used to reject the order's regulated information.
   */
   ...
   * @param {module:js_client.orders_v0.model/RegulatedOrderVerificationStatus} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/RegulatedOrderVerificationStatus} The populated <code>RegulatedOrderVerificationStatus</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/VerificationStatus} status
 */
 ...
 * @member {Array.<module:js_client.orders_v0.model/RejectionReason>} validRejectionReasons
 */
RegulatedOrderVerificationStatus.prototype.validRejectionReasons = undefined;

/**
 * @member {module:js_client.orders_v0.model/RejectionReason} rejectionReason
 */
 ...
 * @member {Array.<module:js_client.orders_v0.model/ValidVerificationDetail>} validVerificationDetails
 */
