 ...
 * @module js_client.orders_v0.model/ConfirmShipmentRequest
 * @version v0
 */
export class ConfirmShipmentRequest {
   ...
   * @alias module:js_client.orders_v0.model/ConfirmShipmentRequest
   * @class
   * @param packageDetail {module:js_client.orders_v0.model/PackageDetail} 
   ...
   * @param {module:js_client.orders_v0.model/ConfirmShipmentRequest} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/ConfirmShipmentRequest} The populated <code>ConfirmShipmentRequest</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/PackageDetail} packageDetail
 */
 ...
 * @member {module:js_client.orders_v0.model/ConfirmShipmentRequest.CodCollectionMethodEnum} codCollectionMethod
 */
