 ...
 * @module js_client.orders_v0.model/GetOrderItemsBuyerInfoResponse
 * @version v0
 */
export class GetOrderItemsBuyerInfoResponse {
   ...
   * @alias module:js_client.orders_v0.model/GetOrderItemsBuyerInfoResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/GetOrderItemsBuyerInfoResponse} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/GetOrderItemsBuyerInfoResponse} The populated <code>GetOrderItemsBuyerInfoResponse</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/OrderItemsBuyerInfoList} payload
 */
