...
* @readonly
*/
export default class EasyShipShipmentStatus {
    ...
    * @return {module:js_client.orders_v0.model/EasyShipShipmentStatus} The enum <code>EasyShipShipmentStatus</code> value.
    */
