 ...
 * @module js_client.orders_v0.model/AddressExtendedFields
 * @version v0
 */
export class AddressExtendedFields {
   ...
   * @alias module:js_client.orders_v0.model/AddressExtendedFields
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/AddressExtendedFields} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/AddressExtendedFields} The populated <code>AddressExtendedFields</code> instance.
   */
