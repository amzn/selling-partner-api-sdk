 ...
 * @module js_client.orders_v0.model/MarketplaceTaxInfo
 * @version v0
 */
export class MarketplaceTaxInfo {
   ...
   * @alias module:js_client.orders_v0.model/MarketplaceTaxInfo
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/MarketplaceTaxInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/MarketplaceTaxInfo} The populated <code>MarketplaceTaxInfo</code> instance.
   */
