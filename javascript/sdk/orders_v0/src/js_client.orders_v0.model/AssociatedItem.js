 ...
 * @module js_client.orders_v0.model/AssociatedItem
 * @version v0
 */
export class AssociatedItem {
   ...
   * @alias module:js_client.orders_v0.model/AssociatedItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/AssociatedItem} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/AssociatedItem} The populated <code>AssociatedItem</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/AssociationType} associationType
 */
