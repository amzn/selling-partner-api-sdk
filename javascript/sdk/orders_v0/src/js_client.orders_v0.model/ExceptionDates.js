 ...
 * @module js_client.orders_v0.model/ExceptionDates
 * @version v0
 */
export class ExceptionDates {
   ...
   * @alias module:js_client.orders_v0.model/ExceptionDates
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/ExceptionDates} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/ExceptionDates} The populated <code>ExceptionDates</code> instance.
   */
