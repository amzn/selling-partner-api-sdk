 ...
 * @module js_client.orders_v0.model/PackageDetail
 * @version v0
 */
export class PackageDetail {
   ...
   * @alias module:js_client.orders_v0.model/PackageDetail
   * @class
   ...
   * @param orderItems {Array.<module:js_client.orders_v0.model/ConfirmShipmentOrderItem>} A list of order items.
   */
   ...
   * @param {module:js_client.orders_v0.model/PackageDetail} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/PackageDetail} The populated <code>PackageDetail</code> instance.
   */
 ...
 * @member {Array.<module:js_client.orders_v0.model/ConfirmShipmentOrderItem>} orderItems
 */
