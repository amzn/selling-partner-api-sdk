 ...
 * @module js_client.orders_v0.model/OpenInterval
 * @version v0
 */
export class OpenInterval {
   ...
   * @alias module:js_client.orders_v0.model/OpenInterval
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/OpenInterval} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OpenInterval} The populated <code>OpenInterval</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/OpenTimeInterval} startTime
 */
OpenInterval.prototype.startTime = undefined;

/**
 * @member {module:js_client.orders_v0.model/OpenTimeInterval} endTime
 */
