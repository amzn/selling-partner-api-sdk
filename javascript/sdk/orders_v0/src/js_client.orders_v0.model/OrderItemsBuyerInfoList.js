 ...
 * @module js_client.orders_v0.model/OrderItemsBuyerInfoList
 * @version v0
 */
export class OrderItemsBuyerInfoList {
   ...
   * @alias module:js_client.orders_v0.model/OrderItemsBuyerInfoList
   * @class
   * @param orderItems {Array.<module:js_client.orders_v0.model/OrderItemBuyerInfo>} A single order item's buyer information list.
   ...
   * @param {module:js_client.orders_v0.model/OrderItemsBuyerInfoList} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderItemsBuyerInfoList} The populated <code>OrderItemsBuyerInfoList</code> instance.
   */
 ...
 * @member {Array.<module:js_client.orders_v0.model/OrderItemBuyerInfo>} orderItems
 */
