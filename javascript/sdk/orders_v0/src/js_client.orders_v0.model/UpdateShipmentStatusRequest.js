 ...
 * @module js_client.orders_v0.model/UpdateShipmentStatusRequest
 * @version v0
 */
export class UpdateShipmentStatusRequest {
   ...
   * @alias module:js_client.orders_v0.model/UpdateShipmentStatusRequest
   * @class
   * @param marketplaceId {String} The unobfuscated marketplace identifier.
   * @param shipmentStatus {module:js_client.orders_v0.model/ShipmentStatus} 
   */
   ...
   * @param {module:js_client.orders_v0.model/UpdateShipmentStatusRequest} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/UpdateShipmentStatusRequest} The populated <code>UpdateShipmentStatusRequest</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/ShipmentStatus} shipmentStatus
 */
 ...
 * @member {Array.<module:js_client.orders_v0.model/OrderItemsInner>} orderItems
 */
