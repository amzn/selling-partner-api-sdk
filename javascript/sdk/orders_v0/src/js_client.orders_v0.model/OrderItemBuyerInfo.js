 ...
 * @module js_client.orders_v0.model/OrderItemBuyerInfo
 * @version v0
 */
export class OrderItemBuyerInfo {
   ...
   * @alias module:js_client.orders_v0.model/OrderItemBuyerInfo
   * @class
   ...
   * @param {module:js_client.orders_v0.model/OrderItemBuyerInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderItemBuyerInfo} The populated <code>OrderItemBuyerInfo</code> instance.
   */
