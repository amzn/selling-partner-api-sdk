 ...
 * @module js_client.orders_v0.model/BusinessHours
 * @version v0
 */
export class BusinessHours {
   ...
   * @alias module:js_client.orders_v0.model/BusinessHours
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/BusinessHours} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/BusinessHours} The populated <code>BusinessHours</code> instance.
   */
...
/**
 * Day of the week.
 * @member {module:js_client.orders_v0.model/BusinessHours.DayOfWeekEnum} dayOfWeek
 */
BusinessHours.prototype.dayOfWeek = undefined;

/**
 * Time window during the day when the business is open.
 * @member {Array.<module:js_client.orders_v0.model/OpenInterval>} openIntervals
 */
