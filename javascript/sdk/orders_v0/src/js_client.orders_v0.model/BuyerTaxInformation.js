 ...
 * @module js_client.orders_v0.model/BuyerTaxInformation
 * @version v0
 */
export class BuyerTaxInformation {
   ...
   * @alias module:js_client.orders_v0.model/BuyerTaxInformation
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/BuyerTaxInformation} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/BuyerTaxInformation} The populated <code>BuyerTaxInformation</code> instance.
   */
