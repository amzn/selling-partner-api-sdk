 ...
 * @module js_client.orders_v0.model/UpdateVerificationStatusRequestBody
 * @version v0
 */
export class UpdateVerificationStatusRequestBody {
   ...
   * @alias module:js_client.orders_v0.model/UpdateVerificationStatusRequestBody
   * @class
   ...
   * @param {module:js_client.orders_v0.model/UpdateVerificationStatusRequestBody} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/UpdateVerificationStatusRequestBody} The populated <code>UpdateVerificationStatusRequestBody</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/VerificationDetails} verificationDetails
 */
