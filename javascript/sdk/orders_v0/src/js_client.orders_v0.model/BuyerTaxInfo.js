 ...
 * @module js_client.orders_v0.model/BuyerTaxInfo
 * @version v0
 */
export class BuyerTaxInfo {
   ...
   * @alias module:js_client.orders_v0.model/BuyerTaxInfo
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/BuyerTaxInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/BuyerTaxInfo} The populated <code>BuyerTaxInfo</code> instance.
   */
 ...
 * @member {Array.<module:js_client.orders_v0.model/TaxClassification>} taxClassifications
 */
