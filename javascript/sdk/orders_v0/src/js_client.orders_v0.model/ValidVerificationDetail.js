 ...
 * @module js_client.orders_v0.model/ValidVerificationDetail
 * @version v0
 */
export class ValidVerificationDetail {
   ...
   * @alias module:js_client.orders_v0.model/ValidVerificationDetail
   * @class
   ...
   * @param {module:js_client.orders_v0.model/ValidVerificationDetail} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/ValidVerificationDetail} The populated <code>ValidVerificationDetail</code> instance.
   */
 ...
 * @member {Array.<module:js_client.orders_v0.model/VerificationStatus>} validVerificationStatuses
 */
