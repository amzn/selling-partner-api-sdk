 ...
 * @module js_client.orders_v0.model/OrderAddress
 * @version v0
 */
export class OrderAddress {
   ...
   * @alias module:js_client.orders_v0.model/OrderAddress
   * @class
   ...
   * @param {module:js_client.orders_v0.model/OrderAddress} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderAddress} The populated <code>OrderAddress</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/DeliveryPreferences} deliveryPreferences
 */
