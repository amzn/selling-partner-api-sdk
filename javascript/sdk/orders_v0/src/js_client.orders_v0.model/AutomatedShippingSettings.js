 ...
 * @module js_client.orders_v0.model/AutomatedShippingSettings
 * @version v0
 */
export class AutomatedShippingSettings {
   ...
   * @alias module:js_client.orders_v0.model/AutomatedShippingSettings
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/AutomatedShippingSettings} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/AutomatedShippingSettings} The populated <code>AutomatedShippingSettings</code> instance.
   */
