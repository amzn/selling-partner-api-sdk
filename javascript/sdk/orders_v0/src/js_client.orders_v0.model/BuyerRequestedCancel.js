 ...
 * @module js_client.orders_v0.model/BuyerRequestedCancel
 * @version v0
 */
export class BuyerRequestedCancel {
   ...
   * @alias module:js_client.orders_v0.model/BuyerRequestedCancel
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/BuyerRequestedCancel} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/BuyerRequestedCancel} The populated <code>BuyerRequestedCancel</code> instance.
   */
