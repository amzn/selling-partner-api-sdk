 ...
 * @module js_client.orders_v0.model/VerificationDetails
 * @version v0
 */
export class VerificationDetails {
   ...
   * @alias module:js_client.orders_v0.model/VerificationDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/VerificationDetails} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/VerificationDetails} The populated <code>VerificationDetails</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/PrescriptionDetail} prescriptionDetail
 */
