 ...
 * @module js_client.orders_v0.model/OrderItemsInner
 * @version v0
 */
export class OrderItemsInner {
  /**
   * Constructs a new <code>OrderItemsInner</code>.
   * @alias module:js_client.orders_v0.model/OrderItemsInner
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.orders_v0.model/OrderItemsInner} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderItemsInner} The populated <code>OrderItemsInner</code> instance.
   */
