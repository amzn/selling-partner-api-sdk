 ...
 * @module js_client.orders_v0.model/Order
 * @version v0
 */
export class Order {
  /**
   ...
   * Order information.
   * @alias module:js_client.orders_v0.model/Order
   * @class
   ...
   * @param orderStatus {module:js_client.orders_v0.model/Order.OrderStatusEnum} The current order status.
   */
   ...
   * @param {module:js_client.orders_v0.model/Order} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/Order} The populated <code>Order</code> instance.
   */
 ...
 * @member {module:js_client.orders_v0.model/Order.OrderStatusEnum} orderStatus
 */
 ...
 * @member {module:js_client.orders_v0.model/Order.FulfillmentChannelEnum} fulfillmentChannel
 */
...
/**
 * @member {module:js_client.orders_v0.model/Money} orderTotal
 */
 ...
 * @member {Array.<module:js_client.orders_v0.model/PaymentExecutionDetailItem>} paymentExecutionDetail
 */
 ...
 * @member {module:js_client.orders_v0.model/Order.PaymentMethodEnum} paymentMethod
 */
...
/**
 * @member {module:js_client.orders_v0.model/EasyShipShipmentStatus} easyShipShipmentStatus
 */
...
/**
 * The order's type.
 * @member {module:js_client.orders_v0.model/Order.OrderTypeEnum} orderType
 */
...
/**
 * @member {module:js_client.orders_v0.model/Address} defaultShipFromLocationAddress
 */
 ...
 * @member {module:js_client.orders_v0.model/Order.BuyerInvoicePreferenceEnum} buyerInvoicePreference
 */
Order.prototype.buyerInvoicePreference = undefined;

/**
 * @member {module:js_client.orders_v0.model/BuyerTaxInformation} buyerTaxInformation
 */
Order.prototype.buyerTaxInformation = undefined;

/**
 * @member {module:js_client.orders_v0.model/FulfillmentInstruction} fulfillmentInstruction
 */
...
/**
 * @member {module:js_client.orders_v0.model/MarketplaceTaxInfo} marketplaceTaxInfo
 */
...
/**
 * @member {module:js_client.orders_v0.model/Address} shippingAddress
 */
Order.prototype.shippingAddress = undefined;

/**
 * @member {module:js_client.orders_v0.model/BuyerInfo} buyerInfo
 */
Order.prototype.buyerInfo = undefined;

/**
 * @member {module:js_client.orders_v0.model/AutomatedShippingSettings} automatedShippingSettings
 */
...
/**
 * @member {module:js_client.orders_v0.model/ElectronicInvoiceStatus} electronicInvoiceStatus
 */
