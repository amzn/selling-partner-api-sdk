 ...
 * @module js_client.orders_v0.model/OrderBuyerInfo
 * @version v0
 */
export class OrderBuyerInfo {
   ...
   * @alias module:js_client.orders_v0.model/OrderBuyerInfo
   * @class
   ...
   * @param {module:js_client.orders_v0.model/OrderBuyerInfo} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderBuyerInfo} The populated <code>OrderBuyerInfo</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/BuyerTaxInfo} buyerTaxInfo
 */
