 ...
 * @module js_client.orders_v0.model/OrdersList
 * @version v0
 */
export class OrdersList {
   ...
   * @alias module:js_client.orders_v0.model/OrdersList
   * @class
   * @param orders {Array.<module:js_client.orders_v0.model/Order>} A list of orders.
   */
  constructor(orders) {
    this.orders = orders;
  }
   ...
   * @param {module:js_client.orders_v0.model/OrdersList} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrdersList} The populated <code>OrdersList</code> instance.
   */
...
/**
 * A list of orders.
 * @member {Array.<module:js_client.orders_v0.model/Order>} orders
 */
