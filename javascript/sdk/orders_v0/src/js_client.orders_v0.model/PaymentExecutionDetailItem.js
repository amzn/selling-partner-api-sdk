 ...
 * @module js_client.orders_v0.model/PaymentExecutionDetailItem
 * @version v0
 */
export class PaymentExecutionDetailItem {
   ...
   * @alias module:js_client.orders_v0.model/PaymentExecutionDetailItem
   * @class
   * @param payment {module:js_client.orders_v0.model/Money} 
   ...
   * @param {module:js_client.orders_v0.model/PaymentExecutionDetailItem} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/PaymentExecutionDetailItem} The populated <code>PaymentExecutionDetailItem</code> instance.
   */
...
/**
 * @member {module:js_client.orders_v0.model/Money} payment
 */
