 ...
 * @module js_client.orders_v0.model/RegulatedInformationField
 * @version v0
 */
export class RegulatedInformationField {
   ...
   * @alias module:js_client.orders_v0.model/RegulatedInformationField
   * @class
   * @param fieldId {String} The unique identifier of the field.
   * @param fieldLabel {String} The name of the field.
   * @param fieldType {module:js_client.orders_v0.model/RegulatedInformationField.FieldTypeEnum} The type of field.
   ...
   * @param {module:js_client.orders_v0.model/RegulatedInformationField} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/RegulatedInformationField} The populated <code>RegulatedInformationField</code> instance.
   */
...
/**
 * The type of field.
 * @member {module:js_client.orders_v0.model/RegulatedInformationField.FieldTypeEnum} fieldType
 */
