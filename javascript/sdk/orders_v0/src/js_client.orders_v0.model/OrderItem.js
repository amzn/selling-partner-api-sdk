 ...
 * @module js_client.orders_v0.model/OrderItem
 * @version v0
 */
export class OrderItem {
   ...
   * A single order item.
   * @alias module:js_client.orders_v0.model/OrderItem
   * @class
   ...
   * @param {module:js_client.orders_v0.model/OrderItem} obj Optional instance to populate.
   * @return {module:js_client.orders_v0.model/OrderItem} The populated <code>OrderItem</code> instance.
   */
 ...
 * @member {Array.<module:js_client.orders_v0.model/AssociatedItem>} associatedItems
 */
...
/**
 * @member {module:js_client.orders_v0.model/ProductInfoDetail} productInfo
 */
OrderItem.prototype.productInfo = undefined;

/**
 * @member {module:js_client.orders_v0.model/PointsGrantedDetail} pointsGranted
 */
OrderItem.prototype.pointsGranted = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} itemPrice
 */
OrderItem.prototype.itemPrice = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} shippingPrice
 */
OrderItem.prototype.shippingPrice = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} itemTax
 */
OrderItem.prototype.itemTax = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} shippingTax
 */
OrderItem.prototype.shippingTax = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} shippingDiscount
 */
OrderItem.prototype.shippingDiscount = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} shippingDiscountTax
 */
OrderItem.prototype.shippingDiscountTax = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} promotionDiscount
 */
OrderItem.prototype.promotionDiscount = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} promotionDiscountTax
 */
...
/**
 * @member {module:js_client.orders_v0.model/Money} cODFee
 */
OrderItem.prototype.cODFee = undefined;

/**
 * @member {module:js_client.orders_v0.model/Money} cODFeeDiscount
 */
...
/**
 * @member {module:js_client.orders_v0.model/TaxCollection} taxCollection
 */
 ...
 * @member {module:js_client.orders_v0.model/OrderItem.DeemedResellerCategoryEnum} deemedResellerCategory
 */
OrderItem.prototype.deemedResellerCategory = undefined;

/**
 * @member {module:js_client.orders_v0.model/ItemBuyerInfo} buyerInfo
 */
OrderItem.prototype.buyerInfo = undefined;

/**
 * @member {module:js_client.orders_v0.model/BuyerRequestedCancel} buyerRequestedCancel
 */
...
/**
 * @member {module:js_client.orders_v0.model/SubstitutionPreferences} substitutionPreferences
 */
OrderItem.prototype.substitutionPreferences = undefined;

/**
 * @member {module:js_client.orders_v0.model/Measurement} measurement
 */
OrderItem.prototype.measurement = undefined;

/**
 * @member {module:js_client.orders_v0.model/ShippingConstraints} shippingConstraints
 */
OrderItem.prototype.shippingConstraints = undefined;

/**
 * @member {module:js_client.orders_v0.model/AmazonPrograms} amazonPrograms
 */
OrderItem.prototype.amazonPrograms = undefined;

/**
 * @member {module:js_client.orders_v0.model/ExportInfo} exportInfo
 */
