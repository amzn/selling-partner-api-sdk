...
(function(root, factory) {
  ...
  describe('SubstitutionPreferences', function() {
    it('should create an instance of SubstitutionPreferences', function() {
      // uncomment below and update the code to test SubstitutionPreferences
      //var instance = new SellingPartnerApiForOrders.SubstitutionPreferences();
    ...
    it('should have the property substitutionType (base name: "SubstitutionType")', function() {
      // uncomment below and update the code to test the property substitutionType
      //var instance = new SellingPartnerApiForOrders.SubstitutionPreferences();
      //expect(instance).to.be();
    });

    it('should have the property substitutionOptions (base name: "SubstitutionOptions")', function() {
      // uncomment below and update the code to test the property substitutionOptions
      //var instance = new SellingPartnerApiForOrders.SubstitutionPreferences();
      //expect(instance).to.be();
    });
