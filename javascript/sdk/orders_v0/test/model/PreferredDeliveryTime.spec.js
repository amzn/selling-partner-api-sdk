...
(function(root, factory) {
  ...
  describe('PreferredDeliveryTime', function() {
    it('should create an instance of PreferredDeliveryTime', function() {
      // uncomment below and update the code to test PreferredDeliveryTime
      //var instance = new SellingPartnerApiForOrders.PreferredDeliveryTime();
    ...
    it('should have the property exceptionDates (base name: "ExceptionDates")', function() {
      // uncomment below and update the code to test the property exceptionDates
      //var instance = new SellingPartnerApiForOrders.PreferredDeliveryTime();
      //expect(instance).to.be();
    });
