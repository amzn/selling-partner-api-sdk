...
(function(root, factory) {
  ...
  describe('UpdateShipmentStatusErrorResponse', function() {
    it('should create an instance of UpdateShipmentStatusErrorResponse', function() {
      // uncomment below and update the code to test UpdateShipmentStatusErrorResponse
      //var instance = new SellingPartnerApiForOrders.UpdateShipmentStatusErrorResponse();
