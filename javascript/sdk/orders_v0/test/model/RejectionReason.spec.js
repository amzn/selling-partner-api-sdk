...
(function(root, factory) {
  ...
  describe('RejectionReason', function() {
    it('should create an instance of RejectionReason', function() {
      // uncomment below and update the code to test RejectionReason
      //var instance = new SellingPartnerApiForOrders.RejectionReason();
    ...
    it('should have the property rejectionReasonDescription (base name: "RejectionReasonDescription")', function() {
      // uncomment below and update the code to test the property rejectionReasonDescription
      //var instance = new SellingPartnerApiForOrders.RejectionReason();
      //expect(instance).to.be();
    });
