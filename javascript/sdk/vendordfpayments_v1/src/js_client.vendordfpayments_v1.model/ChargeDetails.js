 ...
 * @module js_client.vendordfpayments_v1.model/ChargeDetails
 * @version v1
 */
export class ChargeDetails {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/ChargeDetails
   * @class
   * @param type {module:js_client.vendordfpayments_v1.model/ChargeDetails.TypeEnum} Type of charge applied.
   * @param chargeAmount {module:js_client.vendordfpayments_v1.model/Money} 
   */
   ...
   * @param {module:js_client.vendordfpayments_v1.model/ChargeDetails} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/ChargeDetails} The populated <code>ChargeDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendordfpayments_v1.model/ChargeDetails.TypeEnum} type
 */
ChargeDetails.prototype.type = undefined;

/**
 * @member {module:js_client.vendordfpayments_v1.model/Money} chargeAmount
 */
