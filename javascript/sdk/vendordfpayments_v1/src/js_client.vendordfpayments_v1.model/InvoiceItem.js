 ...
 * @module js_client.vendordfpayments_v1.model/InvoiceItem
 * @version v1
 */
export class InvoiceItem {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/InvoiceItem
   * @class
   ...
   * @param invoicedQuantity {module:js_client.vendordfpayments_v1.model/ItemQuantity} 
   * @param netCost {module:js_client.vendordfpayments_v1.model/Money} 
   ...
   * @param {module:js_client.vendordfpayments_v1.model/InvoiceItem} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/InvoiceItem} The populated <code>InvoiceItem</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfpayments_v1.model/ItemQuantity} invoicedQuantity
 */
InvoiceItem.prototype.invoicedQuantity = undefined;

/**
 * @member {module:js_client.vendordfpayments_v1.model/Money} netCost
 */
 ...
 * @member {Array.<module:js_client.vendordfpayments_v1.model/TaxDetail>} taxDetails
 */
