 ...
 * @module js_client.vendordfpayments_v1.model/TaxRegistrationDetail
 * @version v1
 */
export class TaxRegistrationDetail {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/TaxRegistrationDetail
   * @class
   ...
   * @param {module:js_client.vendordfpayments_v1.model/TaxRegistrationDetail} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/TaxRegistrationDetail} The populated <code>TaxRegistrationDetail</code> instance.
   */
 ...
 * @member {module:js_client.vendordfpayments_v1.model/TaxRegistrationDetail.TaxRegistrationTypeEnum} taxRegistrationType
 */
...
/**
 * @member {module:js_client.vendordfpayments_v1.model/Address} taxRegistrationAddress
 */
