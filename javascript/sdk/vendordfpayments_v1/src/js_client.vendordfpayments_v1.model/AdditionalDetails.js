 ...
 * @module js_client.vendordfpayments_v1.model/AdditionalDetails
 * @version v1
 */
export class AdditionalDetails {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/AdditionalDetails
   * @class
   * @param type {module:js_client.vendordfpayments_v1.model/AdditionalDetails.TypeEnum} The type of the additional information provided by the selling party.
   ...
   * @param {module:js_client.vendordfpayments_v1.model/AdditionalDetails} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/AdditionalDetails} The populated <code>AdditionalDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendordfpayments_v1.model/AdditionalDetails.TypeEnum} type
 */
