 ...
 * @module js_client.vendordfpayments_v1.model/InvoiceDetail
 * @version v1
 */
export class InvoiceDetail {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/InvoiceDetail
   * @class
   * @param invoiceNumber {String} The unique invoice number.
   * @param invoiceDate {Date} Invoice date.
   * @param remitToParty {module:js_client.vendordfpayments_v1.model/PartyIdentification} 
   * @param shipFromParty {module:js_client.vendordfpayments_v1.model/PartyIdentification} 
   * @param invoiceTotal {module:js_client.vendordfpayments_v1.model/Money} 
   * @param items {Array.<module:js_client.vendordfpayments_v1.model/InvoiceItem>} Provides the details of the items in this invoice.
   */
   ...
   * @param {module:js_client.vendordfpayments_v1.model/InvoiceDetail} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/InvoiceDetail} The populated <code>InvoiceDetail</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfpayments_v1.model/PartyIdentification} remitToParty
 */
InvoiceDetail.prototype.remitToParty = undefined;

/**
 * @member {module:js_client.vendordfpayments_v1.model/PartyIdentification} shipFromParty
 */
InvoiceDetail.prototype.shipFromParty = undefined;

/**
 * @member {module:js_client.vendordfpayments_v1.model/PartyIdentification} billToParty
 */
...
/**
 * @member {module:js_client.vendordfpayments_v1.model/Money} invoiceTotal
 */
InvoiceDetail.prototype.invoiceTotal = undefined;

/**
 * Individual tax details per line item.
 * @member {Array.<module:js_client.vendordfpayments_v1.model/TaxDetail>} taxTotals
 */
InvoiceDetail.prototype.taxTotals = undefined;

/**
 * Additional details provided by the selling party, for tax-related or other purposes.
 * @member {Array.<module:js_client.vendordfpayments_v1.model/AdditionalDetails>} additionalDetails
 */
InvoiceDetail.prototype.additionalDetails = undefined;

/**
 * Total charge amount details for all line items.
 * @member {Array.<module:js_client.vendordfpayments_v1.model/ChargeDetails>} chargeDetails
 */
InvoiceDetail.prototype.chargeDetails = undefined;

/**
 * Provides the details of the items in this invoice.
 * @member {Array.<module:js_client.vendordfpayments_v1.model/InvoiceItem>} items
 */
