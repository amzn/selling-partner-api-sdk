 ...
 * @module js_client.vendordfpayments_v1.model/PartyIdentification
 * @version v1
 */
export class PartyIdentification {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/PartyIdentification
   * @class
   ...
   * @param {module:js_client.vendordfpayments_v1.model/PartyIdentification} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/PartyIdentification} The populated <code>PartyIdentification</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfpayments_v1.model/Address} address
 */
PartyIdentification.prototype.address = undefined;

/**
 * Tax registration details of the entity.
 * @member {Array.<module:js_client.vendordfpayments_v1.model/TaxRegistrationDetail>} taxRegistrationDetails
 */
