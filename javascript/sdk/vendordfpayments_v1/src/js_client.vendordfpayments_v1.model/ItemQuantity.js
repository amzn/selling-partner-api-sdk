 ...
 * @module js_client.vendordfpayments_v1.model/ItemQuantity
 * @version v1
 */
export class ItemQuantity {
   ...
   * @alias module:js_client.vendordfpayments_v1.model/ItemQuantity
   * @class
   ...
   * @param {module:js_client.vendordfpayments_v1.model/ItemQuantity} obj Optional instance to populate.
   * @return {module:js_client.vendordfpayments_v1.model/ItemQuantity} The populated <code>ItemQuantity</code> instance.
   */
