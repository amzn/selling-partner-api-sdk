...
(function(root, factory) {
  ...
  describe('AllowanceDetails', function() {
    it('should create an instance of AllowanceDetails', function() {
      // uncomment below and update the code to test AllowanceDetails
      //var instance = new SellingPartnerApiForRetailProcurementPayments.AllowanceDetails();
    ...
    it('should have the property allowanceAmount (base name: "allowanceAmount")', function() {
      // uncomment below and update the code to test the property allowanceAmount
      //var instance = new SellingPartnerApiForRetailProcurementPayments.AllowanceDetails();
      //expect(instance).to.be();
    });
