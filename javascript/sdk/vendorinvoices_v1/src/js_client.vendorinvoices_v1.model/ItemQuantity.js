 ...
 * @module js_client.vendorinvoices_v1.model/ItemQuantity
 * @version v1
 */
export class ItemQuantity {
   ...
   * Details of quantity.
   * @alias module:js_client.vendorinvoices_v1.model/ItemQuantity
   * @class
   * @param amount {Number} Quantity of an item. This value should not be zero.
   * @param unitOfMeasure {module:js_client.vendorinvoices_v1.model/ItemQuantity.UnitOfMeasureEnum} Unit of measure for the quantity.
   */
   ...
   * @param {module:js_client.vendorinvoices_v1.model/ItemQuantity} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/ItemQuantity} The populated <code>ItemQuantity</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/ItemQuantity.UnitOfMeasureEnum} unitOfMeasure
 */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/TotalWeight} totalWeight
 */
