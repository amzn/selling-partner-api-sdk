 ...
 * @module js_client.vendorinvoices_v1.model/TotalWeight
 * @version v1
 */
export class TotalWeight {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/TotalWeight
   * @class
   * @param unitOfMeasure {module:js_client.vendorinvoices_v1.model/TotalWeight.UnitOfMeasureEnum} The unit of measure for items sold by weight.
   ...
   * @param {module:js_client.vendorinvoices_v1.model/TotalWeight} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/TotalWeight} The populated <code>TotalWeight</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/TotalWeight.UnitOfMeasureEnum} unitOfMeasure
 */
