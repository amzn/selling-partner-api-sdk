 ...
 * @module js_client.vendorinvoices_v1.model/PaymentTerms
 * @version v1
 */
export class PaymentTerms {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/PaymentTerms
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorinvoices_v1.model/PaymentTerms} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/PaymentTerms} The populated <code>PaymentTerms</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/PaymentTerms.TypeEnum} type
 */
