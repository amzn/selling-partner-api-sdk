 ...
 * @module js_client.vendorinvoices_v1.model/InvoiceItem
 * @version v1
 */
export class InvoiceItem {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/InvoiceItem
   * @class
   * @param itemSequenceNumber {Number} Unique number related to this line item.
   * @param invoicedQuantity {module:js_client.vendorinvoices_v1.model/ItemQuantity} 
   * @param netCost {module:js_client.vendorinvoices_v1.model/Money} 
   */
   ...
   * @param {module:js_client.vendorinvoices_v1.model/InvoiceItem} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/InvoiceItem} The populated <code>InvoiceItem</code> instance.
   */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/ItemQuantity} invoicedQuantity
 */
InvoiceItem.prototype.invoicedQuantity = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/Money} netCost
 */
InvoiceItem.prototype.netCost = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/NetCostUnitOfMeasure} netCostUnitOfMeasure
 */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/CreditNoteDetails} creditNoteDetails
 */
