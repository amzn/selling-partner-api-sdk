 ...
 * @module js_client.vendorinvoices_v1.model/CreditNoteDetails
 * @version v1
 */
export class CreditNoteDetails {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/CreditNoteDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorinvoices_v1.model/CreditNoteDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/CreditNoteDetails} The populated <code>CreditNoteDetails</code> instance.
   */
