 ...
 * @module js_client.vendorinvoices_v1.model/SubmitInvoicesRequest
 * @version v1
 */
export class SubmitInvoicesRequest {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/SubmitInvoicesRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.vendorinvoices_v1.model/SubmitInvoicesRequest} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/SubmitInvoicesRequest} The populated <code>SubmitInvoicesRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vendorinvoices_v1.model/Invoice>} invoices
 */
