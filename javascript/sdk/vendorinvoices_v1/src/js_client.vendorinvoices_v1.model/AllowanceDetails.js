 ...
 * @module js_client.vendorinvoices_v1.model/AllowanceDetails
 * @version v1
 */
export class AllowanceDetails {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/AllowanceDetails
   * @class
   * @param type {module:js_client.vendorinvoices_v1.model/AllowanceDetails.TypeEnum} Type of the allowance applied.
   * @param allowanceAmount {module:js_client.vendorinvoices_v1.model/Money} 
   */
   ...
   * @param {module:js_client.vendorinvoices_v1.model/AllowanceDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/AllowanceDetails} The populated <code>AllowanceDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/AllowanceDetails.TypeEnum} type
 */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/Money} allowanceAmount
 */
