 ...
 * @module js_client.vendorinvoices_v1.model/Invoice
 * @version v1
 */
export class Invoice {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/Invoice
   * @class
   * @param invoiceType {module:js_client.vendorinvoices_v1.model/Invoice.InvoiceTypeEnum} Identifies the type of invoice.
   ...
   * @param remitToParty {module:js_client.vendorinvoices_v1.model/PartyIdentification} 
   * @param invoiceTotal {module:js_client.vendorinvoices_v1.model/Money} 
   */
   ...
   * @param {module:js_client.vendorinvoices_v1.model/Invoice} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/Invoice} The populated <code>Invoice</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/Invoice.InvoiceTypeEnum} invoiceType
 */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/PartyIdentification} remitToParty
 */
Invoice.prototype.remitToParty = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/PartyIdentification} shipToParty
 */
Invoice.prototype.shipToParty = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/PartyIdentification} shipFromParty
 */
Invoice.prototype.shipFromParty = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/PartyIdentification} billToParty
 */
Invoice.prototype.billToParty = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/PaymentTerms} paymentTerms
 */
Invoice.prototype.paymentTerms = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/Money} invoiceTotal
 */
 ...
 * @member {Array.<module:js_client.vendorinvoices_v1.model/AdditionalDetails>} additionalDetails
 */
Invoice.prototype.additionalDetails = undefined;

/**
 * Total charge amount details for all line items.
 * @member {Array.<module:js_client.vendorinvoices_v1.model/ChargeDetails>} chargeDetails
 */
Invoice.prototype.chargeDetails = undefined;

/**
 * Total allowance amount details for all line items.
 * @member {Array.<module:js_client.vendorinvoices_v1.model/AllowanceDetails>} allowanceDetails
 */
Invoice.prototype.allowanceDetails = undefined;

/**
 * The list of invoice items.
 * @member {Array.<module:js_client.vendorinvoices_v1.model/InvoiceItem>} items
 */
