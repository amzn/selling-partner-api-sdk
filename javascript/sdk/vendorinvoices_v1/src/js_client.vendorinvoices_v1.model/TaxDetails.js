 ...
 * @module js_client.vendorinvoices_v1.model/TaxDetails
 * @version v1
 */
export class TaxDetails {
   ...
   * @alias module:js_client.vendorinvoices_v1.model/TaxDetails
   * @class
   * @param taxType {module:js_client.vendorinvoices_v1.model/TaxDetails.TaxTypeEnum} Type of the tax applied.
   * @param taxAmount {module:js_client.vendorinvoices_v1.model/Money} 
   */
   ...
   * @param {module:js_client.vendorinvoices_v1.model/TaxDetails} obj Optional instance to populate.
   * @return {module:js_client.vendorinvoices_v1.model/TaxDetails} The populated <code>TaxDetails</code> instance.
   */
 ...
 * @member {module:js_client.vendorinvoices_v1.model/TaxDetails.TaxTypeEnum} taxType
 */
...
/**
 * @member {module:js_client.vendorinvoices_v1.model/Money} taxAmount
 */
TaxDetails.prototype.taxAmount = undefined;

/**
 * @member {module:js_client.vendorinvoices_v1.model/Money} taxableAmount
 */
