...
(function(root, factory) {
  ...
  describe('CreateNotificationResponse', function() {
    it('should create an instance of CreateNotificationResponse', function() {
      // uncomment below and update the code to test CreateNotificationResponse
      //var instance = new TheSellingPartnerApiForThirdPartyApplicationIntegrations.CreateNotificationResponse();
