...
* @module js_client.appintegrations_v2024_04_01.api/AppIntegrationsApi
* @version 2024-04-01
*/
export class AppIntegrationsApi {
    ...
    * @alias module:js_client.appintegrations_v2024_04_01.api/AppIntegrationsApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.appintegrations_v2024_04_01.model/CreateNotificationRequest} body The request body for the &#x60;createNotification&#x60; operation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.appintegrations_v2024_04_01.model/CreateNotificationResponse} and HTTP response
     */
     ...
     * Create a notification for sellers in Seller Central.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Sellers whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.appintegrations_v2024_04_01.model/CreateNotificationRequest} body The request body for the &#x60;createNotification&#x60; operation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.appintegrations_v2024_04_01.model/CreateNotificationResponse}
     */
     ...
     * @param {module:js_client.appintegrations_v2024_04_01.model/DeleteNotificationsRequest} body The request body for the &#x60;deleteNotifications&#x60; operation.
     ...
     * @param {module:js_client.appintegrations_v2024_04_01.model/RecordActionFeedbackRequest} body The request body for the &#x60;recordActionFeedback&#x60; operation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
