...
(function(root, factory) {
  ...
  describe('InboundPreferences', function() {
    it('should create an instance of InboundPreferences', function() {
      // uncomment below and update the code to test InboundPreferences
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.InboundPreferences();
