...
(function(root, factory) {
  ...
  describe('DistributionPackageContents', function() {
    it('should create an instance of DistributionPackageContents', function() {
      // uncomment below and update the code to test DistributionPackageContents
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.DistributionPackageContents();
