...
(function(root, factory) {
  ...
  describe('PrepInstruction', function() {
    it('should create an instance of PrepInstruction', function() {
      ...
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.PrepInstruction();
    ...
    it('should have the property prepType (base name: "prepType")', function() {
      // uncomment below and update the code to test the property prepType
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.PrepInstruction();
      //expect(instance).to.be();
    });
