...
(function(root, factory) {
  ...
  describe('InventoryQuantity', function() {
    it('should create an instance of InventoryQuantity', function() {
      // uncomment below and update the code to test InventoryQuantity
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.InventoryQuantity();
