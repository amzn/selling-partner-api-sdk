...
(function(root, factory) {
  ...
  describe('PrepOwner', function() {
    it('should create an instance of PrepOwner', function() {
      ...
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.PrepOwner();
      //expect(instance).to.be.a(TheSellingPartnerApiForAmazonWarehousingAndDistribution.PrepOwner);
    });
