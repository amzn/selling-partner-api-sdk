...
(function(root, factory) {
  ...
  describe('ExpirationDetails', function() {
    it('should create an instance of ExpirationDetails', function() {
      // uncomment below and update the code to test ExpirationDetails
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.ExpirationDetails();
