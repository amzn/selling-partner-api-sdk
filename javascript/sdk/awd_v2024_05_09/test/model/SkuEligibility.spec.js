...
(function(root, factory) {
  ...
  describe('SkuEligibility', function() {
    it('should create an instance of SkuEligibility', function() {
      // uncomment below and update the code to test SkuEligibility
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.SkuEligibility();
