...
(function(root, factory) {
  ...
  describe('DistributionPackage', function() {
    it('should create an instance of DistributionPackage', function() {
      // uncomment below and update the code to test DistributionPackage
      //var instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.DistributionPackage();
