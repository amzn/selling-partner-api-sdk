...
/**
* Awd service.
* @module js_client.awd_v2024_05_09.api/AwdApi
* @version 2024-05-09
*/
export class AwdApi {
    ...
    * @alias module:js_client.awd_v2024_05_09.api/AwdApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.awd_v2024_05_09.model/InboundPackages} body Represents the packages you want to inbound.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/InboundEligibility} and HTTP response
     */
     ...
     * Determines if the packages you specify are eligible for an AWD inbound order and contains error details for ineligible packages.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.awd_v2024_05_09.model/InboundPackages} body Represents the packages you want to inbound.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/InboundEligibility}
     */
     ...
     * @param {module:js_client.awd_v2024_05_09.model/InboundOrderCreationData} body Payload for creating an inbound order.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/InboundOrderReference} and HTTP response
     */
     ...
     * Creates a draft AWD inbound order with a list of packages for inbound shipment. The operation creates one shipment per order.   **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.awd_v2024_05_09.model/InboundOrderCreationData} body Payload for creating an inbound order.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/InboundOrderReference}
     */
    createInbound(body) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/InboundOrder} and HTTP response
     */
     ...
     * Retrieves an AWD inbound order.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {String} orderId The ID of the inbound order that you want to retrieve.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/InboundOrder}
     */
    getInbound(orderId) {
     ...
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.skuQuantities If equal to &#x60;SHOW&#x60;, the response includes the shipment SKU quantity details.  Defaults to &#x60;HIDE&#x60;, in which case the response does not contain SKU quantities
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/InboundShipment} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.skuQuantities If equal to &#x60;SHOW&#x60;, the response includes the shipment SKU quantity details.  Defaults to &#x60;HIDE&#x60;, in which case the response does not contain SKU quantities
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/InboundShipment}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.pageType Page type for the generated labels. The default is &#x60;PLAIN_PAPER&#x60;.
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.formatType The format type of the output file that contains your labels. The default format type is &#x60;PDF&#x60;.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/ShipmentLabels} and HTTP response
     */
     ...
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.pageType Page type for the generated labels. The default is &#x60;PLAIN_PAPER&#x60;.
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.formatType The format type of the output file that contains your labels. The default format type is &#x60;PDF&#x60;.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/ShipmentLabels}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.sortBy Field to sort results by. By default, the response will be sorted by UPDATED_AT.
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.sortOrder Sort the response in ASCENDING or DESCENDING order. By default, the response will be sorted in DESCENDING order.
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.shipmentStatus Filter by inbound shipment status.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/ShipmentListing} and HTTP response
     */
     ...
     * @param {Number} opts.maxResults Maximum number of results to return. (default to 25)
     * @param {String} opts.nextToken A token that is used to retrieve the next page of results. The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;maxResults&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/ShipmentListing}
     */
     ...
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.sortOrder Sort the response in &#x60;ASCENDING&#x60; or &#x60;DESCENDING&#x60; order.
     * @param {module:js_client.awd_v2024_05_09.model/String} opts.details Set to &#x60;SHOW&#x60; to return summaries with additional inventory details. Defaults to &#x60;HIDE,&#x60; which returns only inventory summary totals.
     * @param {String} opts.nextToken A token that is used to retrieve the next page of results. The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;maxResults&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages.
     * @param {Number} opts.maxResults Maximum number of results to return. (default to 25)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.awd_v2024_05_09.model/InventoryListing} and HTTP response
     */
     ...
     * @param {String} opts.nextToken A token that is used to retrieve the next page of results. The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;maxResults&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages.
     * @param {Number} opts.maxResults Maximum number of results to return. (default to 25)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.awd_v2024_05_09.model/InventoryListing}
     */
    listInventory(opts) {
     ...
     * @param {module:js_client.awd_v2024_05_09.model/InboundOrder} body Represents an AWD inbound order.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     * @param {module:js_client.awd_v2024_05_09.model/TransportationDetails} body Transportation details for the shipment.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
