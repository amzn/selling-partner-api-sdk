 ...
 * @module js_client.awd_v2024_05_09.model/InboundEligibility
 * @version 2024-05-09
 */
export class InboundEligibility {
   ...
   * @alias module:js_client.awd_v2024_05_09.model/InboundEligibility
   * @class
   * @param packagesToInbound {Array.<module:js_client.awd_v2024_05_09.model/SkuEligibility>} Details on SKU eligibility for each inbound package.
   * @param previewedAt {Date} Timestamp when the eligibility check is performed.
   * @param status {module:js_client.awd_v2024_05_09.model/InboundEligibilityStatus} 
   */
   ...
   * @param {module:js_client.awd_v2024_05_09.model/InboundEligibility} obj Optional instance to populate.
   * @return {module:js_client.awd_v2024_05_09.model/InboundEligibility} The populated <code>InboundEligibility</code> instance.
   */
 ...
 * @member {Array.<module:js_client.awd_v2024_05_09.model/OrderIneligibilityReason>} ineligibilityReasons
 */
InboundEligibility.prototype.ineligibilityReasons = undefined;

/**
 * Details on SKU eligibility for each inbound package.
 * @member {Array.<module:js_client.awd_v2024_05_09.model/SkuEligibility>} packagesToInbound
 */
...
/**
 * @member {module:js_client.awd_v2024_05_09.model/InboundEligibilityStatus} status
 */
