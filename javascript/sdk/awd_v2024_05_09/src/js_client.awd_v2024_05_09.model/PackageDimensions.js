 ...
 * @module js_client.awd_v2024_05_09.model/PackageDimensions
 * @version 2024-05-09
 */
export class PackageDimensions {
   ...
   * @alias module:js_client.awd_v2024_05_09.model/PackageDimensions
   * @class
   * @param height {Number} Height of the package.
   * @param length {Number} Length of the package.
   * @param unitOfMeasurement {module:js_client.awd_v2024_05_09.model/DimensionUnitOfMeasurement} 
   ...
   * @param {module:js_client.awd_v2024_05_09.model/PackageDimensions} obj Optional instance to populate.
   * @return {module:js_client.awd_v2024_05_09.model/PackageDimensions} The populated <code>PackageDimensions</code> instance.
   */
...
/**
 * @member {module:js_client.awd_v2024_05_09.model/DimensionUnitOfMeasurement} unitOfMeasurement
 */
