 ...
 * @module js_client.finances_2024-06-19.model/Breakdown
 * @version 2024-06-19
 */
export class Breakdown {
   ...
   * @alias module:js_client.finances_2024-06-19.model/Breakdown
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_2024-06-19.model/Breakdown} obj Optional instance to populate.
   * @return {module:js_client.finances_2024-06-19.model/Breakdown} The populated <code>Breakdown</code> instance.
   */
...
/**
 * @member {module:js_client.finances_2024-06-19.model/Currency} breakdownAmount
 */
Breakdown.prototype.breakdownAmount = undefined;

/**
 * @member {module:js_client.finances_2024-06-19.model/Breakdown} breakdowns
 */
