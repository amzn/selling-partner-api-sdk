 ...
 * @module js_client.finances_2024-06-19.model/DeferredContext
 * @version 2024-06-19
 */
export class DeferredContext {
   ...
   * @alias module:js_client.finances_2024-06-19.model/DeferredContext
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_2024-06-19.model/DeferredContext} obj Optional instance to populate.
   * @return {module:js_client.finances_2024-06-19.model/DeferredContext} The populated <code>DeferredContext</code> instance.
   */
