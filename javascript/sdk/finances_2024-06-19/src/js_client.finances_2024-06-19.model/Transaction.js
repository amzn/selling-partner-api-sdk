 ...
 * @module js_client.finances_2024-06-19.model/Transaction
 * @version 2024-06-19
 */
export class Transaction {
   ...
   * @alias module:js_client.finances_2024-06-19.model/Transaction
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_2024-06-19.model/Transaction} obj Optional instance to populate.
   * @return {module:js_client.finances_2024-06-19.model/Transaction} The populated <code>Transaction</code> instance.
   */
...
/**
 * @member {module:js_client.finances_2024-06-19.model/SellingPartnerMetadata} sellingPartnerMetadata
 */
Transaction.prototype.sellingPartnerMetadata = undefined;

/**
 * Related business identifiers of the transaction.
 * @member {Array.<module:js_client.finances_2024-06-19.model/RelatedIdentifier>} relatedIdentifiers
 */
...
/**
 * @member {module:js_client.finances_2024-06-19.model/Currency} totalAmount
 */
Transaction.prototype.totalAmount = undefined;

/**
 * @member {module:js_client.finances_2024-06-19.model/MarketplaceDetails} marketplaceDetails
 */
Transaction.prototype.marketplaceDetails = undefined;

/**
 * List of items in the transaction
 * @member {Array.<module:js_client.finances_2024-06-19.model/Item>} items
 */
Transaction.prototype.items = undefined;

/**
 * List of additional Information about the item.
 * @member {Array.<module:js_client.finances_2024-06-19.model/Context>} contexts
 */
 ...
 * @member {Array.<module:js_client.finances_2024-06-19.model/Breakdown>} breakdowns
 */
