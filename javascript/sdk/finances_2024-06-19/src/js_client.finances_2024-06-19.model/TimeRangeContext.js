 ...
 * @module js_client.finances_2024-06-19.model/TimeRangeContext
 * @version 2024-06-19
 */
export class TimeRangeContext {
   ...
   * @alias module:js_client.finances_2024-06-19.model/TimeRangeContext
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_2024-06-19.model/TimeRangeContext} obj Optional instance to populate.
   * @return {module:js_client.finances_2024-06-19.model/TimeRangeContext} The populated <code>TimeRangeContext</code> instance.
   */
