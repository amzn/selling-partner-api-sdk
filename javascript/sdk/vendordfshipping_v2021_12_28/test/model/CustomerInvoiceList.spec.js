...
(function(root, factory) {
  ...
  describe('CustomerInvoiceList', function() {
    it('should create an instance of CustomerInvoiceList', function() {
      // uncomment below and update the code to test CustomerInvoiceList
      //var instance = new SellingPartnerApiForDirectFulfillmentShipping.CustomerInvoiceList();
    ...
    it('should have the property customerInvoices (base name: "customerInvoices")', function() {
      // uncomment below and update the code to test the property customerInvoices
      //var instance = new SellingPartnerApiForDirectFulfillmentShipping.CustomerInvoiceList();
      //expect(instance).to.be();
    });
