...
(function(root, factory) {
  ...
  describe('ShippingLabelList', function() {
    it('should create an instance of ShippingLabelList', function() {
      // uncomment below and update the code to test ShippingLabelList
      //var instance = new SellingPartnerApiForDirectFulfillmentShipping.ShippingLabelList();
    ...
    it('should have the property shippingLabels (base name: "shippingLabels")', function() {
      // uncomment below and update the code to test the property shippingLabels
      //var instance = new SellingPartnerApiForDirectFulfillmentShipping.ShippingLabelList();
      //expect(instance).to.be();
    });
