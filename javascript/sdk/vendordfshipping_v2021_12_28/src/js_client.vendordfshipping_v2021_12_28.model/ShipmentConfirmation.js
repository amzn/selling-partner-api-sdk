 ...
 * @module js_client.vendordfshipping_v2021_12_28.model/ShipmentConfirmation
 * @version 2021-12-28
 */
export class ShipmentConfirmation {
   ...
   * @alias module:js_client.vendordfshipping_v2021_12_28.model/ShipmentConfirmation
   * @class
   * @param purchaseOrderNumber {String} Purchase order number corresponding to the shipment.
   * @param shipmentDetails {module:js_client.vendordfshipping_v2021_12_28.model/ShipmentDetails} 
   * @param sellingParty {module:js_client.vendordfshipping_v2021_12_28.model/PartyIdentification} 
   * @param shipFromParty {module:js_client.vendordfshipping_v2021_12_28.model/PartyIdentification} 
   * @param items {Array.<module:js_client.vendordfshipping_v2021_12_28.model/Item>} Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
   */
   ...
   * @param {module:js_client.vendordfshipping_v2021_12_28.model/ShipmentConfirmation} obj Optional instance to populate.
   * @return {module:js_client.vendordfshipping_v2021_12_28.model/ShipmentConfirmation} The populated <code>ShipmentConfirmation</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfshipping_v2021_12_28.model/ShipmentDetails} shipmentDetails
 */
ShipmentConfirmation.prototype.shipmentDetails = undefined;

/**
 * @member {module:js_client.vendordfshipping_v2021_12_28.model/PartyIdentification} sellingParty
 */
ShipmentConfirmation.prototype.sellingParty = undefined;

/**
 * @member {module:js_client.vendordfshipping_v2021_12_28.model/PartyIdentification} shipFromParty
 */
 ...
 * @member {Array.<module:js_client.vendordfshipping_v2021_12_28.model/Item>} items
 */
ShipmentConfirmation.prototype.items = undefined;

/**
 * Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
 * @member {Array.<module:js_client.vendordfshipping_v2021_12_28.model/Container>} containers
 */
