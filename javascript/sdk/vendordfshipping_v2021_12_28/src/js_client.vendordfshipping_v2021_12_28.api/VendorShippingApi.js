...
* @module js_client.vendordfshipping_v2021_12_28.api/VendorShippingApi
* @version 2021-12-28
*/
export class VendorShippingApi {
    ...
    * @alias module:js_client.vendordfshipping_v2021_12_28.api/VendorShippingApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/PackingSlip} and HTTP response
     */
     ...
     * Returns a packing slip based on the purchaseOrderNumber that you specify.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
     * @param {String} purchaseOrderNumber The &#x60;purchaseOrderNumber&#x60; for the packing slip that you want.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/PackingSlip}
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder The packing slip creation dates, which are sorted by ascending or descending order. (default to &#39;ASC&#39;)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/PackingSlipList} and HTTP response
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder The packing slip creation dates, which are sorted by ascending or descending order. (default to &#39;ASC&#39;)
     * @param {String} opts.nextToken Used for pagination when there are more packing slips than the specified result size limit. The token value is returned in the previous API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/PackingSlipList}
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/SubmitShipmentConfirmationsRequest} body Request body containing the shipment confirmations data.
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/SubmitShipmentStatusUpdatesRequest} body Request body containing the shipment status update data.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/TransactionReference} and HTTP response
     */
