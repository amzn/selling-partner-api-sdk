...
* @module js_client.vendordfshipping_v2021_12_28.api/VendorShippingLabelsApi
* @version 2021-12-28
*/
export class VendorShippingLabelsApi {
    ...
    * @alias module:js_client.vendordfshipping_v2021_12_28.api/VendorShippingLabelsApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/CreateShippingLabelsRequest} body The request payload that contains the parameters for creating shipping labels.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/ShippingLabel} and HTTP response
     */
     ...
     * @param {String} purchaseOrderNumber The purchase order number for which you want to return the shipping labels. It should be the same number as the &#x60;purchaseOrderNumber&#x60; in the order.
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/CreateShippingLabelsRequest} body The request payload that contains the parameters for creating shipping labels.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/ShippingLabel}
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder The sort order creation date. You can choose between ascending (&#x60;ASC&#x60;) or descending (&#x60;DESC&#x60;) sort order. (default to &#39;ASC&#39;)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/ShippingLabelList} and HTTP response
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder The sort order creation date. You can choose between ascending (&#x60;ASC&#x60;) or descending (&#x60;DESC&#x60;) sort order. (default to &#39;ASC&#39;)
     * @param {String} opts.nextToken Used for pagination when there are more ship labels than the specified result size limit. The token value is returned in the previous API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/ShippingLabelList}
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/SubmitShippingLabelsRequest} body The request body that contains the shipping labels data.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/TransactionReference} and HTTP response
     */
     ...
     * Creates a shipping label for a purchase order and returns a &#x60;transactionId&#x60; for reference.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/SubmitShippingLabelsRequest} body The request body that contains the shipping labels data.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/TransactionReference}
     */
