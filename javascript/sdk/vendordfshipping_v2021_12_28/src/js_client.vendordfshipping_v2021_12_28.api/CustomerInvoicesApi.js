...
* @module js_client.vendordfshipping_v2021_12_28.api/CustomerInvoicesApi
* @version 2021-12-28
*/
export class CustomerInvoicesApi {
    ...
    * @alias module:js_client.vendordfshipping_v2021_12_28.api/CustomerInvoicesApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/CustomerInvoice} and HTTP response
     */
     ...
     * Returns a customer invoice based on the purchaseOrderNumber that you specify.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may have higher rate and burst values then those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
     * @param {String} purchaseOrderNumber Purchase order number of the shipment for which to return the invoice.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/CustomerInvoice}
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder Sort ASC or DESC by order creation date.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/CustomerInvoiceList} and HTTP response
     */
     ...
     * @param {module:js_client.vendordfshipping_v2021_12_28.model/String} opts.sortOrder Sort ASC or DESC by order creation date.
     * @param {String} opts.nextToken Used for pagination when there are more orders than the specified result size limit. The token value is returned in the previous API call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfshipping_v2021_12_28.model/CustomerInvoiceList}
     */
