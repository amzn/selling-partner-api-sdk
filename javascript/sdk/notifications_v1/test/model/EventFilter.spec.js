...
(function(root, factory) {
  ...
  describe('EventFilter', function() {
    it('should create an instance of EventFilter', function() {
      ...
      //var instance = new SellingPartnerApiForNotifications.EventFilter();
    ...
    it('should have the property aggregationSettings (base name: "aggregationSettings")', function() {
      // uncomment below and update the code to test the property aggregationSettings
      //var instance = new SellingPartnerApiForNotifications.EventFilter();
    ...
    it('should have the property orderChangeTypes (base name: "orderChangeTypes")', function() {
      // uncomment below and update the code to test the property orderChangeTypes
      //var instance = new SellingPartnerApiForNotifications.EventFilter();
      //expect(instance).to.be();
    });

    it('should have the property eventFilterType (base name: "eventFilterType")', function() {
      // uncomment below and update the code to test the property eventFilterType
      //var instance = new SellingPartnerApiForNotifications.EventFilter();
      //expect(instance).to.be();
    });
