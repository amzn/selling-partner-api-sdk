 ...
 * @module js_client.notifications_v1.model/EventBridgeResourceSpecification
 * @version v1
 */
export class EventBridgeResourceSpecification {
   ...
   * @alias module:js_client.notifications_v1.model/EventBridgeResourceSpecification
   * @class
   ...
   * @param {module:js_client.notifications_v1.model/EventBridgeResourceSpecification} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/EventBridgeResourceSpecification} The populated <code>EventBridgeResourceSpecification</code> instance.
   */
