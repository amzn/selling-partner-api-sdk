 ...
 * @module js_client.notifications_v1.model/MarketplaceFilter
 * @version v1
 */
export class MarketplaceFilter {
   ...
   * @alias module:js_client.notifications_v1.model/MarketplaceFilter
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/MarketplaceFilter} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/MarketplaceFilter} The populated <code>MarketplaceFilter</code> instance.
   */
