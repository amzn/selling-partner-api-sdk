 ...
 * @module js_client.notifications_v1.model/AggregationFilter
 * @version v1
 */
export class AggregationFilter {
   ...
   * @alias module:js_client.notifications_v1.model/AggregationFilter
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/AggregationFilter} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/AggregationFilter} The populated <code>AggregationFilter</code> instance.
   */
