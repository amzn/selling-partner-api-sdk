 ...
 * @module js_client.notifications_v1.model/DestinationResourceSpecification
 * @version v1
 */
export class DestinationResourceSpecification {
   ...
   * @alias module:js_client.notifications_v1.model/DestinationResourceSpecification
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/DestinationResourceSpecification} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/DestinationResourceSpecification} The populated <code>DestinationResourceSpecification</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/SqsResource} sqs
 */
DestinationResourceSpecification.prototype.sqs = undefined;

/**
 * @member {module:js_client.notifications_v1.model/EventBridgeResourceSpecification} eventBridge
 */
