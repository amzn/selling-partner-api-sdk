 ...
 * @module js_client.notifications_v1.model/DestinationResource
 * @version v1
 */
export class DestinationResource {
   ...
   * @alias module:js_client.notifications_v1.model/DestinationResource
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/DestinationResource} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/DestinationResource} The populated <code>DestinationResource</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/EventBridgeResource} eventBridge
 */
