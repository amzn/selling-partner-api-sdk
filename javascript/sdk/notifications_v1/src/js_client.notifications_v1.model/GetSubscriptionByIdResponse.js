 ...
 * @module js_client.notifications_v1.model/GetSubscriptionByIdResponse
 * @version v1
 */
export class GetSubscriptionByIdResponse {
   ...
   * @alias module:js_client.notifications_v1.model/GetSubscriptionByIdResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/GetSubscriptionByIdResponse} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/GetSubscriptionByIdResponse} The populated <code>GetSubscriptionByIdResponse</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/Subscription} payload
 */
