 ...
 * @module js_client.notifications_v1.model/SqsResource
 * @version v1
 */
export class SqsResource {
   ...
   * @alias module:js_client.notifications_v1.model/SqsResource
   * @class
   ...
   * @param {module:js_client.notifications_v1.model/SqsResource} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/SqsResource} The populated <code>SqsResource</code> instance.
   */
