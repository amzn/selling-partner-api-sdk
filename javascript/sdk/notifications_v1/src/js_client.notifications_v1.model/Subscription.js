 ...
 * @module js_client.notifications_v1.model/Subscription
 * @version v1
 */
export class Subscription {
   ...
   * @alias module:js_client.notifications_v1.model/Subscription
   * @class
   ...
   * @param {module:js_client.notifications_v1.model/Subscription} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/Subscription} The populated <code>Subscription</code> instance.
   */
