...
* @readonly
*/
export default class OrderChangeTypeEnum {
    ...
    * @return {module:js_client.notifications_v1.model/OrderChangeTypeEnum} The enum <code>OrderChangeTypeEnum</code> value.
    */
