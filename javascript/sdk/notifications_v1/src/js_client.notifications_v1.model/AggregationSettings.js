 ...
 * @module js_client.notifications_v1.model/AggregationSettings
 * @version v1
 */
export class AggregationSettings {
   ...
   * @alias module:js_client.notifications_v1.model/AggregationSettings
   * @class
   * @param aggregationTimePeriod {module:js_client.notifications_v1.model/AggregationTimePeriod} 
   */
   ...
   * @param {module:js_client.notifications_v1.model/AggregationSettings} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/AggregationSettings} The populated <code>AggregationSettings</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/AggregationTimePeriod} aggregationTimePeriod
 */
