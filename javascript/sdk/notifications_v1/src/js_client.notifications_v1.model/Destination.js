 ...
 * @module js_client.notifications_v1.model/Destination
 * @version v1
 */
export class Destination {
   ...
   * @alias module:js_client.notifications_v1.model/Destination
   * @class
   ...
   * @param resource {module:js_client.notifications_v1.model/DestinationResource} 
   */
   ...
   * @param {module:js_client.notifications_v1.model/Destination} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/Destination} The populated <code>Destination</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/DestinationResource} resource
 */
