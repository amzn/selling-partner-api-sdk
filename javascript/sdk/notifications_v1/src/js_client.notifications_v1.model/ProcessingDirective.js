 ...
 * @module js_client.notifications_v1.model/ProcessingDirective
 * @version v1
 */
export class ProcessingDirective {
   ...
   * @alias module:js_client.notifications_v1.model/ProcessingDirective
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.notifications_v1.model/ProcessingDirective} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/ProcessingDirective} The populated <code>ProcessingDirective</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/EventFilter} eventFilter
 */
