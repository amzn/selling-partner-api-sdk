 ...
 * @module js_client.notifications_v1.model/CreateSubscriptionRequest
 * @version v1
 */
export class CreateSubscriptionRequest {
   ...
   * @alias module:js_client.notifications_v1.model/CreateSubscriptionRequest
   * @class
   ...
   * @param {module:js_client.notifications_v1.model/CreateSubscriptionRequest} obj Optional instance to populate.
   * @return {module:js_client.notifications_v1.model/CreateSubscriptionRequest} The populated <code>CreateSubscriptionRequest</code> instance.
   */
...
/**
 * @member {module:js_client.notifications_v1.model/ProcessingDirective} processingDirective
 */
