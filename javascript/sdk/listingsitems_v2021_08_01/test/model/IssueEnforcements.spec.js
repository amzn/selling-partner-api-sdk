...
(function(root, factory) {
  ...
  describe('IssueEnforcements', function() {
    it('should create an instance of IssueEnforcements', function() {
      // uncomment below and update the code to test IssueEnforcements
      //var instance = new SellingPartnerApiForListingsItems.IssueEnforcements();
    ...
    it('should have the property exemption (base name: "exemption")', function() {
      // uncomment below and update the code to test the property exemption
      //var instance = new SellingPartnerApiForListingsItems.IssueEnforcements();
      //expect(instance).to.be();
    });
