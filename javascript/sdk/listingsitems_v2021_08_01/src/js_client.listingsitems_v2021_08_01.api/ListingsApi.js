...
/**
* Listings service.
* @module js_client.listingsitems_v2021_08_01.api/ListingsApi
* @version 2021-08-01
*/
export class ListingsApi {
    ...
    * @alias module:js_client.listingsitems_v2021_08_01.api/ListingsApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.listingsitems_v2021_08_01.model/ListingsItemSubmissionResponse} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is not available in the specified locale.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.listingsitems_v2021_08_01.model/ListingsItemSubmissionResponse}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is not available in the specified locale.
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.includedData A comma-delimited list of data sets to include in the response. Default: &#x60;summaries&#x60;.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.listingsitems_v2021_08_01.model/Item} and HTTP response
     */
     ...
     * @param {String} opts.issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is not available in the specified locale.
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.includedData A comma-delimited list of data sets to include in the response. Default: &#x60;summaries&#x60;.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.listingsitems_v2021_08_01.model/Item}
     */
     ...
     * @param {String} sku A selling partner provided identifier for an Amazon listing.
     * @param {Array.<String>} marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request.
     * @param {module:js_client.listingsitems_v2021_08_01.model/ListingsItemPatchRequest} body The request body schema for the &#x60;patchListingsItem&#x60; operation.
     * @param {Object} opts Optional parameters
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.includedData A comma-delimited list of data sets to include in the response. Default: &#x60;issues&#x60;.
     * @param {module:js_client.listingsitems_v2021_08_01.model/String} opts.mode The mode of operation for the request.
     * @param {String} opts.issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is not available in the specified locale.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.listingsitems_v2021_08_01.model/ListingsItemSubmissionResponse} and HTTP response
     */
     ...
     * @param {String} sku A selling partner provided identifier for an Amazon listing.
     * @param {Array.<String>} marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request.
     * @param {module:js_client.listingsitems_v2021_08_01.model/ListingsItemPutRequest} body The request body schema for the &#x60;putListingsItem&#x60; operation.
     * @param {Object} opts Optional parameters
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.includedData A comma-delimited list of data sets to include in the response. Default: &#x60;issues&#x60;.
     * @param {module:js_client.listingsitems_v2021_08_01.model/String} opts.mode The mode of operation for the request.
     * @param {String} opts.issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;, &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is not available in the specified locale.
     ...
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.includedData A comma-delimited list of datasets that you want to include in the response. Default: &#x60;summaries&#x60;.
     ...
     * @param {module:js_client.listingsitems_v2021_08_01.model/String} opts.identifiersType A type of product identifiers that you can use to search for listings items.   **Note**:  This is required when &#x60;identifiers&#x60; is provided.
     ...
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.withIssueSeverity Filter results to include only listing items that have issues that match one or more of the specified severity levels.
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.withStatus Filter results to include only listing items that have the specified status.
     * @param {Array.<module:js_client.listingsitems_v2021_08_01.model/String>} opts.withoutStatus Filter results to include only listing items that don&#39;t contain the specified statuses.
     * @param {module:js_client.listingsitems_v2021_08_01.model/String} opts.sortBy An attribute by which to sort the returned listing items. (default to &#39;lastUpdatedDate&#39;)
     * @param {module:js_client.listingsitems_v2021_08_01.model/String} opts.sortOrder The order in which to sort the result items. (default to &#39;DESC&#39;)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.listingsitems_v2021_08_01.model/ItemSearchResults} and HTTP response
     */
     ...
     * @param {Number} opts.pageSize The number of results that you want to include on each page. (default to 10)
     * @param {String} opts.pageToken A token that you can use to fetch a specific page when there are multiple pages of results.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.listingsitems_v2021_08_01.model/ItemSearchResults}
     */
