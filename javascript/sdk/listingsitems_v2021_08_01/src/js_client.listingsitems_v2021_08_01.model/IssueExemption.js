 ...
 * @module js_client.listingsitems_v2021_08_01.model/IssueExemption
 * @version 2021-08-01
 */
export class IssueExemption {
   ...
   * @alias module:js_client.listingsitems_v2021_08_01.model/IssueExemption
   * @class
   * @param status {module:js_client.listingsitems_v2021_08_01.model/IssueExemption.StatusEnum} This field indicates the current exemption status for the listed enforcement actions. It can take values such as `EXEMPT`, signifying permanent exemption, `EXEMPT_UNTIL_EXPIRY_DATE` indicating temporary exemption until a specified date, or `NOT_EXEMPT` signifying no exemptions, and enforcement actions were already applied.
   */
  constructor(status) {
    this.status = status;
  }
   ...
   * @param {module:js_client.listingsitems_v2021_08_01.model/IssueExemption} obj Optional instance to populate.
   * @return {module:js_client.listingsitems_v2021_08_01.model/IssueExemption} The populated <code>IssueExemption</code> instance.
   */
 ...
 * @member {module:js_client.listingsitems_v2021_08_01.model/IssueExemption.StatusEnum} status
 */
