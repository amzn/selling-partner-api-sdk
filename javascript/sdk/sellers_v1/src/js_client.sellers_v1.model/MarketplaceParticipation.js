 ...
 * @module js_client.sellers_v1.model/MarketplaceParticipation
 * @version v1
 */
export class MarketplaceParticipation {
  /**
   * Constructs a new <code>MarketplaceParticipation</code>.
   * @alias module:js_client.sellers_v1.model/MarketplaceParticipation
   * @class
   * @param marketplace {module:js_client.sellers_v1.model/Marketplace} 
   * @param participation {module:js_client.sellers_v1.model/Participation} 
   ...
   * @param {module:js_client.sellers_v1.model/MarketplaceParticipation} obj Optional instance to populate.
   * @return {module:js_client.sellers_v1.model/MarketplaceParticipation} The populated <code>MarketplaceParticipation</code> instance.
   */
...
/**
 * @member {module:js_client.sellers_v1.model/Marketplace} marketplace
 */
MarketplaceParticipation.prototype.marketplace = undefined;

/**
 * @member {module:js_client.sellers_v1.model/Participation} participation
 */
