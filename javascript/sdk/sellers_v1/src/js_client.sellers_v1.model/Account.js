 ...
 * @module js_client.sellers_v1.model/Account
 * @version v1
 */
export class Account {
   ...
   * @alias module:js_client.sellers_v1.model/Account
   * @class
   * @param marketplaceParticipationList {Array.<module:js_client.sellers_v1.model/MarketplaceParticipation>} List of marketplace participations.
   * @param businessType {module:js_client.sellers_v1.model/Account.BusinessTypeEnum} The type of business registered for the seller account.
   * @param sellingPlan {module:js_client.sellers_v1.model/Account.SellingPlanEnum} The selling plan details.
   */
   ...
   * @param {module:js_client.sellers_v1.model/Account} obj Optional instance to populate.
   * @return {module:js_client.sellers_v1.model/Account} The populated <code>Account</code> instance.
   */
 ...
 * @member {Array.<module:js_client.sellers_v1.model/MarketplaceParticipation>} marketplaceParticipationList
 */
 ...
 * @member {module:js_client.sellers_v1.model/Account.BusinessTypeEnum} businessType
 */
 ...
 * @member {module:js_client.sellers_v1.model/Account.SellingPlanEnum} sellingPlan
 */
Account.prototype.sellingPlan = undefined;

/**
 * @member {module:js_client.sellers_v1.model/Business} business
 */
Account.prototype.business = undefined;

/**
 * @member {module:js_client.sellers_v1.model/PrimaryContact} primaryContact
 */
