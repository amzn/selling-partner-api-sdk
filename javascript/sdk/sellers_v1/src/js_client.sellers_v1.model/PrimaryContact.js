 ...
 * @module js_client.sellers_v1.model/PrimaryContact
 * @version v1
 */
export class PrimaryContact {
   ...
   * @alias module:js_client.sellers_v1.model/PrimaryContact
   * @class
   * @param name {String} The full name of the seller's primary contact.
   * @param address {module:js_client.sellers_v1.model/Address} 
   */
   ...
   * @param {module:js_client.sellers_v1.model/PrimaryContact} obj Optional instance to populate.
   * @return {module:js_client.sellers_v1.model/PrimaryContact} The populated <code>PrimaryContact</code> instance.
   */
...
/**
 * @member {module:js_client.sellers_v1.model/Address} address
 */
