 ...
 * @module js_client.sellers_v1.model/Business
 * @version v1
 */
export class Business {
   ...
   * @alias module:js_client.sellers_v1.model/Business
   * @class
   * @param name {String} The registered business name.
   * @param registeredBusinessAddress {module:js_client.sellers_v1.model/Address} 
   */
   ...
   * @param {module:js_client.sellers_v1.model/Business} obj Optional instance to populate.
   * @return {module:js_client.sellers_v1.model/Business} The populated <code>Business</code> instance.
   */
...
/**
 * @member {module:js_client.sellers_v1.model/Address} registeredBusinessAddress
 */
