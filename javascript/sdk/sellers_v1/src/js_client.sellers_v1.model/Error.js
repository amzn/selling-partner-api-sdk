 ...
 * @module js_client.sellers_v1.model/Error
 * @version v1
 */
export class Error {
  /**
   ...
   * @alias module:js_client.sellers_v1.model/Error
   * @class
   ...
   * @param {module:js_client.sellers_v1.model/Error} obj Optional instance to populate.
   * @return {module:js_client.sellers_v1.model/Error} The populated <code>Error</code> instance.
   */
