...
const modulePath = join(process.cwd(), 'src', 'financesinvoices_v2026_06_25', 'index.js');
...
describe('DefaultApi', () => {
  ...
  beforeEach(() => {
    ...
    instance = new TheSellingPartnerApiForInvoices.DefaultApi(apiClientInstance);
  });

  describe('getInvoice', () => {
    it('should successfully call getInvoiceWithHttpInfo', async () => {
      await instructBackendMock("default", "getInvoice", "200")
      const params = [
  ...
  describe('getInvoiceHeaders', () => {
    it('should successfully call getInvoiceHeadersWithHttpInfo', async () => {
      await instructBackendMock("default", "getInvoiceHeaders", "200")
      const params = [
        generateMockData('String'),
      ];
      const response = await instance.getInvoiceHeadersWithHttpInfo(...params);
  ...
  describe('constructor', () => {
    it('should use default ApiClient when none provided', () => {
      const defaultInstance = new TheSellingPartnerApiForInvoices.DefaultApi();
    ...
    it('should use provided ApiClient', () => {
      ...
      const customInstance = new TheSellingPartnerApiForInvoices.DefaultApi(customClient);
