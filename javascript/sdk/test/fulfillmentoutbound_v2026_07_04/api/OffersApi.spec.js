...
describe('OffersApi', () => {
  ...
  beforeEach(() => {
    ...
    instance = new TheSellingPartnerApiForFulfillmentOutbound.OffersApi(apiClientInstance);
  });
  ...
  describe('constructor', () => {
    it('should use default ApiClient when none provided', () => {
      const defaultInstance = new TheSellingPartnerApiForFulfillmentOutbound.OffersApi();
    ...
    it('should use provided ApiClient', () => {
      ...
      const customInstance = new TheSellingPartnerApiForFulfillmentOutbound.OffersApi(customClient);
