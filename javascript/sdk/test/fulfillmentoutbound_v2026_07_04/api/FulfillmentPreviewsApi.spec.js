...
describe('FulfillmentPreviewsApi', () => {
  let instance;

  beforeEach(() => {
    const apiClientInstance = new TheSellingPartnerApiForFulfillmentOutbound.ApiClient(endpoint);
    apiClientInstance.applyXAmzAccessTokenToRequest("testAccessToken");
    instance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentPreviewsApi(apiClientInstance);
  });
  ...
  describe('constructor', () => {
    it('should use default ApiClient when none provided', () => {
      const defaultInstance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentPreviewsApi();
    ...
    it('should use provided ApiClient', () => {
      ...
      const customInstance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentPreviewsApi(customClient);
