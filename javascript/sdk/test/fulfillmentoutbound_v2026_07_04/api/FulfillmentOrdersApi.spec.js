...
describe('FulfillmentOrdersApi', () => {
  let instance;

  beforeEach(() => {
    const apiClientInstance = new TheSellingPartnerApiForFulfillmentOutbound.ApiClient(endpoint);
    apiClientInstance.applyXAmzAccessTokenToRequest("testAccessToken");
    instance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentOrdersApi(apiClientInstance);
  });
  ...
  describe('constructor', () => {
    it('should use default ApiClient when none provided', () => {
      const defaultInstance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentOrdersApi();
    ...
    it('should use provided ApiClient', () => {
      ...
      const customInstance = new TheSellingPartnerApiForFulfillmentOutbound.FulfillmentOrdersApi(customClient);
