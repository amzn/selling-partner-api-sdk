 ...
 * @module js_client.fulfillmentinbound_v0.model/LabelDownloadURL
 * @version v0
 */
export class LabelDownloadURL {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/LabelDownloadURL
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/LabelDownloadURL} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/LabelDownloadURL} The populated <code>LabelDownloadURL</code> instance.
   */
