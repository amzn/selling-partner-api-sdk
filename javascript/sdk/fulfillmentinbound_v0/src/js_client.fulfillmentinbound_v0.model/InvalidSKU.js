 ...
 * @module js_client.fulfillmentinbound_v0.model/InvalidSKU
 * @version v0
 */
export class InvalidSKU {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/InvalidSKU
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/InvalidSKU} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/InvalidSKU} The populated <code>InvalidSKU</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/ErrorReason} errorReason
 */
