 ...
 * @module js_client.fulfillmentinbound_v0.model/SKUPrepInstructions
 * @version v0
 */
export class SKUPrepInstructions {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/SKUPrepInstructions
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/SKUPrepInstructions} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/SKUPrepInstructions} The populated <code>SKUPrepInstructions</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/BarcodeInstruction} barcodeInstruction
 */
SKUPrepInstructions.prototype.barcodeInstruction = undefined;

/**
 * @member {module:js_client.fulfillmentinbound_v0.model/PrepGuidance} prepGuidance
 */
SKUPrepInstructions.prototype.prepGuidance = undefined;

/**
 * A list of preparation instructions to help with item sourcing decisions.
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/PrepInstruction>} prepInstructionList
 */
SKUPrepInstructions.prototype.prepInstructionList = undefined;

/**
 * A list of preparation instructions and fees for Amazon to prep goods for shipment.
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/AmazonPrepFeesDetails>} amazonPrepFeesDetailsList
 */
