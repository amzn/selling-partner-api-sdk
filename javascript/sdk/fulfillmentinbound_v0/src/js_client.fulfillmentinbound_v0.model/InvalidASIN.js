 ...
 * @module js_client.fulfillmentinbound_v0.model/InvalidASIN
 * @version v0
 */
export class InvalidASIN {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/InvalidASIN
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/InvalidASIN} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/InvalidASIN} The populated <code>InvalidASIN</code> instance.
   */
