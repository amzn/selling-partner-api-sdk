 ...
 * @module js_client.fulfillmentinbound_v0.model/GetShipmentsResponse
 * @version v0
 */
export class GetShipmentsResponse {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/GetShipmentsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/GetShipmentsResponse} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/GetShipmentsResponse} The populated <code>GetShipmentsResponse</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/GetShipmentsResult} payload
 */
