 ...
 * @module js_client.fulfillmentinbound_v0.model/Address
 * @version v0
 */
export class Address {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/Address
   * @class
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/Address} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/Address} The populated <code>Address</code> instance.
   */
