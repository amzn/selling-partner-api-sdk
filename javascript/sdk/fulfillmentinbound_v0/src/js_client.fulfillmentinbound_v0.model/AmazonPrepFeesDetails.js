 ...
 * @module js_client.fulfillmentinbound_v0.model/AmazonPrepFeesDetails
 * @version v0
 */
export class AmazonPrepFeesDetails {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/AmazonPrepFeesDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/AmazonPrepFeesDetails} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/AmazonPrepFeesDetails} The populated <code>AmazonPrepFeesDetails</code> instance.
   */
