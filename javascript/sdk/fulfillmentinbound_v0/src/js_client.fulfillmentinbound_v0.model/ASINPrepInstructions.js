 ...
 * @module js_client.fulfillmentinbound_v0.model/ASINPrepInstructions
 * @version v0
 */
export class ASINPrepInstructions {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/ASINPrepInstructions
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/ASINPrepInstructions} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/ASINPrepInstructions} The populated <code>ASINPrepInstructions</code> instance.
   */
