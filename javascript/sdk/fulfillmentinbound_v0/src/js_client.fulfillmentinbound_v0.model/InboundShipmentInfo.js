 ...
 * @module js_client.fulfillmentinbound_v0.model/InboundShipmentInfo
 * @version v0
 */
export class InboundShipmentInfo {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/InboundShipmentInfo
   * @class
   * @param shipFromAddress {module:js_client.fulfillmentinbound_v0.model/Address} 
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/InboundShipmentInfo} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/InboundShipmentInfo} The populated <code>InboundShipmentInfo</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/Address} shipFromAddress
 */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/ShipmentStatus} shipmentStatus
 */
InboundShipmentInfo.prototype.shipmentStatus = undefined;

/**
 * @member {module:js_client.fulfillmentinbound_v0.model/LabelPrepType} labelPrepType
 */
...
/**
 * @member {module:js_client.fulfillmentinbound_v0.model/BoxContentsSource} boxContentsSource
 */
InboundShipmentInfo.prototype.boxContentsSource = undefined;

/**
 * @member {module:js_client.fulfillmentinbound_v0.model/BoxContentsFeeDetails} estimatedBoxContentsFee
 */
