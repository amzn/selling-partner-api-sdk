 ...
 * @module js_client.fulfillmentinbound_v0.model/GetPrepInstructionsResult
 * @version v0
 */
export class GetPrepInstructionsResult {
   ...
   * @alias module:js_client.fulfillmentinbound_v0.model/GetPrepInstructionsResult
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fulfillmentinbound_v0.model/GetPrepInstructionsResult} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v0.model/GetPrepInstructionsResult} The populated <code>GetPrepInstructionsResult</code> instance.
   */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/SKUPrepInstructions>} sKUPrepInstructionsList
 */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/InvalidSKU>} invalidSKUList
 */
GetPrepInstructionsResult.prototype.invalidSKUList = undefined;

/**
 * A list of item preparation instructions.
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/ASINPrepInstructions>} aSINPrepInstructionsList
 */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v0.model/InvalidASIN>} invalidASINList
 */
