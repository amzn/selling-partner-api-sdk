 ...
 * @module js_client.messaging_v1.model/GetMessagingActionResponse
 * @version v1
 */
export class GetMessagingActionResponse {
   ...
   * @alias module:js_client.messaging_v1.model/GetMessagingActionResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/GetMessagingActionResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/GetMessagingActionResponse} The populated <code>GetMessagingActionResponse</code> instance.
   */
...
/**
 * @member {module:js_client.messaging_v1.model/GetMessagingActionResponseLinks} links
 */
GetMessagingActionResponse.prototype.links = undefined;

/**
 * @member {module:js_client.messaging_v1.model/GetMessagingActionResponseEmbedded} embedded
 */
GetMessagingActionResponse.prototype.embedded = undefined;

/**
 * @member {module:js_client.messaging_v1.model/MessagingAction} payload
 */
