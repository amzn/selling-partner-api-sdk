 ...
 * @module js_client.messaging_v1.model/InvoiceRequest
 * @version v1
 */
export class InvoiceRequest {
   ...
   * @alias module:js_client.messaging_v1.model/InvoiceRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/InvoiceRequest} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/InvoiceRequest} The populated <code>InvoiceRequest</code> instance.
   */
