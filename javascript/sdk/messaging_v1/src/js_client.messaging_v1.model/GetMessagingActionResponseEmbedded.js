 ...
 * @module js_client.messaging_v1.model/GetMessagingActionResponseEmbedded
 * @version v1
 */
export class GetMessagingActionResponseEmbedded {
   ...
   * @alias module:js_client.messaging_v1.model/GetMessagingActionResponseEmbedded
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/GetMessagingActionResponseEmbedded} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/GetMessagingActionResponseEmbedded} The populated <code>GetMessagingActionResponseEmbedded</code> instance.
   */
...
/**
 * @member {module:js_client.messaging_v1.model/GetSchemaResponse} schema
 */
