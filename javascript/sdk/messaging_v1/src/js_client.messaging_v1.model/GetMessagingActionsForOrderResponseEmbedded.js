 ...
 * @module js_client.messaging_v1.model/GetMessagingActionsForOrderResponseEmbedded
 * @version v1
 */
export class GetMessagingActionsForOrderResponseEmbedded {
   ...
   * @alias module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseEmbedded
   * @class
   * @param actions {Array.<module:js_client.messaging_v1.model/GetMessagingActionResponse>} 
   */
  constructor(actions) {
   ...
   * @param {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseEmbedded} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseEmbedded} The populated <code>GetMessagingActionsForOrderResponseEmbedded</code> instance.
   */
...
/**
 * @member {Array.<module:js_client.messaging_v1.model/GetMessagingActionResponse>} actions
 */
