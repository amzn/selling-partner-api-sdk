 ...
 * @module js_client.messaging_v1.model/GetMessagingActionsForOrderResponseLinks
 * @version v1
 */
export class GetMessagingActionsForOrderResponseLinks {
   ...
   * @alias module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseLinks
   * @class
   * @param self {module:js_client.messaging_v1.model/LinkObject} 
   * @param actions {Array.<module:js_client.messaging_v1.model/LinkObject>} Eligible actions for the specified amazonOrderId.
   */
   ...
   * @param {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseLinks} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseLinks} The populated <code>GetMessagingActionsForOrderResponseLinks</code> instance.
   */
...
/**
 * @member {module:js_client.messaging_v1.model/LinkObject} self
 */
GetMessagingActionsForOrderResponseLinks.prototype.self = undefined;

/**
 * Eligible actions for the specified amazonOrderId.
 * @member {Array.<module:js_client.messaging_v1.model/LinkObject>} actions
 */
