 ...
 * @module js_client.messaging_v1.model/CreateConfirmOrderDetailsResponse
 * @version v1
 */
export class CreateConfirmOrderDetailsResponse {
   ...
   * @alias module:js_client.messaging_v1.model/CreateConfirmOrderDetailsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateConfirmOrderDetailsResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateConfirmOrderDetailsResponse} The populated <code>CreateConfirmOrderDetailsResponse</code> instance.
   */
