 ...
 * @module js_client.messaging_v1.model/CreateWarrantyRequest
 * @version v1
 */
export class CreateWarrantyRequest {
   ...
   * @alias module:js_client.messaging_v1.model/CreateWarrantyRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateWarrantyRequest} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateWarrantyRequest} The populated <code>CreateWarrantyRequest</code> instance.
   */
