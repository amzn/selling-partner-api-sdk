 ...
 * @module js_client.messaging_v1.model/CreateConfirmServiceDetailsResponse
 * @version v1
 */
export class CreateConfirmServiceDetailsResponse {
   ...
   * @alias module:js_client.messaging_v1.model/CreateConfirmServiceDetailsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateConfirmServiceDetailsResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateConfirmServiceDetailsResponse} The populated <code>CreateConfirmServiceDetailsResponse</code> instance.
   */
