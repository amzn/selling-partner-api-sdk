 ...
 * @module js_client.messaging_v1.model/CreateUnexpectedProblemRequest
 * @version v1
 */
export class CreateUnexpectedProblemRequest {
   ...
   * @alias module:js_client.messaging_v1.model/CreateUnexpectedProblemRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateUnexpectedProblemRequest} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateUnexpectedProblemRequest} The populated <code>CreateUnexpectedProblemRequest</code> instance.
   */
