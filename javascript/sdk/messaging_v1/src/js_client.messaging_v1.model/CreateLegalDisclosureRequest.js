 ...
 * @module js_client.messaging_v1.model/CreateLegalDisclosureRequest
 * @version v1
 */
export class CreateLegalDisclosureRequest {
   ...
   * @alias module:js_client.messaging_v1.model/CreateLegalDisclosureRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateLegalDisclosureRequest} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateLegalDisclosureRequest} The populated <code>CreateLegalDisclosureRequest</code> instance.
   */
