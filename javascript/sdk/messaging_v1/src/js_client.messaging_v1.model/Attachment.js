 ...
 * @module js_client.messaging_v1.model/Attachment
 * @version v1
 */
export class Attachment {
   ...
   * @alias module:js_client.messaging_v1.model/Attachment
   * @class
   ...
   * @param {module:js_client.messaging_v1.model/Attachment} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/Attachment} The populated <code>Attachment</code> instance.
   */
