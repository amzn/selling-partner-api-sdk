 ...
 * @module js_client.messaging_v1.model/CreateConfirmCustomizationDetailsRequest
 * @version v1
 */
export class CreateConfirmCustomizationDetailsRequest {
   ...
   * @alias module:js_client.messaging_v1.model/CreateConfirmCustomizationDetailsRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateConfirmCustomizationDetailsRequest} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateConfirmCustomizationDetailsRequest} The populated <code>CreateConfirmCustomizationDetailsRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.messaging_v1.model/Attachment>} attachments
 */
