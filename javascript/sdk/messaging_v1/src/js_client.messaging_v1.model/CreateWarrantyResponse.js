 ...
 * @module js_client.messaging_v1.model/CreateWarrantyResponse
 * @version v1
 */
export class CreateWarrantyResponse {
   ...
   * @alias module:js_client.messaging_v1.model/CreateWarrantyResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateWarrantyResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateWarrantyResponse} The populated <code>CreateWarrantyResponse</code> instance.
   */
