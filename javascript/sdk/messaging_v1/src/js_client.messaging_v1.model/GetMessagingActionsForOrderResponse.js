 ...
 * @module js_client.messaging_v1.model/GetMessagingActionsForOrderResponse
 * @version v1
 */
export class GetMessagingActionsForOrderResponse {
   ...
   * @alias module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponse} The populated <code>GetMessagingActionsForOrderResponse</code> instance.
   */
...
/**
 * @member {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseLinks} links
 */
GetMessagingActionsForOrderResponse.prototype.links = undefined;

/**
 * @member {module:js_client.messaging_v1.model/GetMessagingActionsForOrderResponseEmbedded} embedded
 */
