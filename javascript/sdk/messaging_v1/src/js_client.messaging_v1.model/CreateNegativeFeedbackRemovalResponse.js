 ...
 * @module js_client.messaging_v1.model/CreateNegativeFeedbackRemovalResponse
 * @version v1
 */
export class CreateNegativeFeedbackRemovalResponse {
   ...
   * @alias module:js_client.messaging_v1.model/CreateNegativeFeedbackRemovalResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.messaging_v1.model/CreateNegativeFeedbackRemovalResponse} obj Optional instance to populate.
   * @return {module:js_client.messaging_v1.model/CreateNegativeFeedbackRemovalResponse} The populated <code>CreateNegativeFeedbackRemovalResponse</code> instance.
   */
