...
(function(root, factory) {
  ...
  describe('CreateUnexpectedProblemRequest', function() {
    it('should create an instance of CreateUnexpectedProblemRequest', function() {
      // uncomment below and update the code to test CreateUnexpectedProblemRequest
      //var instance = new SellingPartnerApiForMessaging.CreateUnexpectedProblemRequest();
