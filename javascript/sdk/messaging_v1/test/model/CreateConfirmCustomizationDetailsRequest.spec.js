...
(function(root, factory) {
  ...
  describe('CreateConfirmCustomizationDetailsRequest', function() {
    it('should create an instance of CreateConfirmCustomizationDetailsRequest', function() {
      // uncomment below and update the code to test CreateConfirmCustomizationDetailsRequest
      //var instance = new SellingPartnerApiForMessaging.CreateConfirmCustomizationDetailsRequest();
