 ...
 * @module js_client.invoicing_v0.model/ShipmentInvoiceStatusInfo
 * @version v0
 */
export class ShipmentInvoiceStatusInfo {
   ...
   * @alias module:js_client.invoicing_v0.model/ShipmentInvoiceStatusInfo
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.invoicing_v0.model/ShipmentInvoiceStatusInfo} obj Optional instance to populate.
   * @return {module:js_client.invoicing_v0.model/ShipmentInvoiceStatusInfo} The populated <code>ShipmentInvoiceStatusInfo</code> instance.
   */
...
/**
 * @member {module:js_client.invoicing_v0.model/ShipmentInvoiceStatus} invoiceStatus
 */
