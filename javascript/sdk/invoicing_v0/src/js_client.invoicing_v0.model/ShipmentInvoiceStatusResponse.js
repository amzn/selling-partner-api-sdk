 ...
 * @module js_client.invoicing_v0.model/ShipmentInvoiceStatusResponse
 * @version v0
 */
export class ShipmentInvoiceStatusResponse {
   ...
   * @alias module:js_client.invoicing_v0.model/ShipmentInvoiceStatusResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.invoicing_v0.model/ShipmentInvoiceStatusResponse} obj Optional instance to populate.
   * @return {module:js_client.invoicing_v0.model/ShipmentInvoiceStatusResponse} The populated <code>ShipmentInvoiceStatusResponse</code> instance.
   */
...
/**
 * @member {module:js_client.invoicing_v0.model/ShipmentInvoiceStatusInfo} shipments
 */
