 ...
 * @module js_client.invoicing_v0.model/SubmitInvoiceRequest
 * @version v0
 */
export class SubmitInvoiceRequest {
   ...
   * @alias module:js_client.invoicing_v0.model/SubmitInvoiceRequest
   * @class
   ...
   * @param {module:js_client.invoicing_v0.model/SubmitInvoiceRequest} obj Optional instance to populate.
   * @return {module:js_client.invoicing_v0.model/SubmitInvoiceRequest} The populated <code>SubmitInvoiceRequest</code> instance.
   */
