 ...
 * @module js_client.invoicing_v0.model/ShipmentDetail
 * @version v0
 */
export class ShipmentDetail {
   ...
   * @alias module:js_client.invoicing_v0.model/ShipmentDetail
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.invoicing_v0.model/ShipmentDetail} obj Optional instance to populate.
   * @return {module:js_client.invoicing_v0.model/ShipmentDetail} The populated <code>ShipmentDetail</code> instance.
   */
...
/**
 * @member {module:js_client.invoicing_v0.model/Address} shippingAddress
 */
...
/**
 * @member {module:js_client.invoicing_v0.model/BuyerTaxInfo} buyerTaxInfo
 */
ShipmentDetail.prototype.buyerTaxInfo = undefined;

/**
 * @member {module:js_client.invoicing_v0.model/MarketplaceTaxInfo} marketplaceTaxInfo
 */
 ...
 * @member {Array.<module:js_client.invoicing_v0.model/ShipmentItem>} shipmentItems
 */
