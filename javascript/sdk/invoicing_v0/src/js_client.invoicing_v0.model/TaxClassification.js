 ...
 * @module js_client.invoicing_v0.model/TaxClassification
 * @version v0
 */
export class TaxClassification {
   ...
   * @alias module:js_client.invoicing_v0.model/TaxClassification
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.invoicing_v0.model/TaxClassification} obj Optional instance to populate.
   * @return {module:js_client.invoicing_v0.model/TaxClassification} The populated <code>TaxClassification</code> instance.
   */
