 ...
 * @module js_client.merchantfulfillment_v0.model/FileContents
 * @version v0
 */
export class FileContents {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/FileContents
   * @class
   * @param contents {String} Data for printing labels encoded into a Base64, GZip-compressed string.
   * @param fileType {module:js_client.merchantfulfillment_v0.model/FileType} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/FileContents} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/FileContents} The populated <code>FileContents</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/FileType} fileType
 */
