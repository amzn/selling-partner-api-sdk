 ...
 * @module js_client.merchantfulfillment_v0.model/GetEligibleShipmentServicesRequest
 * @version v0
 */
export class GetEligibleShipmentServicesRequest {
   ...
   * Request schema.
   * @alias module:js_client.merchantfulfillment_v0.model/GetEligibleShipmentServicesRequest
   * @class
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/GetEligibleShipmentServicesRequest} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/GetEligibleShipmentServicesRequest} The populated <code>GetEligibleShipmentServicesRequest</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/ShippingOfferingFilter} shippingOfferingFilter
 */
