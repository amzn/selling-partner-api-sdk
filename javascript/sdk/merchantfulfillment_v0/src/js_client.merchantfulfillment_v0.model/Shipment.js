 ...
 * @module js_client.merchantfulfillment_v0.model/Shipment
 * @version v0
 */
export class Shipment {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/Shipment
   * @class
   ...
   * @param itemList {Array.<module:js_client.merchantfulfillment_v0.model/Item>} The list of items you want to include in a shipment.
   * @param shipFromAddress {module:js_client.merchantfulfillment_v0.model/Address} 
   * @param shipToAddress {module:js_client.merchantfulfillment_v0.model/Address} 
   * @param packageDimensions {module:js_client.merchantfulfillment_v0.model/PackageDimensions} 
   * @param weight {module:js_client.merchantfulfillment_v0.model/Weight} 
   * @param insurance {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} 
   * @param shippingService {module:js_client.merchantfulfillment_v0.model/ShippingService} 
   * @param label {module:js_client.merchantfulfillment_v0.model/Label} 
   * @param status {module:js_client.merchantfulfillment_v0.model/ShipmentStatus} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/Shipment} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/Shipment} The populated <code>Shipment</code> instance.
   */
 ...
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/Item>} itemList
 */
Shipment.prototype.itemList = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Address} shipFromAddress
 */
Shipment.prototype.shipFromAddress = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Address} shipToAddress
 */
Shipment.prototype.shipToAddress = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/PackageDimensions} packageDimensions
 */
Shipment.prototype.packageDimensions = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Weight} weight
 */
Shipment.prototype.weight = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} insurance
 */
Shipment.prototype.insurance = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/ShippingService} shippingService
 */
Shipment.prototype.shippingService = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Label} label
 */
Shipment.prototype.label = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/ShipmentStatus} status
 */
