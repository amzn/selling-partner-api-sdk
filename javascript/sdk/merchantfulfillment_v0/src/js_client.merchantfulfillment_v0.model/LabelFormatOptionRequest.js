 ...
 * @module js_client.merchantfulfillment_v0.model/LabelFormatOptionRequest
 * @version v0
 */
export class LabelFormatOptionRequest {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/LabelFormatOptionRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/LabelFormatOptionRequest} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/LabelFormatOptionRequest} The populated <code>LabelFormatOptionRequest</code> instance.
   */
