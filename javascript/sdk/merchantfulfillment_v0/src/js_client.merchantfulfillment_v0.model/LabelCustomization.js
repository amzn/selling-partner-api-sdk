 ...
 * @module js_client.merchantfulfillment_v0.model/LabelCustomization
 * @version v0
 */
export class LabelCustomization {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/LabelCustomization
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/LabelCustomization} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/LabelCustomization} The populated <code>LabelCustomization</code> instance.
   */
