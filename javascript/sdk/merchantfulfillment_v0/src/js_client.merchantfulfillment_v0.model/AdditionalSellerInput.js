 ...
 * @module js_client.merchantfulfillment_v0.model/AdditionalSellerInput
 * @version v0
 */
export class AdditionalSellerInput {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} The populated <code>AdditionalSellerInput</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/Address} valueAsAddress
 */
AdditionalSellerInput.prototype.valueAsAddress = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Weight} valueAsWeight
 */
AdditionalSellerInput.prototype.valueAsWeight = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/Length} valueAsDimension
 */
AdditionalSellerInput.prototype.valueAsDimension = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} valueAsCurrency
 */
