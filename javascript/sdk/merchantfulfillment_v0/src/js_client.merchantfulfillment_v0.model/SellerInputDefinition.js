 ...
 * @module js_client.merchantfulfillment_v0.model/SellerInputDefinition
 * @version v0
 */
export class SellerInputDefinition {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/SellerInputDefinition
   * @class
   ...
   * @param constraints {Array.<module:js_client.merchantfulfillment_v0.model/Constraint>} List of constraints.
   * @param inputDisplayText {String} The display text for the additional input field.
   * @param storedValue {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} 
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/SellerInputDefinition} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/SellerInputDefinition} The populated <code>SellerInputDefinition</code> instance.
   */
...
/**
 * List of constraints.
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/Constraint>} constraints
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/InputTargetType} inputTarget
 */
SellerInputDefinition.prototype.inputTarget = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} storedValue
 */
