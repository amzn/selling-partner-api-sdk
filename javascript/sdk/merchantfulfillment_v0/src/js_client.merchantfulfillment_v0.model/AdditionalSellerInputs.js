 ...
 * @module js_client.merchantfulfillment_v0.model/AdditionalSellerInputs
 * @version v0
 */
export class AdditionalSellerInputs {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/AdditionalSellerInputs
   * @class
   * @param additionalInputFieldName {String} The name of the additional input field.
   * @param additionalSellerInput {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} 
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInputs} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInputs} The populated <code>AdditionalSellerInputs</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/AdditionalSellerInput} additionalSellerInput
 */
