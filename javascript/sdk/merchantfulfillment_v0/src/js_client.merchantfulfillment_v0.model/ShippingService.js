 ...
 * @module js_client.merchantfulfillment_v0.model/ShippingService
 * @version v0
 */
export class ShippingService {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/ShippingService
   * @class
   ...
   * @param rate {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/ShippingService} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/ShippingService} The populated <code>ShippingService</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} rate
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/AvailableShippingServiceOptions} availableShippingServiceOptions
 */
ShippingService.prototype.availableShippingServiceOptions = undefined;

/**
 * List of label formats.
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/LabelFormat>} availableLabelFormats
 */
ShippingService.prototype.availableLabelFormats = undefined;

/**
 * The available label formats.
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/LabelFormatOption>} availableFormatOptionsForLabel
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/Benefits} benefits
 */
