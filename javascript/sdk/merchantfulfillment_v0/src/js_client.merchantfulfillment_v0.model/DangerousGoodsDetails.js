 ...
 * @module js_client.merchantfulfillment_v0.model/DangerousGoodsDetails
 * @version v0
 */
export class DangerousGoodsDetails {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails} The populated <code>DangerousGoodsDetails</code> instance.
   */
 ...
 * @member {module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails.PackingGroupEnum} packingGroup
 */
 ...
 * @member {module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails.PackingInstructionEnum} packingInstruction
 */
