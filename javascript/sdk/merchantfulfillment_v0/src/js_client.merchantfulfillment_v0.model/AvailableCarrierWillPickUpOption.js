 ...
 * @module js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption
 * @version v0
 */
export class AvailableCarrierWillPickUpOption {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption
   * @class
   * @param carrierWillPickUpOption {module:js_client.merchantfulfillment_v0.model/CarrierWillPickUpOption} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption} The populated <code>AvailableCarrierWillPickUpOption</code> instance.
   */
