 ...
 * @module js_client.merchantfulfillment_v0.model/Benefits
 * @version v0
 */
export class Benefits {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/Benefits
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/Benefits} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/Benefits} The populated <code>Benefits</code> instance.
   */
 ...
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/ExcludedBenefit>} excludedBenefits
 */
