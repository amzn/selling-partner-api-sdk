 ...
 * @module js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsResponse
 * @version v0
 */
export class GetAdditionalSellerInputsResponse {
   ...
   * Response schema.
   * @alias module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsResponse} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsResponse} The populated <code>GetAdditionalSellerInputsResponse</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsResult} payload
 */
