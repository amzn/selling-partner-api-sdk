 ...
 * @module js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption
 * @version v0
 */
export class AvailableDeliveryExperienceOption {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption
   * @class
   * @param deliveryExperienceOption {module:js_client.merchantfulfillment_v0.model/DeliveryExperienceOption} 
   * @param charge {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} 
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption} The populated <code>AvailableDeliveryExperienceOption</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/DeliveryExperienceOption} deliveryExperienceOption
 */
AvailableDeliveryExperienceOption.prototype.deliveryExperienceOption = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} charge
 */
