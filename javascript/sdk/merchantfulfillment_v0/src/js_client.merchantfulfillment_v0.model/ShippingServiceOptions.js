 ...
 * @module js_client.merchantfulfillment_v0.model/ShippingServiceOptions
 * @version v0
 */
export class ShippingServiceOptions {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/ShippingServiceOptions
   * @class
   * @param deliveryExperience {module:js_client.merchantfulfillment_v0.model/DeliveryExperienceType} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/ShippingServiceOptions} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/ShippingServiceOptions} The populated <code>ShippingServiceOptions</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/DeliveryExperienceType} deliveryExperience
 */
ShippingServiceOptions.prototype.deliveryExperience = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/CurrencyAmount} declaredValue
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/CarrierWillPickUpOption} carrierWillPickUpOption
 */
ShippingServiceOptions.prototype.carrierWillPickUpOption = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/LabelFormat} labelFormat
 */
