 ...
 * @module js_client.merchantfulfillment_v0.model/ShippingOfferingFilter
 * @version v0
 */
export class ShippingOfferingFilter {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/ShippingOfferingFilter
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/ShippingOfferingFilter} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/ShippingOfferingFilter} The populated <code>ShippingOfferingFilter</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/CarrierWillPickUpOption} carrierWillPickUp
 */
ShippingOfferingFilter.prototype.carrierWillPickUp = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/DeliveryExperienceOption} deliveryExperience
 */
