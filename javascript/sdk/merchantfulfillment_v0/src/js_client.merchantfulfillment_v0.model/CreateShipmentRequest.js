 ...
 * @module js_client.merchantfulfillment_v0.model/CreateShipmentRequest
 * @version v0
 */
export class CreateShipmentRequest {
   ...
   * Request schema.
   * @alias module:js_client.merchantfulfillment_v0.model/CreateShipmentRequest
   * @class
   * @param shipmentRequestDetails {module:js_client.merchantfulfillment_v0.model/ShipmentRequestDetails} 
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/CreateShipmentRequest} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/CreateShipmentRequest} The populated <code>CreateShipmentRequest</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/ShipmentRequestDetails} shipmentRequestDetails
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/HazmatType} hazmatType
 */
CreateShipmentRequest.prototype.hazmatType = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/LabelFormatOptionRequest} labelFormatOption
 */
CreateShipmentRequest.prototype.labelFormatOption = undefined;

/**
 * A list of additional seller input pairs required to purchase shipping.
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/AdditionalSellerInputs>} shipmentLevelSellerInputsList
 */
