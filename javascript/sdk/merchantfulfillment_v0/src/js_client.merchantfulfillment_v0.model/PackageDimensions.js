 ...
 * @module js_client.merchantfulfillment_v0.model/PackageDimensions
 * @version v0
 */
export class PackageDimensions {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/PackageDimensions
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/PackageDimensions} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/PackageDimensions} The populated <code>PackageDimensions</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/UnitOfLength} unit
 */
PackageDimensions.prototype.unit = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/PredefinedPackageDimensions} predefinedPackageDimensions
 */
