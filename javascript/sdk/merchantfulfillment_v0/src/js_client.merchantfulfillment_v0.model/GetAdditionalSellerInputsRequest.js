 ...
 * @module js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsRequest
 * @version v0
 */
export class GetAdditionalSellerInputsRequest {
   ...
   * Request schema.
   * @alias module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsRequest
   * @class
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsRequest} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/GetAdditionalSellerInputsRequest} The populated <code>GetAdditionalSellerInputsRequest</code> instance.
   */
