 ...
 * @module js_client.merchantfulfillment_v0.model/Label
 * @version v0
 */
export class Label {
  /**
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/Label
   * @class
   * @param dimensions {module:js_client.merchantfulfillment_v0.model/LabelDimensions} 
   * @param fileContents {module:js_client.merchantfulfillment_v0.model/FileContents} 
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/Label} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/Label} The populated <code>Label</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/LabelDimensions} dimensions
 */
Label.prototype.dimensions = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/FileContents} fileContents
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/StandardIdForLabel} standardIdForLabel
 */
