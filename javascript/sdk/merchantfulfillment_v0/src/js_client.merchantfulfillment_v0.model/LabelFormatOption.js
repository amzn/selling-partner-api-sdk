 ...
 * @module js_client.merchantfulfillment_v0.model/LabelFormatOption
 * @version v0
 */
export class LabelFormatOption {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/LabelFormatOption
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/LabelFormatOption} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/LabelFormatOption} The populated <code>LabelFormatOption</code> instance.
   */
