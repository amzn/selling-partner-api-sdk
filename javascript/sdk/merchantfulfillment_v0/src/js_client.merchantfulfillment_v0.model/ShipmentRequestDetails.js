 ...
 * @module js_client.merchantfulfillment_v0.model/ShipmentRequestDetails
 * @version v0
 */
export class ShipmentRequestDetails {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/ShipmentRequestDetails
   * @class
   ...
   * @param shippingServiceOptions {module:js_client.merchantfulfillment_v0.model/ShippingServiceOptions} 
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/ShipmentRequestDetails} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/ShipmentRequestDetails} The populated <code>ShipmentRequestDetails</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/ShippingServiceOptions} shippingServiceOptions
 */
ShipmentRequestDetails.prototype.shippingServiceOptions = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/LabelCustomization} labelCustomization
 */
