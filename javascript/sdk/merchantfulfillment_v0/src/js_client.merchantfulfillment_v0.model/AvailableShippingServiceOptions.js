 ...
 * @module js_client.merchantfulfillment_v0.model/AvailableShippingServiceOptions
 * @version v0
 */
export class AvailableShippingServiceOptions {
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/AvailableShippingServiceOptions
   * @class
   * @param availableCarrierWillPickUpOptions {Array.<module:js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption>} List of available carrier pickup options.
   * @param availableDeliveryExperienceOptions {Array.<module:js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption>} List of available delivery experience options.
   */
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/AvailableShippingServiceOptions} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/AvailableShippingServiceOptions} The populated <code>AvailableShippingServiceOptions</code> instance.
   */
 ...
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/AvailableCarrierWillPickUpOption>} availableCarrierWillPickUpOptions
 */
 ...
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/AvailableDeliveryExperienceOption>} availableDeliveryExperienceOptions
 */
