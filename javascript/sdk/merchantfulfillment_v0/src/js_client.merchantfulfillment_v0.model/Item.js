 ...
 * @module js_client.merchantfulfillment_v0.model/Item
 * @version v0
 */
export class Item {
  /**
   ...
   * @alias module:js_client.merchantfulfillment_v0.model/Item
   * @class
   ...
   * @param {module:js_client.merchantfulfillment_v0.model/Item} obj Optional instance to populate.
   * @return {module:js_client.merchantfulfillment_v0.model/Item} The populated <code>Item</code> instance.
   */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/Weight} itemWeight
 */
 ...
 * @member {Array.<module:js_client.merchantfulfillment_v0.model/AdditionalSellerInputs>} itemLevelSellerInputsList
 */
Item.prototype.itemLevelSellerInputsList = undefined;

/**
 * @member {module:js_client.merchantfulfillment_v0.model/LiquidVolume} liquidVolume
 */
...
/**
 * @member {module:js_client.merchantfulfillment_v0.model/DangerousGoodsDetails} dangerousGoodsDetails
 */
