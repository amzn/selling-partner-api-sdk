...
(function(root, factory) {
  ...
  describe('ParkingWithAddressConfiguration', function() {
    it('should create an instance of ParkingWithAddressConfiguration', function() {
      // uncomment below and update the code to test ParkingWithAddressConfiguration
      //var instance = new SellingPartnerApiForSupplySources.ParkingWithAddressConfiguration();
