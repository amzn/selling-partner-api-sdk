...
(function(root, factory) {
  ...
  describe('GetSupplySourcesResponse', function() {
    it('should create an instance of GetSupplySourcesResponse', function() {
      // uncomment below and update the code to test GetSupplySourcesResponse
      //var instance = new SellingPartnerApiForSupplySources.GetSupplySourcesResponse();
    ...
    it('should have the property supplySources (base name: "supplySources")', function() {
      // uncomment below and update the code to test the property supplySources
      //var instance = new SellingPartnerApiForSupplySources.GetSupplySourcesResponse();
