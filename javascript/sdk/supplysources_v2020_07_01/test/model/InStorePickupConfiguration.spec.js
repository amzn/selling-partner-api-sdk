...
(function(root, factory) {
  ...
  describe('InStorePickupConfiguration', function() {
    it('should create an instance of InStorePickupConfiguration', function() {
      // uncomment below and update the code to test InStorePickupConfiguration
      //var instance = new SellingPartnerApiForSupplySources.InStorePickupConfiguration();
    ...
    it('should have the property parkingConfiguration (base name: "parkingConfiguration")', function() {
      // uncomment below and update the code to test the property parkingConfiguration
      //var instance = new SellingPartnerApiForSupplySources.InStorePickupConfiguration();
      //expect(instance).to.be();
    });
