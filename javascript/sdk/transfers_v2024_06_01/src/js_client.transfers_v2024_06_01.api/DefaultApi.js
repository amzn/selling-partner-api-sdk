...
/**
* Default service.
* @module js_client.transfers_v2024_06_01.api/DefaultApi
* @version 2024-06-01
*/
export class DefaultApi {
    ...
    * @alias module:js_client.transfers_v2024_06_01.api/DefaultApi
    * @class
    ...
    */
     ...
     * @param {Array.<module:js_client.transfers_v2024_06_01.model/String>} opts.paymentMethodTypes A comma-separated list of the payment method types you want to include in the response.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.transfers_v2024_06_01.model/GetPaymentMethodsResponse} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:js_client.transfers_v2024_06_01.model/String>} opts.paymentMethodTypes A comma-separated list of the payment method types you want to include in the response.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.transfers_v2024_06_01.model/GetPaymentMethodsResponse}
     */
     ...
     * @param {module:js_client.transfers_v2024_06_01.model/InitiatePayoutRequest} body The request body for the &#x60;initiatePayout&#x60; operation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.transfers_v2024_06_01.model/InitiatePayoutResponse} and HTTP response
     */
     ...
     * Initiates an on-demand payout to the seller&#39;s default deposit method in Seller Central for the given &#x60;marketplaceId&#x60; and &#x60;accountType&#x60;, if eligible. You can only initiate one on-demand payout for each marketplace and account type within a 24-hour period.   **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.017 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the operation, when available. The preceding table contains the default rate and burst values for this operation. Selling partners whose business demands require higher throughput might have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {module:js_client.transfers_v2024_06_01.model/InitiatePayoutRequest} body The request body for the &#x60;initiatePayout&#x60; operation.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.transfers_v2024_06_01.model/InitiatePayoutResponse}
     */
    initiatePayout(body) {
