 ...
 * @module js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentOrderResult
 * @version 2020-07-01
 */
export class GetFulfillmentOrderResult {
   ...
   * @alias module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentOrderResult
   * @class
   * @param fulfillmentOrder {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentOrder} 
   * @param fulfillmentOrderItems {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentOrderItem>} An array of fulfillment order item information.
   * @param returnItems {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/ReturnItem>} An array of items that Amazon accepted for return. Returns empty if no items were accepted for return.
   * @param returnAuthorizations {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/ReturnAuthorization>} An array of return authorization information.
   */
   ...
   * @param {module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentOrderResult} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentOrderResult} The populated <code>GetFulfillmentOrderResult</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentOrder} fulfillmentOrder
 */
GetFulfillmentOrderResult.prototype.fulfillmentOrder = undefined;

/**
 * An array of fulfillment order item information.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentOrderItem>} fulfillmentOrderItems
 */
GetFulfillmentOrderResult.prototype.fulfillmentOrderItems = undefined;

/**
 * An array of fulfillment shipment information.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment>} fulfillmentShipments
 */
GetFulfillmentOrderResult.prototype.fulfillmentShipments = undefined;

/**
 * An array of items that Amazon accepted for return. Returns empty if no items were accepted for return.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/ReturnItem>} returnItems
 */
GetFulfillmentOrderResult.prototype.returnItems = undefined;

/**
 * An array of return authorization information.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/ReturnAuthorization>} returnAuthorizations
 */
