 ...
 * @module js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation
 * @version 2020-07-01
 */
export class DropOffLocation {
   ...
   * @alias module:js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation
   * @class
   * @param type {module:js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation.TypeEnum} Specifies the preferred location to leave the package at the destination address.
   */
  constructor(type) {
    this.type = type;
  }
   ...
   * @param {module:js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation} The populated <code>DropOffLocation</code> instance.
   */
 ...
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/DropOffLocation.TypeEnum} type
 */
