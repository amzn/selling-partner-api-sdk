 ...
 * @module js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewRequest
 * @version 2020-07-01
 */
export class GetFulfillmentPreviewRequest {
   ...
   * @alias module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewRequest
   * @class
   * @param address {module:js_client.fulfillmentoutbound_v2020_07_01.model/Address} 
   * @param items {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewItem>} An array of fulfillment preview item information.
   */
   ...
   * @param {module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewRequest} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewRequest} The populated <code>GetFulfillmentPreviewRequest</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/Address} address
 */
GetFulfillmentPreviewRequest.prototype.address = undefined;

/**
 * An array of fulfillment preview item information.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/GetFulfillmentPreviewItem>} items
 */
GetFulfillmentPreviewRequest.prototype.items = undefined;

/**
 * ShippingSpeedCategory List
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/ShippingSpeedCategory>} shippingSpeedCategories
 */
