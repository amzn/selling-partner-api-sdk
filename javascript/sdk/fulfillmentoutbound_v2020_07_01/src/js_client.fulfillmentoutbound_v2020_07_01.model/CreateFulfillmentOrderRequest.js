 ...
 * @module js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderRequest
 * @version 2020-07-01
 */
export class CreateFulfillmentOrderRequest {
   ...
   * @alias module:js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderRequest
   * @class
   ...
   * @param shippingSpeedCategory {module:js_client.fulfillmentoutbound_v2020_07_01.model/ShippingSpeedCategory} 
   * @param destinationAddress {module:js_client.fulfillmentoutbound_v2020_07_01.model/Address} 
   * @param items {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderItem>} An array of item information for creating a fulfillment order.
   */
   ...
   * @param {module:js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderRequest} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderRequest} The populated <code>CreateFulfillmentOrderRequest</code> instance.
   */
...
/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/ShippingSpeedCategory} shippingSpeedCategory
 */
CreateFulfillmentOrderRequest.prototype.shippingSpeedCategory = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/DeliveryWindow} deliveryWindow
 */
CreateFulfillmentOrderRequest.prototype.deliveryWindow = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/Address} destinationAddress
 */
CreateFulfillmentOrderRequest.prototype.destinationAddress = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/DeliveryPreferences} deliveryPreferences
 */
CreateFulfillmentOrderRequest.prototype.deliveryPreferences = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentAction} fulfillmentAction
 */
CreateFulfillmentOrderRequest.prototype.fulfillmentAction = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentPolicy} fulfillmentPolicy
 */
CreateFulfillmentOrderRequest.prototype.fulfillmentPolicy = undefined;

/**
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/CODSettings} codSettings
 */
 ...
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FeatureSettings>} featureConstraints
 */
 ...
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/CreateFulfillmentOrderItem>} items
 */
 ...
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/PaymentInformation>} paymentInformation
 */
