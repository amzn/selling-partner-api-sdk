 ...
 * @module js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment
 * @version 2020-07-01
 */
export class FulfillmentShipment {
   ...
   * @alias module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment
   * @class
   ...
   * @param fulfillmentShipmentStatus {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment.FulfillmentShipmentStatusEnum} The current status of the shipment.
   * @param fulfillmentShipmentItem {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipmentItem>} An array of fulfillment shipment item information.
   */
   ...
   * @param {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment} The populated <code>FulfillmentShipment</code> instance.
   */
 ...
 * @member {module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipment.FulfillmentShipmentStatusEnum} fulfillmentShipmentStatus
 */
 ...
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipmentItem>} fulfillmentShipmentItem
 */
FulfillmentShipment.prototype.fulfillmentShipmentItem = undefined;

/**
 * An array of fulfillment shipment package information.
 * @member {Array.<module:js_client.fulfillmentoutbound_v2020_07_01.model/FulfillmentShipmentPackage>} fulfillmentShipmentPackage
 */
