...
(function(root, factory) {
  ...
  describe('GetDeliveryOffersProduct', function() {
    it('should create an instance of GetDeliveryOffersProduct', function() {
      // uncomment below and update the code to test GetDeliveryOffersProduct
      //var instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersProduct();
