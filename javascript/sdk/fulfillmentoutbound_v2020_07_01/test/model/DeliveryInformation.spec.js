...
(function(root, factory) {
  ...
  describe('DeliveryInformation', function() {
    it('should create an instance of DeliveryInformation', function() {
      // uncomment below and update the code to test DeliveryInformation
      //var instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryInformation();
    ...
    it('should have the property deliveryDocumentList (base name: "deliveryDocumentList")', function() {
      // uncomment below and update the code to test the property deliveryDocumentList
      //var instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryInformation();
