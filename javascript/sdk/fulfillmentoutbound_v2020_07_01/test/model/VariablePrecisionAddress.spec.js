...
(function(root, factory) {
  ...
  describe('VariablePrecisionAddress', function() {
    it('should create an instance of VariablePrecisionAddress', function() {
      // uncomment below and update the code to test VariablePrecisionAddress
      //var instance = new SellingPartnerApisForFulfillmentOutbound.VariablePrecisionAddress();
