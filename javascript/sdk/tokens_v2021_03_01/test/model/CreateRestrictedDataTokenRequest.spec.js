...
(function(root, factory) {
  ...
  describe('CreateRestrictedDataTokenRequest', function() {
    it('should create an instance of CreateRestrictedDataTokenRequest', function() {
      // uncomment below and update the code to test CreateRestrictedDataTokenRequest
      //var instance = new SellingPartnerApiForTokens.CreateRestrictedDataTokenRequest();
    ...
    it('should have the property targetApplication (base name: "targetApplication")', function() {
      // uncomment below and update the code to test the property targetApplication
      //var instance = new SellingPartnerApiForTokens.CreateRestrictedDataTokenRequest();
      //expect(instance).to.be();
    });

    it('should have the property restrictedResources (base name: "restrictedResources")', function() {
      // uncomment below and update the code to test the property restrictedResources
      //var instance = new SellingPartnerApiForTokens.CreateRestrictedDataTokenRequest();
      //expect(instance).to.be();
    });
