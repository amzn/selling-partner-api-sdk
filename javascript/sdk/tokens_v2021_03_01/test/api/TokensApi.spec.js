...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForTokens.TokensApi();
  });
  ...
  describe('TokensApi', function() {
    describe('createRestrictedDataToken', function() {
      it('should call createRestrictedDataToken successfully', function(done) {
        //uncomment below and update the code to test createRestrictedDataToken
        //instance.createRestrictedDataToken(function(error) {
