# SellingPartnerApiForTokens.TokensApi
...
```javascript
import SellingPartnerApiForTokens from 'selling_partner_api_for_tokens_';

let apiInstance = new SellingPartnerApiForTokens.TokensApi();
let body = new SellingPartnerApiForTokens.CreateRestrictedDataTokenRequest(); // CreateRestrictedDataTokenRequest | The restricted data token request details.
