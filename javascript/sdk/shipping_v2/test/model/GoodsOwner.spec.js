...
(function(root, factory) {
  ...
  describe('GoodsOwner', function() {
    it('should create an instance of GoodsOwner', function() {
      // uncomment below and update the code to test GoodsOwner
      //var instance = new AmazonShippingApi.GoodsOwner();
