...
(function(root, factory) {
  ...
  describe('LinkableAccountType', function() {
    it('should create an instance of LinkableAccountType', function() {
      // uncomment below and update the code to test LinkableAccountType
      //var instance = new AmazonShippingApi.LinkableAccountType();
    ...
    it('should have the property carrierAccountInputs (base name: "carrierAccountInputs")', function() {
      // uncomment below and update the code to test the property carrierAccountInputs
      //var instance = new AmazonShippingApi.LinkableAccountType();
      //expect(instance).to.be();
    });
