...
(function(root, factory) {
  ...
  describe('GetShipmentDocumentsResult', function() {
    it('should create an instance of GetShipmentDocumentsResult', function() {
      // uncomment below and update the code to test GetShipmentDocumentsResult
      //var instance = new AmazonShippingApi.GetShipmentDocumentsResult();
    ...
    it('should have the property packageDocumentDetail (base name: "packageDocumentDetail")', function() {
      // uncomment below and update the code to test the property packageDocumentDetail
      //var instance = new AmazonShippingApi.GetShipmentDocumentsResult();
      //expect(instance).to.be();
    });
