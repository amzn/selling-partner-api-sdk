...
(function(root, factory) {
  ...
  describe('CarrierAccount', function() {
    it('should create an instance of CarrierAccount', function() {
      // uncomment below and update the code to test CarrierAccount
      //var instance = new AmazonShippingApi.CarrierAccount();
