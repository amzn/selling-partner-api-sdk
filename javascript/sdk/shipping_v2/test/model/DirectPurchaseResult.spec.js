...
(function(root, factory) {
  ...
  describe('DirectPurchaseResult', function() {
    it('should create an instance of DirectPurchaseResult', function() {
      // uncomment below and update the code to test DirectPurchaseResult
      //var instance = new AmazonShippingApi.DirectPurchaseResult();
    ...
    it('should have the property packageDocumentDetailList (base name: "packageDocumentDetailList")', function() {
      // uncomment below and update the code to test the property packageDocumentDetailList
      //var instance = new AmazonShippingApi.DirectPurchaseResult();
      //expect(instance).to.be();
    });
