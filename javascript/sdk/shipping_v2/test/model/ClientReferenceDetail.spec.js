...
(function(root, factory) {
  ...
  describe('ClientReferenceDetail', function() {
    it('should create an instance of ClientReferenceDetail', function() {
      // uncomment below and update the code to test ClientReferenceDetail
      //var instance = new AmazonShippingApi.ClientReferenceDetail();
    ...
    it('should have the property clientReferenceType (base name: "clientReferenceType")', function() {
      // uncomment below and update the code to test the property clientReferenceType
      //var instance = new AmazonShippingApi.ClientReferenceDetail();
