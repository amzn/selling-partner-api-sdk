...
(function(root, factory) {
  ...
  describe('CreateClaimResponse', function() {
    it('should create an instance of CreateClaimResponse', function() {
      // uncomment below and update the code to test CreateClaimResponse
      //var instance = new AmazonShippingApi.CreateClaimResponse();
