...
(function(root, factory) {
  ...
  describe('LinkableCarrier', function() {
    it('should create an instance of LinkableCarrier', function() {
      // uncomment below and update the code to test LinkableCarrier
      //var instance = new AmazonShippingApi.LinkableCarrier();
    ...
    it('should have the property linkableAccountTypes (base name: "linkableAccountTypes")', function() {
      // uncomment below and update the code to test the property linkableAccountTypes
      //var instance = new AmazonShippingApi.LinkableCarrier();
      //expect(instance).to.be();
    });
