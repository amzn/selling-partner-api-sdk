...
(function(root, factory) {
  ...
  describe('PackageDocumentDetail', function() {
    it('should create an instance of PackageDocumentDetail', function() {
      // uncomment below and update the code to test PackageDocumentDetail
      //var instance = new AmazonShippingApi.PackageDocumentDetail();
    ...
    it('should have the property packageDocuments (base name: "packageDocuments")', function() {
      // uncomment below and update the code to test the property packageDocuments
      //var instance = new AmazonShippingApi.PackageDocumentDetail();
      //expect(instance).to.be();
    });
