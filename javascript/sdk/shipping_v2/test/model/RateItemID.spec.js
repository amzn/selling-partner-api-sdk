...
(function(root, factory) {
  ...
  describe('RateItemID', function() {
    it('should create an instance of RateItemID', function() {
      // uncomment below and update the code to test RateItemID
      //var instance = new AmazonShippingApi.RateItemID();
      //expect(instance).to.be.a(AmazonShippingApi.RateItemID);
    });
