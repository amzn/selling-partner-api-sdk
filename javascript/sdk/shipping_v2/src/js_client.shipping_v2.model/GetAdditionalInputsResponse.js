 ...
 * @module js_client.shipping_v2.model/GetAdditionalInputsResponse
 * @version v2
 */
export class GetAdditionalInputsResponse {
   ...
   * @alias module:js_client.shipping_v2.model/GetAdditionalInputsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GetAdditionalInputsResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetAdditionalInputsResponse} The populated <code>GetAdditionalInputsResponse</code> instance.
   */
