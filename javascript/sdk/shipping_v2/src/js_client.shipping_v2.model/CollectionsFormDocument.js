 ...
 * @module js_client.shipping_v2.model/CollectionsFormDocument
 * @version v2
 */
export class CollectionsFormDocument {
   ...
   * @alias module:js_client.shipping_v2.model/CollectionsFormDocument
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/CollectionsFormDocument} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CollectionsFormDocument} The populated <code>CollectionsFormDocument</code> instance.
   */
