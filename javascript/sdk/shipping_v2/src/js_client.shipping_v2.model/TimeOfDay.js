 ...
 * @module js_client.shipping_v2.model/TimeOfDay
 * @version v2
 */
export class TimeOfDay {
   ...
   * @alias module:js_client.shipping_v2.model/TimeOfDay
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/TimeOfDay} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/TimeOfDay} The populated <code>TimeOfDay</code> instance.
   */
