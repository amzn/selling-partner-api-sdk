 ...
 * @module js_client.shipping_v2.model/CreateClaimResponse
 * @version v2
 */
export class CreateClaimResponse {
   ...
   * @alias module:js_client.shipping_v2.model/CreateClaimResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/CreateClaimResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CreateClaimResponse} The populated <code>CreateClaimResponse</code> instance.
   */
