 ...
 * @module js_client.shipping_v2.model/CarrierAccount
 * @version v2
 */
export class CarrierAccount {
   ...
   * @alias module:js_client.shipping_v2.model/CarrierAccount
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/CarrierAccount} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CarrierAccount} The populated <code>CarrierAccount</code> instance.
   */
