 ...
 * @module js_client.shipping_v2.model/DangerousGoodsDetails
 * @version v2
 */
export class DangerousGoodsDetails {
   ...
   * @alias module:js_client.shipping_v2.model/DangerousGoodsDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/DangerousGoodsDetails} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DangerousGoodsDetails} The populated <code>DangerousGoodsDetails</code> instance.
   */
 ...
 * @member {module:js_client.shipping_v2.model/DangerousGoodsDetails.PackingGroupEnum} packingGroup
 */
 ...
 * @member {module:js_client.shipping_v2.model/DangerousGoodsDetails.PackingInstructionEnum} packingInstruction
 */
