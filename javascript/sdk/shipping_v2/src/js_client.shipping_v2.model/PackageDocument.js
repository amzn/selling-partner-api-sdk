 ...
 * @module js_client.shipping_v2.model/PackageDocument
 * @version v2
 */
export class PackageDocument {
   ...
   * @alias module:js_client.shipping_v2.model/PackageDocument
   * @class
   * @param type {module:js_client.shipping_v2.model/DocumentType} 
   ...
   * @param {module:js_client.shipping_v2.model/PackageDocument} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/PackageDocument} The populated <code>PackageDocument</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/DocumentType} type
 */
