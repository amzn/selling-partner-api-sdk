 ...
 * @module js_client.shipping_v2.model/PrintOption
 * @version v2
 */
export class PrintOption {
   ...
   * @alias module:js_client.shipping_v2.model/PrintOption
   * @class
   ...
   * @param supportedDocumentDetails {Array.<module:js_client.shipping_v2.model/SupportedDocumentDetail>} A list of the supported documented details.
   */
   ...
   * @param {module:js_client.shipping_v2.model/PrintOption} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/PrintOption} The populated <code>PrintOption</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/SupportedDocumentDetail>} supportedDocumentDetails
 */
