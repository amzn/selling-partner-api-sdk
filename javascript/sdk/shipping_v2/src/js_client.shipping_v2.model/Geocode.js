 ...
 * @module js_client.shipping_v2.model/Geocode
 * @version v2
 */
export class Geocode {
   ...
   * @alias module:js_client.shipping_v2.model/Geocode
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/Geocode} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Geocode} The populated <code>Geocode</code> instance.
   */
