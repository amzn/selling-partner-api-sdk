 ...
 * @module js_client.shipping_v2.model/RateItem
 * @version v2
 */
export class RateItem {
   ...
   * @alias module:js_client.shipping_v2.model/RateItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/RateItem} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/RateItem} The populated <code>RateItem</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/RateItemID} rateItemID
 */
RateItem.prototype.rateItemID = undefined;

/**
 * @member {module:js_client.shipping_v2.model/RateItemType} rateItemType
 */
RateItem.prototype.rateItemType = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Currency} rateItemCharge
 */
