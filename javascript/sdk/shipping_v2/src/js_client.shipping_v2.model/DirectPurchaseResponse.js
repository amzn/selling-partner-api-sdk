 ...
 * @module js_client.shipping_v2.model/DirectPurchaseResponse
 * @version v2
 */
export class DirectPurchaseResponse {
   ...
   * @alias module:js_client.shipping_v2.model/DirectPurchaseResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/DirectPurchaseResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DirectPurchaseResponse} The populated <code>DirectPurchaseResponse</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/DirectPurchaseResult} payload
 */
