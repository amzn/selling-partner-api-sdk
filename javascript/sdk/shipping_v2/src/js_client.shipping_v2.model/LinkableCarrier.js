 ...
 * @module js_client.shipping_v2.model/LinkableCarrier
 * @version v2
 */
export class LinkableCarrier {
   ...
   * @alias module:js_client.shipping_v2.model/LinkableCarrier
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/LinkableCarrier} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/LinkableCarrier} The populated <code>LinkableCarrier</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/LinkableAccountType>} linkableAccountTypes
 */
