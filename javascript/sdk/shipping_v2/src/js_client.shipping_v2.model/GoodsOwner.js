 ...
 * @module js_client.shipping_v2.model/GoodsOwner
 * @version v2
 */
export class GoodsOwner {
   ...
   * @alias module:js_client.shipping_v2.model/GoodsOwner
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/GoodsOwner} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GoodsOwner} The populated <code>GoodsOwner</code> instance.
   */
