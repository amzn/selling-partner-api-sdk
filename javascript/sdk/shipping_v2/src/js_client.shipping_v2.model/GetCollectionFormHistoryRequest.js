 ...
 * @module js_client.shipping_v2.model/GetCollectionFormHistoryRequest
 * @version v2
 */
export class GetCollectionFormHistoryRequest {
   ...
   * @alias module:js_client.shipping_v2.model/GetCollectionFormHistoryRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GetCollectionFormHistoryRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetCollectionFormHistoryRequest} The populated <code>GetCollectionFormHistoryRequest</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/DateRange} dateRange
 */
