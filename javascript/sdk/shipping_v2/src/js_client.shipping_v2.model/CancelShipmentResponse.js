 ...
 * @module js_client.shipping_v2.model/CancelShipmentResponse
 * @version v2
 */
export class CancelShipmentResponse {
   ...
   * @alias module:js_client.shipping_v2.model/CancelShipmentResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/CancelShipmentResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CancelShipmentResponse} The populated <code>CancelShipmentResponse</code> instance.
   */
