 ...
 * @module js_client.shipping_v2.model/Location
 * @version v2
 */
export class Location {
   ...
   * @alias module:js_client.shipping_v2.model/Location
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/Location} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Location} The populated <code>Location</code> instance.
   */
