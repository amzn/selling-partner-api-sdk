 ...
 * @module js_client.shipping_v2.model/AccessPoint
 * @version v2
 */
export class AccessPoint {
   ...
   * @alias module:js_client.shipping_v2.model/AccessPoint
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/AccessPoint} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/AccessPoint} The populated <code>AccessPoint</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/AccessPointType} type
 */
AccessPoint.prototype.type = undefined;

/**
 * @member {module:js_client.shipping_v2.model/AccessibilityAttributes} accessibilityAttributes
 */
AccessPoint.prototype.accessibilityAttributes = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Address} address
 */
AccessPoint.prototype.address = undefined;

/**
 * Exception operating hours for Access Point
 * @member {Array.<module:js_client.shipping_v2.model/ExceptionOperatingHours>} exceptionOperatingHours
 */
 ...
 * @member {module:js_client.shipping_v2.model/AccessPoint.AssistanceTypeEnum} assistanceType
 */
 ...
 * @member {Object.<String, module:js_client.shipping_v2.model/OperatingHours>} standardOperatingHours
 */
