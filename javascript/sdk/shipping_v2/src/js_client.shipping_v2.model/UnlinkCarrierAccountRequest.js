 ...
 * @module js_client.shipping_v2.model/UnlinkCarrierAccountRequest
 * @version v2
 */
export class UnlinkCarrierAccountRequest {
   ...
   * @alias module:js_client.shipping_v2.model/UnlinkCarrierAccountRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/UnlinkCarrierAccountRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/UnlinkCarrierAccountRequest} The populated <code>UnlinkCarrierAccountRequest</code> instance.
   */
