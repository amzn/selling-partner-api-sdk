 ...
 * @module js_client.shipping_v2.model/Service
 * @version v2
 */
export class Service {
   ...
   * @alias module:js_client.shipping_v2.model/Service
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/Service} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Service} The populated <code>Service</code> instance.
   */
