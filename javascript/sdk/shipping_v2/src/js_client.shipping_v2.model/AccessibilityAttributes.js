 ...
 * @module js_client.shipping_v2.model/AccessibilityAttributes
 * @version v2
 */
export class AccessibilityAttributes {
   ...
   * @alias module:js_client.shipping_v2.model/AccessibilityAttributes
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/AccessibilityAttributes} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/AccessibilityAttributes} The populated <code>AccessibilityAttributes</code> instance.
   */
