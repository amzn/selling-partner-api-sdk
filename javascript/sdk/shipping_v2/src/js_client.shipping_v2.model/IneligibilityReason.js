 ...
 * @module js_client.shipping_v2.model/IneligibilityReason
 * @version v2
 */
export class IneligibilityReason {
   ...
   * @alias module:js_client.shipping_v2.model/IneligibilityReason
   * @class
   * @param code {module:js_client.shipping_v2.model/IneligibilityReasonCode} 
   ...
   * @param {module:js_client.shipping_v2.model/IneligibilityReason} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/IneligibilityReason} The populated <code>IneligibilityReason</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/IneligibilityReasonCode} code
 */
