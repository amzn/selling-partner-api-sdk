 ...
 * @module js_client.shipping_v2.model/PurchaseShipmentRequest
 * @version v2
 */
export class PurchaseShipmentRequest {
   ...
   * @alias module:js_client.shipping_v2.model/PurchaseShipmentRequest
   * @class
   ...
   * @param requestedDocumentSpecification {module:js_client.shipping_v2.model/RequestedDocumentSpecification} 
   */
   ...
   * @param {module:js_client.shipping_v2.model/PurchaseShipmentRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/PurchaseShipmentRequest} The populated <code>PurchaseShipmentRequest</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/RequestedDocumentSpecification} requestedDocumentSpecification
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/RequestedValueAddedService>} requestedValueAddedServices
 */
