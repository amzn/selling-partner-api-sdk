 ...
 * @module js_client.shipping_v2.model/DocumentSize
 * @version v2
 */
export class DocumentSize {
   ...
   * @alias module:js_client.shipping_v2.model/DocumentSize
   * @class
   ...
   * @param unit {module:js_client.shipping_v2.model/DocumentSize.UnitEnum} The unit of measurement.
   */
   ...
   * @param {module:js_client.shipping_v2.model/DocumentSize} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DocumentSize} The populated <code>DocumentSize</code> instance.
   */
 ...
 * @member {module:js_client.shipping_v2.model/DocumentSize.UnitEnum} unit
 */
