 ...
 * @module js_client.shipping_v2.model/UnmanifestedShipmentLocation
 * @version v2
 */
export class UnmanifestedShipmentLocation {
   ...
   * @alias module:js_client.shipping_v2.model/UnmanifestedShipmentLocation
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/UnmanifestedShipmentLocation} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/UnmanifestedShipmentLocation} The populated <code>UnmanifestedShipmentLocation</code> instance.
   */
