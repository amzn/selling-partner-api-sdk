 ...
 * @module js_client.shipping_v2.model/Dimensions
 * @version v2
 */
export class Dimensions {
   ...
   * @alias module:js_client.shipping_v2.model/Dimensions
   * @class
   ...
   * @param unit {module:js_client.shipping_v2.model/Dimensions.UnitEnum} The unit of measurement.
   */
   ...
   * @param {module:js_client.shipping_v2.model/Dimensions} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Dimensions} The populated <code>Dimensions</code> instance.
   */
 ...
 * @member {module:js_client.shipping_v2.model/Dimensions.UnitEnum} unit
 */
