 ...
 * @module js_client.shipping_v2.model/RequestedDocumentSpecification
 * @version v2
 */
export class RequestedDocumentSpecification {
   ...
   * @alias module:js_client.shipping_v2.model/RequestedDocumentSpecification
   * @class
   * @param format {module:js_client.shipping_v2.model/DocumentFormat} 
   * @param size {module:js_client.shipping_v2.model/DocumentSize} 
   ...
   * @param requestedDocumentTypes {Array.<module:js_client.shipping_v2.model/DocumentType>} A list of the document types requested.
   */
   ...
   * @param {module:js_client.shipping_v2.model/RequestedDocumentSpecification} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/RequestedDocumentSpecification} The populated <code>RequestedDocumentSpecification</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/DocumentFormat} format
 */
RequestedDocumentSpecification.prototype.format = undefined;

/**
 * @member {module:js_client.shipping_v2.model/DocumentSize} size
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/DocumentType>} requestedDocumentTypes
 */
RequestedDocumentSpecification.prototype.requestedDocumentTypes = undefined;

/**
 * @member {module:js_client.shipping_v2.model/RequestedLabelCustomization} requestedLabelCustomization
 */
