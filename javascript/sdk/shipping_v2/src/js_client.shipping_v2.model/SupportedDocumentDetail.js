 ...
 * @module js_client.shipping_v2.model/SupportedDocumentDetail
 * @version v2
 */
export class SupportedDocumentDetail {
   ...
   * @alias module:js_client.shipping_v2.model/SupportedDocumentDetail
   * @class
   * @param name {module:js_client.shipping_v2.model/DocumentType} 
   ...
   * @param {module:js_client.shipping_v2.model/SupportedDocumentDetail} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/SupportedDocumentDetail} The populated <code>SupportedDocumentDetail</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/DocumentType} name
 */
