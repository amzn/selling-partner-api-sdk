 ...
 * @module js_client.shipping_v2.model/OneClickShipmentValueAddedService
 * @version v2
 */
export class OneClickShipmentValueAddedService {
   ...
   * @alias module:js_client.shipping_v2.model/OneClickShipmentValueAddedService
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/OneClickShipmentValueAddedService} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/OneClickShipmentValueAddedService} The populated <code>OneClickShipmentValueAddedService</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Currency} amount
 */
