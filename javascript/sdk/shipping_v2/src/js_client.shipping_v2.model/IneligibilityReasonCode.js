...
* @readonly
*/
export default class IneligibilityReasonCode {
    ...
    * @return {module:js_client.shipping_v2.model/IneligibilityReasonCode} The enum <code>IneligibilityReasonCode</code> value.
    */
