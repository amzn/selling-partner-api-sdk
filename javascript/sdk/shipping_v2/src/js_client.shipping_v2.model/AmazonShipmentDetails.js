 ...
 * @module js_client.shipping_v2.model/AmazonShipmentDetails
 * @version v2
 */
export class AmazonShipmentDetails {
   ...
   * @alias module:js_client.shipping_v2.model/AmazonShipmentDetails
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/AmazonShipmentDetails} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/AmazonShipmentDetails} The populated <code>AmazonShipmentDetails</code> instance.
   */
