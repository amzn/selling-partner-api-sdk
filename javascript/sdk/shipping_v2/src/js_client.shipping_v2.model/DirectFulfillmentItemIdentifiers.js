 ...
 * @module js_client.shipping_v2.model/DirectFulfillmentItemIdentifiers
 * @version v2
 */
export class DirectFulfillmentItemIdentifiers {
   ...
   * @alias module:js_client.shipping_v2.model/DirectFulfillmentItemIdentifiers
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/DirectFulfillmentItemIdentifiers} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DirectFulfillmentItemIdentifiers} The populated <code>DirectFulfillmentItemIdentifiers</code> instance.
   */
