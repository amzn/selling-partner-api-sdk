 ...
 * @module js_client.shipping_v2.model/InvoiceDetails
 * @version v2
 */
export class InvoiceDetails {
   ...
   * @alias module:js_client.shipping_v2.model/InvoiceDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/InvoiceDetails} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/InvoiceDetails} The populated <code>InvoiceDetails</code> instance.
   */
