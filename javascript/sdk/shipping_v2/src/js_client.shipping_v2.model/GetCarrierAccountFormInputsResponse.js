 ...
 * @module js_client.shipping_v2.model/GetCarrierAccountFormInputsResponse
 * @version v2
 */
export class GetCarrierAccountFormInputsResponse {
   ...
   * @alias module:js_client.shipping_v2.model/GetCarrierAccountFormInputsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GetCarrierAccountFormInputsResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetCarrierAccountFormInputsResponse} The populated <code>GetCarrierAccountFormInputsResponse</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/LinkableCarrier>} linkableCarriersList
 */
