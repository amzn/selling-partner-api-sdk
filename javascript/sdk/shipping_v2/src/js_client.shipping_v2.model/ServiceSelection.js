 ...
 * @module js_client.shipping_v2.model/ServiceSelection
 * @version v2
 */
export class ServiceSelection {
   ...
   * @alias module:js_client.shipping_v2.model/ServiceSelection
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/ServiceSelection} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ServiceSelection} The populated <code>ServiceSelection</code> instance.
   */
