 ...
 * @module js_client.shipping_v2.model/GetUnmanifestedShipmentsRequest
 * @version v2
 */
export class GetUnmanifestedShipmentsRequest {
   ...
   * @alias module:js_client.shipping_v2.model/GetUnmanifestedShipmentsRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GetUnmanifestedShipmentsRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetUnmanifestedShipmentsRequest} The populated <code>GetUnmanifestedShipmentsRequest</code> instance.
   */
