 ...
 * @module js_client.shipping_v2.model/DirectPurchaseRequest
 * @version v2
 */
export class DirectPurchaseRequest {
   ...
   * @alias module:js_client.shipping_v2.model/DirectPurchaseRequest
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/DirectPurchaseRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DirectPurchaseRequest} The populated <code>DirectPurchaseRequest</code> instance.
   */
