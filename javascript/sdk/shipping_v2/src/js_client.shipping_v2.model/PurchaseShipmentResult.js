 ...
 * @module js_client.shipping_v2.model/PurchaseShipmentResult
 * @version v2
 */
export class PurchaseShipmentResult {
   ...
   * @alias module:js_client.shipping_v2.model/PurchaseShipmentResult
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/PurchaseShipmentResult} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/PurchaseShipmentResult} The populated <code>PurchaseShipmentResult</code> instance.
   */
