 ...
 * @module js_client.shipping_v2.model/OperatingHours
 * @version v2
 */
export class OperatingHours {
   ...
   * @alias module:js_client.shipping_v2.model/OperatingHours
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/OperatingHours} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/OperatingHours} The populated <code>OperatingHours</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/TimeOfDay} closingTime
 */
OperatingHours.prototype.closingTime = undefined;

/**
 * @member {module:js_client.shipping_v2.model/TimeOfDay} openingTime
 */
OperatingHours.prototype.openingTime = undefined;

/**
 * midDayClosures operating hours array
 * @member {Array.<module:js_client.shipping_v2.model/TimeOfDay>} midDayClosures
 */
