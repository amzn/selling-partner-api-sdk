 ...
 * @module js_client.shipping_v2.model/GenerateCollectionFormRequest
 * @version v2
 */
export class GenerateCollectionFormRequest {
   ...
   * @alias module:js_client.shipping_v2.model/GenerateCollectionFormRequest
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/GenerateCollectionFormRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GenerateCollectionFormRequest} The populated <code>GenerateCollectionFormRequest</code> instance.
   */
