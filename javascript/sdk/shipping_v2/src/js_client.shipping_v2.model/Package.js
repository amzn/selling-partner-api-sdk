 ...
 * @module js_client.shipping_v2.model/Package
 * @version v2
 */
export class Package {
   ...
   * @alias module:js_client.shipping_v2.model/Package
   * @class
   * @param dimensions {module:js_client.shipping_v2.model/Dimensions} 
   * @param weight {module:js_client.shipping_v2.model/Weight} 
   * @param insuredValue {module:js_client.shipping_v2.model/Currency} 
   ...
   * @param items {Array.<module:js_client.shipping_v2.model/Item>} A list of items.
   */
   ...
   * @param {module:js_client.shipping_v2.model/Package} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Package} The populated <code>Package</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Dimensions} dimensions
 */
Package.prototype.dimensions = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Weight} weight
 */
Package.prototype.weight = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Currency} insuredValue
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/ChargeComponent>} charges
 */
...
/**
 * A list of items.
 * @member {Array.<module:js_client.shipping_v2.model/Item>} items
 */
