 ...
 * @module js_client.shipping_v2.model/TrackingDetailCodes
 * @version v2
 */
export class TrackingDetailCodes {
   ...
   * @alias module:js_client.shipping_v2.model/TrackingDetailCodes
   * @class
   * @param forward {Array.<module:js_client.shipping_v2.model/DetailCodes>} Contains detail codes that provide additional details related to the forward leg of the shipment.
   * @param returns {Array.<module:js_client.shipping_v2.model/DetailCodes>} Contains detail codes that provide additional details related to the return leg of the shipment.
   */
   ...
   * @param {module:js_client.shipping_v2.model/TrackingDetailCodes} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/TrackingDetailCodes} The populated <code>TrackingDetailCodes</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/DetailCodes>} forward
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/DetailCodes>} returns
 */
