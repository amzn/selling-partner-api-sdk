 ...
 * @module js_client.shipping_v2.model/LinkCarrierAccountRequest
 * @version v2
 */
export class LinkCarrierAccountRequest {
   ...
   * @alias module:js_client.shipping_v2.model/LinkCarrierAccountRequest
   * @class
   * @param carrierAccountType {String} CarrierAccountType  associated with account.
   * @param carrierAccountAttributes {Array.<module:js_client.shipping_v2.model/CarrierAccountAttribute>} A list of all attributes required by the carrier in order to successfully link the merchant's account
   */
   ...
   * @param {module:js_client.shipping_v2.model/LinkCarrierAccountRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/LinkCarrierAccountRequest} The populated <code>LinkCarrierAccountRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/CarrierAccountAttribute>} carrierAccountAttributes
 */
LinkCarrierAccountRequest.prototype.carrierAccountAttributes = undefined;

/**
 * A list of all attributes required by the carrier in order to successfully link the merchant's account
 * @member {Array.<module:js_client.shipping_v2.model/CarrierAccountAttribute>} encryptedCarrierAccountAttributes
 */
