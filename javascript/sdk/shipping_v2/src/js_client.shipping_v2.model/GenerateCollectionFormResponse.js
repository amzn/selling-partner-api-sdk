 ...
 * @module js_client.shipping_v2.model/GenerateCollectionFormResponse
 * @version v2
 */
export class GenerateCollectionFormResponse {
   ...
   * @alias module:js_client.shipping_v2.model/GenerateCollectionFormResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GenerateCollectionFormResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GenerateCollectionFormResponse} The populated <code>GenerateCollectionFormResponse</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/CollectionsFormDocument} collectionsFormDocument
 */
