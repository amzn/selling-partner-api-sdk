 ...
 * @module js_client.shipping_v2.model/ChannelDetails
 * @version v2
 */
export class ChannelDetails {
   ...
   * @alias module:js_client.shipping_v2.model/ChannelDetails
   * @class
   * @param channelType {module:js_client.shipping_v2.model/ChannelType} 
   */
   ...
   * @param {module:js_client.shipping_v2.model/ChannelDetails} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ChannelDetails} The populated <code>ChannelDetails</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/ChannelType} channelType
 */
ChannelDetails.prototype.channelType = undefined;

/**
 * @member {module:js_client.shipping_v2.model/AmazonOrderDetails} amazonOrderDetails
 */
ChannelDetails.prototype.amazonOrderDetails = undefined;

/**
 * @member {module:js_client.shipping_v2.model/AmazonShipmentDetails} amazonShipmentDetails
 */
