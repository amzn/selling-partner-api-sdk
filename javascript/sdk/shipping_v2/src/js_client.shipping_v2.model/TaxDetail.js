 ...
 * @module js_client.shipping_v2.model/TaxDetail
 * @version v2
 */
export class TaxDetail {
   ...
   * @alias module:js_client.shipping_v2.model/TaxDetail
   * @class
   * @param taxType {module:js_client.shipping_v2.model/TaxType} 
   ...
   * @param {module:js_client.shipping_v2.model/TaxDetail} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/TaxDetail} The populated <code>TaxDetail</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/TaxType} taxType
 */
