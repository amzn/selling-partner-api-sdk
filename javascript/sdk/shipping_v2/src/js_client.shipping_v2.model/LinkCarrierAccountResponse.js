 ...
 * @module js_client.shipping_v2.model/LinkCarrierAccountResponse
 * @version v2
 */
export class LinkCarrierAccountResponse {
   ...
   * @alias module:js_client.shipping_v2.model/LinkCarrierAccountResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/LinkCarrierAccountResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/LinkCarrierAccountResponse} The populated <code>LinkCarrierAccountResponse</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/AccountStatus} registrationStatus
 */
