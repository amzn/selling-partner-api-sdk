 ...
 * @module js_client.shipping_v2.model/AvailableValueAddedServiceGroup
 * @version v2
 */
export class AvailableValueAddedServiceGroup {
   ...
   * @alias module:js_client.shipping_v2.model/AvailableValueAddedServiceGroup
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/AvailableValueAddedServiceGroup} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/AvailableValueAddedServiceGroup} The populated <code>AvailableValueAddedServiceGroup</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/ValueAddedService>} valueAddedServices
 */
