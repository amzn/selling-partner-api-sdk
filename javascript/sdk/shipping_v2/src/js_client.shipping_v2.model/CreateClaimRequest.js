 ...
 * @module js_client.shipping_v2.model/CreateClaimRequest
 * @version v2
 */
export class CreateClaimRequest {
   ...
   * @alias module:js_client.shipping_v2.model/CreateClaimRequest
   * @class
   * @param trackingId {String} The carrier generated identifier for a package in a purchased shipment.
   * @param claimReason {module:js_client.shipping_v2.model/ClaimReason} 
   * @param settlementType {module:js_client.shipping_v2.model/SettlementType} 
   */
   ...
   * @param {module:js_client.shipping_v2.model/CreateClaimRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CreateClaimRequest} The populated <code>CreateClaimRequest</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Currency} declaredValue
 */
CreateClaimRequest.prototype.declaredValue = undefined;

/**
 * @member {module:js_client.shipping_v2.model/ClaimReason} claimReason
 */
...
/**
 * @member {module:js_client.shipping_v2.model/SettlementType} settlementType
 */
