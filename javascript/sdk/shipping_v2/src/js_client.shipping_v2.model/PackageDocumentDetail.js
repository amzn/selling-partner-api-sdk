 ...
 * @module js_client.shipping_v2.model/PackageDocumentDetail
 * @version v2
 */
export class PackageDocumentDetail {
   ...
   * @alias module:js_client.shipping_v2.model/PackageDocumentDetail
   * @class
   ...
   * @param packageDocuments {Array.<module:js_client.shipping_v2.model/PackageDocument>} A list of documents related to a package.
   */
   ...
   * @param {module:js_client.shipping_v2.model/PackageDocumentDetail} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/PackageDocumentDetail} The populated <code>PackageDocumentDetail</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/PackageDocument>} packageDocuments
 */
