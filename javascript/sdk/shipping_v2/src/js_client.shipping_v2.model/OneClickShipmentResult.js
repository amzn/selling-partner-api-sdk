 ...
 * @module js_client.shipping_v2.model/OneClickShipmentResult
 * @version v2
 */
export class OneClickShipmentResult {
   ...
   * @alias module:js_client.shipping_v2.model/OneClickShipmentResult
   * @class
   * @param shipmentId {String} The unique shipment identifier provided by a shipping service.
   * @param packageDocumentDetails {Array.<module:js_client.shipping_v2.model/PackageDocumentDetail>} A list of post-purchase details about a package that will be shipped using a shipping service.
   * @param promise {module:js_client.shipping_v2.model/Promise} 
   * @param carrier {module:js_client.shipping_v2.model/Carrier} 
   * @param service {module:js_client.shipping_v2.model/Service} 
   ...
   * @param {module:js_client.shipping_v2.model/OneClickShipmentResult} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/OneClickShipmentResult} The populated <code>OneClickShipmentResult</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/PackageDocumentDetail>} packageDocumentDetails
 */
...
/**
 * @member {module:js_client.shipping_v2.model/Carrier} carrier
 */
OneClickShipmentResult.prototype.carrier = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Service} service
 */
