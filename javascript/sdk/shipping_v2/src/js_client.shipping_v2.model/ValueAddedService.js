 ...
 * @module js_client.shipping_v2.model/ValueAddedService
 * @version v2
 */
export class ValueAddedService {
   ...
   * @alias module:js_client.shipping_v2.model/ValueAddedService
   * @class
   * @param id {String} The identifier for the value-added service.
   * @param name {String} The name of the value-added service.
   * @param cost {module:js_client.shipping_v2.model/Currency} 
   */
   ...
   * @param {module:js_client.shipping_v2.model/ValueAddedService} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ValueAddedService} The populated <code>ValueAddedService</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Currency} cost
 */
