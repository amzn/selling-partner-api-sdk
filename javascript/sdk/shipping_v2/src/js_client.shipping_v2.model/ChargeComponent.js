 ...
 * @module js_client.shipping_v2.model/ChargeComponent
 * @version v2
 */
export class ChargeComponent {
   ...
   * @alias module:js_client.shipping_v2.model/ChargeComponent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/ChargeComponent} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ChargeComponent} The populated <code>ChargeComponent</code> instance.
   */
...
/**
 * The type of charge.
 * @member {module:js_client.shipping_v2.model/ChargeComponent.ChargeTypeEnum} chargeType
 */
