 ...
 * @module js_client.shipping_v2.model/Item
 * @version v2
 */
export class Item {
  /**
   ...
   * @alias module:js_client.shipping_v2.model/Item
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/Item} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Item} The populated <code>Item</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Currency} itemValue
 */
...
/**
 * @member {module:js_client.shipping_v2.model/LiquidVolume} liquidVolume
 */
...
/**
 * @member {module:js_client.shipping_v2.model/DangerousGoodsDetails} dangerousGoodsDetails
 */
...
/**
 * @member {module:js_client.shipping_v2.model/InvoiceDetails} invoiceDetails
 */
...
/**
 * @member {module:js_client.shipping_v2.model/DirectFulfillmentItemIdentifiers} directFulfillmentItemIdentifiers
 */
