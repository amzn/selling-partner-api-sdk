 ...
 * @module js_client.shipping_v2.model/Rate
 * @version v2
 */
export class Rate {
  /**
   ...
   * @alias module:js_client.shipping_v2.model/Rate
   * @class
   ...
   * @param totalCharge {module:js_client.shipping_v2.model/Currency} 
   * @param promise {module:js_client.shipping_v2.model/Promise} 
   * @param supportedDocumentSpecifications {Array.<module:js_client.shipping_v2.model/SupportedDocumentSpecification>} A list of the document specifications supported for a shipment service offering.
   ...
   * @param {module:js_client.shipping_v2.model/Rate} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Rate} The populated <code>Rate</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Weight} billedWeight
 */
Rate.prototype.billedWeight = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Currency} totalCharge
 */
Rate.prototype.totalCharge = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Promise} promise
 */
Rate.prototype.promise = undefined;

/**
 * A list of the document specifications supported for a shipment service offering.
 * @member {Array.<module:js_client.shipping_v2.model/SupportedDocumentSpecification>} supportedDocumentSpecifications
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/AvailableValueAddedServiceGroup>} availableValueAddedServiceGroups
 */
...
/**
 * A list of RateItem
 * @member {Array.<module:js_client.shipping_v2.model/RateItem>} rateItemList
 */
Rate.prototype.rateItemList = undefined;

/**
 * @member {module:js_client.shipping_v2.model/PaymentType} paymentType
 */
Rate.prototype.paymentType = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Benefits} benefits
 */
