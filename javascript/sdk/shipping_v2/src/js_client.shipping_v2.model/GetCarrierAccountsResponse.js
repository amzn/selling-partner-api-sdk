 ...
 * @module js_client.shipping_v2.model/GetCarrierAccountsResponse
 * @version v2
 */
export class GetCarrierAccountsResponse {
   ...
   * @alias module:js_client.shipping_v2.model/GetCarrierAccountsResponse
   * @class
   * @param activeAccounts {Array.<module:js_client.shipping_v2.model/ActiveAccount>} A list of ActiveAccount
   */
   ...
   * @param {module:js_client.shipping_v2.model/GetCarrierAccountsResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetCarrierAccountsResponse} The populated <code>GetCarrierAccountsResponse</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/ActiveAccount>} activeAccounts
 */
