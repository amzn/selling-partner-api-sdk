 ...
 * @module js_client.shipping_v2.model/GetCollectionFormResponse
 * @version v2
 */
export class GetCollectionFormResponse {
   ...
   * @alias module:js_client.shipping_v2.model/GetCollectionFormResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/GetCollectionFormResponse} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/GetCollectionFormResponse} The populated <code>GetCollectionFormResponse</code> instance.
   */
