 ...
 * @module js_client.shipping_v2.model/CollectionFormsHistoryRecord
 * @version v2
 */
export class CollectionFormsHistoryRecord {
   ...
   * @alias module:js_client.shipping_v2.model/CollectionFormsHistoryRecord
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/CollectionFormsHistoryRecord} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CollectionFormsHistoryRecord} The populated <code>CollectionFormsHistoryRecord</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/GenerationStatus} generationStatus
 */
...
/**
 * @member {module:js_client.shipping_v2.model/Address} shipFromAddress
 */
