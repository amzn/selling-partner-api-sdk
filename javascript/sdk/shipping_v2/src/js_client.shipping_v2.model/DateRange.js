 ...
 * @module js_client.shipping_v2.model/DateRange
 * @version v2
 */
export class DateRange {
   ...
   * @alias module:js_client.shipping_v2.model/DateRange
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/DateRange} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DateRange} The populated <code>DateRange</code> instance.
   */
