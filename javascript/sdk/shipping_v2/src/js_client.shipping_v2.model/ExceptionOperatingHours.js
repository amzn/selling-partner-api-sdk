 ...
 * @module js_client.shipping_v2.model/ExceptionOperatingHours
 * @version v2
 */
export class ExceptionOperatingHours {
   ...
   * @alias module:js_client.shipping_v2.model/ExceptionOperatingHours
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/ExceptionOperatingHours} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ExceptionOperatingHours} The populated <code>ExceptionOperatingHours</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/OperatingHours} operatingHours
 */
