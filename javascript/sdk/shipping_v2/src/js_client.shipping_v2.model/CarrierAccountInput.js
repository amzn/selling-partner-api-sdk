 ...
 * @module js_client.shipping_v2.model/CarrierAccountInput
 * @version v2
 */
export class CarrierAccountInput {
   ...
   * @alias module:js_client.shipping_v2.model/CarrierAccountInput
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/CarrierAccountInput} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/CarrierAccountInput} The populated <code>CarrierAccountInput</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/InputType} inputType
 */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/ValidationMetadata>} validationMetadata
 */
