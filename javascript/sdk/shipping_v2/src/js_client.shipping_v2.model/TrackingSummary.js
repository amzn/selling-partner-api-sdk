 ...
 * @module js_client.shipping_v2.model/TrackingSummary
 * @version v2
 */
export class TrackingSummary {
   ...
   * @alias module:js_client.shipping_v2.model/TrackingSummary
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/TrackingSummary} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/TrackingSummary} The populated <code>TrackingSummary</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/Status} status
 */
TrackingSummary.prototype.status = undefined;

/**
 * @member {module:js_client.shipping_v2.model/TrackingDetailCodes} trackingDetailCodes
 */
