 ...
 * @module js_client.shipping_v2.model/ClientReferenceDetail
 * @version v2
 */
export class ClientReferenceDetail {
   ...
   * @alias module:js_client.shipping_v2.model/ClientReferenceDetail
   * @class
   * @param clientReferenceType {module:js_client.shipping_v2.model/ClientReferenceDetail.ClientReferenceTypeEnum} Client Reference type.
   ...
   * @param {module:js_client.shipping_v2.model/ClientReferenceDetail} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/ClientReferenceDetail} The populated <code>ClientReferenceDetail</code> instance.
   */
 ...
 * @member {module:js_client.shipping_v2.model/ClientReferenceDetail.ClientReferenceTypeEnum} clientReferenceType
 */
