 ...
 * @module js_client.shipping_v2.model/AccessPointDetails
 * @version v2
 */
export class AccessPointDetails {
   ...
   * @alias module:js_client.shipping_v2.model/AccessPointDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.shipping_v2.model/AccessPointDetails} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/AccessPointDetails} The populated <code>AccessPointDetails</code> instance.
   */
