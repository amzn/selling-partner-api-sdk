 ...
 * @module js_client.shipping_v2.model/SubmitNdrFeedbackRequest
 * @version v2
 */
export class SubmitNdrFeedbackRequest {
   ...
   * @alias module:js_client.shipping_v2.model/SubmitNdrFeedbackRequest
   * @class
   * @param trackingId {String} The carrier generated identifier for a package in a purchased shipment.
   * @param ndrAction {module:js_client.shipping_v2.model/NdrAction} 
   */
   ...
   * @param {module:js_client.shipping_v2.model/SubmitNdrFeedbackRequest} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/SubmitNdrFeedbackRequest} The populated <code>SubmitNdrFeedbackRequest</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/NdrAction} ndrAction
 */
SubmitNdrFeedbackRequest.prototype.ndrAction = undefined;

/**
 * @member {module:js_client.shipping_v2.model/NdrRequestData} ndrRequestData
 */
