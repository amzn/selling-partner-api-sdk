 ...
 * @module js_client.shipping_v2.model/DirectPurchaseResult
 * @version v2
 */
export class DirectPurchaseResult {
   ...
   * @alias module:js_client.shipping_v2.model/DirectPurchaseResult
   * @class
   ...
   * @param {module:js_client.shipping_v2.model/DirectPurchaseResult} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/DirectPurchaseResult} The populated <code>DirectPurchaseResult</code> instance.
   */
 ...
 * @member {Array.<module:js_client.shipping_v2.model/PackageDocumentDetail>} packageDocumentDetailList
 */
