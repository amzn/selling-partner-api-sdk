 ...
 * @module js_client.shipping_v2.model/Event
 * @version v2
 */
export class Event {
  /**
   ...
   * A tracking event.
   * @alias module:js_client.shipping_v2.model/Event
   * @class
   * @param eventCode {module:js_client.shipping_v2.model/EventCode} 
   ...
   * @param {module:js_client.shipping_v2.model/Event} obj Optional instance to populate.
   * @return {module:js_client.shipping_v2.model/Event} The populated <code>Event</code> instance.
   */
...
/**
 * @member {module:js_client.shipping_v2.model/EventCode} eventCode
 */
Event.prototype.eventCode = undefined;

/**
 * @member {module:js_client.shipping_v2.model/Location} location
 */
