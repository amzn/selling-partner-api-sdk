...
(function(root, factory) {
  ...
  describe('CapacityReservationBillingEvent', function() {
    it('should create an instance of CapacityReservationBillingEvent', function() {
      // uncomment below and update the code to test CapacityReservationBillingEvent
      //var instance = new SellingPartnerApiForFinances.CapacityReservationBillingEvent();
