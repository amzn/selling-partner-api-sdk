 ...
 * @module js_client.finances_v0.model/NetworkComminglingTransactionEvent
 * @version v0
 */
export class NetworkComminglingTransactionEvent {
   ...
   * @alias module:js_client.finances_v0.model/NetworkComminglingTransactionEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/NetworkComminglingTransactionEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/NetworkComminglingTransactionEvent} The populated <code>NetworkComminglingTransactionEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} taxExclusiveAmount
 */
