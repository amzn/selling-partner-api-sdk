 ...
 * @module js_client.finances_v0.model/FailedAdhocDisbursementEvent
 * @version v0
 */
export class FailedAdhocDisbursementEvent {
   ...
   * @alias module:js_client.finances_v0.model/FailedAdhocDisbursementEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/FailedAdhocDisbursementEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/FailedAdhocDisbursementEvent} The populated <code>FailedAdhocDisbursementEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} transferAmount
 */
