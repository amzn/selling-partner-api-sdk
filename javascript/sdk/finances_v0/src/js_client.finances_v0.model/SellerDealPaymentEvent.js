 ...
 * @module js_client.finances_v0.model/SellerDealPaymentEvent
 * @version v0
 */
export class SellerDealPaymentEvent {
   ...
   * @alias module:js_client.finances_v0.model/SellerDealPaymentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/SellerDealPaymentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/SellerDealPaymentEvent} The populated <code>SellerDealPaymentEvent</code> instance.
   */
