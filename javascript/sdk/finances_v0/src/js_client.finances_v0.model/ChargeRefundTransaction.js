 ...
 * @module js_client.finances_v0.model/ChargeRefundTransaction
 * @version v0
 */
export class ChargeRefundTransaction {
   ...
   * @alias module:js_client.finances_v0.model/ChargeRefundTransaction
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ChargeRefundTransaction} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ChargeRefundTransaction} The populated <code>ChargeRefundTransaction</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} chargeAmount
 */
