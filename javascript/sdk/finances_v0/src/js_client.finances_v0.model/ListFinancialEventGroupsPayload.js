 ...
 * @module js_client.finances_v0.model/ListFinancialEventGroupsPayload
 * @version v0
 */
export class ListFinancialEventGroupsPayload {
   ...
   * @alias module:js_client.finances_v0.model/ListFinancialEventGroupsPayload
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ListFinancialEventGroupsPayload} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ListFinancialEventGroupsPayload} The populated <code>ListFinancialEventGroupsPayload</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/FinancialEventGroup>} financialEventGroupList
 */
