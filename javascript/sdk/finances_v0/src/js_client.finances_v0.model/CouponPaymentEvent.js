 ...
 * @module js_client.finances_v0.model/CouponPaymentEvent
 * @version v0
 */
export class CouponPaymentEvent {
   ...
   * @alias module:js_client.finances_v0.model/CouponPaymentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/CouponPaymentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/CouponPaymentEvent} The populated <code>CouponPaymentEvent</code> instance.
   */
