 ...
 * @module js_client.finances_v0.model/AdjustmentItem
 * @version v0
 */
export class AdjustmentItem {
   ...
   * @alias module:js_client.finances_v0.model/AdjustmentItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/AdjustmentItem} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/AdjustmentItem} The populated <code>AdjustmentItem</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} perUnitAmount
 */
