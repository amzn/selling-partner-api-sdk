 ...
 * @module js_client.finances_v0.model/RemovalShipmentItemAdjustment
 * @version v0
 */
export class RemovalShipmentItemAdjustment {
   ...
   * @alias module:js_client.finances_v0.model/RemovalShipmentItemAdjustment
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RemovalShipmentItemAdjustment} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RemovalShipmentItemAdjustment} The populated <code>RemovalShipmentItemAdjustment</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} revenueAdjustment
 */
RemovalShipmentItemAdjustment.prototype.revenueAdjustment = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxAmountAdjustment
 */
RemovalShipmentItemAdjustment.prototype.taxAmountAdjustment = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxWithheldAdjustment
 */
