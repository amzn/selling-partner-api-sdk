 ...
 * @module js_client.finances_v0.model/RemovalShipmentAdjustmentEvent
 * @version v0
 */
export class RemovalShipmentAdjustmentEvent {
   ...
   * @alias module:js_client.finances_v0.model/RemovalShipmentAdjustmentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RemovalShipmentAdjustmentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RemovalShipmentAdjustmentEvent} The populated <code>RemovalShipmentAdjustmentEvent</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/RemovalShipmentItemAdjustment>} removalShipmentItemAdjustmentList
 */
