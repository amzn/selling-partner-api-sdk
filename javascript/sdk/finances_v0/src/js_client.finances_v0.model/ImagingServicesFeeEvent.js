 ...
 * @module js_client.finances_v0.model/ImagingServicesFeeEvent
 * @version v0
 */
export class ImagingServicesFeeEvent {
   ...
   * @alias module:js_client.finances_v0.model/ImagingServicesFeeEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ImagingServicesFeeEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ImagingServicesFeeEvent} The populated <code>ImagingServicesFeeEvent</code> instance.
   */
