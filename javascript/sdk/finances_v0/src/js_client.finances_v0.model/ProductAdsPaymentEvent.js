 ...
 * @module js_client.finances_v0.model/ProductAdsPaymentEvent
 * @version v0
 */
export class ProductAdsPaymentEvent {
   ...
   * @alias module:js_client.finances_v0.model/ProductAdsPaymentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ProductAdsPaymentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ProductAdsPaymentEvent} The populated <code>ProductAdsPaymentEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} baseValue
 */
ProductAdsPaymentEvent.prototype.baseValue = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxValue
 */
ProductAdsPaymentEvent.prototype.taxValue = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} transactionValue
 */
