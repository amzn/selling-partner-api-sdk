 ...
 * @module js_client.finances_v0.model/FBALiquidationEvent
 * @version v0
 */
export class FBALiquidationEvent {
   ...
   * @alias module:js_client.finances_v0.model/FBALiquidationEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/FBALiquidationEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/FBALiquidationEvent} The populated <code>FBALiquidationEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} liquidationProceedsAmount
 */
FBALiquidationEvent.prototype.liquidationProceedsAmount = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} liquidationFeeAmount
 */
