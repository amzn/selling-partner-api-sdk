 ...
 * @module js_client.finances_v0.model/DirectPayment
 * @version v0
 */
export class DirectPayment {
   ...
   * @alias module:js_client.finances_v0.model/DirectPayment
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/DirectPayment} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/DirectPayment} The populated <code>DirectPayment</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} directPaymentAmount
 */
