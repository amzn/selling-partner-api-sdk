 ...
 * @module js_client.finances_v0.model/Promotion
 * @version v0
 */
export class Promotion {
   ...
   * @alias module:js_client.finances_v0.model/Promotion
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/Promotion} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/Promotion} The populated <code>Promotion</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} promotionAmount
 */
