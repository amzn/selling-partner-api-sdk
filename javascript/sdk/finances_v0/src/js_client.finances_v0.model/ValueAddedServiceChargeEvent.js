 ...
 * @module js_client.finances_v0.model/ValueAddedServiceChargeEvent
 * @version v0
 */
export class ValueAddedServiceChargeEvent {
   ...
   * @alias module:js_client.finances_v0.model/ValueAddedServiceChargeEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ValueAddedServiceChargeEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ValueAddedServiceChargeEvent} The populated <code>ValueAddedServiceChargeEvent</code> instance.
   */
