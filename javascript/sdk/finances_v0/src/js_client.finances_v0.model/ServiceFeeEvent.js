 ...
 * @module js_client.finances_v0.model/ServiceFeeEvent
 * @version v0
 */
export class ServiceFeeEvent {
   ...
   * @alias module:js_client.finances_v0.model/ServiceFeeEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ServiceFeeEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ServiceFeeEvent} The populated <code>ServiceFeeEvent</code> instance.
   */
