 ...
 * @module js_client.finances_v0.model/RemovalShipmentEvent
 * @version v0
 */
export class RemovalShipmentEvent {
   ...
   * @alias module:js_client.finances_v0.model/RemovalShipmentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RemovalShipmentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RemovalShipmentEvent} The populated <code>RemovalShipmentEvent</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/RemovalShipmentItem>} removalShipmentItemList
 */
