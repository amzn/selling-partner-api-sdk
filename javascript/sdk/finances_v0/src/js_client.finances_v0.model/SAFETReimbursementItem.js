 ...
 * @module js_client.finances_v0.model/SAFETReimbursementItem
 * @version v0
 */
export class SAFETReimbursementItem {
   ...
   * @alias module:js_client.finances_v0.model/SAFETReimbursementItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/SAFETReimbursementItem} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/SAFETReimbursementItem} The populated <code>SAFETReimbursementItem</code> instance.
   */
