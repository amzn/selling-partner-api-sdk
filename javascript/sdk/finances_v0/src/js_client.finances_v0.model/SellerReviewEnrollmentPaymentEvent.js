 ...
 * @module js_client.finances_v0.model/SellerReviewEnrollmentPaymentEvent
 * @version v0
 */
export class SellerReviewEnrollmentPaymentEvent {
   ...
   * @alias module:js_client.finances_v0.model/SellerReviewEnrollmentPaymentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/SellerReviewEnrollmentPaymentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/SellerReviewEnrollmentPaymentEvent} The populated <code>SellerReviewEnrollmentPaymentEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/FeeComponent} feeComponent
 */
SellerReviewEnrollmentPaymentEvent.prototype.feeComponent = undefined;

/**
 * @member {module:js_client.finances_v0.model/ChargeComponent} chargeComponent
 */
SellerReviewEnrollmentPaymentEvent.prototype.chargeComponent = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} totalAmount
 */
