 ...
 * @module js_client.finances_v0.model/SAFETReimbursementEvent
 * @version v0
 */
export class SAFETReimbursementEvent {
   ...
   * @alias module:js_client.finances_v0.model/SAFETReimbursementEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/SAFETReimbursementEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/SAFETReimbursementEvent} The populated <code>SAFETReimbursementEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} reimbursedAmount
 */
 ...
 * @member {Array.<module:js_client.finances_v0.model/SAFETReimbursementItem>} sAFETReimbursementItemList
 */
