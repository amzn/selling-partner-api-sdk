 ...
 * @module js_client.finances_v0.model/ChargeComponent
 * @version v0
 */
export class ChargeComponent {
   ...
   * @alias module:js_client.finances_v0.model/ChargeComponent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ChargeComponent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ChargeComponent} The populated <code>ChargeComponent</code> instance.
   */
