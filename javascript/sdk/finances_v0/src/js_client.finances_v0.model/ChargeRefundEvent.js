 ...
 * @module js_client.finances_v0.model/ChargeRefundEvent
 * @version v0
 */
export class ChargeRefundEvent {
   ...
   * @alias module:js_client.finances_v0.model/ChargeRefundEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ChargeRefundEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ChargeRefundEvent} The populated <code>ChargeRefundEvent</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/ChargeRefundTransaction>} chargeRefundTransactions
 */
