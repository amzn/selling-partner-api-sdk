 ...
 * @module js_client.finances_v0.model/FinancialEventGroup
 * @version v0
 */
export class FinancialEventGroup {
   ...
   * @alias module:js_client.finances_v0.model/FinancialEventGroup
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/FinancialEventGroup} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/FinancialEventGroup} The populated <code>FinancialEventGroup</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} originalTotal
 */
FinancialEventGroup.prototype.originalTotal = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} convertedTotal
 */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} beginningBalance
 */
