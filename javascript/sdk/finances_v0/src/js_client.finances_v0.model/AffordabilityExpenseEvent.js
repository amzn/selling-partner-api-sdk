 ...
 * @module js_client.finances_v0.model/AffordabilityExpenseEvent
 * @version v0
 */
export class AffordabilityExpenseEvent {
   ...
   * @alias module:js_client.finances_v0.model/AffordabilityExpenseEvent
   * @class
   * @param taxTypeCGST {module:js_client.finances_v0.model/Currency} 
   * @param taxTypeSGST {module:js_client.finances_v0.model/Currency} 
   * @param taxTypeIGST {module:js_client.finances_v0.model/Currency} 
   */
   ...
   * @param {module:js_client.finances_v0.model/AffordabilityExpenseEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/AffordabilityExpenseEvent} The populated <code>AffordabilityExpenseEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} baseExpense
 */
AffordabilityExpenseEvent.prototype.baseExpense = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxTypeCGST
 */
AffordabilityExpenseEvent.prototype.taxTypeCGST = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxTypeSGST
 */
AffordabilityExpenseEvent.prototype.taxTypeSGST = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxTypeIGST
 */
AffordabilityExpenseEvent.prototype.taxTypeIGST = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} totalExpense
 */
