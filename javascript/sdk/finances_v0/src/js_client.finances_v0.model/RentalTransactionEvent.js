 ...
 * @module js_client.finances_v0.model/RentalTransactionEvent
 * @version v0
 */
export class RentalTransactionEvent {
   ...
   * @alias module:js_client.finances_v0.model/RentalTransactionEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RentalTransactionEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RentalTransactionEvent} The populated <code>RentalTransactionEvent</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/ChargeComponent>} rentalChargeList
 */
RentalTransactionEvent.prototype.rentalChargeList = undefined;

/**
 * A list of fee component information.
 * @member {Array.<module:js_client.finances_v0.model/FeeComponent>} rentalFeeList
 */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} rentalInitialValue
 */
RentalTransactionEvent.prototype.rentalInitialValue = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} rentalReimbursement
 */
RentalTransactionEvent.prototype.rentalReimbursement = undefined;

/**
 * A list of information about taxes withheld.
 * @member {Array.<module:js_client.finances_v0.model/TaxWithheldComponent>} rentalTaxWithheldList
 */
