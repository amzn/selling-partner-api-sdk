 ...
 * @module js_client.finances_v0.model/TDSReimbursementEvent
 * @version v0
 */
export class TDSReimbursementEvent {
   ...
   * @alias module:js_client.finances_v0.model/TDSReimbursementEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/TDSReimbursementEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/TDSReimbursementEvent} The populated <code>TDSReimbursementEvent</code> instance.
   */
