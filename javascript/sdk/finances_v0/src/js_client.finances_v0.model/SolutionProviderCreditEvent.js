 ...
 * @module js_client.finances_v0.model/SolutionProviderCreditEvent
 * @version v0
 */
export class SolutionProviderCreditEvent {
   ...
   * @alias module:js_client.finances_v0.model/SolutionProviderCreditEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/SolutionProviderCreditEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/SolutionProviderCreditEvent} The populated <code>SolutionProviderCreditEvent</code> instance.
   */
