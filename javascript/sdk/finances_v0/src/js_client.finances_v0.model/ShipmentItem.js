 ...
 * @module js_client.finances_v0.model/ShipmentItem
 * @version v0
 */
export class ShipmentItem {
   ...
   * @alias module:js_client.finances_v0.model/ShipmentItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ShipmentItem} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ShipmentItem} The populated <code>ShipmentItem</code> instance.
   */
 ...
 * @member {Array.<module:js_client.finances_v0.model/ChargeComponent>} itemChargeList
 */
ShipmentItem.prototype.itemChargeList = undefined;

/**
 * A list of charge information on the seller's account.
 * @member {Array.<module:js_client.finances_v0.model/ChargeComponent>} itemChargeAdjustmentList
 */
ShipmentItem.prototype.itemChargeAdjustmentList = undefined;

/**
 * A list of fee component information.
 * @member {Array.<module:js_client.finances_v0.model/FeeComponent>} itemFeeList
 */
ShipmentItem.prototype.itemFeeList = undefined;

/**
 * A list of fee component information.
 * @member {Array.<module:js_client.finances_v0.model/FeeComponent>} itemFeeAdjustmentList
 */
ShipmentItem.prototype.itemFeeAdjustmentList = undefined;

/**
 * A list of information about taxes withheld.
 * @member {Array.<module:js_client.finances_v0.model/TaxWithheldComponent>} itemTaxWithheldList
 */
ShipmentItem.prototype.itemTaxWithheldList = undefined;

/**
 * A list of promotions.
 * @member {Array.<module:js_client.finances_v0.model/Promotion>} promotionList
 */
ShipmentItem.prototype.promotionList = undefined;

/**
 * A list of promotions.
 * @member {Array.<module:js_client.finances_v0.model/Promotion>} promotionAdjustmentList
 */
ShipmentItem.prototype.promotionAdjustmentList = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} costOfPointsGranted
 */
ShipmentItem.prototype.costOfPointsGranted = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} costOfPointsReturned
 */
