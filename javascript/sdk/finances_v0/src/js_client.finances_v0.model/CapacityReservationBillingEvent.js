 ...
 * @module js_client.finances_v0.model/CapacityReservationBillingEvent
 * @version v0
 */
export class CapacityReservationBillingEvent {
   ...
   * @alias module:js_client.finances_v0.model/CapacityReservationBillingEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/CapacityReservationBillingEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/CapacityReservationBillingEvent} The populated <code>CapacityReservationBillingEvent</code> instance.
   */
