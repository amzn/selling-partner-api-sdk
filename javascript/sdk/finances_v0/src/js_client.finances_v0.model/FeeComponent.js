 ...
 * @module js_client.finances_v0.model/FeeComponent
 * @version v0
 */
export class FeeComponent {
   ...
   * @alias module:js_client.finances_v0.model/FeeComponent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/FeeComponent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/FeeComponent} The populated <code>FeeComponent</code> instance.
   */
