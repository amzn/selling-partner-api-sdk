 ...
 * @module js_client.finances_v0.model/TaxWithholdingPeriod
 * @version v0
 */
export class TaxWithholdingPeriod {
   ...
   * @alias module:js_client.finances_v0.model/TaxWithholdingPeriod
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/TaxWithholdingPeriod} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/TaxWithholdingPeriod} The populated <code>TaxWithholdingPeriod</code> instance.
   */
