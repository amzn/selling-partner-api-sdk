 ...
 * @module js_client.finances_v0.model/ChargeInstrument
 * @version v0
 */
export class ChargeInstrument {
   ...
   * @alias module:js_client.finances_v0.model/ChargeInstrument
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/ChargeInstrument} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/ChargeInstrument} The populated <code>ChargeInstrument</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} amount
 */
