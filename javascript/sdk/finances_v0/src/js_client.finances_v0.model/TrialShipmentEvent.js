 ...
 * @module js_client.finances_v0.model/TrialShipmentEvent
 * @version v0
 */
export class TrialShipmentEvent {
   ...
   * @alias module:js_client.finances_v0.model/TrialShipmentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/TrialShipmentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/TrialShipmentEvent} The populated <code>TrialShipmentEvent</code> instance.
   */
