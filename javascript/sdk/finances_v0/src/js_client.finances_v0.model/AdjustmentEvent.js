 ...
 * @module js_client.finances_v0.model/AdjustmentEvent
 * @version v0
 */
export class AdjustmentEvent {
   ...
   * @alias module:js_client.finances_v0.model/AdjustmentEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/AdjustmentEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/AdjustmentEvent} The populated <code>AdjustmentEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} adjustmentAmount
 */
 ...
 * @member {Array.<module:js_client.finances_v0.model/AdjustmentItem>} adjustmentItemList
 */
