 ...
 * @module js_client.finances_v0.model/RetrochargeEvent
 * @version v0
 */
export class RetrochargeEvent {
   ...
   * @alias module:js_client.finances_v0.model/RetrochargeEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RetrochargeEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RetrochargeEvent} The populated <code>RetrochargeEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} baseTax
 */
RetrochargeEvent.prototype.baseTax = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} shippingTax
 */
 ...
 * @member {Array.<module:js_client.finances_v0.model/TaxWithheldComponent>} retrochargeTaxWithheldList
 */
