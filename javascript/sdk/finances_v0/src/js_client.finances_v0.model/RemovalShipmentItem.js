 ...
 * @module js_client.finances_v0.model/RemovalShipmentItem
 * @version v0
 */
export class RemovalShipmentItem {
   ...
   * @alias module:js_client.finances_v0.model/RemovalShipmentItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/RemovalShipmentItem} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/RemovalShipmentItem} The populated <code>RemovalShipmentItem</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/Currency} revenue
 */
RemovalShipmentItem.prototype.revenue = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} feeAmount
 */
RemovalShipmentItem.prototype.feeAmount = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxAmount
 */
RemovalShipmentItem.prototype.taxAmount = undefined;

/**
 * @member {module:js_client.finances_v0.model/Currency} taxWithheld
 */
