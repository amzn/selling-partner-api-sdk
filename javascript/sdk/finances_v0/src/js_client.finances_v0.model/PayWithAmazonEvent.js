 ...
 * @module js_client.finances_v0.model/PayWithAmazonEvent
 * @version v0
 */
export class PayWithAmazonEvent {
   ...
   * @alias module:js_client.finances_v0.model/PayWithAmazonEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.finances_v0.model/PayWithAmazonEvent} obj Optional instance to populate.
   * @return {module:js_client.finances_v0.model/PayWithAmazonEvent} The populated <code>PayWithAmazonEvent</code> instance.
   */
...
/**
 * @member {module:js_client.finances_v0.model/ChargeComponent} charge
 */
PayWithAmazonEvent.prototype.charge = undefined;

/**
 * A list of fee component information.
 * @member {Array.<module:js_client.finances_v0.model/FeeComponent>} feeList
 */
