...
(function(root, factory) {
  ...
  describe('ShipmentDates', function() {
    it('should create an instance of ShipmentDates', function() {
      // uncomment below and update the code to test ShipmentDates
      //var instance = new SellingPartnerApiForDirectFulfillmentOrders.ShipmentDates();
    ...
    it('should have the property requiredShipDate (base name: "requiredShipDate")', function() {
      // uncomment below and update the code to test the property requiredShipDate
      //var instance = new SellingPartnerApiForDirectFulfillmentOrders.ShipmentDates();
