...
(function(root, factory) {
  ...
  describe('TaxItemDetails', function() {
    it('should create an instance of TaxItemDetails', function() {
      // uncomment below and update the code to test TaxItemDetails
      //var instance = new SellingPartnerApiForDirectFulfillmentOrders.TaxItemDetails();
    ...
    it('should have the property taxLineItem (base name: "taxLineItem")', function() {
      // uncomment below and update the code to test the property taxLineItem
      //var instance = new SellingPartnerApiForDirectFulfillmentOrders.TaxItemDetails();
