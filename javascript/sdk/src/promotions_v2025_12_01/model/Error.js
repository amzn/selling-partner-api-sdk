 ...
 * @module promotions_v2025_12_01/model/Error
 * @version 2025-12-01
 */
export class Error {
  /**
   ...
   * @alias module:promotions_v2025_12_01/model/Error
   * @class
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('itemIdentifier')) { obj.itemIdentifier = ItemIdentifier.constructFromObject(data.itemIdentifier) }
    }
    return obj
  }
}
...
/**
 * @member {ItemIdentifier} itemIdentifier
 * @type {ItemIdentifier}
 */
Error.prototype.itemIdentifier = undefined
