...
export class DefaultApi {
  ...
  /**
     ...
     */
  listTransactionsWithHttpInfo (postedAfter, marketplaceId, opts) {
    opts = opts || {}
    const postBody = null
    ...
    if (marketplaceId === undefined || marketplaceId === null) {
      throw new Error("Missing the required parameter 'marketplaceId' when calling listTransactions")
    }
  ...
  /**
     ...
     * @return {Promise<ListTransactionsResponse>}
     */
  listTransactions (postedAfter, marketplaceId, opts) {
    return this.listTransactionsWithHttpInfo(postedAfter, marketplaceId, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
