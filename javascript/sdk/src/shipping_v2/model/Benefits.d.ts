...
export class Benefits {
     ...
     * @class
     * @param includedBenefits {Array[]} A list of included benefits.
     * @param excludedBenefits {Array[]} A list of excluded benefit. Refer to the ExcludeBenefit object for further documentation
     */
    constructor(includedBenefits: any[][], excludedBenefits: any[][]);
