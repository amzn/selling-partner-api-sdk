...
* @alias module:orders_v2026_01_01/ApiClient
* @class
*/
export class ApiClient {
    ...
    /**
      ...
      * @param {module:orders_v2026_01_01/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
