...
export class SerialNumberRequirement {
  /**
   * Constructs a new <code>SerialNumberRequirement</code>.
   * Whether serial numbers must be provided for this line item.
   * @alias module:orders_v2026_01_01/model/SerialNumberRequirement
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new SerialNumberRequirement()
      if (data.hasOwnProperty('requirementType')) { obj.requirementType = ApiClient.convertToType(data.requirementType, 'String') }
    }
    return obj
  }
}
 ...
 * @type {String}
 */
SerialNumberRequirement.prototype.requirementType = undefined
