...
export class ItemPicking {
  /**
   * Constructs a new <code>ItemPicking</code>.
   * Information related to the warehouse picking process for an order item.
   * @alias module:orders_v2026_01_01/model/ItemPicking
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ItemPicking()
      if (data.hasOwnProperty('substitutionPreference')) { obj.substitutionPreference = ItemSubstitutionPreference.constructFromObject(data.substitutionPreference) }
    }
    return obj
  }
}
 ...
 */
ItemPicking.prototype.substitutionPreference = undefined
