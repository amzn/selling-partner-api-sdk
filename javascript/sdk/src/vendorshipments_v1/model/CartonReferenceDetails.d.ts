...
export class CartonReferenceDetails {
     ...
     * @class
     * @param cartonReferenceNumbers {Array[]} Array of reference numbers for the carton that are part of this pallet/shipment. Please provide the cartonSequenceNumber from the 'cartons' segment to refer to that carton's details here.
     */
    constructor(cartonReferenceNumbers: any[][]);
    cartonReferenceNumbers: any[][];
    /**
