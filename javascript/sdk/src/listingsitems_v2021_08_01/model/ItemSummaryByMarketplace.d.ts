...
export class ItemSummaryByMarketplace {
     ...
     * @param status {Array[]} Statuses that apply to the listings item.
     ...
     */
    constructor(marketplaceId: string, productType: string, status: any[][], createdDate: Date, lastUpdatedDate: Date);
