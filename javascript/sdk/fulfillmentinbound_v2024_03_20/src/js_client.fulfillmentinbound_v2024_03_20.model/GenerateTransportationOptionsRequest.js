 ...
 * @module js_client.fulfillmentinbound_v2024_03_20.model/GenerateTransportationOptionsRequest
 * @version 2024-03-20
 */
export class GenerateTransportationOptionsRequest {
   ...
   * @alias module:js_client.fulfillmentinbound_v2024_03_20.model/GenerateTransportationOptionsRequest
   * @class
   * @param placementOptionId {String} The placement option to generate transportation options for.
   * @param shipmentTransportationConfigurations {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/ShipmentTransportationConfiguration>} List of shipment transportation configurations.
   */
   ...
   * @param {module:js_client.fulfillmentinbound_v2024_03_20.model/GenerateTransportationOptionsRequest} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v2024_03_20.model/GenerateTransportationOptionsRequest} The populated <code>GenerateTransportationOptionsRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/ShipmentTransportationConfiguration>} shipmentTransportationConfigurations
 */
