 ...
 * @module js_client.fulfillmentinbound_v2024_03_20.model/PackingOption
 * @version 2024-03-20
 */
export class PackingOption {
   ...
   * @alias module:js_client.fulfillmentinbound_v2024_03_20.model/PackingOption
   * @class
   * @param discounts {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/Incentive>} Discount for the offered option.
   * @param fees {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/Incentive>} Fee for the offered option.
   ...
   * @param supportedConfigurations {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/PackingConfiguration>} A list of possible configurations for this option.
   * @param supportedShippingConfigurations {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/ShippingConfiguration>} **This field is deprecated**. Use the `shippingRequirements` property under `supportedConfigurations` instead. List of supported shipping modes.
   */
   ...
   * @param {module:js_client.fulfillmentinbound_v2024_03_20.model/PackingOption} obj Optional instance to populate.
   * @return {module:js_client.fulfillmentinbound_v2024_03_20.model/PackingOption} The populated <code>PackingOption</code> instance.
   */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/Incentive>} discounts
 */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/Incentive>} fees
 */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/PackingConfiguration>} supportedConfigurations
 */
 ...
 * @member {Array.<module:js_client.fulfillmentinbound_v2024_03_20.model/ShippingConfiguration>} supportedShippingConfigurations
 */
