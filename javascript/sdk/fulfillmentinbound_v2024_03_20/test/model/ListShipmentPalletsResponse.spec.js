...
(function(root, factory) {
  ...
  describe('ListShipmentPalletsResponse', function() {
    it('should create an instance of ListShipmentPalletsResponse', function() {
      // uncomment below and update the code to test ListShipmentPalletsResponse
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ListShipmentPalletsResponse();
