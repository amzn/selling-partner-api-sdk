...
(function(root, factory) {
  ...
  describe('PackingConfiguration', function() {
    it('should create an instance of PackingConfiguration', function() {
      // uncomment below and update the code to test PackingConfiguration
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.PackingConfiguration();
    ...
    it('should have the property boxPackingMethods (base name: "boxPackingMethods")', function() {
      // uncomment below and update the code to test the property boxPackingMethods
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.PackingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property boxRequirements (base name: "boxRequirements")', function() {
      // uncomment below and update the code to test the property boxRequirements
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.PackingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property shippingRequirements (base name: "shippingRequirements")', function() {
      // uncomment below and update the code to test the property shippingRequirements
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.PackingConfiguration();
      //expect(instance).to.be();
    });
