...
(function(root, factory) {
  ...
  describe('OwnerConstraint', function() {
    it('should create an instance of OwnerConstraint', function() {
      // uncomment below and update the code to test OwnerConstraint
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.OwnerConstraint();
      //expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.OwnerConstraint);
    });
