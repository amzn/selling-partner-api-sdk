...
(function(root, factory) {
  ...
  describe('ListPackingOptionsResponse', function() {
    it('should create an instance of ListPackingOptionsResponse', function() {
      // uncomment below and update the code to test ListPackingOptionsResponse
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ListPackingOptionsResponse();
