...
(function(root, factory) {
  ...
  describe('SelfShipAppointmentSlotsAvailability', function() {
    it('should create an instance of SelfShipAppointmentSlotsAvailability', function() {
      // uncomment below and update the code to test SelfShipAppointmentSlotsAvailability
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.SelfShipAppointmentSlotsAvailability();
