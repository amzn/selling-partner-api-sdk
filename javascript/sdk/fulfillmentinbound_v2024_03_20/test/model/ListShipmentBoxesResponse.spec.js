...
(function(root, factory) {
  ...
  describe('ListShipmentBoxesResponse', function() {
    it('should create an instance of ListShipmentBoxesResponse', function() {
      // uncomment below and update the code to test ListShipmentBoxesResponse
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ListShipmentBoxesResponse();
