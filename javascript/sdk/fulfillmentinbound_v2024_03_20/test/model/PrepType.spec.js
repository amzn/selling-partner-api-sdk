...
(function(root, factory) {
  ...
  describe('PrepType', function() {
    it('should create an instance of PrepType', function() {
      // uncomment below and update the code to test PrepType
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.PrepType();
      //expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.PrepType);
    });
