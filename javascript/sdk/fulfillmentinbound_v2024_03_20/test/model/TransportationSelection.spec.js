...
(function(root, factory) {
  ...
  describe('TransportationSelection', function() {
    it('should create an instance of TransportationSelection', function() {
      // uncomment below and update the code to test TransportationSelection
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.TransportationSelection();
