...
(function(root, factory) {
  ...
  describe('CreateInboundPlanRequest', function() {
    it('should create an instance of CreateInboundPlanRequest', function() {
      // uncomment below and update the code to test CreateInboundPlanRequest
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.CreateInboundPlanRequest();
    ...
    it('should have the property destinationMarketplaces (base name: "destinationMarketplaces")', function() {
      // uncomment below and update the code to test the property destinationMarketplaces
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.CreateInboundPlanRequest();
