...
(function(root, factory) {
  ...
  describe('AppointmentSlot', function() {
    it('should create an instance of AppointmentSlot', function() {
      // uncomment below and update the code to test AppointmentSlot
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.AppointmentSlot();
    ...
    it('should have the property slotTime (base name: "slotTime")', function() {
      // uncomment below and update the code to test the property slotTime
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.AppointmentSlot();
      //expect(instance).to.be();
    });
