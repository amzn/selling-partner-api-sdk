...
(function(root, factory) {
  ...
  describe('ListDeliveryWindowOptionsResponse', function() {
    it('should create an instance of ListDeliveryWindowOptionsResponse', function() {
      // uncomment below and update the code to test ListDeliveryWindowOptionsResponse
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ListDeliveryWindowOptionsResponse();
    ...
    it('should have the property deliveryWindowOptions (base name: "deliveryWindowOptions")', function() {
      // uncomment below and update the code to test the property deliveryWindowOptions
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ListDeliveryWindowOptionsResponse();
