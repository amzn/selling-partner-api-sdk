...
(function(root, factory) {
  ...
  describe('Stackability', function() {
    it('should create an instance of Stackability', function() {
      // uncomment below and update the code to test Stackability
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.Stackability();
      //expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.Stackability);
    });
