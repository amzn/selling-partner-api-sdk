...
(function(root, factory) {
  ...
  describe('UpdateItemComplianceDetailsRequest', function() {
    it('should create an instance of UpdateItemComplianceDetailsRequest', function() {
      // uncomment below and update the code to test UpdateItemComplianceDetailsRequest
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.UpdateItemComplianceDetailsRequest();
