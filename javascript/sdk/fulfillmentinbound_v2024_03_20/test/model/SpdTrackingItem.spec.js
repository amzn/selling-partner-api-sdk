...
(function(root, factory) {
  ...
  describe('SpdTrackingItem', function() {
    it('should create an instance of SpdTrackingItem', function() {
      // uncomment below and update the code to test SpdTrackingItem
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.SpdTrackingItem();
    ...
    it('should have the property trackingNumberValidationStatus (base name: "trackingNumberValidationStatus")', function() {
      // uncomment below and update the code to test the property trackingNumberValidationStatus
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.SpdTrackingItem();
      //expect(instance).to.be();
    });
