...
(function(root, factory) {
  ...
  describe('CancelSelfShipAppointmentResponse', function() {
    it('should create an instance of CancelSelfShipAppointmentResponse', function() {
      // uncomment below and update the code to test CancelSelfShipAppointmentResponse
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.CancelSelfShipAppointmentResponse();
