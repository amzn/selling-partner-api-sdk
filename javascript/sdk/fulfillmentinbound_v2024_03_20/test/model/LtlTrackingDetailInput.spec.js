...
(function(root, factory) {
  ...
  describe('LtlTrackingDetailInput', function() {
    it('should create an instance of LtlTrackingDetailInput', function() {
      // uncomment below and update the code to test LtlTrackingDetailInput
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.LtlTrackingDetailInput();
    ...
    it('should have the property freightBillNumber (base name: "freightBillNumber")', function() {
      // uncomment below and update the code to test the property freightBillNumber
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.LtlTrackingDetailInput();
      //expect(instance).to.be();
    });
