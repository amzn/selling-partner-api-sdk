...
(function(root, factory) {
  ...
  describe('GenerateShipmentContentUpdatePreviewsRequest', function() {
    it('should create an instance of GenerateShipmentContentUpdatePreviewsRequest', function() {
      // uncomment below and update the code to test GenerateShipmentContentUpdatePreviewsRequest
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.GenerateShipmentContentUpdatePreviewsRequest();
