...
(function(root, factory) {
  ...
  describe('UnitOfWeight', function() {
    it('should create an instance of UnitOfWeight', function() {
      ...
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.UnitOfWeight();
      //expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.UnitOfWeight);
    });
