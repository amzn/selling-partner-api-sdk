...
(function(root, factory) {
  ...
  describe('TaxRate', function() {
    it('should create an instance of TaxRate', function() {
      ...
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.TaxRate();
    ...
    it('should have the property cessRate (base name: "cessRate")', function() {
      // uncomment below and update the code to test the property cessRate
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.TaxRate();
      //expect(instance).to.be();
    });

    it('should have the property gstRate (base name: "gstRate")', function() {
      // uncomment below and update the code to test the property gstRate
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.TaxRate();
      //expect(instance).to.be();
    });
