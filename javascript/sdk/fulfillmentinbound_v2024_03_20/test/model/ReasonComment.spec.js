...
(function(root, factory) {
  ...
  describe('ReasonComment', function() {
    it('should create an instance of ReasonComment', function() {
      // uncomment below and update the code to test ReasonComment
      //var instance = new TheSellingPartnerApiForFbaInboundOperations.ReasonComment();
      //expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ReasonComment);
    });
