 ...
 * @module js_client.vendordfinventory_v1.model/ItemDetails
 * @version v1
 */
export class ItemDetails {
   ...
   * @alias module:js_client.vendordfinventory_v1.model/ItemDetails
   * @class
   * @param availableQuantity {module:js_client.vendordfinventory_v1.model/ItemQuantity} 
   */
   ...
   * @param {module:js_client.vendordfinventory_v1.model/ItemDetails} obj Optional instance to populate.
   * @return {module:js_client.vendordfinventory_v1.model/ItemDetails} The populated <code>ItemDetails</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfinventory_v1.model/ItemQuantity} availableQuantity
 */
