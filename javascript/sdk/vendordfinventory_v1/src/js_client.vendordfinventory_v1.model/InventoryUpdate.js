 ...
 * @module js_client.vendordfinventory_v1.model/InventoryUpdate
 * @version v1
 */
export class InventoryUpdate {
   ...
   * @alias module:js_client.vendordfinventory_v1.model/InventoryUpdate
   * @class
   * @param sellingParty {module:js_client.vendordfinventory_v1.model/PartyIdentification} 
   ...
   * @param items {Array.<module:js_client.vendordfinventory_v1.model/ItemDetails>} A list of inventory items with updated details, including quantity available.
   */
   ...
   * @param {module:js_client.vendordfinventory_v1.model/InventoryUpdate} obj Optional instance to populate.
   * @return {module:js_client.vendordfinventory_v1.model/InventoryUpdate} The populated <code>InventoryUpdate</code> instance.
   */
...
/**
 * @member {module:js_client.vendordfinventory_v1.model/PartyIdentification} sellingParty
 */
 ...
 * @member {Array.<module:js_client.vendordfinventory_v1.model/ItemDetails>} items
 */
