...
* @module js_client.vendordfinventory_v1.api/UpdateInventoryApi
* @version v1
*/
export class UpdateInventoryApi {
    ...
    * @alias module:js_client.vendordfinventory_v1.api/UpdateInventoryApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.vendordfinventory_v1.model/SubmitInventoryUpdateRequest} body The request body containing the inventory update data to submit.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.vendordfinventory_v1.model/SubmitInventoryUpdateResponse} and HTTP response
     */
     ...
     * @param {String} warehouseId Identifier for the warehouse for which to update inventory.
     * @param {module:js_client.vendordfinventory_v1.model/SubmitInventoryUpdateRequest} body The request body containing the inventory update data to submit.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.vendordfinventory_v1.model/SubmitInventoryUpdateResponse}
     */
