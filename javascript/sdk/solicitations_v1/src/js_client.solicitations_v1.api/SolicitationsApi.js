...
* @module js_client.solicitations_v1.api/SolicitationsApi
* @version v1
*/
export class SolicitationsApi {
    ...
    * @alias module:js_client.solicitations_v1.api/SolicitationsApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse} and HTTP response
     */
     ...
     * @param {String} amazonOrderId An Amazon order identifier. This specifies the order for which a solicitation is sent.
     * @param {Array.<String>} marketplaceIds A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse}
     */
     ...
     * @param {Array.<String>} marketplaceIds A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.solicitations_v1.model/GetSolicitationActionsForOrderResponse} and HTTP response
     */
     ...
     * @param {String} amazonOrderId An Amazon order identifier. This specifies the order for which you want a list of available solicitation types.
     * @param {Array.<String>} marketplaceIds A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.solicitations_v1.model/GetSolicitationActionsForOrderResponse}
     */
