 ...
 * @module js_client.solicitations_v1.model/GetSchemaResponse
 * @version v1
 */
export class GetSchemaResponse {
  /**
   * Constructs a new <code>GetSchemaResponse</code>.
   * @alias module:js_client.solicitations_v1.model/GetSchemaResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.solicitations_v1.model/GetSchemaResponse} obj Optional instance to populate.
   * @return {module:js_client.solicitations_v1.model/GetSchemaResponse} The populated <code>GetSchemaResponse</code> instance.
   */
...
/**
 * @member {module:js_client.solicitations_v1.model/GetSchemaResponseLinks} links
 */
