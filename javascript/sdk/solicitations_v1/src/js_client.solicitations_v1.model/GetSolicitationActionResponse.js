 ...
 * @module js_client.solicitations_v1.model/GetSolicitationActionResponse
 * @version v1
 */
export class GetSolicitationActionResponse {
   ...
   * @alias module:js_client.solicitations_v1.model/GetSolicitationActionResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.solicitations_v1.model/GetSolicitationActionResponse} obj Optional instance to populate.
   * @return {module:js_client.solicitations_v1.model/GetSolicitationActionResponse} The populated <code>GetSolicitationActionResponse</code> instance.
   */
...
/**
 * @member {module:js_client.solicitations_v1.model/GetSolicitationActionResponseLinks} links
 */
GetSolicitationActionResponse.prototype.links = undefined;

/**
 * @member {module:js_client.solicitations_v1.model/GetSolicitationActionResponseEmbedded} embedded
 */
GetSolicitationActionResponse.prototype.embedded = undefined;

/**
 * @member {module:js_client.solicitations_v1.model/SolicitationsAction} payload
 */
GetSolicitationActionResponse.prototype.payload = undefined;

/**
 * A list of error responses returned when a request is unsuccessful.
 * @member {Array.<module:js_client.solicitations_v1.model/Error>} errors
 */
