 ...
 * @module js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse
 * @version v1
 */
export class CreateProductReviewAndSellerFeedbackSolicitationResponse {
   ...
   * @alias module:js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse} obj Optional instance to populate.
   * @return {module:js_client.solicitations_v1.model/CreateProductReviewAndSellerFeedbackSolicitationResponse} The populated <code>CreateProductReviewAndSellerFeedbackSolicitationResponse</code> instance.
   */
