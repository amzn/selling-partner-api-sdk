...
* @module js_client.fbainventory_v1.api/FbaInventoryApi
* @version v1
*/
export class FbaInventoryApi {
    ...
    * @alias module:js_client.fbainventory_v1.api/FbaInventoryApi
    * @class
    ...
    */
     ...
     * @param {module:js_client.fbainventory_v1.model/AddInventoryRequest} addInventoryRequestBody List of items to add to Sandbox inventory.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.fbainventory_v1.model/AddInventoryResponse} and HTTP response
     */
     ...
     * @param {String} xAmznIdempotencyToken A unique token/requestId provided with each call to ensure idempotency.
     * @param {module:js_client.fbainventory_v1.model/AddInventoryRequest} addInventoryRequestBody List of items to add to Sandbox inventory.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.fbainventory_v1.model/AddInventoryResponse}
     */
     ...
     * @param {module:js_client.fbainventory_v1.model/CreateInventoryItemRequest} createInventoryItemRequestBody CreateInventoryItem Request Body Parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.fbainventory_v1.model/CreateInventoryItemResponse} and HTTP response
     */
     ...
     * Requests that Amazon create product-details in the Sandbox Inventory in the sandbox environment. This is a sandbox-only operation and must be directed to a sandbox endpoint. Refer to [Selling Partner API sandbox](https://developer-docs.amazon.com/sp-api/docs/the-selling-partner-api-sandbox) for more information.
     * @param {module:js_client.fbainventory_v1.model/CreateInventoryItemRequest} createInventoryItemRequestBody CreateInventoryItem Request Body Parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.fbainventory_v1.model/CreateInventoryItemResponse}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.fbainventory_v1.model/DeleteInventoryItemResponse} and HTTP response
     */
     ...
     * @param {String} sellerSku A single seller SKU used for querying the specified seller SKU inventory summaries.
     * @param {String} marketplaceId The marketplace ID for the marketplace for which the sellerSku is to be deleted.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.fbainventory_v1.model/DeleteInventoryItemResponse}
     */
     ...
     * @param {module:js_client.fbainventory_v1.model/String} granularityType The granularity type for the inventory aggregation level.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:js_client.fbainventory_v1.model/GetInventorySummariesResponse} and HTTP response
     */
     ...
     * @param {String} opts.sellerSku A single seller SKU used for querying the specified seller SKU inventory summaries.
     * @param {String} opts.nextToken String token returned in the response of your previous request. The string token will expire 30 seconds after being created.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:js_client.fbainventory_v1.model/GetInventorySummariesResponse}
     */
