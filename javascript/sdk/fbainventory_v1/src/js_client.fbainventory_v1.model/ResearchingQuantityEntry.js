 ...
 * @module js_client.fbainventory_v1.model/ResearchingQuantityEntry
 * @version v1
 */
export class ResearchingQuantityEntry {
   ...
   * @alias module:js_client.fbainventory_v1.model/ResearchingQuantityEntry
   * @class
   * @param name {module:js_client.fbainventory_v1.model/ResearchingQuantityEntry.NameEnum} The duration of the research.
   ...
   * @param {module:js_client.fbainventory_v1.model/ResearchingQuantityEntry} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/ResearchingQuantityEntry} The populated <code>ResearchingQuantityEntry</code> instance.
   */
 ...
 * @member {module:js_client.fbainventory_v1.model/ResearchingQuantityEntry.NameEnum} name
 */
