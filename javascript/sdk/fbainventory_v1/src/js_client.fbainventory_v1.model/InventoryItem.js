 ...
 * @module js_client.fbainventory_v1.model/InventoryItem
 * @version v1
 */
export class InventoryItem {
   ...
   * @alias module:js_client.fbainventory_v1.model/InventoryItem
   * @class
   ...
   * @param {module:js_client.fbainventory_v1.model/InventoryItem} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/InventoryItem} The populated <code>InventoryItem</code> instance.
   */
