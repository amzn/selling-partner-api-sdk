 ...
 * @module js_client.fbainventory_v1.model/UnfulfillableQuantity
 * @version v1
 */
export class UnfulfillableQuantity {
   ...
   * @alias module:js_client.fbainventory_v1.model/UnfulfillableQuantity
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fbainventory_v1.model/UnfulfillableQuantity} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/UnfulfillableQuantity} The populated <code>UnfulfillableQuantity</code> instance.
   */
