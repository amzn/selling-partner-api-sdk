 ...
 * @module js_client.fbainventory_v1.model/ReservedQuantity
 * @version v1
 */
export class ReservedQuantity {
   ...
   * @alias module:js_client.fbainventory_v1.model/ReservedQuantity
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fbainventory_v1.model/ReservedQuantity} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/ReservedQuantity} The populated <code>ReservedQuantity</code> instance.
   */
