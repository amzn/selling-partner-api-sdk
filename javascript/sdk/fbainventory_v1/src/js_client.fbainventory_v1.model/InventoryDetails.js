 ...
 * @module js_client.fbainventory_v1.model/InventoryDetails
 * @version v1
 */
export class InventoryDetails {
   ...
   * @alias module:js_client.fbainventory_v1.model/InventoryDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fbainventory_v1.model/InventoryDetails} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/InventoryDetails} The populated <code>InventoryDetails</code> instance.
   */
...
/**
 * @member {module:js_client.fbainventory_v1.model/ReservedQuantity} reservedQuantity
 */
InventoryDetails.prototype.reservedQuantity = undefined;

/**
 * @member {module:js_client.fbainventory_v1.model/ResearchingQuantity} researchingQuantity
 */
InventoryDetails.prototype.researchingQuantity = undefined;

/**
 * @member {module:js_client.fbainventory_v1.model/UnfulfillableQuantity} unfulfillableQuantity
 */
