 ...
 * @module js_client.fbainventory_v1.model/CreateInventoryItemRequest
 * @version v1
 */
export class CreateInventoryItemRequest {
   ...
   * @alias module:js_client.fbainventory_v1.model/CreateInventoryItemRequest
   * @class
   ...
   * @param {module:js_client.fbainventory_v1.model/CreateInventoryItemRequest} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/CreateInventoryItemRequest} The populated <code>CreateInventoryItemRequest</code> instance.
   */
