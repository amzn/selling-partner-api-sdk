 ...
 * @module js_client.fbainventory_v1.model/InventorySummary
 * @version v1
 */
export class InventorySummary {
   ...
   * @alias module:js_client.fbainventory_v1.model/InventorySummary
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fbainventory_v1.model/InventorySummary} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/InventorySummary} The populated <code>InventorySummary</code> instance.
   */
...
/**
 * @member {module:js_client.fbainventory_v1.model/InventoryDetails} inventoryDetails
 */
