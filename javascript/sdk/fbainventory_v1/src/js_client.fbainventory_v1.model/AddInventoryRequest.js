 ...
 * @module js_client.fbainventory_v1.model/AddInventoryRequest
 * @version v1
 */
export class AddInventoryRequest {
   ...
   * @alias module:js_client.fbainventory_v1.model/AddInventoryRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.fbainventory_v1.model/AddInventoryRequest} obj Optional instance to populate.
   * @return {module:js_client.fbainventory_v1.model/AddInventoryRequest} The populated <code>AddInventoryRequest</code> instance.
   */
 ...
 * @member {Array.<module:js_client.fbainventory_v1.model/InventoryItem>} inventoryItems
 */
