 ...
 * @module js_client.listingsrestrictions_v2021_08_01.model/Link
 * @version 2021-08-01
 */
export class Link {
  /**
   ...
   * @alias module:js_client.listingsrestrictions_v2021_08_01.model/Link
   * @class
   * @param resource {String} The URI of the related resource.
   * @param verb {module:js_client.listingsrestrictions_v2021_08_01.model/Link.VerbEnum} The HTTP verb used to interact with the related resource.
   */
   ...
   * @param {module:js_client.listingsrestrictions_v2021_08_01.model/Link} obj Optional instance to populate.
   * @return {module:js_client.listingsrestrictions_v2021_08_01.model/Link} The populated <code>Link</code> instance.
   */
 ...
 * @member {module:js_client.listingsrestrictions_v2021_08_01.model/Link.VerbEnum} verb
 */
