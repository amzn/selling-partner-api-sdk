 ...
 * @module js_client.vehicles_v2024_11_01.model/Vehicle
 * @version 2024-11-01
 */
export class Vehicle {
   ...
   * @alias module:js_client.vehicles_v2024_11_01.model/Vehicle
   * @class
   * @param make {String} Vehicle Brand.
   * @param model {String} Specific model of a vehicle.
   * @param identifiers {Array.<module:js_client.vehicles_v2024_11_01.model/VehicleIdentifiers>} Identifiers that can be used to identify the vehicle uniquely
   */
   ...
   * @param {module:js_client.vehicles_v2024_11_01.model/Vehicle} obj Optional instance to populate.
   * @return {module:js_client.vehicles_v2024_11_01.model/Vehicle} The populated <code>Vehicle</code> instance.
   */
 ...
 * @member {Array.<module:js_client.vehicles_v2024_11_01.model/EngineOutput>} engineOutput
 */
Vehicle.prototype.engineOutput = undefined;

/**
 * @member {module:js_client.vehicles_v2024_11_01.model/MonthAndYear} manufacturingStartDate
 */
Vehicle.prototype.manufacturingStartDate = undefined;

/**
 * @member {module:js_client.vehicles_v2024_11_01.model/MonthAndYear} manufacturingStopDate
 */
...
/**
 * @member {module:js_client.vehicles_v2024_11_01.model/VehicleStatusInCatalog} status
 */
Vehicle.prototype.status = undefined;

/**
 * Identifiers that can be used to identify the vehicle uniquely
 * @member {Array.<module:js_client.vehicles_v2024_11_01.model/VehicleIdentifiers>} identifiers
 */
