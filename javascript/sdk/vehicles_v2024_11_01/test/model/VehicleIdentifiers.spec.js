...
(function(root, factory) {
  ...
  describe('VehicleIdentifiers', function() {
    it('should create an instance of VehicleIdentifiers', function() {
      // uncomment below and update the code to test VehicleIdentifiers
      //var instance = new TheSellingPartnerApiForAutomotive.VehicleIdentifiers();
