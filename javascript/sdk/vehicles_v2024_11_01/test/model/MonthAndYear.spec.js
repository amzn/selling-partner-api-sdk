...
(function(root, factory) {
  ...
  describe('MonthAndYear', function() {
    it('should create an instance of MonthAndYear', function() {
      // uncomment below and update the code to test MonthAndYear
      //var instance = new TheSellingPartnerApiForAutomotive.MonthAndYear();
