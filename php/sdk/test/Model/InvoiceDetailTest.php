...
use OpenAPI\Client\Model\vendorDfPayments\InvoiceDetail;
...
class InvoiceDetailTest extends TestCase
{
    ...
    public function testPropertyRemitToParty()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification();
    ...
    public function testPropertyInvoiceTotal()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorDfPayments\Money();
