...
use OpenAPI\Client\Model\vendorShipments\ShipmentInformation;
...
class ShipmentInformationTest extends TestCase
{
    ...
    public function testPropertyVendorDetails()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\VendorDetails();
    ...
    public function testPropertyShipToParty()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\PartyIdentification();
