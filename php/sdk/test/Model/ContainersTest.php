...
use OpenAPI\Client\Model\vendorShipments\Containers;
...
class ContainersTest extends TestCase
{
    ...
    public function testPropertyDimensions()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\Dimensions();
    ...
    public function testPropertyWeight()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\Weight();
    ...
    public function testPropertyInnerContainersDetails()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\InnerContainersDetails();
