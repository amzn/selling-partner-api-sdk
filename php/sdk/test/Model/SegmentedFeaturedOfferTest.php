...
use OpenAPI\Client\Model\pricing\SegmentedFeaturedOffer;
...
class SegmentedFeaturedOfferTest extends TestCase
{
    ...
    {
        $enumInstance = new \OpenAPI\Client\Model\pricing\Condition();
    ...
    {
        $enumInstance = new \OpenAPI\Client\Model\pricing\FulfillmentType();
        $allowedValues = $enumInstance->getAllowableEnumValues();
        $testValue = reset($allowedValues);
    ...
    public function testPropertyPrimeDetails()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\pricing\PrimeDetails();
