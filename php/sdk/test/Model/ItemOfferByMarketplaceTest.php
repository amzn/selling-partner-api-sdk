...
use OpenAPI\Client\Model\listingsItems\ItemOfferByMarketplace;
...
class ItemOfferByMarketplaceTest extends TestCase
{
    ...
    public function testPropertyPoints()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\listingsItems\Points();
    ...
    public function testPropertyAudience()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\listingsItems\Audience();
