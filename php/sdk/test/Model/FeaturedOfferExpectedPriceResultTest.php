...
use OpenAPI\Client\Model\pricing\FeaturedOfferExpectedPriceResult;
...
class FeaturedOfferExpectedPriceResultTest extends TestCase
{
    ...
    public function testPropertyFeaturedOfferExpectedPrice()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\pricing\FeaturedOfferExpectedPrice();
    ...
    public function testPropertyCompetingFeaturedOffer()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\pricing\FeaturedOffer();
