...
use OpenAPI\Client\Model\vendorShipments\PackedItems;
...
class PackedItemsTest extends TestCase
{
    ...
    public function testPropertyPackedQuantity()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\ItemQuantity();
    ...
    public function testPropertyItemDetails()
    {
        ...
        $testValue = new \OpenAPI\Client\Model\vendorShipments\PackageItemDetails();
