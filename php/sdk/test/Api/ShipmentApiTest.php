...
class ShipmentApiTest extends TestCase
{
    ...
    public function testupdateShipmentStatus()
    {
        ...
        $this->instructBackendMock('shipment', $mockOperationId, '204');
        
        $order_id = $this->generateMockData('string');
        
        $payload = $this->generateMockData('\SpApi\Model\orders\v0\UpdateShipmentStatusRequest');
        

        $response = $this->api->updateShipmentStatusWithHttpInfo($order_id, $payload);
