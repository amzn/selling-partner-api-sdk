 ...
 * @internal
 */
class BatchInventoryApiTest extends TestCase
{
    ...
    public function testbatchInventory()
    {
        ...
        $response = $this->api->batchInventoryWithHttpInfo($body);

        $this->assertEquals(207, $response[1]);
        $this->assertValidResponsePayload(207, $response[0]);
    }
