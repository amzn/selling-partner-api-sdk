...
class UploadsApiTest extends TestCase
{
    ...
    public function testcreateUploadDestinationForResource()
    {
        ...
        $content_md5 = $this->generateMockData('string');
        
        $resource = $this->generateMockData('string');
        

        $response = $this->api->createUploadDestinationForResourceWithHttpInfo($marketplace_ids, $content_md5, $resource, null);
