...
class DefaultApiTest extends BaseTestCase
{
  ...
  &quot;x-amzn-api-sandbox&quot; : {
    ...
    /**
     * Test case for listTransactions_200
     */
    public function testListTransactions200()
    {
        try {
            // Skip test if it is in the skip list
            if ($this->testHelper->shouldSkipTest('testListTransactions200', 'DefaultApi')) {
                $this->assertTrue(true);
                return;
            }
            $jsonSchema = '{
  ...
  &quot;x-amzn-api-sandbox&quot; : {
      ...
      &quot;response&quot; : {
        &quot;payload&quot; : {
          ...
          &quot;Transactions&quot; : [ {
            ...
            // Act: Call API
            list($response, $statusCode, $headers) =
                $this->apiInstance->listTransactionsWithHttpInfo(...array_values($requestParams));
    ...
    /**
     * Test case for listTransactions_400
     */
    public function testListTransactions400()
    {
        try {
            // Skip test if it is in the skip list
            if ($this->testHelper->shouldSkipTest('testListTransactions400', 'DefaultApi')) {
                $this->assertTrue(true);
                return;
            }
            $jsonSchema = '{
  ...
  &quot;x-amzn-api-sandbox&quot; : {
    ...
    /**
     * Test case for listTransactions_403
     */
    public function testListTransactions403()
    {
        // Skip this test
        $this->markTestSkipped('Skip test for this operation.');
    }
    /**
     * Test case for listTransactions_404
     */
    public function testListTransactions404()
    {
        // Skip this test
        $this->markTestSkipped('Skip test for this operation.');
    }
    /**
     * Test case for listTransactions_429
     */
    public function testListTransactions429()
    {
        // Skip this test
        $this->markTestSkipped('Skip test for this operation.');
    }
    /**
     * Test case for listTransactions_500
     */
    public function testListTransactions500()
    {
        // Skip this test
        $this->markTestSkipped('Skip test for this operation.');
    }
    /**
     * Test case for listTransactions_503
     */
    public function testListTransactions503()
    {
        // Skip this test
        $this->markTestSkipped('Skip test for this operation.');
    }
