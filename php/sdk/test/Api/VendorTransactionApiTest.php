...
class VendorTransactionApiTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->api = new VendorTransactionApi($config, null, false);
    }


    public function testgetTransactionStatus()
    {
        $this->instructBackendMock('vendorTransaction', 'getTransactionStatus', '200');
        
        $transaction_id = $this->generateMockData('string');
        

        $response = $this->api->getTransactionStatusWithHttpInfo($transaction_id);
