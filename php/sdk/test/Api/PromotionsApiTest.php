...
use SpApi\Api\Promotions\v2025_12_01\PromotionsApi;
...
class PromotionsApiTest extends TestCase
{
    ...
    public function testgetPromotion()
    {
        ...
        $this->instructBackendMock('promotions', $mockOperationId, '200');
        
        $promotion_id = $this->generateMockData('string');
        

        $response = $this->api->getPromotionWithHttpInfo($promotion_id, null, null);
    ...
    public function testgetSelection()
    {
        ...
        $selection_id = $this->generateMockData('string');
        
        $revision_id = $this->generateMockData('int');
        

        $response = $this->api->getSelectionWithHttpInfo($promotion_id, $selection_id, $revision_id, null, null, null, null);
    ...
    public function testsearchPromotions()
    {
        ...
        $response = $this->api->searchPromotionsWithHttpInfo($marketplace_ids, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
