 ...
 * @internal
 */
class ShipmentProcessingApiTest extends TestCase
{
    private static string $endpoint = 'http://localhost:3000';
    private static string $authEndpoint = 'http://localhost:3000/auth/o2/token';

    private ShipmentProcessingApi $api;
    ...
    protected function setUp(): void
    {
        ...
        $this->api = new ShipmentProcessingApi($config, null, false);
    }
    ...
    public function testcreatePackages()
    {
        ...
        $body = $this->generateMockData('\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Packages');
        

        $response = $this->api->createPackagesWithHttpInfo($shipment_id, $body);
    ...
    public function testgenerateInvoice()
    {
        ...
        $response = $this->api->generateInvoiceWithHttpInfo($shipment_id);
    ...
    public function testgenerateShipLabels()
    {
        ...
        $operation = $this->generateMockData('string');
        

        $response = $this->api->generateShipLabelsWithHttpInfo($shipment_id, $operation, null, null);
    ...
    public function testprocessShipment()
    {
        ...
        $response = $this->api->processShipmentWithHttpInfo($shipment_id, $operation, null);
    ...
    public function testretrieveInvoice()
    {
        ...
        $response = $this->api->retrieveInvoiceWithHttpInfo($shipment_id);
    ...
    public function testretrieveShippingOptions()
    {
        ...
        $response = $this->api->retrieveShippingOptionsWithHttpInfo($shipment_id, $package_id);
    ...
    public function testupdatePackage()
    {
        ...
        $body = $this->generateMockData('\SpApi\Model\externalFulfillment\shipments\v2024_09_11\Package');
        

        $response = $this->api->updatePackageWithHttpInfo($shipment_id, $package_id, $body);
    ...
    public function testupdatePackageStatus()
    {
        ...
        $response = $this->api->updatePackageStatusWithHttpInfo($shipment_id, $package_id, null, null);
