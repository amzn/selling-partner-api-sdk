...
class SolicitationsApiTest extends TestCase
{
    ...
    public function testcreateProductReviewAndSellerFeedbackSolicitation()
    {
        ...
        $response = $this->api->createProductReviewAndSellerFeedbackSolicitationWithHttpInfo($amazon_order_id, $marketplace_ids);
    ...
    public function testgetSolicitationActionsForOrder()
    {
        ...
        $response = $this->api->getSolicitationActionsForOrderWithHttpInfo($amazon_order_id, $marketplace_ids);
