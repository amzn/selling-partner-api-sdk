...
class DeleteNotificationsRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public const DELETION_REASON_INCORRECT_CONTENT = 'INCORRECT_CONTENT';
    public const DELETION_REASON_INCORRECT_RECIPIENT = 'INCORRECT_RECIPIENT';
    ...
    {
        return [
            self::DELETION_REASON_INCORRECT_CONTENT,
            self::DELETION_REASON_INCORRECT_RECIPIENT,
        ];
    }
