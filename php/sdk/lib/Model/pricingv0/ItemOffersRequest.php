...
class ItemOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'uri' => 'string',
             'method' => '\OpenAPI\Client\Model\pricingv0\HttpMethod',
             'headers' => 'array<string,string>',
             'marketplace_id' => 'string',
             'item_condition' => '\OpenAPI\Client\Model\pricingv0\ItemCondition',
             'customer_type' => '\OpenAPI\Client\Model\pricingv0\CustomerType'    ];
