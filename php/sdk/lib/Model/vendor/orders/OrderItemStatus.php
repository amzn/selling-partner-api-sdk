...
class OrderItemStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'net_cost' => '\OpenAPI\Client\Model\vendor.orders\Money',
             'list_price' => '\OpenAPI\Client\Model\vendor.orders\Money',
             'ordered_quantity' => '\OpenAPI\Client\Model\vendor.orders\OrderItemStatusOrderedQuantity',
             'acknowledgement_status' => '\OpenAPI\Client\Model\vendor.orders\OrderItemStatusAcknowledgementStatus',
             'receiving_status' => '\OpenAPI\Client\Model\vendor.orders\OrderItemStatusReceivingStatus'    ];
    ...
    */
     ...
     * Gets net_cost
     *
     * @return \OpenAPI\Client\Model\vendor.orders\Money|null
     */
    public function getNetCost(): ?\OpenAPI\Client\Model\vendor.orders\Money
    {
     ...
     * Sets net_cost
     *
     * @param \OpenAPI\Client\Model\vendor.orders\Money|null $net_cost net_cost
     *
     * @return self
     */
    public function setNetCost(?\OpenAPI\Client\Model\vendor.orders\Money $net_cost): self
    {
        if (is_null($net_cost)) {
     ...
     * @return \OpenAPI\Client\Model\vendor.orders\Money|null
     */
    public function getListPrice(): ?\OpenAPI\Client\Model\vendor.orders\Money
    {
     ...
     * Sets list_price
     *
     * @param \OpenAPI\Client\Model\vendor.orders\Money|null $list_price list_price
     *
     * @return self
     */
    public function setListPrice(?\OpenAPI\Client\Model\vendor.orders\Money $list_price): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendor.orders\OrderItemStatusOrderedQuantity|null
     */
    public function getOrderedQuantity(): ?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusOrderedQuantity
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendor.orders\OrderItemStatusOrderedQuantity|null $ordered_quantity ordered_quantity
     *
     * @return self
     */
    public function setOrderedQuantity(?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusOrderedQuantity $ordered_quantity): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendor.orders\OrderItemStatusAcknowledgementStatus|null
     */
    public function getAcknowledgementStatus(): ?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusAcknowledgementStatus
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendor.orders\OrderItemStatusAcknowledgementStatus|null $acknowledgement_status acknowledgement_status
     *
     * @return self
     */
    public function setAcknowledgementStatus(?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusAcknowledgementStatus $acknowledgement_status): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendor.orders\OrderItemStatusReceivingStatus|null
     */
    public function getReceivingStatus(): ?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusReceivingStatus
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendor.orders\OrderItemStatusReceivingStatus|null $receiving_status receiving_status
     *
     * @return self
     */
    public function setReceivingStatus(?\OpenAPI\Client\Model\vendor.orders\OrderItemStatusReceivingStatus $receiving_status): self
    {
