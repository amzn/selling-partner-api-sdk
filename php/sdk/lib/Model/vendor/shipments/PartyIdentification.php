...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'address' => '\OpenAPI\Client\Model\vendor.shipments\Address',
             'party_id' => 'string',
             'tax_registration_details' => '\OpenAPI\Client\Model\vendor.shipments\TaxRegistrationDetails[]'    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\vendor.shipments\Address|null
     */
    public function getAddress(): ?\OpenAPI\Client\Model\vendor.shipments\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\vendor.shipments\Address|null $address address
     *
     * @return self
     */
    public function setAddress(?\OpenAPI\Client\Model\vendor.shipments\Address $address): self
    {
        if (is_null($address)) {
