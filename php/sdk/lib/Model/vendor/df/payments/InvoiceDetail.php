...
namespace OpenAPI\Client\Model\vendor.df.payments;
...
class InvoiceDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'remit_to_party' => '\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification',
             'ship_from_party' => '\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification',
             'bill_to_party' => '\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification',
             'ship_to_country_code' => 'string',
             'payment_terms_code' => 'string',
             'invoice_total' => '\OpenAPI\Client\Model\vendor.df.payments\Money',
             'tax_totals' => '\OpenAPI\Client\Model\vendor.df.payments\TaxDetail[]',
             'additional_details' => '\OpenAPI\Client\Model\vendor.df.payments\AdditionalDetails[]',
             'charge_details' => '\OpenAPI\Client\Model\vendor.df.payments\ChargeDetails[]',
             'items' => '\OpenAPI\Client\Model\vendor.df.payments\InvoiceItem[]'    ];
    ...
    */
     ...
     * Gets remit_to_party
     *
     * @return \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification
     */
    public function getRemitToParty(): \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification
    {
     ...
     * Sets remit_to_party
     *
     * @param \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification $remit_to_party remit_to_party
     *
     * @return self
     */
    public function setRemitToParty(\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification $remit_to_party): self
    {
     ...
     * @return \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification
     */
    public function getShipFromParty(): \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification $ship_from_party ship_from_party
     *
     * @return self
     */
    public function setShipFromParty(\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification $ship_from_party): self
    {
     ...
     * Gets bill_to_party
     *
     * @return \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification|null
     */
    public function getBillToParty(): ?\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification
    {
     ...
     * Sets bill_to_party
     *
     * @param \OpenAPI\Client\Model\vendor.df.payments\PartyIdentification|null $bill_to_party bill_to_party
     *
     * @return self
     */
    public function setBillToParty(?\OpenAPI\Client\Model\vendor.df.payments\PartyIdentification $bill_to_party): self
    {
     ...
     * Gets invoice_total
     *
     * @return \OpenAPI\Client\Model\vendor.df.payments\Money
     */
    public function getInvoiceTotal(): \OpenAPI\Client\Model\vendor.df.payments\Money
    {
     ...
     * Sets invoice_total
     *
     * @param \OpenAPI\Client\Model\vendor.df.payments\Money $invoice_total invoice_total
     *
     * @return self
     */
    public function setInvoiceTotal(\OpenAPI\Client\Model\vendor.df.payments\Money $invoice_total): self
    {
