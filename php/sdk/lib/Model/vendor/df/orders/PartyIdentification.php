...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'party_id' => 'string',
             'address' => '\OpenAPI\Client\Model\vendor\df\orders\Address',
             'tax_info' => '\OpenAPI\Client\Model\vendor\df\orders\TaxRegistrationDetails'    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\vendor\df\orders\Address|null
     */
    public function getAddress(): ?\OpenAPI\Client\Model\vendor\df\orders\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\vendor\df\orders\Address|null $address address
     *
     * @return self
     */
    public function setAddress(?\OpenAPI\Client\Model\vendor\df\orders\Address $address): self
    {
        if (is_null($address)) {
     ...
     * Gets tax_info
     *
     * @return \OpenAPI\Client\Model\vendor\df\orders\TaxRegistrationDetails|null
     */
    public function getTaxInfo(): ?\OpenAPI\Client\Model\vendor\df\orders\TaxRegistrationDetails
    {
     ...
     * Sets tax_info
     *
     * @param \OpenAPI\Client\Model\vendor\df\orders\TaxRegistrationDetails|null $tax_info tax_info
     *
     * @return self
     */
    public function setTaxInfo(?\OpenAPI\Client\Model\vendor\df\orders\TaxRegistrationDetails $tax_info): self
    {
        if (is_null($tax_info)) {
