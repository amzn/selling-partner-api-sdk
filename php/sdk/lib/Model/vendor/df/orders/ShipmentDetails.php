...
class ShipmentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'is_gift' => 'bool',
             'ship_method' => 'string',
             'shipment_dates' => '\OpenAPI\Client\Model\vendor.df.orders\ShipmentDates',
    ...
    */
     ...
     * Gets shipment_dates
     *
     * @return \OpenAPI\Client\Model\vendor.df.orders\ShipmentDates
     */
    public function getShipmentDates(): \OpenAPI\Client\Model\vendor.df.orders\ShipmentDates
    {
     ...
     * Sets shipment_dates
     *
     * @param \OpenAPI\Client\Model\vendor.df.orders\ShipmentDates $shipment_dates shipment_dates
     *
     * @return self
     */
    public function setShipmentDates(\OpenAPI\Client\Model\vendor.df.orders\ShipmentDates $shipment_dates): self
    {
