...
class ContainerLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'content' => 'string',
             'format' => '\OpenAPI\Client\Model\vendor\df\shipping\ContainerLabelFormat'    ];
    ...
    */
     ...
     *
     * @param string|null $container_tracking_number Container (pallet) tracking identifier from the shipping carrier.
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string $content This field will contain the Base64encoded string of the container label content.
     *
     * @return self
     */
