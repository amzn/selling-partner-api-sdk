...
class SubmitShipmentStatusUpdatesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'shipment_status_updates' => '\OpenAPI\Client\Model\vendor\df\shipping\ShipmentStatusUpdate[]'    ];
    ...
    */
     ...
     *
     * @param array|null $shipment_status_updates Contains a list of one or more ShipmentStatusUpdate objects, each representing an update to the status of a specific shipment.
     *
     * @return self
     */
