...
class FinancialEvents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'shipment_event_list' => '\OpenAPI\Client\Model\financesV0\ShipmentEvent[]',
             'shipment_settle_event_list' => '\OpenAPI\Client\Model\financesV0\ShipmentEvent[]',
             'refund_event_list' => '\OpenAPI\Client\Model\financesV0\ShipmentEvent[]',
             'guarantee_claim_event_list' => '\OpenAPI\Client\Model\financesV0\ShipmentEvent[]',
             'chargeback_event_list' => '\OpenAPI\Client\Model\financesV0\ShipmentEvent[]',
             'pay_with_amazon_event_list' => '\OpenAPI\Client\Model\financesV0\PayWithAmazonEvent[]',
             'service_provider_credit_event_list' => '\OpenAPI\Client\Model\financesV0\SolutionProviderCreditEvent[]',
             'retrocharge_event_list' => '\OpenAPI\Client\Model\financesV0\RetrochargeEvent[]',
             'rental_transaction_event_list' => '\OpenAPI\Client\Model\financesV0\RentalTransactionEvent[]',
             'product_ads_payment_event_list' => '\OpenAPI\Client\Model\financesV0\ProductAdsPaymentEvent[]',
             'service_fee_event_list' => '\OpenAPI\Client\Model\financesV0\ServiceFeeEvent[]',
             'seller_deal_payment_event_list' => '\OpenAPI\Client\Model\financesV0\SellerDealPaymentEvent[]',
             'debt_recovery_event_list' => '\OpenAPI\Client\Model\financesV0\DebtRecoveryEvent[]',
             'loan_servicing_event_list' => '\OpenAPI\Client\Model\financesV0\LoanServicingEvent[]',
             'adjustment_event_list' => '\OpenAPI\Client\Model\financesV0\AdjustmentEvent[]',
             'safet_reimbursement_event_list' => '\OpenAPI\Client\Model\financesV0\SAFETReimbursementEvent[]',
             'seller_review_enrollment_payment_event_list' => '\OpenAPI\Client\Model\financesV0\SellerReviewEnrollmentPaymentEvent[]',
             'fba_liquidation_event_list' => '\OpenAPI\Client\Model\financesV0\FBALiquidationEvent[]',
             'coupon_payment_event_list' => '\OpenAPI\Client\Model\financesV0\CouponPaymentEvent[]',
             'imaging_services_fee_event_list' => '\OpenAPI\Client\Model\financesV0\ImagingServicesFeeEvent[]',
             'network_commingling_transaction_event_list' => '\OpenAPI\Client\Model\financesV0\NetworkComminglingTransactionEvent[]',
             'affordability_expense_event_list' => '\OpenAPI\Client\Model\financesV0\AffordabilityExpenseEvent[]',
             'affordability_expense_reversal_event_list' => '\OpenAPI\Client\Model\financesV0\AffordabilityExpenseEvent[]',
             'removal_shipment_event_list' => '\OpenAPI\Client\Model\financesV0\RemovalShipmentEvent[]',
             'removal_shipment_adjustment_event_list' => '\OpenAPI\Client\Model\financesV0\RemovalShipmentAdjustmentEvent[]',
             'trial_shipment_event_list' => '\OpenAPI\Client\Model\financesV0\TrialShipmentEvent[]',
             'tds_reimbursement_event_list' => '\OpenAPI\Client\Model\financesV0\TDSReimbursementEvent[]',
             'adhoc_disbursement_event_list' => '\OpenAPI\Client\Model\financesV0\AdhocDisbursementEvent[]',
             'tax_withholding_event_list' => '\OpenAPI\Client\Model\financesV0\TaxWithholdingEvent[]',
             'charge_refund_event_list' => '\OpenAPI\Client\Model\financesV0\ChargeRefundEvent[]',
             'failed_adhoc_disbursement_event_list' => '\OpenAPI\Client\Model\financesV0\FailedAdhocDisbursementEvent[]',
             'value_added_service_charge_event_list' => '\OpenAPI\Client\Model\financesV0\ValueAddedServiceChargeEvent[]',
             'capacity_reservation_billing_event_list' => '\OpenAPI\Client\Model\financesV0\CapacityReservationBillingEvent[]'    ];
