...
class LinkedAsset implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'LinkedAsset';
     ...
     * Sets asset_type.
     *
     * @param null|string $asset_type The type of the linked asset. For example: `VEHICLE`.
     */
     ...
     * Sets asset_name.
     *
     * @param null|string $asset_name The name of the linked asset. For example: `2024 Polaris Slingshot SLR AutoDrive`.
     */
    public function setAssetName(?string $asset_name): self
    {
     ...
     *
     * @param null|array<string,string> $additional_attributes additional attributes of the linked asset, such as vehicle make, model, year, and engine details
     */
    public function setAdditionalAttributes(?array $additional_attributes): self
    {
