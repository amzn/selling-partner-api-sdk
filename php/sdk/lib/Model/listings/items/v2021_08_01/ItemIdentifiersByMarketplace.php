...
class ItemIdentifiersByMarketplace implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets marketplace_id.
     *
     * @param null|string $marketplace_id Amazon store identifier. Identifies the listings item's Amazon store.
     */
     ...
     * Sets asin.
     *
     * @param null|string $asin the ASIN of the listings item
     */
