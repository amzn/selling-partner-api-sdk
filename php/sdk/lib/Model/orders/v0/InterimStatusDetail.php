...
/**
 * InterimStatusDetail Class Doc Comment.
 *
 * @category Class
 *
...
class InterimStatusDetail implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['status_date_time']) {
     ...
     *
     * @param \DateTime $status_date_time The date and time when this interim status was set, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date and time format.
     */
