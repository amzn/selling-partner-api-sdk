 ...
 */
class FulfillmentPlanItem implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'FulfillmentPlanItem';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['measurement']) {
     ...
     * Sets order_item_id.
     *
     * @param string $order_item_id an Amazon-defined associated order item's order item identifier
     */
