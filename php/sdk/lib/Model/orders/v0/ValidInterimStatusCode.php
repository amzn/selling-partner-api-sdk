...
/**
 * ValidInterimStatusCode Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class ValidInterimStatusCode implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ValidInterimStatusCode';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['status_code']) {
            $invalidProperties[] = "'status_code' can't be null";
        }
        if (null === $this->container['status_description']) {
     ...
     * Sets status_code.
     *
     * @param string $status_code the identifier for the interim status type
     */
     ...
     *
     * @param string $status_description a customer-facing description of the interim status
     */
