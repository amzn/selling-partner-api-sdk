...
class RegulatedOrderVerificationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'status' => '\OpenAPI\Client\Model\orders\VerificationStatus',
             'requires_merchant_action' => 'bool',
             'valid_rejection_reasons' => '\OpenAPI\Client\Model\orders\RejectionReason[]',
             'rejection_reason' => '\OpenAPI\Client\Model\orders\RejectionReason',
             'review_date' => 'string',
             'external_reviewer_id' => 'string',
             'valid_verification_details' => '\OpenAPI\Client\Model\orders\ValidVerificationDetail[]'    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\orders\RejectionReason|null
     */
    public function getRejectionReason(): ?\OpenAPI\Client\Model\orders\RejectionReason
    {
     ...
     *
     * @param \OpenAPI\Client\Model\orders\RejectionReason|null $rejection_reason rejection_reason
     *
     * @return self
     */
