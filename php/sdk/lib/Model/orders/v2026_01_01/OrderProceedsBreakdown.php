...
/**
 * OrderProceedsBreakdown Class Doc Comment.
 *
 * @category Class
 *
...
class OrderProceedsBreakdown implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets status.
     *
     * @param null|string $status The processing status of the charge. Only present for categories processed separately after checkout, such as `DELIVERY_TIP`.  **Possible values**: `PENDING`, `FINALIZED`.
     */
