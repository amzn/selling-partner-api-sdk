...
class PaymentExecution implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'payment_amount' => '\SpApi\Model\orders\v2026_01_01\Money',
        'acquirer_id' => 'string',
        'card_brand' => 'string',
     ...
     * Sets payment_method.
     *
     * @param null|string $payment_method the payment method used for this payment execution (for example, CashOnDelivery, ConvenienceStore, CreditCard, Invoice, Pix, and so on)
     */
     ...
     * Sets payment_amount.
     *
     * @param null|Money $payment_amount payment_amount
     */
    public function setPaymentAmount(?Money $payment_amount): self
    {
     ...
     * Sets acquirer_id.
     *
     * @param null|string $acquirer_id The unique identifier of the payment processor or acquiring bank that authorizes the payment.   **Note**: This attribute is only available for orders in the Brazil (BR) marketplace when the `paymentMethod` is `CreditCard` or `Pix`.
     */
