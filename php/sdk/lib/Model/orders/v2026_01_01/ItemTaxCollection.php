...
/**
 * ItemTaxCollection Class Doc Comment.
 *
 * @category Class
 *
...
class ItemTaxCollection implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets model.
     *
     * @param null|string $model The tax collection model applied to the item.  **Possible values**: - `MARKETPLACE_FACILITATOR` (Tax is withheld and remitted to the taxing authority by Amazon on behalf of the seller)
     */
