...
class OrderPayment implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'payment_executions' => '\SpApi\Model\orders\v2026_01_01\PaymentExecution[]'];
    ...
    {
        $this->setIfExists('payment_executions', $data ?? [], null);
    }
     ...
     *
     * @param null|array $payment_executions a list of payment executions for the order
     */
    public function setPaymentExecutions(?array $payment_executions): self
    {
        if (is_null($payment_executions)) {
            array_push($this->openAPINullablesSetToNull, 'payment_executions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_executions', $nullablesSetToNull);
            if (false !== $index) {
