...
/**
 * AssociatedOrderItem Class Doc Comment.
 *
 * @category Class
 *
...
class AssociatedOrderItem implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets order_id.
     *
     * @param null|string $order_id the order identifier of the associated order item
     */
     ...
     * Sets order_item_id.
     *
     * @param null|string $order_item_id the order item identifier of the associated order item
     */
