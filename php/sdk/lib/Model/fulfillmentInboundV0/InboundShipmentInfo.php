...
class InboundShipmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'ship_from_address' => '\OpenAPI\Client\Model\fulfillmentInboundV0\Address',
             'destination_fulfillment_center_id' => 'string',
             'shipment_status' => '\OpenAPI\Client\Model\fulfillmentInboundV0\ShipmentStatus',
             'label_prep_type' => '\OpenAPI\Client\Model\fulfillmentInboundV0\LabelPrepType',
             'are_cases_required' => 'bool',
             'confirmed_need_by_date' => '\DateTime',
             'box_contents_source' => '\OpenAPI\Client\Model\fulfillmentInboundV0\BoxContentsSource',
             'estimated_box_contents_fee' => '\OpenAPI\Client\Model\fulfillmentInboundV0\BoxContentsFeeDetails'    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\Address
     */
    public function getShipFromAddress(): \OpenAPI\Client\Model\fulfillmentInboundV0\Address
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\Address $ship_from_address ship_from_address
     *
     * @return self
     */
    public function setShipFromAddress(\OpenAPI\Client\Model\fulfillmentInboundV0\Address $ship_from_address): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\BoxContentsFeeDetails|null
     */
    public function getEstimatedBoxContentsFee(): ?\OpenAPI\Client\Model\fulfillmentInboundV0\BoxContentsFeeDetails
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\BoxContentsFeeDetails|null $estimated_box_contents_fee estimated_box_contents_fee
     *
     * @return self
     */
