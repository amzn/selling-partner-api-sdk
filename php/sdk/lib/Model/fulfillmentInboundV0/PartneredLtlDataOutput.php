...
class PartneredLtlDataOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'amazon_calculated_value' => '\OpenAPI\Client\Model\fulfillmentInboundV0\Amount',
             'preview_pickup_date' => '\DateTime',
             'preview_delivery_date' => '\DateTime',
             'preview_freight_class' => '\OpenAPI\Client\Model\fulfillmentInboundV0\SellerFreightClass',
             'amazon_reference_id' => 'string',
             'is_bill_of_lading_available' => 'bool',
             'partnered_estimate' => '\OpenAPI\Client\Model\fulfillmentInboundV0\PartneredEstimate',
             'carrier_name' => 'string'    ];
    ...
    */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\Contact
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\Contact $contact contact
     *
     * @return self
     */
     ...
     * Gets total_weight
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\Weight
     */
     ...
     * Sets total_weight
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\Weight $total_weight total_weight
     *
     * @return self
     */
     ...
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\Amount|null
     */
    public function getAmazonCalculatedValue(): ?\OpenAPI\Client\Model\fulfillmentInboundV0\Amount
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\Amount|null $amazon_calculated_value amazon_calculated_value
     *
     * @return self
     */
    public function setAmazonCalculatedValue(?\OpenAPI\Client\Model\fulfillmentInboundV0\Amount $amazon_calculated_value): self
    {
        if (is_null($amazon_calculated_value)) {
            throw new \InvalidArgumentException('non-nullable amazon_calculated_value cannot be null');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\PartneredEstimate|null
     */
    public function getPartneredEstimate(): ?\OpenAPI\Client\Model\fulfillmentInboundV0\PartneredEstimate
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\PartneredEstimate|null $partnered_estimate partnered_estimate
     *
     * @return self
     */
