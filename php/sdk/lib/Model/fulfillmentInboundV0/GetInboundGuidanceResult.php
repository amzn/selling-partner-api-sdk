...
class GetInboundGuidanceResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'sku_inbound_guidance_list' => '\OpenAPI\Client\Model\fulfillmentInboundV0\SKUInboundGuidance[]',
             'invalid_sku_list' => '\OpenAPI\Client\Model\fulfillmentInboundV0\InvalidSKU[]',
             'asin_inbound_guidance_list' => '\OpenAPI\Client\Model\fulfillmentInboundV0\ASINInboundGuidance[]',
             'invalid_asin_list' => '\OpenAPI\Client\Model\fulfillmentInboundV0\InvalidASIN[]'    ];
    ...
    protected static array $openAPINullables = [
        'sku_inbound_guidance_list' => true,
        'invalid_sku_list' => true,
        'asin_inbound_guidance_list' => true,
    ...
    {
        $this->setIfExists('sku_inbound_guidance_list', $data ?? [], null);
        $this->setIfExists('invalid_sku_list', $data ?? [], null);
        $this->setIfExists('asin_inbound_guidance_list', $data ?? [], null);
    ...
    */
     ...
     *
     * @param array|null $sku_inbound_guidance_list A list of SKU inbound guidance information.
     *
     * @return self
     */
    public function setSkuInboundGuidanceList(?array $sku_inbound_guidance_list): self
    {
        if (is_null($sku_inbound_guidance_list)) {
            array_push($this->openAPINullablesSetToNull, 'sku_inbound_guidance_list');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sku_inbound_guidance_list', $nullablesSetToNull);
            if ($index !== false) {
     ...
     *
     * @param array|null $asin_inbound_guidance_list A list of ASINs and their associated inbound guidance.
     *
     * @return self
     */
    public function setAsinInboundGuidanceList(?array $asin_inbound_guidance_list): self
    {
        if (is_null($asin_inbound_guidance_list)) {
            array_push($this->openAPINullablesSetToNull, 'asin_inbound_guidance_list');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('asin_inbound_guidance_list', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
