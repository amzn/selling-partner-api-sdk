...
class PartneredEstimate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'amount' => '\OpenAPI\Client\Model\fulfillmentInboundV0\Amount',
    ...
    */
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\fulfillmentInboundV0\Amount
     */
    public function getAmount(): \OpenAPI\Client\Model\fulfillmentInboundV0\Amount
    {
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\fulfillmentInboundV0\Amount $amount amount
     *
     * @return self
     */
    public function setAmount(\OpenAPI\Client\Model\fulfillmentInboundV0\Amount $amount): self
    {
        if (is_null($amount)) {
