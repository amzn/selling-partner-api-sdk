...
class OneClickShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'shipment_id' => 'string',
             'package_document_details' => '\OpenAPI\Client\Model\shipping\PackageDocumentDetail[]',
             'promise' => '\OpenAPI\Client\Model\shipping\Promise',
             'carrier' => '\OpenAPI\Client\Model\shipping\Carrier',
             'service' => '\OpenAPI\Client\Model\shipping\Service',
    ...
    */
     ...
     * Gets carrier
     *
     * @return \OpenAPI\Client\Model\shipping\Carrier
     */
    public function getCarrier(): \OpenAPI\Client\Model\shipping\Carrier
    {
     ...
     * Sets carrier
     *
     * @param \OpenAPI\Client\Model\shipping\Carrier $carrier carrier
     *
     * @return self
     */
    public function setCarrier(\OpenAPI\Client\Model\shipping\Carrier $carrier): self
    {
        if (is_null($carrier)) {
     ...
     * Gets service
     *
     * @return \OpenAPI\Client\Model\shipping\Service
     */
    public function getService(): \OpenAPI\Client\Model\shipping\Service
    {
     ...
     * Sets service
     *
     * @param \OpenAPI\Client\Model\shipping\Service $service service
     *
     * @return self
     */
    public function setService(\OpenAPI\Client\Model\shipping\Service $service): self
    {
        if (is_null($service)) {
