...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'address' => '\OpenAPI\Client\Model\vendorShipments\Address',
             'party_id' => 'string',
             'tax_registration_details' => '\OpenAPI\Client\Model\vendorShipments\TaxRegistrationDetails[]'    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\vendorShipments\Address|null
     */
    public function getAddress(): ?\OpenAPI\Client\Model\vendorShipments\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\vendorShipments\Address|null $address address
     *
     * @return self
     */
    public function setAddress(?\OpenAPI\Client\Model\vendorShipments\Address $address): self
    {
        if (is_null($address)) {
