...
class SummaryResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'SummaryResponse';
    ...
    protected static array $openAPITypes = [
        'summaries' => '\SpApi\Model\finances\v2024_06_19\Summary[]',
        'next_token' => 'string'];
     ...
     * Sets summaries.
     *
     * @param null|array $summaries a list of financial summaries
     */
     ...
     * Sets next_token.
     *
     * @param null|string $next_token A token to retrieve the next page of results. If null, no more results are available.
     */
