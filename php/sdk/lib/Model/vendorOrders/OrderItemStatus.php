...
class OrderItemStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'net_cost' => '\OpenAPI\Client\Model\vendorOrders\Money',
             'list_price' => '\OpenAPI\Client\Model\vendorOrders\Money',
             'ordered_quantity' => '\OpenAPI\Client\Model\vendorOrders\OrderItemStatusOrderedQuantity',
             'acknowledgement_status' => '\OpenAPI\Client\Model\vendorOrders\OrderItemStatusAcknowledgementStatus',
             'receiving_status' => '\OpenAPI\Client\Model\vendorOrders\OrderItemStatusReceivingStatus'    ];
    ...
    */
     ...
     * Gets net_cost
     *
     * @return \OpenAPI\Client\Model\vendorOrders\Money|null
     */
    public function getNetCost(): ?\OpenAPI\Client\Model\vendorOrders\Money
    {
     ...
     * Sets net_cost
     *
     * @param \OpenAPI\Client\Model\vendorOrders\Money|null $net_cost net_cost
     *
     * @return self
     */
    public function setNetCost(?\OpenAPI\Client\Model\vendorOrders\Money $net_cost): self
    {
        if (is_null($net_cost)) {
     ...
     * @return \OpenAPI\Client\Model\vendorOrders\Money|null
     */
    public function getListPrice(): ?\OpenAPI\Client\Model\vendorOrders\Money
    {
     ...
     * Sets list_price
     *
     * @param \OpenAPI\Client\Model\vendorOrders\Money|null $list_price list_price
     *
     * @return self
     */
    public function setListPrice(?\OpenAPI\Client\Model\vendorOrders\Money $list_price): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendorOrders\OrderItemStatusOrderedQuantity|null
     */
    public function getOrderedQuantity(): ?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusOrderedQuantity
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorOrders\OrderItemStatusOrderedQuantity|null $ordered_quantity ordered_quantity
     *
     * @return self
     */
    public function setOrderedQuantity(?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusOrderedQuantity $ordered_quantity): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendorOrders\OrderItemStatusAcknowledgementStatus|null
     */
    public function getAcknowledgementStatus(): ?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusAcknowledgementStatus
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorOrders\OrderItemStatusAcknowledgementStatus|null $acknowledgement_status acknowledgement_status
     *
     * @return self
     */
    public function setAcknowledgementStatus(?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusAcknowledgementStatus $acknowledgement_status): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendorOrders\OrderItemStatusReceivingStatus|null
     */
    public function getReceivingStatus(): ?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusReceivingStatus
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorOrders\OrderItemStatusReceivingStatus|null $receiving_status receiving_status
     *
     * @return self
     */
    public function setReceivingStatus(?\OpenAPI\Client\Model\vendorOrders\OrderItemStatusReceivingStatus $receiving_status): self
    {
