...
class TimeInterval implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets start_time.
     *
     * @param \DateTime $start_time Date timestamp in [ISO 8601](https://developer-docs.amazon/sp-api/docs/iso-8601) date time format.
     */
     ...
     * Sets end_time.
     *
     * @param \DateTime $end_time Date timestamp in [ISO 8601](https://developer-docs.amazon/sp-api/docs/iso-8601) date time format.
     */
