...
class OrderDestination implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OrderDestination';
    ...
    protected static array $openAPITypes = [
        'delivery_address' => '\SpApi\Model\fulfillment\outbound\v2026_07_04\Address',
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['delivery_address']) {
     ...
     *
     * @param Address $delivery_address delivery_address
     */
     ...
     * Sets delivery_notes.
     *
     * @param null|string $delivery_notes delivery notes for the fulfillment order
     */
