...
/**
 * ShipmentServiceLevel Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class ShipmentServiceLevel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ShipmentServiceLevel';
     ...
     * Sets service_tier.
     *
     * @param null|string $service_tier The service tier used for this shipment. Possible values: `STANDARD`, `EXPEDITED`, `PRIORITY` (only available in Canada, India, and Mexico), `SCHEDULED` (only available in Japan).
     */
