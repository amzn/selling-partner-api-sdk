...
/**
 * AmazonFacility Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class AmazonFacility implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'AmazonFacility';
    ...
    protected static array $openAPITypes = [
        'facility_id' => 'string',
        'address' => '\SpApi\Model\fulfillment\outbound\v2026_07_04\Address'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['facility_id']) {
            $invalidProperties[] = "'facility_id' can't be null";
        }
        if (mb_strlen($this->container['facility_id']) > 40) {
            $invalidProperties[] = "invalid value for 'facility_id', the character length must be smaller than or equal to 40.";
        }
     ...
     * Sets facility_id.
     *
     * @param string $facility_id an identifier for the Amazon facility from which the shipment is sent
     */
    public function setFacilityId(string $facility_id): self
    {
