...
class OfferItem implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OfferItem';
     ...
     *
     * @param null|ProductIdentifier $product_identifier product_identifier
     */
    public function setProductIdentifier(?ProductIdentifier $product_identifier): self
    {
        if (is_null($product_identifier)) {
            array_push($this->openAPINullablesSetToNull, 'product_identifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('product_identifier', $nullablesSetToNull);
            if (false !== $index) {
