...
class CarrierTracking implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets carrier_code.
     *
     * @param string $carrier_code identifies the carrier who delivers the shipment to the recipient
     */
     ...
     * Sets tracking_url.
     *
     * @param null|string $tracking_url represents the tracking URL where package tracking information is shown
     */
