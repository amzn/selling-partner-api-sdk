...
class Package implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'status' => 'string',
        'tracking' => '\SpApi\Model\fulfillment\outbound\v2026_07_04\Tracking',
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (mb_strlen($this->container['package_id']) > 40) {
     ...
     * Sets package_id.
     *
     * @param string $package_id identifies a package in a shipment
     */
     ...
     * Sets status.
     *
     * @param null|string $status The current status of a package. Possible values: `PROCESSING`, `IN_TRANSIT`, `DELAYED`, `OUT_FOR_DELIVERY`, `DELIVERED`, `UNDELIVERABLE`, `EXPIRED`.
     */
     ...
     * Sets tracking.
     *
     * @param null|Tracking $tracking tracking
     */
     ...
     *
     * @param null|array $shipment_item_ids the shipment item identifiers contained in this package
     */
    public function setShipmentItemIds(?array $shipment_item_ids): self
    {
        if (is_null($shipment_item_ids)) {
            array_push($this->openAPINullablesSetToNull, 'shipment_item_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipment_item_ids', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
