...
class Amount implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets unit.
     *
     * @param null|string $unit The unit of measure for the amount. Possible values: `EACHES`.
     */
     ...
     * Sets value.
     *
     * @param string $value A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows [RFC 7159](https://datatracker.ietf.org/doc/html/rfc7159) for number representation.
     */
