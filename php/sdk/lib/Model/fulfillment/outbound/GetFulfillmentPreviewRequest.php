...
class GetFulfillmentPreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'address' => '\OpenAPI\Client\Model\fulfillment\outbound\Address',
             'items' => '\OpenAPI\Client\Model\fulfillment\outbound\GetFulfillmentPreviewItem[]',
             'shipping_speed_categories' => '\OpenAPI\Client\Model\fulfillment\outbound\ShippingSpeedCategory[]',
    ...
    */
     ...
     */
    public function getAddress(): \OpenAPI\Client\Model\fulfillment\outbound\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\fulfillment\outbound\Address $address address
     *
     * @return self
     */
    public function setAddress(\OpenAPI\Client\Model\fulfillment\outbound\Address $address): self
    {
        if (is_null($address)) {
