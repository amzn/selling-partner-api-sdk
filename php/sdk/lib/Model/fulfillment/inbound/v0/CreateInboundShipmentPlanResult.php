...
class CreateInboundShipmentPlanResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'inbound_shipment_plans' => '\OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentPlan[]'    ];
    ...
    {
        $this->setIfExists('inbound_shipment_plans', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param array|null $inbound_shipment_plans A list of inbound shipment plan information
     *
     * @return self
     */
