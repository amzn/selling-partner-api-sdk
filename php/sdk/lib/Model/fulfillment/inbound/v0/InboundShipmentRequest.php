...
class InboundShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'inbound_shipment_header' => '\OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentHeader',
             'inbound_shipment_items' => '\OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentItem[]',
    ...
    protected static array $openAPINullables = [
        'inbound_shipment_header' => false,
        'inbound_shipment_items' => false,
    ...
    {
        $this->setIfExists('inbound_shipment_header', $data ?? [], null);
        $this->setIfExists('inbound_shipment_items', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentHeader
     */
    public function getInboundShipmentHeader(): \OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentHeader
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentHeader $inbound_shipment_header inbound_shipment_header
     *
     * @return self
     */
    public function setInboundShipmentHeader(\OpenAPI\Client\Model\fulfillment\inbound\v0\InboundShipmentHeader $inbound_shipment_header): self
    {
        if (is_null($inbound_shipment_header)) {
            throw new \InvalidArgumentException('non-nullable inbound_shipment_header cannot be null');
        }
     ...
     *
     * @param array $inbound_shipment_items A list of inbound shipment item information.
     *
     * @return self
     */
    public function setInboundShipmentItems(array $inbound_shipment_items): self
    {
        if (is_null($inbound_shipment_items)) {
            throw new \InvalidArgumentException('non-nullable inbound_shipment_items cannot be null');
        }
