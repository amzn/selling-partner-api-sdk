...
class PartneredEstimate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'amount' => '\OpenAPI\Client\Model\fulfillment\inbound\v0\Amount',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('confirm_deadline', $data ?? [], null);
        $this->setIfExists('void_deadline', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\fulfillment\inbound\v0\Amount
     */
    public function getAmount(): \OpenAPI\Client\Model\fulfillment\inbound\v0\Amount
    {
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\fulfillment\inbound\v0\Amount $amount amount
     *
     * @return self
     */
    public function setAmount(\OpenAPI\Client\Model\fulfillment\inbound\v0\Amount $amount): self
    {
        if (is_null($amount)) {
     ...
     *
     * @param \DateTime|null $confirm_deadline Timestamp in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets void_deadline
     *
     * @param \DateTime|null $void_deadline Timestamp in ISO 8601 format.
     *
     * @return self
     */
