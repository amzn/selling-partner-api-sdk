...
class TransportResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'transport_status' => '\OpenAPI\Client\Model\fulfillment\inbound\v0\TransportStatus',
             'error_code' => 'string',
    ...
    {
        $this->setIfExists('transport_status', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setTransportStatus(string $transport_status): self
    {
        if (is_null($transport_status)) {
            throw new \InvalidArgumentException('non-nullable transport_status cannot be null');
        }
