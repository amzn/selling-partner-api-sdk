...
/**
 * UpdateBoxIdentifiersResponse Class Doc Comment.
 *
 * @category Class
 *
 * @description The &#x60;updateBoxIdentifiers&#x60; response.
 *
 * @author   OpenAPI Generator team
 *
 * @see     https://openapi-generator.tech
 ...
 */
class UpdateBoxIdentifiersResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'UpdateBoxIdentifiersResponse';
    ...
    public function setOperationId(string $operation_id): self
    {
        ...
        if (mb_strlen($operation_id) > 38) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling UpdateBoxIdentifiersResponse., must be smaller than or equal to 38.');
        }
        if (mb_strlen($operation_id) < 36) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling UpdateBoxIdentifiersResponse., must be bigger than or equal to 36.');
        }
        if (!preg_match('/^[a-zA-Z0-9-]*$/', ObjectSerializer::toString($operation_id))) {
            throw new \InvalidArgumentException('invalid value for $operation_id when calling UpdateBoxIdentifiersResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.');
        }
