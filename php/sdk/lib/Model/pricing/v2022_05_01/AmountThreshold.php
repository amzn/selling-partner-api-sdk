...
/**
 * AmountThreshold Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class AmountThreshold implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'AmountThreshold';
    ...
    protected static array $openAPITypes = [
        'type' => 'string',
        'currency' => '\SpApi\Model\pricing\v2022_05_01\MoneyType'];
     ...
     * Sets type.
     *
     * @param string $type Indicates how the amount requirement is evaluated. For spend-based conditions, the supported value is AT_LEAST, meaning the customer must spend at least the specified dollar amount to qualify.
     */
     ...
     * Gets currency.
     */
    public function getCurrency(): MoneyType
    {
     ...
     * Sets currency.
     *
     * @param MoneyType $currency currency
     */
    public function setCurrency(MoneyType $currency): self
    {
        if (is_null($currency)) {
