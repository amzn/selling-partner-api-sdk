...
class QuantityThreshold implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets quantity.
     *
     * @param int $quantity number of items required to meet this purchase condition
     */
