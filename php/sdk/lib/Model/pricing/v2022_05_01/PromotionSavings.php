...
/**
 * PromotionSavings Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class PromotionSavings implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'PromotionSavings';
    ...
    protected static array $openAPITypes = [
        'discount' => '\SpApi\Model\pricing\v2022_05_01\PromotionDiscount',
        'discounted_price' => '\SpApi\Model\pricing\v2022_05_01\MoneyType'];
     ...
     * Gets discount.
     */
    public function getDiscount(): ?PromotionDiscount
    {
     ...
     * Sets discount.
     *
     * @param null|PromotionDiscount $discount discount
     */
    public function setDiscount(?PromotionDiscount $discount): self
    {
        if (is_null($discount)) {
     ...
     */
    public function getDiscountedPrice(): ?MoneyType
    {
     ...
     *
     * @param null|MoneyType $discounted_price discounted_price
     */
    public function setDiscountedPrice(?MoneyType $discounted_price): self
    {
        if (is_null($discounted_price)) {
            array_push($this->openAPINullablesSetToNull, 'discounted_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('discounted_price', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
