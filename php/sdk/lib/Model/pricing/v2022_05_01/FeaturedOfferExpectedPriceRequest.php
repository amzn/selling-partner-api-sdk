...
class FeaturedOfferExpectedPriceRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets marketplace_id.
     *
     * @param string $marketplace_id The `MarketplaceID` is the globally unique identifier of an Amazon store. To find the ID for your Amazon store, refer to [Amazon store IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).
     */
