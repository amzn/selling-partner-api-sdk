...
namespace OpenAPI\Client\Model\vendorDfPayments;
...
class InvoiceDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'remit_to_party' => '\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification',
             'ship_from_party' => '\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification',
             'bill_to_party' => '\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification',
             'ship_to_country_code' => 'string',
             'payment_terms_code' => 'string',
             'invoice_total' => '\OpenAPI\Client\Model\vendorDfPayments\Money',
             'tax_totals' => '\OpenAPI\Client\Model\vendorDfPayments\TaxDetail[]',
             'additional_details' => '\OpenAPI\Client\Model\vendorDfPayments\AdditionalDetails[]',
             'charge_details' => '\OpenAPI\Client\Model\vendorDfPayments\ChargeDetails[]',
             'items' => '\OpenAPI\Client\Model\vendorDfPayments\InvoiceItem[]'    ];
    ...
    */
     ...
     * Gets remit_to_party
     *
     * @return \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification
     */
    public function getRemitToParty(): \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification
    {
     ...
     * Sets remit_to_party
     *
     * @param \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification $remit_to_party remit_to_party
     *
     * @return self
     */
    public function setRemitToParty(\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification $remit_to_party): self
    {
     ...
     * @return \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification
     */
    public function getShipFromParty(): \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification $ship_from_party ship_from_party
     *
     * @return self
     */
    public function setShipFromParty(\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification $ship_from_party): self
    {
     ...
     * Gets bill_to_party
     *
     * @return \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification|null
     */
    public function getBillToParty(): ?\OpenAPI\Client\Model\vendorDfPayments\PartyIdentification
    {
     ...
     * Sets bill_to_party
     *
     * @param \OpenAPI\Client\Model\vendorDfPayments\PartyIdentification|null $bill_to_party bill_to_party
     *
     * @return self
     */
     ...
     * Gets invoice_total
     *
     * @return \OpenAPI\Client\Model\vendorDfPayments\Money
     */
    public function getInvoiceTotal(): \OpenAPI\Client\Model\vendorDfPayments\Money
    {
     ...
     * Sets invoice_total
     *
     * @param \OpenAPI\Client\Model\vendorDfPayments\Money $invoice_total invoice_total
     *
     * @return self
     */
    public function setInvoiceTotal(\OpenAPI\Client\Model\vendorDfPayments\Money $invoice_total): self
    {
