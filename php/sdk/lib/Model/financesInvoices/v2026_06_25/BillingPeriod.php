...
class BillingPeriod implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'BillingPeriod';
     ...
     * Sets start_date.
     *
     * @param \DateTime $start_date The start of the billing period of an invoice. In ISO 8601 format.
     */
     ...
     * Sets end_date.
     *
     * @param \DateTime $end_date The end of the billing period of an invoice. In ISO 8601 format.
     */
