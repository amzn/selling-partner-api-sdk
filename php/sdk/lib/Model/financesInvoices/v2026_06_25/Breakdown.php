...
class Breakdown implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'breakdown_amount' => '\SpApi\Model\financesInvoices\v2026_06_25\Currency',
        'breakdowns' => '\SpApi\Model\financesInvoices\v2026_06_25\Breakdown[]'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['breakdown_type']) {
            $invalidProperties[] = "'breakdown_type' can't be null";
        }
        if (null === $this->container['breakdown_amount']) {
            $invalidProperties[] = "'breakdown_amount' can't be null";
        }
     ...
     *
     * @param Currency $breakdown_amount breakdown_amount
     */
     ...
     * Sets breakdowns.
     *
     * @param null|array $breakdowns a list of breakdowns that detail how the total amount is calculated
     */
