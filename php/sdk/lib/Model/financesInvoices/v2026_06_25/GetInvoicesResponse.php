...
class GetInvoicesResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'invoices' => '\SpApi\Model\financesInvoices\v2026_06_25\InvoiceHeader[]',
        'num_of_records' => 'int',
        'next_token' => 'string'];
    ...
    protected static array $setters = [
        ...
        'num_of_records' => 'setNumOfRecords',
    ...
    protected static array $getters = [
        ...
        'num_of_records' => 'getNumOfRecords',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('num_of_records', $data ?? [], null);
     ...
     * Sets invoices.
     *
     * @param null|array $invoices a list of invoices with header-level details
     */
    ...
    {
        return $this->container['num_of_records'];
    }

    /**
     * Sets num_of_records.
     *
     * @param null|int $num_of_records the number of records returned
     */
    public function setNumOfRecords(?int $num_of_records): self
    {
        if (is_null($num_of_records)) {
            array_push($this->openAPINullablesSetToNull, 'num_of_records');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('num_of_records', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['num_of_records'] = $num_of_records;
