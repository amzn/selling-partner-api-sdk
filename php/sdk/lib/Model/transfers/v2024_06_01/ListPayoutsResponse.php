...
class ListPayoutsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ListPayoutsResponse';
    ...
    protected static array $openAPITypes = [
        'payouts' => '\SpApi\Model\transfers\v2024_06_01\Payout[]',
        'next_token' => 'string'];
     ...
     * Sets payouts.
     *
     * @param null|array $payouts a list of payouts matching the request criteria
     */
    public function setPayouts(?array $payouts): self
    {
        if (is_null($payouts)) {
