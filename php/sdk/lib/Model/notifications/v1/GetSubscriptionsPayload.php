...
/**
 * GetSubscriptionsPayload Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class GetSubscriptionsPayload implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'GetSubscriptionsPayload';
     ...
     * Sets subscriptions.
     *
     * @param null|array $subscriptions a list of subscriptions
     */
     ...
     * Sets next_token.
     *
     * @param null|string $next_token A token that you can use to retrieve the next page of results. When this field is not empty, pass its value in the `nextToken` query parameter of the next request.
     */
