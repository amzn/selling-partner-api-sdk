 ...
 */
class OutboundListing implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OutboundListing';
    ...
    protected static array $openAPITypes = [
        'next_token' => 'string',
        'outbound_orders' => '\SpApi\Model\awd\v2024_05_09\OutboundOrder[]'];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('outbound_orders', $data ?? [], null);
    }
     ...
     */
    public function getOutboundOrders(): ?array
    {
     ...
     *
     * @param null|array $outbound_orders list of outbound orders
     */
    public function setOutboundOrders(?array $outbound_orders): self
    {
        if (is_null($outbound_orders)) {
            array_push($this->openAPINullablesSetToNull, 'outbound_orders');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outbound_orders', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
