 ...
 */
class OutboundExecutionError implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OutboundExecutionError';
     ...
     *
     * @param array $failure_reasons failure reasons for the error
     */
     ...
     * Sets sku.
     *
     * @param null|string $sku MSKU associated with the error
     */
