...
class CreateMarketplaceItemLabelsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'height' => 'float',
             'label_type' => '\OpenAPI\Client\Model\fulfillmentInbound\LabelPrintType',
             'locale_code' => 'string',
             'marketplace_id' => 'string',
             'msku_quantities' => '\OpenAPI\Client\Model\fulfillmentInbound\MskuQuantity[]',
             'page_type' => '\OpenAPI\Client\Model\fulfillmentInbound\ItemLabelPageType',
             'width' => 'float'    ];
