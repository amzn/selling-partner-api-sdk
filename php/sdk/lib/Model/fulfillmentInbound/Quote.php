...
class Quote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'cost' => '\OpenAPI\Client\Model\fulfillmentInbound\Currency',
             'expiration' => '\DateTime',
    ...
    */
     ...
     */
    public function getCost(): \OpenAPI\Client\Model\fulfillmentInbound\Currency
    {
     ...
     * Sets cost
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\Currency $cost cost
     *
     * @return self
     */
    public function setCost(\OpenAPI\Client\Model\fulfillmentInbound\Currency $cost): self
    {
        if (is_null($cost)) {
