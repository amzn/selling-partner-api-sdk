...
class Incentive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'target' => 'string',
             'type' => 'string',
             'value' => '\OpenAPI\Client\Model\fulfillmentInbound\Currency'    ];
    ...
    */
     ...
     * Gets value
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\Currency
     */
    public function getValue(): \OpenAPI\Client\Model\fulfillmentInbound\Currency
    {
     ...
     * Sets value
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\Currency $value value
     *
     * @return self
     */
    public function setValue(\OpenAPI\Client\Model\fulfillmentInbound\Currency $value): self
    {
        if (is_null($value)) {
