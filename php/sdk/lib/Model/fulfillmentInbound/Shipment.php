...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'contact_information' => '\OpenAPI\Client\Model\fulfillmentInbound\ContactInformation',
             'dates' => '\OpenAPI\Client\Model\fulfillmentInbound\Dates',
             'destination' => '\OpenAPI\Client\Model\fulfillmentInbound\ShipmentDestination',
             'freight_information' => '\OpenAPI\Client\Model\fulfillmentInbound\FreightInformation',
             'name' => 'string',
             'placement_option_id' => 'string',
             'selected_delivery_window' => '\OpenAPI\Client\Model\fulfillmentInbound\SelectedDeliveryWindow',
             'selected_transportation_option_id' => 'string',
             'self_ship_appointment_details' => '\OpenAPI\Client\Model\fulfillmentInbound\SelfShipAppointmentDetails[]',
             'shipment_confirmation_id' => 'string',
             'shipment_id' => 'string',
             'source' => '\OpenAPI\Client\Model\fulfillmentInbound\ShipmentSource',
             'status' => 'string',
             'tracking_details' => '\OpenAPI\Client\Model\fulfillmentInbound\TrackingDetails'    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\ContactInformation|null
     */
    public function getContactInformation(): ?\OpenAPI\Client\Model\fulfillmentInbound\ContactInformation
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\ContactInformation|null $contact_information contact_information
     *
     * @return self
     */
     ...
     * Gets dates
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\Dates|null
     */
    public function getDates(): ?\OpenAPI\Client\Model\fulfillmentInbound\Dates
    {
     ...
     * Sets dates
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\Dates|null $dates dates
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\ShipmentDestination
     */
    public function getDestination(): \OpenAPI\Client\Model\fulfillmentInbound\ShipmentDestination
    {
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\ShipmentDestination $destination destination
     *
     * @return self
     */
    public function setDestination(\OpenAPI\Client\Model\fulfillmentInbound\ShipmentDestination $destination): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\FreightInformation|null
     */
    public function getFreightInformation(): ?\OpenAPI\Client\Model\fulfillmentInbound\FreightInformation
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\FreightInformation|null $freight_information freight_information
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\SelectedDeliveryWindow|null
     */
    public function getSelectedDeliveryWindow(): ?\OpenAPI\Client\Model\fulfillmentInbound\SelectedDeliveryWindow
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\SelectedDeliveryWindow|null $selected_delivery_window selected_delivery_window
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\ShipmentSource
     */
    public function getSource(): \OpenAPI\Client\Model\fulfillmentInbound\ShipmentSource
    {
     ...
     * Sets source
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\ShipmentSource $source source
     *
     * @return self
     */
    public function setSource(\OpenAPI\Client\Model\fulfillmentInbound\ShipmentSource $source): self
    {
        if (is_null($source)) {
     ...
     *
     * @return \OpenAPI\Client\Model\fulfillmentInbound\TrackingDetails|null
     */
    public function getTrackingDetails(): ?\OpenAPI\Client\Model\fulfillmentInbound\TrackingDetails
    {
     ...
     *
     * @param \OpenAPI\Client\Model\fulfillmentInbound\TrackingDetails|null $tracking_details tracking_details
     *
     * @return self
     */
