...
namespace OpenAPI\Client\Model\vendorDfOrders;
...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'title' => 'string',
             'ordered_quantity' => '\OpenAPI\Client\Model\vendorDfOrders\ItemQuantity',
             'scheduled_delivery_shipment' => '\OpenAPI\Client\Model\vendorDfOrders\ScheduledDeliveryShipment',
             'gift_details' => '\OpenAPI\Client\Model\vendorDfOrders\GiftDetails',
             'net_price' => '\OpenAPI\Client\Model\vendorDfOrders\Money',
             'tax_details' => '\OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails',
             'total_price' => '\OpenAPI\Client\Model\vendorDfOrders\Money',
             'buyer_customized_info' => '\OpenAPI\Client\Model\vendorDfOrders\BuyerCustomizedInfoDetail'    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\ItemQuantity
     */
    public function getOrderedQuantity(): \OpenAPI\Client\Model\vendorDfOrders\ItemQuantity
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\ItemQuantity $ordered_quantity ordered_quantity
     *
     * @return self
     */
    public function setOrderedQuantity(\OpenAPI\Client\Model\vendorDfOrders\ItemQuantity $ordered_quantity): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\ScheduledDeliveryShipment|null
     */
    public function getScheduledDeliveryShipment(): ?\OpenAPI\Client\Model\vendorDfOrders\ScheduledDeliveryShipment
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\ScheduledDeliveryShipment|null $scheduled_delivery_shipment scheduled_delivery_shipment
     *
     * @return self
     */
    public function setScheduledDeliveryShipment(?\OpenAPI\Client\Model\vendorDfOrders\ScheduledDeliveryShipment $scheduled_delivery_shipment): self
    {
     ...
     * Gets gift_details
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\GiftDetails|null
     */
    public function getGiftDetails(): ?\OpenAPI\Client\Model\vendorDfOrders\GiftDetails
    {
     ...
     * Sets gift_details
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\GiftDetails|null $gift_details gift_details
     *
     * @return self
     */
    public function setGiftDetails(?\OpenAPI\Client\Model\vendorDfOrders\GiftDetails $gift_details): self
    {
     ...
     * Gets net_price
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\Money
     */
    public function getNetPrice(): \OpenAPI\Client\Model\vendorDfOrders\Money
    {
     ...
     * Sets net_price
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\Money $net_price net_price
     *
     * @return self
     */
    public function setNetPrice(\OpenAPI\Client\Model\vendorDfOrders\Money $net_price): self
    {
     ...
     * Gets tax_details
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails|null
     */
    public function getTaxDetails(): ?\OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails
    {
     ...
     * Sets tax_details
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails|null $tax_details tax_details
     *
     * @return self
     */
    public function setTaxDetails(?\OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails $tax_details): self
    {
     ...
     * Gets total_price
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\Money|null
     */
    public function getTotalPrice(): ?\OpenAPI\Client\Model\vendorDfOrders\Money
    {
     ...
     * Sets total_price
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\Money|null $total_price total_price
     *
     * @return self
     */
    public function setTotalPrice(?\OpenAPI\Client\Model\vendorDfOrders\Money $total_price): self
    {
     ...
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\BuyerCustomizedInfoDetail|null
     */
    public function getBuyerCustomizedInfo(): ?\OpenAPI\Client\Model\vendorDfOrders\BuyerCustomizedInfoDetail
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\BuyerCustomizedInfoDetail|null $buyer_customized_info buyer_customized_info
     *
     * @return self
     */
    public function setBuyerCustomizedInfo(?\OpenAPI\Client\Model\vendorDfOrders\BuyerCustomizedInfoDetail $buyer_customized_info): self
    {
