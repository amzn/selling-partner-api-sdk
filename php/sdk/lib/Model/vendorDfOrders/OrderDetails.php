...
class OrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'order_date' => '\DateTime',
             'order_status' => 'string',
             'shipment_details' => '\OpenAPI\Client\Model\vendorDfOrders\ShipmentDetails',
             'tax_total' => '\OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails',
             'selling_party' => '\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification',
             'ship_from_party' => '\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification',
             'ship_to_party' => '\OpenAPI\Client\Model\vendorDfOrders\Address',
             'bill_to_party' => '\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification',
             'items' => '\OpenAPI\Client\Model\vendorDfOrders\OrderItem[]'    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\ShipmentDetails
     */
    public function getShipmentDetails(): \OpenAPI\Client\Model\vendorDfOrders\ShipmentDetails
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\ShipmentDetails $shipment_details shipment_details
     *
     * @return self
     */
    public function setShipmentDetails(\OpenAPI\Client\Model\vendorDfOrders\ShipmentDetails $shipment_details): self
    {
     ...
     */
    public function getTaxTotal(): ?\OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails
    {
     ...
     * Sets tax_total
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\TaxItemDetails|null $tax_total tax_total
     *
     * @return self
     */
     ...
     * Gets selling_party
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
     */
    public function getSellingParty(): \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
    {
     ...
     * Sets selling_party
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $selling_party selling_party
     *
     * @return self
     */
    public function setSellingParty(\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $selling_party): self
    {
     ...
     * @return \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
     */
    public function getShipFromParty(): \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
    {
     ...
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $ship_from_party ship_from_party
     *
     * @return self
     */
    public function setShipFromParty(\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $ship_from_party): self
    {
     ...
     * Gets ship_to_party
     *
     * @return \OpenAPI\Client\Model\vendorDfOrders\Address
     */
    public function getShipToParty(): \OpenAPI\Client\Model\vendorDfOrders\Address
    {
     ...
     * Sets ship_to_party
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\Address $ship_to_party ship_to_party
     *
     * @return self
     */
    public function setShipToParty(\OpenAPI\Client\Model\vendorDfOrders\Address $ship_to_party): self
    {
     ...
     * @return \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
     */
    public function getBillToParty(): \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification
    {
     ...
     * Sets bill_to_party
     *
     * @param \OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $bill_to_party bill_to_party
     *
     * @return self
     */
    public function setBillToParty(\OpenAPI\Client\Model\vendorDfOrders\PartyIdentification $bill_to_party): self
    {
