...
class GetOffersResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'asin' => 'string',
             'sku' => 'string',
             'item_condition' => '\OpenAPI\Client\Model\pricingV0\ConditionType',
             'status' => 'string',
             'identifier' => '\OpenAPI\Client\Model\pricingV0\ItemIdentifier',
             'summary' => '\OpenAPI\Client\Model\pricingV0\Summary',
             'offers' => '\OpenAPI\Client\Model\pricingV0\OfferDetail[]'    ];
    ...
    */
     ...
     * Gets identifier
     *
     * @return \OpenAPI\Client\Model\pricingV0\ItemIdentifier
     */
    public function getIdentifier(): \OpenAPI\Client\Model\pricingV0\ItemIdentifier
    {
     ...
     * Sets identifier
     *
     * @param \OpenAPI\Client\Model\pricingV0\ItemIdentifier $identifier identifier
     *
     * @return self
     */
    public function setIdentifier(\OpenAPI\Client\Model\pricingV0\ItemIdentifier $identifier): self
    {
     ...
     * Gets summary
     *
     * @return \OpenAPI\Client\Model\pricingV0\Summary
     */
    public function getSummary(): \OpenAPI\Client\Model\pricingV0\Summary
    {
     ...
     * Sets summary
     *
     * @param \OpenAPI\Client\Model\pricingV0\Summary $summary summary
     *
     * @return self
     */
    public function setSummary(\OpenAPI\Client\Model\pricingV0\Summary $summary): self
    {
        if (is_null($summary)) {
