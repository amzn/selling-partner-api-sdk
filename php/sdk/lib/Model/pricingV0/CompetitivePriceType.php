...
class CompetitivePriceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'price' => '\OpenAPI\Client\Model\pricingV0\PriceType',
             'condition' => 'string',
             'subcondition' => 'string',
    ...
    */
     ...
     */
    public function getPrice(): \OpenAPI\Client\Model\pricingV0\PriceType
    {
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\pricingV0\PriceType $price price
     *
     * @return self
     */
    public function setPrice(\OpenAPI\Client\Model\pricingV0\PriceType $price): self
    {
        if (is_null($price)) {
