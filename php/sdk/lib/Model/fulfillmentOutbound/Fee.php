...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'name' => 'string',
             'amount' => '\OpenAPI\Client\Model\fulfillmentOutbound\Money'    ];
    ...
    */
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\fulfillmentOutbound\Money
     */
    public function getAmount(): \OpenAPI\Client\Model\fulfillmentOutbound\Money
    {
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\fulfillmentOutbound\Money $amount amount
     *
     * @return self
     */
    public function setAmount(\OpenAPI\Client\Model\fulfillmentOutbound\Money $amount): self
    {
        if (is_null($amount)) {
