...
class GetFulfillmentPreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'address' => '\OpenAPI\Client\Model\fulfillmentoutbound\Address',
             'items' => '\OpenAPI\Client\Model\fulfillmentoutbound\GetFulfillmentPreviewItem[]',
             'shipping_speed_categories' => '\OpenAPI\Client\Model\fulfillmentoutbound\ShippingSpeedCategory[]',
    ...
    */
     ...
     */
    public function getAddress(): \OpenAPI\Client\Model\fulfillmentoutbound\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\fulfillmentoutbound\Address $address address
     *
     * @return self
     */
    public function setAddress(\OpenAPI\Client\Model\fulfillmentoutbound\Address $address): self
    {
        if (is_null($address)) {
