...
class CreateInboundShipmentPlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             ...
             'label_prep_preference' => '\OpenAPI\Client\Model\fulfillmentinboundv0\LabelPrepPreference',
             'ship_to_country_code' => 'string',
             'ship_to_country_subdivision_code' => 'string',
             'inbound_shipment_plan_request_items' => '\OpenAPI\Client\Model\fulfillmentinboundv0\InboundShipmentPlanRequestItem[]'    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ship_to_country_subdivision_code', $data ?? [], null);
        $this->setIfExists('inbound_shipment_plan_request_items', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param array $inbound_shipment_plan_request_items List of inbound shipment plan requests
     *
     * @return self
     */
    public function setInboundShipmentPlanRequestItems(array $inbound_shipment_plan_request_items): self
    {
        if (is_null($inbound_shipment_plan_request_items)) {
            throw new \InvalidArgumentException('non-nullable inbound_shipment_plan_request_items cannot be null');
        }
