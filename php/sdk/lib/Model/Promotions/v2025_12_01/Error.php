...
class Error implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'message' => 'string',
        'details' => 'string',
        'item_identifier' => '\SpApi\Model\Promotions\v2025_12_01\ItemIdentifier'];
    ...
    public function setMessage(string $message): self
    {
        ...
        if (!ObjectSerializer::getSkipModelValidation()) {
            if (mb_strlen($message) > 1024) {
                throw new \InvalidArgumentException('invalid length for $message when calling Error., must be smaller than or equal to 1024.');
            }
        }
     ...
     *
     * @param null|ItemIdentifier $item_identifier item_identifier
     */
    public function setItemIdentifier(?ItemIdentifier $item_identifier): self
    {
