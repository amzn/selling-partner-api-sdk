...
class Currency implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setAmount(float $amount): self
    {
        ...
        if (!ObjectSerializer::getSkipModelValidation()) {
            if ($amount <= 0) {
                throw new \InvalidArgumentException('invalid value for $amount when calling Currency., must be bigger than 0.');
            }
        }
    ...
    public function setCurrencyCode(string $currency_code): self
    {
        ...
        if (!ObjectSerializer::getSkipModelValidation()) {
            if (mb_strlen($currency_code) > 3) {
                throw new \InvalidArgumentException('invalid length for $currency_code when calling Currency., must be smaller than or equal to 3.');
            }
            if (mb_strlen($currency_code) < 3) {
                throw new \InvalidArgumentException('invalid length for $currency_code when calling Currency., must be bigger than or equal to 3.');
            }
        }
