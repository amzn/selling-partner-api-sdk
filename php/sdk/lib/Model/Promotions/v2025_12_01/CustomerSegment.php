...
class CustomerSegment implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'segment_type' => '\SpApi\Model\Promotions\v2025_12_01\CustomerSegmentType',
        'segment_id' => 'string',
        'segment_details' => '\SpApi\Model\Promotions\v2025_12_01\CustomerSegmentDetails'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['segment_type']) {
            $invalidProperties[] = "'segment_type' can't be null";
        }
        if (null === $this->container['segment_id']) {
     ...
     * Sets segment_type.
     *
     * @param string $segment_type segment_type
     */
    public function setSegmentType(string $segment_type): self
    {
     ...
     * Sets segment_id.
     *
     * @param string $segment_id The segment identifier. For `BRAND`: the segment / audience ID. For `PROGRAM`: the program name (for example, `PRIME_EXCLUSIVE`, `MOM`, `STUDENT` etc).
     */
    public function setSegmentId(string $segment_id): self
    {
     ...
     */
    public function getSegmentDetails(): ?CustomerSegmentDetails
    {
     ...
     *
     * @param null|CustomerSegmentDetails $segment_details segment_details
     */
    public function setSegmentDetails(?CustomerSegmentDetails $segment_details): self
    {
