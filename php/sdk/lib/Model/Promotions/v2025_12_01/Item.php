...
class Item implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'asin' => 'string',
        'sku' => 'string',
        'benefit' => '\SpApi\Model\Promotions\v2025_12_01\ItemBenefit',
     ...
     * Sets asin.
     *
     * @param null|string $asin the Amazon Standard Identification Number (ASIN) is the unique identifier for an item in the Amazon catalog
     */
     ...
     * Sets sku.
     *
     * @param null|string $sku the Stock Keeping Unit (SKU)
     */
     ...
     * Gets benefit.
     */
    public function getBenefit(): ?ItemBenefit
    {
     ...
     * Sets benefit.
     *
     * @param null|ItemBenefit $benefit benefit
     */
    public function setBenefit(?ItemBenefit $benefit): self
    {
        if (is_null($benefit)) {
