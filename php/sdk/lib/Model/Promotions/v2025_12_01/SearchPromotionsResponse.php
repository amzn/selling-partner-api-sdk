...
/**
 * SearchPromotionsResponse Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class SearchPromotionsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'SearchPromotionsResponse';
    ...
    protected static array $openAPITypes = [
        'total_results' => 'int',
        'pagination' => '\SpApi\Model\Promotions\v2025_12_01\Pagination',
        'promotions' => '\SpApi\Model\Promotions\v2025_12_01\PromotionSummary[]'];
     ...
     * Sets total_results.
     *
     * @param int $total_results The total number of promotions matching the search criteria, across all pages. This count remains consistent across paginated requests. **Note:** In rare cases, individual records cannot be returned and are omitted from the response. When this happens, a page may contain fewer items than expected, and the combined number of items across all pages may be less than `totalResults`. The request itself still completes successfully.
     */
    public function setTotalResults(int $total_results): self
    {
        ...
        if (!ObjectSerializer::getSkipModelValidation()) {
            if ($total_results < 0) {
                throw new \InvalidArgumentException('invalid value for $total_results when calling SearchPromotionsResponse., must be bigger than or equal to 0.');
            }
        }
     ...
     * Sets promotions.
     *
     * @param array $promotions a list of promotion summaries that matches the search criteria
     */
