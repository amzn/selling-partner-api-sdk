 ...
 */
class ItemIssue implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'ItemIssue';
    ...
    protected static array $openAPITypes = [
        ...
        'message' => 'string',
        'severity' => 'string',
        'identifier' => '\SpApi\Model\Promotions\v2025_12_01\ItemIdentifier'];
    ...
    public function setMessage(string $message): self
    {
        ...
        if (!ObjectSerializer::getSkipModelValidation()) {
            if (mb_strlen($message) > 1024) {
                throw new \InvalidArgumentException('invalid length for $message when calling ItemIssue., must be smaller than or equal to 1024.');
            }
        }
