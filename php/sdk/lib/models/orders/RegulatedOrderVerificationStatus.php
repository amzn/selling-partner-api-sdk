...
class RegulatedOrderVerificationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => '\OpenAPI\Client\models\orders\VerificationStatus',
        'requires_merchant_action' => 'bool',
        'valid_rejection_reasons' => '\OpenAPI\Client\models\orders\RejectionReason[]',
        'rejection_reason' => '\OpenAPI\Client\models\orders\RejectionReason',
        'review_date' => 'string',
        'external_reviewer_id' => 'string',
        'valid_verification_details' => '\OpenAPI\Client\models\orders\ValidVerificationDetail[]'
    ];
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\models\orders\VerificationStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\models\orders\VerificationStatus $status status
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\models\orders\RejectionReason[]
     */
     ...
     *
     * @param \OpenAPI\Client\models\orders\RejectionReason[] $valid_rejection_reasons A list of valid rejection reasons that may be used to reject the order's regulated information.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\models\orders\RejectionReason|null
     */
     ...
     *
     * @param \OpenAPI\Client\models\orders\RejectionReason|null $rejection_reason rejection_reason
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\models\orders\ValidVerificationDetail[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\models\orders\ValidVerificationDetail[]|null $valid_verification_details A list of valid verification details that may be provided and the criteria required for when the verification detail can be provided.
     *
     * @return self
     */
