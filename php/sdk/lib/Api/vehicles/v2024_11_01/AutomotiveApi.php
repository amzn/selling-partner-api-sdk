...
class AutomotiveApi
{
    ...
    public function __construct(
        ...
        if ($rateLimiterEnabled) {
            ...
            $factory = new RateLimiterFactory(Configuration::getRateLimitOptions('AutomotiveApi-getVehicles'), $this->rateLimitStorage);
            $this->getVehiclesRateLimiter = $factory->create('AutomotiveApi-getVehicles');
        }
