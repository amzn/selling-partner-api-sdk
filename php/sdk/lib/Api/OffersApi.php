...
class OffersApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\replenishment\ListOfferMetricsRequest|null $body
     *  The request body for the &#x60;listOfferMetrics&#x60; operation. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse
     */
    public function listOfferMetrics(
        ?\OpenAPI\Client\Model\replenishment\ListOfferMetricsRequest $body = null
    ): \OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listOfferMetricsWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\replenishment\ErrorList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\replenishment\ErrorList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\replenishment\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Model\replenishment\ListOfferMetricsResponse';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\replenishment\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\replenishment\ListOffersRequest|null $body
     *  The request body for the &#x60;listOffers&#x60; operation. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\replenishment\ListOffersResponse
     */
    public function listOffers(
        ?\OpenAPI\Client\Model\replenishment\ListOffersRequest $body = null
    ): \OpenAPI\Client\Model\replenishment\ListOffersResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\replenishment\ListOffersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listOffersWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\replenishment\ListOffersResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\replenishment\ListOffersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\replenishment\ListOffersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\replenishment\ListOffersResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
