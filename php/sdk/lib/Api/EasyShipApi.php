...
class EasyShipApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\easyship\CreateScheduledPackageRequest $create_scheduled_package_request
     *  The request schema for the &#x60;createScheduledPackage&#x60; operation. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\easyship\Package
     */
    public function createScheduledPackage(
        \OpenAPI\Client\Model\easyship\CreateScheduledPackageRequest $create_scheduled_package_request
    ): \OpenAPI\Client\Model\easyship\Package {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\easyship\Package, HTTP status code, HTTP response headers (array of strings)
     */
    public function createScheduledPackageWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\easyship\Package' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\easyship\Package' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\easyship\Package', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\easyship\ErrorList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\easyship\ErrorList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\easyship\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Model\easyship\Package';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\easyship\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\easyship\CreateScheduledPackagesRequest $create_scheduled_packages_request
     *  The request schema for the &#x60;createScheduledPackageBulk&#x60; operation. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse
     */
    public function createScheduledPackageBulk(
        \OpenAPI\Client\Model\easyship\CreateScheduledPackagesRequest $create_scheduled_packages_request
    ): \OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createScheduledPackageBulkWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\easyship\CreateScheduledPackagesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  \OpenAPI\Client\Model\easyship\ListHandoverSlotsRequest|null $list_handover_slots_request
     *  The request schema for the &#x60;listHandoverSlots&#x60; operation. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse
     */
    public function listHandoverSlots(
        ?\OpenAPI\Client\Model\easyship\ListHandoverSlotsRequest $list_handover_slots_request = null
    ): \OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listHandoverSlotsWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\easyship\ListHandoverSlotsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  \OpenAPI\Client\Model\easyship\UpdateScheduledPackagesRequest|null $update_scheduled_packages_request
     *  The request schema for the &#x60;updateScheduledPackages&#x60; operation. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\easyship\Packages
     */
    public function updateScheduledPackages(
        ?\OpenAPI\Client\Model\easyship\UpdateScheduledPackagesRequest $update_scheduled_packages_request = null
    ): \OpenAPI\Client\Model\easyship\Packages {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\easyship\Packages, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateScheduledPackagesWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\easyship\Packages' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\easyship\Packages' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\easyship\Packages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\easyship\Packages';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
