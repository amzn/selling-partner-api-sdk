...
class ProductPricingApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchRequest $requests
     *  The batch of &#x60;getCompetitiveSummary&#x60; requests. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse
     */
    public function getCompetitiveSummary(
        \OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchRequest $requests
    ): \OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompetitiveSummaryWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\pricing\Errors' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\pricing\Errors' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\pricing\Errors', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\OpenAPI\Client\Model\pricing\CompetitiveSummaryBatchResponse';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\pricing\Errors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchRequest $get_featured_offer_expected_price_batch_request_body
     *  The batch of &#x60;getFeaturedOfferExpectedPrice&#x60; requests. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse
     */
    public function getFeaturedOfferExpectedPriceBatch(
        \OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchRequest $get_featured_offer_expected_price_batch_request_body
    ): \OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeaturedOfferExpectedPriceBatchWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\pricing\GetFeaturedOfferExpectedPriceBatchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
