...
class SolicitationsApi
{
     ...
     * @return \OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse
     */
    public function createProductReviewAndSellerFeedbackSolicitation(
        string $amazon_order_id,
        array $marketplace_ids
    ): \OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse
     */
    public function getSolicitationActionsForOrder(
        string $amazon_order_id,
        array $marketplace_ids
    ): \OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSolicitationActionsForOrderWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\solicitations\GetSolicitationActionsForOrderResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
