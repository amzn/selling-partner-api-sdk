...
class SalesApi
{
     ...
     * @return \OpenAPI\Client\Model\sales\GetOrderMetricsResponse
     */
    public function getOrderMetrics(
        ...
        ?string $asin = null,
        ?string $sku = null
    ): \OpenAPI\Client\Model\sales\GetOrderMetricsResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\sales\GetOrderMetricsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderMetricsWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\sales\GetOrderMetricsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\sales\GetOrderMetricsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\sales\GetOrderMetricsResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\sales\GetOrderMetricsResponse';
