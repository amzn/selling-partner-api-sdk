...
use SpApi\Model\finances\v0\ListTransactionsResponse;
...
class DefaultApi
{
     ...
     *                                            The ID of the marketplace from which you want to retrieve transactions. (required)
     * @param null|\DateTime $posted_before
     *                                            The response includes financial events posted before (but not on) this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.  The date-time must be later than &#x60;PostedAfter&#x60; and more than two minutes before the request was submitted. If &#x60;PostedAfter&#x60; and &#x60;PostedBefore&#x60; are more than 180 days apart, the response is empty. If you include the &#x60;PostedBefore&#x60; parameter in your request, you must also specify the &#x60;PostedAfter&#x60; parameter.  **Default:** Two minutes before the time of the request. (optional)
     * @param null|string    $next_token
     *                                            The response includes &#x60;nextToken&#x60; when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until &#x60;nextToken&#x60; is null. Note that this operation can return empty pages. (optional)
    ...
    public function listTransactions(
        ...
        list($response) = $this->listTransactionsWithHttpInfo($posted_after, $marketplace_id, $posted_before, $next_token, $restrictedDataToken);
     ...
     * @param null|string    $restrictedDataToken Restricted Data Token (RDT) for accessing restricted resources (optional, required for operations that return PII)
     *
     * @return array of \SpApi\Model\finances\v0\ListTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function listTransactionsWithHttpInfo(
        ...
        $request = $this->listTransactionsRequest($posted_after, $marketplace_id, $posted_before, $next_token);
        if (null !== $restrictedDataToken) {
        ...
        try {
            ...
            if ('\SpApi\Model\finances\v0\ListTransactionsResponse' === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
                if ('\SpApi\Model\finances\v0\ListTransactionsResponse' !== 'string') {
                    $content = json_decode($content);
                }
            }

            return [
                ObjectSerializer::deserialize($content, '\SpApi\Model\finances\v0\ListTransactionsResponse', []),
                $response->getStatusCode(),
                $response->getHeaders(),
            ];
        } catch (ApiException $e) {
            $data = ObjectSerializer::deserialize(
                $e->getResponseBody(),
                '\SpApi\Model\finances\v0\ListTransactionsResponse',
                $e->getResponseHeaders()
            );
            $e->setResponseObject($data);
    ...
    public function listTransactionsAsync(
        ...
        return $this->listTransactionsAsyncWithHttpInfo($posted_after, $marketplace_id, $posted_before, $next_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function listTransactionsAsyncWithHttpInfo(
        ...
        $returnType = '\SpApi\Model\finances\v0\ListTransactionsResponse';
        $request = $this->listTransactionsRequest($posted_after, $marketplace_id, $posted_before, $next_token);
        if (null !== $restrictedDataToken) {
            $request = RestrictedDataTokenSigner::sign($request, $restrictedDataToken, 'DefaultApi-listTransactions');
        } else {
    ...
    public function listTransactionsRequest(
        ...
        if (null === $marketplace_id || (is_array($marketplace_id) && 0 === count($marketplace_id))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketplace_id when calling listTransactions'
            );
        }

        $resourcePath = '/finances/v0/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
