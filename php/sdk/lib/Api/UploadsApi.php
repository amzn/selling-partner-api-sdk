...
class UploadsApi
{
     ...
     *  A list of marketplace identifiers. This specifies the marketplaces where the upload will be available. Only one marketplace can be specified. (required)
     ...
     * @return \OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse
     */
    ...
    ): \OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUploadDestinationForResourceWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\uploads\CreateUploadDestinationResponse';
