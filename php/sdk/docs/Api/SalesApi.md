...
```php
getOrderMetrics($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku): \OpenAPI\Client\Model\sales\GetOrderMetricsResponse
```
...
[**\OpenAPI\Client\Model\sales\GetOrderMetricsResponse**](../Model/GetOrderMetricsResponse.md)
