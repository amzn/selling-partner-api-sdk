...
```php
createReport($body): \OpenAPI\Client\Model\reports\CreateReportResponse
```
...
$body = new \OpenAPI\Client\Model\reports\CreateReportSpecification(); // \OpenAPI\Client\Model\reports\CreateReportSpecification | Information required to create the report.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\OpenAPI\Client\Model\reports\CreateReportSpecification**](../Model/CreateReportSpecification.md)| Information required to create the report. | |

### Return type

[**\OpenAPI\Client\Model\reports\CreateReportResponse**](../Model/CreateReportResponse.md)
...
```php
createReportSchedule($body): \OpenAPI\Client\Model\reports\CreateReportScheduleResponse
```
...
$body = new \OpenAPI\Client\Model\reports\CreateReportScheduleSpecification(); // \OpenAPI\Client\Model\reports\CreateReportScheduleSpecification | Information required to create the report schedule.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\OpenAPI\Client\Model\reports\CreateReportScheduleSpecification**](../Model/CreateReportScheduleSpecification.md)| Information required to create the report schedule. | |

### Return type

[**\OpenAPI\Client\Model\reports\CreateReportScheduleResponse**](../Model/CreateReportScheduleResponse.md)
...
```php
getReport($report_id): \OpenAPI\Client\Model\reports\Report
```
...
[**\OpenAPI\Client\Model\reports\Report**](../Model/Report.md)
...
```php
getReportDocument($report_document_id): \OpenAPI\Client\Model\reports\ReportDocument
```
...
[**\OpenAPI\Client\Model\reports\ReportDocument**](../Model/ReportDocument.md)
...
```php
getReportSchedule($report_schedule_id): \OpenAPI\Client\Model\reports\ReportSchedule
```
...
[**\OpenAPI\Client\Model\reports\ReportSchedule**](../Model/ReportSchedule.md)
...
```php
getReportSchedules($report_types): \OpenAPI\Client\Model\reports\ReportScheduleList
```
...
[**\OpenAPI\Client\Model\reports\ReportScheduleList**](../Model/ReportScheduleList.md)
...
```php
getReports($report_types, $processing_statuses, $marketplace_ids, $page_size, $created_since, $created_until, $next_token): \OpenAPI\Client\Model\reports\GetReportsResponse
```
...
$created_since = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The earliest report creation date and time for reports to include in the response, in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. The default is 90 days ago. Reports are retained for a maximum of 90 days.
$created_until = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The latest report creation date and time for reports to include in the response, in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. The default is now.
...
[**\OpenAPI\Client\Model\reports\GetReportsResponse**](../Model/GetReportsResponse.md)
