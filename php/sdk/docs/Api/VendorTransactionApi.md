...
```php
getTransaction($transaction_id): \OpenAPI\Client\Model\vendor\transactionStatus\GetTransactionResponse
```
...
[**\OpenAPI\Client\Model\vendor\transactionStatus\GetTransactionResponse**](../Model/GetTransactionResponse.md)
