...
**order_total** | [**\OpenAPI\Client\models\orders\Money**](Money.md) |  | [optional]
...
**payment_execution_detail** | [**\OpenAPI\Client\models\orders\PaymentExecutionDetailItem[]**](PaymentExecutionDetailItem.md) | A list of payment execution detail items. | [optional]
...
**easy_ship_shipment_status** | [**\OpenAPI\Client\models\orders\EasyShipShipmentStatus**](EasyShipShipmentStatus.md) |  | [optional]
...
**default_ship_from_location_address** | [**\OpenAPI\Client\models\orders\Address**](Address.md) |  | [optional]
...
**buyer_tax_information** | [**\OpenAPI\Client\models\orders\BuyerTaxInformation**](BuyerTaxInformation.md) |  | [optional]
**fulfillment_instruction** | [**\OpenAPI\Client\models\orders\FulfillmentInstruction**](FulfillmentInstruction.md) |  | [optional]
...
**marketplace_tax_info** | [**\OpenAPI\Client\models\orders\MarketplaceTaxInfo**](MarketplaceTaxInfo.md) |  | [optional]
...
**buyer_info** | [**\OpenAPI\Client\models\orders\BuyerInfo**](BuyerInfo.md) |  | [optional]
**automated_shipping_settings** | [**\OpenAPI\Client\models\orders\AutomatedShippingSettings**](AutomatedShippingSettings.md) |  | [optional]
...
**electronic_invoice_status** | [**\OpenAPI\Client\models\orders\ElectronicInvoiceStatus**](ElectronicInvoiceStatus.md) |  | [optional]
