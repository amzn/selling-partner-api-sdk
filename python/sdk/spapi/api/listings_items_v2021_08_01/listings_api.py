...
class ListingsApi(object):
    ...
    api_models_module = "spapi.spapi.models.listings_items_v2021_08_01"
    ...
    def delete_listings_item(self, seller_id, sku, marketplace_ids, **kwargs):  # noqa: E501
        ...
        :param List[str] marketplace_ids: A comma-delimited list of Amazon store identifiers for the request. (required)
        :param str issue_locale: A locale for localization of issues. When not provided, the default language code of the first Amazon store is used. Examples: `en_US`, `fr_CA`, `fr_FR`. Localized messages default to `en_US` when localization is not available for the specified locale.
    ...
    def patch_listings_item(self, seller_id, sku, marketplace_ids, body, **kwargs):  # noqa: E501
        ...
        :param str mode: Describes the mode of operation for the request.
        :param str issue_locale: A locale for localization of issues. When not provided, the default language code of the first Amazon store is used. Examples: `en_US`, `fr_CA`, `fr_FR`. Localized messages default to `en_US` when localization is not available for the specified locale.
        :return: ListingsItemSubmissionResponse
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def search_listings_items(self, seller_id, marketplace_ids, **kwargs):  # noqa: E501
        ...
        :param str seller_id: A selling partner identifier, such as a merchant account or vendor code. (required)
        :param List[str] marketplace_ids: A comma-delimited list of Amazon store identifiers for the request. (required)
        :param str issue_locale: A locale that is used to localize issues. When not provided, the default language code of the first Amazon store is used. Examples: \"en_US\", \"fr_CA\", \"fr_FR\". When a localization is not available in the specified locale, localized messages default to \"en_US\".
        :param List[str] included_data: A comma-delimited list of data sets that you want to include in the response. Default: `summaries`.
