...
class VendorShipmentApi(object):
    ...
    def submit_shipment_confirmation(self, body, **kwargs):  # noqa: E501
        """SubmitShipmentConfirmation  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submit_shipment_confirmation(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SubmitShipmentConfirmationRequest body: A request to submit shipment confirmation. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.submit_shipment_confirmation_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.submit_shipment_confirmation_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def submit_shipment_confirmation_with_http_info(self, body, **kwargs):  # noqa: E501
        """SubmitShipmentConfirmation  # noqa: E501

        Submits one shipment confirmation for vendor orders and get response immediately.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submit_shipment_confirmation_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method submit_shipment_confirmation" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `submit_shipment_confirmation`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SubmitShipmentConfirmationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
