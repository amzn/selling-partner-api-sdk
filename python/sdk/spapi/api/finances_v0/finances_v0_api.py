...
class FinancesV0Api(object):
    ...
    def list_transactions(self, posted_after, marketplace_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_transactions(posted_after, marketplace_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param datetime posted_after: The response includes financial events posted after (or on) this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The date-time must be more than two minutes before the time of the request. (required)
        :param str marketplace_id: The ID of the marketplace from which you want to retrieve transactions. (required)
        :param datetime posted_before: The response includes financial events posted before (but not on) this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.  The date-time must be later than `PostedAfter` and more than two minutes before the request was submitted. If `PostedAfter` and `PostedBefore` are more than 180 days apart, the response is empty. If you include the `PostedBefore` parameter in your request, you must also specify the `PostedAfter` parameter.  **Default:** Two minutes before the time of the request.
        :param str next_token: The response includes `nextToken` when the number of results exceeds the specified `pageSize` value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until `nextToken` is null. Note that this operation can return empty pages.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_transactions_with_http_info(posted_after, marketplace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_transactions_with_http_info(posted_after, marketplace_id, **kwargs)  # noqa: E501
            return data

    def list_transactions_with_http_info(self, posted_after, marketplace_id, **kwargs):  # noqa: E501
        """list_transactions  # noqa: E501

        Returns transactions for the given parameters. Orders from the last 48 hours might not be included in financial events.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The preceding table contains the default rate and burst values for this operation. Selling partners whose business demands require higher throughput can have higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_transactions_with_http_info(posted_after, marketplace_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['posted_after', 'marketplace_id', 'posted_before', 'next_token']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('marketplace_id' not in params or
            ...
            raise ValueError("Missing the required parameter `marketplace_id` when calling `list_transactions`")  # noqa: E501
