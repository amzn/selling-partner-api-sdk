...
class GovernmentInvoiceRequest(object):
    ...
    def __init__(self, contexts=None, inbound_plan_id=None, invoice_type=None, marketplace_id=None, shipment_id=None, transaction_type=None, _configuration=None):  # noqa: E501
