...
class CarrierDetailsContext(object):
    ...
    def __init__(self, name=None, address=None, context_type=None, federal_tax_id=None, region_code=None, region_tax_id=None, vehicle_license_plate=None, vehicle_registration_region_code=None, _configuration=None):  # noqa: E501
