...
class ProductAdsPaymentEvent(object):
    ...
    def transaction_type(self):
        ...
        Indicates if the transaction is for a charge or a refund.  Possible values:  * `charge`  * `refund`  # noqa: E501
    ...
    def invoice_id(self):
        ...
        The identifier for the invoice that includes the transaction.  # noqa: E501
