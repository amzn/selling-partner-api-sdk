...
class FailedAdhocDisbursementEvent(object):
    ...
    def funds_transfers_type(self):
        ...
        The type of fund transfer. For example, `Refund`.  # noqa: E501
    ...
    def payment_disbursement_type(self):
        ...
        The type of payment for disbursement. For example, `CREDIT_CARD`.  # noqa: E501
    ...
    def status(self):
        ...
        The status of the failed `AdhocDisbursement`. For example, `HARD_DECLINED`.  # noqa: E501
