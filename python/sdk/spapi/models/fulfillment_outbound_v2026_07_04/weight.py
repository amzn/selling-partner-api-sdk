...
class Weight(object):
    ...
    def unit(self):
        ...
        The unit of weight. Possible values: `KG`, `KILOGRAMS`, `LB`, `POUNDS`.  # noqa: E501
    ...
    def value(self):
        ...
        A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows [RFC 7159](https://datatracker.ietf.org/doc/html/rfc7159) for number representation.  # noqa: E501
