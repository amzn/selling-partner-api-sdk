...
class Currency(object):
    ...
    def currency_amount(self):
        ...
        A signed decimal number.  # noqa: E501
    ...
    def currency_amount(self, currency_amount):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and currency_amount is None:
            raise ValueError("Invalid value for `currency_amount`, must not be `None`")  # noqa: E501
