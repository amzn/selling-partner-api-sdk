...
class ItemShippingConstraints(object):
    ...
    def __init__(self, pallet_delivery=None, cash_on_delivery=None, signature_confirmation=None, recipient_identity_verification=None, recipient_age_verification=None, _configuration=None):  # noqa: E501
