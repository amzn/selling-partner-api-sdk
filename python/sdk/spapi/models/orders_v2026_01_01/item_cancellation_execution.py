...
class ItemCancellationExecution(object):
    ...
    def __init__(self, cancelled_by=None, cancel_reason=None, _configuration=None):  # noqa: E501
        """ItemCancellationExecution - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemCancellationExecution, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemCancellationExecution):
            return False
