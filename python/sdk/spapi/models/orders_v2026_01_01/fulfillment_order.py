...
class FulfillmentOrder(object):
    ...
    def __init__(self, fulfillment_order_id=None, _configuration=None):  # noqa: E501
    ...
    def fulfillment_order_id(self, fulfillment_order_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and fulfillment_order_id is None:
