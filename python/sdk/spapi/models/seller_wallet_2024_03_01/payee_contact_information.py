...
class PayeeContactInformation(object):
    ...
    def __init__(self, payee_first_name=None, payee_middle_name=None, payee_last_name=None, address_line1=None, address_line2=None, city=None, state=None, postal_code=None, country=None, country_code=None, email_address=None, phone_number=None, payee_entity_type=None, _configuration=None):  # noqa: E501
    ...
    def payee_first_name(self, payee_first_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and payee_first_name is None:
    ...
    def payee_last_name(self, payee_last_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and payee_last_name is None:
    ...
    def payee_entity_type(self, payee_entity_type):
        ...
        """
        if self._configuration.client_side_validation and payee_entity_type is None:
